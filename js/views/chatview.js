...
(function (OCA, OC, OCP, Marionette, autosize, moment) {
    ...
    var ChatView = Marionette.View.extend({
        ...
        events: {
            ...
            'click .newCommentForm .icon-confirm': '_onSubmitNonTempComment',
            'click .newCommentForm .icon-confirm-temp': '_onSubmitTempComment',
        ...
        _onSubmitComment: function (e) {
            ...
            // Pass is-temp value to POST request.
            data.isTemp = $form.data("is-temp") || 0;
         ...
         * @private
         */
        _onSubmitNonTempComment: function (e) {
            $(e.target).closest(".newCommentForm").data("is-temp", 0).trigger("submit");
        },

        /**
         * On submit temp comment.
         * Only fired if temp icon is clicked manually.
         *
         * @param e
         * @private
         */
        _onSubmitTempComment: function (e) {
            if(e.hasOwnProperty("originalEvent") && e.originalEvent instanceof MouseEvent) {
                $(e.target).closest(".newCommentForm").data("is-temp", 1).trigger("submit");
            }
        },
        ...
        _onSubmitSuccess: function (model, $form) {
            ...
            /**
             * Send submitted message signal.
             * It submits to onSubmittedComment_ + current active room.
             *
             * @author Oozman
             */
            OCA.SpreedMe.app.signaling._trigger('onSubmittedComment_' + model.token, [model, $form.data("is-temp") || 0]);
