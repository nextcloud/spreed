...
export type paths = {
    ...
    "/ocs/v2.php/apps/spreed/api/{apiVersion}/live-transcription/translation-languages": {
         ...
         * @description The returned array provides a list of origin languages ("origin_languages") and a list of target languages ("target_languages"). Any origin language can be translated to any target language.
    ...
    "/ocs/v2.php/apps/spreed/api/{apiVersion}/live-transcription/{token}/target-language": {
         ...
         *     Translations are also implicitly enabled or disabled depending on whether the target language matches the original transcription language or not.
         *     translations are not supported.
         */
