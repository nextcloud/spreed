...
export type listThreadsParams = operations['thread-list-threads']['parameters']['query']
export type listThreadsResponse = ApiResponse<operations['thread-list-threads']['responses'][200]['content']['application/json']>
export type getThreadResponse = ApiResponse<operations['thread-get-thread']['responses'][200]['content']['application/json']>
export type makeThreadResponse = ApiResponse<operations['thread-make-thread']['responses'][200]['content']['application/json']>
