...
export type preserveConversationResponse = ApiResponse<operations['room-preserve-conversation']['responses'][200]['content']['application/json']>
export type unpreserveConversationResponse = ApiResponse<operations['room-unpreserve-conversation']['responses'][200]['content']['application/json']>
