...
<template>
	<NcAppSettingsDialog
		...
		<NcAppSettingsSectionShortcuts
			...
			<NcHotkeyList>
				<!-- <NcHotkey :label="t('spreed', 'Search')" hotkey="Control F" /> | Overriden by Unified Search-->
			...
			<NcHotkeyList :label="t('spreed', 'Shortcuts while in a chat')">
				...
				<!-- <NcHotkey :label="t('spreed', 'Unfocus the chat input to use shortcuts')" hotkey="Escape" /> | Do we need those? -->
				<NcHotkey :label="t('spreed', 'Edit your last message')" hotkey="Control ArrowUp" />
				<NcHotkey :label="t('spreed', 'Fullscreen the chat or call')" hotkey="F" />
			</NcHotkeyList>
...
import NcAppSettingsSectionShortcuts from '@nextcloud/vue/components/NcAppSettingsSectionShortcuts'
...
.app-settings-section {
	...
	&__version {
		margin: var(--border-radius-element);
		color: var(--color-text-maxcontrast);
	}
