...
export default {
	...
	data() {
		return {
			serverPH: t('spreed', 'Xmpp/Jabber server URL'),
			mucPH: t('spreed', 'MUC server URL'),
			jidPH: t('spreed', 'Jabber ID'),
			nickPH: t('spreed', 'Nick name'),
			passwordPH: t('spreed', 'User password'),
			channelPH: t('spreed', 'Channel'),
			readonly: true,
		}
	},
