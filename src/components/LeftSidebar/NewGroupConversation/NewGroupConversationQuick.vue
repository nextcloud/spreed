...
<template>
	<div class="wrapper">
		<button slot="trigger"
			v-tooltip.bottom="t('spreed','Create a quick group conversation')"
			class="toggle"
			icon=""
			:aria-label="t('spreed','Create a quick group conversation')"
			@click="showModal">
			<Plus decorative
				:size="24" />
		</button>
...
export default {
	...
	name: 'NewGroupConversationQuick',
