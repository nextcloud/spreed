			...
			expect(vuexStore.commit).toHaveBeenNthCalledWith(1, 'updateParticipant',
				{
					token: TOKEN,
					attendeeId: 1,
					updatedData: { attendeeId: 1, displayName: 'User 1', sessionIds: ['nextcloud-session-id-1'] }
				})
			expect(vuexStore.commit).toHaveBeenNthCalledWith(2, 'updateParticipant',
				{
					token: TOKEN,
					attendeeId: 2,
					updatedData: { attendeeId: 2, displayName: 'User 2', sessionIds: ['nextcloud-session-id-2'] }
				})
			expect(vuexStore.commit).toHaveBeenNthCalledWith(3, 'updateParticipant',
				{
					token: TOKEN,
			...
			expect(vuexStore.commit).toHaveBeenNthCalledWith(4, 'updateParticipant',
				{
					token: TOKEN,
					attendeeId: 4,
					updatedData: { attendeeId: 4, displayName: 'User 4', sessionIds: ['nextcloud-session-id-4'] }
				})
			expect(vuexStore.commit).toHaveBeenNthCalledWith(5, 'updateParticipant',
				{
					token: TOKEN,
					attendeeId: 5,
					updatedData: { attendeeId: 5, displayName: 'Guest', sessionIds: ['nextcloud-session-id-5'] }
				})
		})
