...
export const useSettingsStore = defineStore('settings', () => {
	...
	/**
	 * Update when archived conversations are unarchived automatically
	 *
	 * @param value - the unarchive mode ('never', 'mention', 'always')
	 */
	async function updateUnarchive(value: UNARCHIVE_OPTIONS) {
		await setConversationsUnarchive(value)
		unarchive.value = value
	}
