...
- [Room management](#room-management)
  ...
  * [Pin a room](#pin-a-room)
  * [Unpin a room](#unpin-a-room)
...
### 3.3
* `pin-room` - Rooms can be pinned which will stick them to the top of the room list.
...
* Response:
    ...
    - Data:
        ...
        `isPinned` | bool | Flag if the room is pinned by the user
