...
| `start_group_conversation`           | ,string[]                                                        | `[]`       | Yes  | 🖌️    | List of group ids that are allowed to create group conversations                                                                                                                  |
| `start_public_conversation`          | ,string[]                                                        | `[]`       | Yes  | 🖌️    | List of group ids that are allowed to create public conversations                                                                                                                 |
