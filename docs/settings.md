...
| `allowed_recording_mimes`            | string[]                                                         | `{"audio\/ogg":["ogg"],"video\/ogg":["ogv"],"video\/x-matroska":["mkv"]}` |        | List of mime types and associated extensions of recording formats accepted by recording API                                                                                       |
