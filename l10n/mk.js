OC.L10N.register(
    ...
    "The TURN server settings are valid." : "Параметрите на TURN серверот се валидни.",
    "Checking TURN server {server}" : "Проверка на TURN серверот {server}",
    ...
    "Password request by %s" : "Барање за лозинка од %s",
    "_%n other guest_::_%n other guests_" : ["1 гостин","%n други гости"],
    ", " : ", ",
    "%s mentioned you in a private conversation" : "%s те спомна во приватен разговор",
    "%s mentioned you in a group conversation: %s" : "%s те спомна во групен разговор: %s",
    "{user} mentioned you in a group conversation: {call}" : "{user} те спомна во групен разговор: {call}",
    "%s mentioned you in a group conversation" : "%s те спомна во групен разговор",
    "{user} mentioned you in a group conversation" : "{user} те спомна во групен разговор",
    "You were mentioned in a group conversation by a deleted user: %s" : "Бевте спомнати во групен разговор од озбришан корисник: %s",
    "You were mentioned in a group conversation by a deleted user: {call}" : "Бевте спомнати во групен разговор од озбришан корисник: {call}",
    "You were mentioned in a group conversation by a deleted user" : "Бевте спомнати во групен разговор од озбришан корисник",
    "A guest mentioned you in a group conversation: %s" : "Гостин те спомна во групен разговор: %s",
    "A guest mentioned you in a group conversation: {call}" : "Гостин те спомна во групен разговор: {call}",
    "A guest mentioned you in a group conversation" : "Гостин те спомна во групен разговор",
