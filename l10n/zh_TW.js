OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- 版主現在可以釘選訊息，使其保持在頂端顯示",
    "- Schedule a message to send it at a later time" : "- 排程訊息以便稍後發送",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- 對話標籤、分組及排序功能，方便整理對話清單",
    "- Voice-rooms to connect spontaneously" : "- 音訊聊天室，隨時隨地輕鬆連線",
    ...
    "- Channels and announcements to broadcast information to a broader audience" : "- 透過各類頻道及公告，向更廣泛的受眾廣播資訊",
    ...
    "{actor} preserved the conversation" : "{actor} 保留了這段對話",
    "You preserved the conversation" : "您保留了這段對話",
    "An administrator preserved the conversation" : "管理員保留了這段對話",
    "{actor} stopped preserving the conversation" : "{actor} 停止保留該對話",
    "You stopped preserving the conversation" : "您停止保留該對話",
    "An administrator stopped preserving the conversation" : "管理員停止保留該對話",
    ...
    "System added you" : "系統新增了您",
    "System added {user}" : "系統新增了 {user}",
    ...
    "{actor} promoted {user} to owner" : "{actor} 將 {user} 升級為擁有者",
    "You promoted {user} to owner" : "您將 {user} 升級為擁有者",
    "{actor} promoted you to owner" : "{actor} 將您升級為擁有者",
    "An administrator promoted you to owner" : "管理員將您升級為擁有者",
    "An administrator promoted {user} to owner" : "管理員將 {user} 升級為擁有者",
    "{actor} demoted {user} from owner" : "{actor} 將 {user} 從擁有者降級",
    "You demoted {user} from owner" : "您將 {user} 從擁有者降級",
    "{actor} demoted you from owner" : "{actor} 將您從擁有者降級",
    "An administrator demoted you from owner" : "管理員將您從擁有者降級",
    "An administrator demoted {user} from owner" : "管理員將將 {user} 從擁有者降級",
    ...
    "Missing %s field in header line" : "標題行中缺少 %s 欄位",
    ...
    "Reminder: {user} in private conversation" : "提醒：{user} 在私聊中",
    ...
    "Client Push" : "客戶端推播",
    "Client Push is installed, this improves the punctuality of Talk notifications." : "已安裝客戶端推播，這可以改善 Talk 通知的即時性。",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "尚未安裝 {notify_push}。這可能會導致 Talk 通知延遲。",
    ...
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "在至少選取一個群組時，只有這些群組的成員才能發起通話。此限制也適用於主持人，而訪客與聯盟使用者則永遠不會是這些群組的成員。若未選取任何群組，則所有人都仍可以發起通話。",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "對於在聯盟伺服器上舉行的對話，則會套用主機伺服器的設定。",
    ...
    "Enable live transcription (generated by AI)" : "啟用即時轉錄（由人工智慧產生）",
    "Enable live transcription (Live transcriptions app is not installed)" : "啟用即時轉錄（未安裝即時轉錄應用程式）",
    "Disable live translation" : "停用即時翻譯",
    "Enable live translation (generated by AI)" : "啟用即時翻譯（由人工智慧產生）",
    "Original language" : "原始語言",
    "Live translations app is not installed" : "即時轉錄應用程式未安裝",
    "Original language: {languageName}" : "原始語言：{languageName}",
    "Translated language" : "翻譯後的語言",
    "Translated language: {languageName}" : "翻譯後的語言：{languageName}",
    "Exit full screen (F)" : "離開全螢幕 (F)",
    "Full screen (F)" : "全螢幕 (F)",
    "Grid view" : "格狀檢視",
    "Speaker view" : "演講者檢視",
    "Multi-speaker view" : "多演講者檢視",
    ...
    "Failed to enable live translations" : "啟用即時翻譯失敗",
    "Failed to disable live translations" : "停用即時翻譯失敗",
    "End call" : "結束通話",
    "More actions" : "更多動作",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "在主持人手動授予額外權限之前，參與者只能使用有限的功能。",
    ...
    "Live transcriptions app is not installed" : "即時轉錄應用程式未安裝",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "這段對話已保留。它無法被刪除，其中的聊天訊息也無法清除。",
    ...
    "This setting can not be changed while the conversation is preserved." : "在對話被保留期間，此設定無法變更。",
    ...
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "雖然此對話已保留，但無法刪除，其聊天紀錄亦無法清除，且無法變更訪客及可加入的設定。",
    "Only the owner can change whether this conversation is preserved." : "只有該對話的擁有者才能決定是否保留這則對話。",
    ...
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "若您停止保留這段對話，該對話可能會被刪除，其聊天紀錄可能會被清除，且訪客與可加入設定可能會再次被變更。",
    "Conversation" : "對話",
    "To confirm, type the conversation token into the field below:" : "請在下方欄位中輸入對話權杖以進行確認：",
    "Ongoing" : "持續進行",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "內容格式為逗號分隔值 (CSV)：<br/>- 標題行為必填，且必須符合 {sample1} 或 {sample2}<br/>- 一行一個條目（例如 {sample3}）",
    ...
    "Join conversations from other servers" : "加入來自其他伺服器的對話",
    ...
    "Enable noise suppression" : "啟用雜訊抑制",
    "Reduce background noises for better voice quality" : "降低背景雜音，改善語音品質",
    "Basic" : "基本",
    "Advanced" : "進階",
    "Enable echo cancellation" : "啟用迴音消除",
    "Minimize echo effect from own surrounding" : "盡量減少自身周圍環境造成的迴音效應",
    ...
    "Keep pinned for" : "維持釘選狀態",
    "Set custom period" : "設定自訂週期",
    ...
    "Translate to" : "翻譯至",
    "Translating" : "正在翻譯",
    "This translation is AI generated and may contain mistakes." : "此翻譯為人工智慧產生，可能會出錯。",
    "Copy translated text" : "複製已翻譯的文字",
    "Error when scheduling the message" : "安排訊息時發生錯誤",
    "Reschedule" : "重新安排",
    "Send now" : "立刻傳送",
    "Choose a time" : "選擇時間",
    "Send at custom time" : "於自訂時間傳送",
    "Will be sent without notification" : "將不另行通知即寄出",
    ...
    "Reply to thread \"{threadTitle}\"" : "回覆至討論串「{threadTitle}」",
    ...
    "Generate summary with AI" : "使用人工智慧產生摘要",
    "{author} (pinned by you)" : "{author}（由您釘選）",
    "{author} (pinned by {actor})" : "{author}（由 {actor} 釘選）",
    "Unpin" : "取消釘選",
    "Cancel search" : "取消搜尋",
    ...
    "Message was successfully scheduled" : "訊息已成功排定",
    "Add emoji" : "新增表情符號",
    "Adding a mention will only notify users who did not read the message." : "新增提及僅會通知尚未閱讀訊息的使用者。",
    "Thread title" : "討論串標題",
    "Send later" : "稍後傳送",
    "Show scheduled messages" : "顯示已排定的訊息",
    "Cancel editing" : "取消編輯",
    "Schedule message" : "安排訊息",
    ...
    "Voice message {time} ({conversation})" : "語音訊息 {time} ({conversation})",
    ...
    "Standard image quality" : "標準影像品質",
    "Original image quality" : "原始影像品質",
    ...
    "Skip the lobby" : "略過大廳",
    "Post messages" : "張貼訊息",
    "Post messages and reactions" : "張貼訊息與回應",
    "Add reactions" : "新增回應",
    ...
    "The last moderator of a conversation can not be demoted" : "某場對話的最後一位主持人無法被降級",
    "Could not change the type of the participant" : "無法變更參與者類型",
    ...
    "Participants" : "參與者",
    "Pinned by a deleted user" : "由已刪除的使用者釘選",
    ...
    "Save name" : "儲存名稱",
    "I picked message bubbles" : "我選了訊息泡泡",
    ...
    "Error when trying to load the available live translation languages" : "嘗試載入可用即時翻譯語言時發生錯誤",
    "Error when trying to set live translation language" : "嘗試設定即時翻譯語言時發生錯誤",
    ...
    "Camera will be turned off when joining. Always shown if recording consent is required." : "加入時將關閉攝影機。若需取得錄影同意，此訊息將一律顯示。",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["此對話將在%n分鐘內不活躍的情況下自動為所有人刪除。"],
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "此對話已於其他分頁開啟。目前的伺服器版本不支援在多個分頁開啟同一個對話。",
    ...
    "Another user" : "其他使用者",
    "Hey! Are you using the list style or message bubbles?" : "嘿！您想要使用清單樣式或訊息泡泡呢？",
    ...
    "Audio" : "音訊",
    "Show all pinned messages" : "顯示所有釘選訊息",
    ...
    "{actor} demoted you and {user0} from moderators" : "{actor} 將您與 {user0} 從主持人降級",
    ...
    "Error while changing the preserved status of the conversation" : "變更對話的「已保留」狀態時發生錯誤",
    ...
    "The server is in maintenance mode." : "伺服器處於維護模式。",
    "Federated server was updated." : "聯盟伺服器已更新。",
    ...
    "Connecting is taking longer than expected …" : "連線時間比預期更長……",
    "Failed to connect. Retrying …" : "連線失敗。正在重試……",
    "Failed to connect. The signaling server may be set up incorrectly" : "無法連線。訊號伺服器可能設定錯誤",
