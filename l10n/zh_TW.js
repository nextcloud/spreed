OC.L10N.register(
    ...
    "Now" : "現在",
    "Error: Invalid calendar selected" : "錯誤：選取了無效的日曆",
    "Error: Invalid start time selected" : "錯誤：選取了無效的開始時間",
    "Error: Invalid end time selected" : "錯誤：選取了無效的結束時間",
    ...
    "To" : "至",
    "Calendar" : "行事曆",
    "Invite all users and email guests" : "邀請所有使用者與電子郵件訪客",
    "Select attendees" : "選取參與者",
    "Save" : "儲存",
    "Search participants" : "搜尋參與者",
    "No results" : "沒有符合搜尋的項目",
    "_Sending %n invitation_::_Sending %n invitations_" : ["傳送 %n 封邀請"],
