OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 讓對話流暢：提及使用者、對訊息做出反應等\n\n您可以 @all 提及對話中的所有人，或者輸入「@」並從清單中選擇特定參與者的名字來提及他們。",
