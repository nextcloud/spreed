OC.L10N.register(
    ...
    "Defining multiple High-performance backends is deprecated and will no longer be supported in the upcoming version. Instead a load-balancer should be set up together with clustered signaling servers and configured in the Talk settings." : "A definición de varias infraestruturas de alto rendemento está en desuso e xa non se admitirá na próxima versión. No seu canto, débese configurar un balanceador de carga xunto cos servidores de sinalización en clúster e configurarse nos axustes de Talk.",
