OC.L10N.register(
    ...
    "Leave conversation" : "Deixar a conversa",
    ...
    "Talk settings" : "Axustes de Parlar",
    ...
    "Talk setup incomplete" : "Configuración de Parlar incompleta",
    ...
    "Speed up your Talk experience with these quick shortcuts." : "Acelere a súa experiencia con Parlar con estes atallos rápidos.",
    ...
    "Nextcloud Talk was updated, you need to reload the page before you can start or join a call." : "Parlar de Nextcloud foi actualizado, ten que volver cargar a páxina antes de poder comezar ou unirse a unha chamada.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by Nextcloud Talk so this session was closed." : "Uniuse á conversa noutra xanela ou dispositivo. Isto non é compatíbel actualmente con Parlar de Nextcloud polo que esta sesión pechouse.",
    ...
    "Nextcloud Talk was updated, please reload the page" : "Actualizouse Parlar de Nextcloud, volva cargar a páxina",
    "(edited)" : "(editado)",
    ...
    "%s Talk on your mobile devices" : "Parlar de %s nos seus dispositivos móbiles",
    ...
    "- Moderators can now create breakout rooms (requires the external signaling server)" : "– Os moderadores agora poden crear salas parciais (precisa do servidor externo de sinalización)",
    "- Calls can now be recorded (requires the external signaling server)" : "– Agora pódense gravar as chamadas (precisa do servidor externo de sinalización)",
    ...
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk together with a High Performance Back-end." : "É moi recomendábel configurar unha memoria tobo distribuída cando se use Parlar de Nextcloud xunto cunha infraestrutura de alto rendemento.",
    ...
    "- Unsent message drafts are now saved in your browser " : "– Os borradores de mensaxes sen enviar agora gárdanse no seu navegador",
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "– *Vista previa:* A parola de texto agora pódese facer de xeito federado con outros servidores de Parlar",
    "SIP dial-in" : "Marcación SIP",
    "Don't warn about connectivity issues in calls with more than 2 participants" : "Non avisar sobre problemas de conectividade en chamadas con máis de 2 participantes",
