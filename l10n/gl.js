OC.L10N.register(
    ...
    "- Introducing the Nextcloud Talk desktop client for Windows, macOS and Linux: %s" : "– Presentación do cliente de escritorio Nextcloud Talk para Windows, macOS e Linux: %s",
    ...
    "It is highly recommended to configure a memory cache when running Nextcloud Talk with a High-performance backend." : "É moi recomendábel configurar unha caché de memoria cando se executa Talk de Nextcloud Talk cunha infraestrutura de alto rendemento.",
    ...
    "Import e-mail participants" : "Importar participantes polo correo-e",
