OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Deixe que as conversas flúan: mencione aos usuarios, reaccione ás mensaxes e máis…\n\nPode mencionar a todos nunha conversa con %s ou mencionar participantes específicos escribindo «@» e seleccionando o seu nome da lista.",
    ...
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "– *Vista previa:* A parola de texto agora pódese facer de xeito federado con outros servidores de Parladoiro",
    ...
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk together with a High Performance Back-end." : "É moi recomendábel configurar unha memoria tobo distribuída cando se use Parladoiro de Nextcloud xunto cunha infraestrutura de alto rendemento.",
