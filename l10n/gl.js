OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Agora os moderadores poden fixar mensaxes para mantelas na parte superior",
    "- Schedule a message to send it at a later time" : "- Programar unha mensaxe para enviala máis tarde",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Etiquetas de conversación, agrupación e ordenación para organizar a lista de conversacións",
    "- Voice-rooms to connect spontaneously" : "- Salas de voz para conectarse de forma espontánea",
    "- Presets for quick conversation configuration during creation" : "- Axustes predefinidos para a configuración rápida de conversacións durante a creación",
    "- Direct calls from profile menus for calls within other apps" : "- Chamadas directas desde os menús de perfil para chamadas dentro doutras aplicacións",
    ...
    "{actor} pinned a message" : "{actor} fixou unha mensaxe",
    "You pinned a message" : "Vde. fixou unha mensaxe",
    "{actor} unpinned a message" : "{actor} desprendeu unha mensaxe",
    "Message was automatically unpinned" : "A mensaxe foi desprendida automaticamente",
    "You unpinned a message" : "Vde. desprendeu unha mensaxe",
    ...
    "Conversation subfolders are disabled" : "Os subcartafoles de conversación están desactivados",
    "Storage quota exceeded" : "Superouse a cota de almacenamento",
    "Could not prepare conversation folder" : "Non foi posible preparar o cartafol de conversación",
    "File not found" : "Non se atopou o ficheiro",
    "Path must point to a file" : "A ruta debe apuntar a un ficheiro",
    "File is not inside the conversation draft folder for this room" : "O ficheiro non está dentro do cartafol de borradores da conversación desta sala",
    ...
    "Accept" : "Aceptar",
    "Decline" : "Declinar",
    "{user1} invited you to a federated conversation" : "{user1} convidouno a unha conversa federada",
    ...
    "Reminder: {user} in private conversation" : "Lembrete: {user} está nunha conversa privada",
    ...
    "Call via Talk" : "Chamar mediante Talk",
    "Channel" : "Canle",
    "Default" : "Predeterminado",
    "Send messages, create threads, and start voice and video calls." : "Envía mensaxes, crea fíos e inicia chamadas de voz e vídeo.",
    "Presentation" : "Presentación",
    "Restricted conversation for internal presentations." : "Conversación restrinxida para presentacións internas.",
    "Voice room" : "Sala de voz",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Únete directamente á chamada, ideal para poñerse ao día ou para reunións espontáneas.",
    "Webinar" : "Seminario web",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Conversación restrinxida co vestíbulo activado, ideal para webinars públicos.",
    ...
    "Warning: Running version: {version}; Server does not support all features of this Talk version, missing features: {features}" : "Advertencia: Versión en execución: {version}; O servidor non admite todas as funcionalidades desta versión de Parladoiro, faltan as funcionalidades: {features}",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "A notificación automática ao cliente está instalada, isto mellora a puntualidade das notificacións de Parladoiro.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} non está instalada. Isto pode provocar un atraso nas notificacións de Parladoiro.",
    ...
    "Assigned Talk phone numbers must not start with + or 0. Please remove or update the following numbers:\n{list}" : "Os números de teléfono de Talk asignados non deben comezar por + ou 0. Elimina ou actualiza os seguintes números:\n{list}",
    ...
    "Open in full application" : "Abrir na aplicación completa",
    ...
    "Enable live transcription (generated by AI)" : "Activar a transcrición en directo (xerada por IA)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Activar a transcrición en directo (a aplicación de transcricións en directo non está instalada)",
    "Disable live translation" : "Desactivar a tradución en directo",
    "Enable live translation (generated by AI)" : "Activar a tradución en directo (xerada por IA)",
    "Original language" : "Idioma orixinal",
    "Live translations app is not installed" : "A aplicación de traducións en directo non está instalada",
    "Original language: {languageName}" : "Idioma orixinal ({languageName})",
    "Translated language" : "Idioma traducido",
    "Translated language: {languageName}" : "Idioma traducido ({languageName})",
    ...
    "Failed to enable live translations" : "Produciuse un fallo ao activar a tradución en directo",
    "Failed to disable live translations" : "Produciuse un fallo ao desactivar a tradución en directo",
    ...
    "None" : "Ningún",
    "Speaker" : "Altofalante",
    "Microphone settings" : "Axustes do micrófono",
    ...
    "Disable" : "Desactivar",
    "Enable" : "Activar",
    "The bot is not available anymore" : "O bot xa non está dispoñible",
    ...
    "Participants can use all available features." : "Os participantes poden usar todas as funcionalidades dispoñibles.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Os participantes obteñen un conxunto de funcionalidades reducido ata que un moderador lles conceda permisos adicionais de forma manual.",
    ...
    "Live transcriptions app is not installed" : "A aplicación de transcricións en directo non está instalada",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Os eventos do calendario cunha ligazón de conversación como localización móstranse aquí",
    ...
    "Remove all tags" : "Eliminar todas as etiquetas",
    "Rename tag" : "Cambiar o nome da etiqueta",
    "Delete tag" : "Eliminar a etiqueta",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Seguro que queres eliminar \"{name}\"? As conversacións con esta etiqueta moverase a \"Outro\".",
    "Move up" : "Mover cara arriba",
    "Move down" : "Mover cara abaixo",
    "Pending invitations" : "Convites pendentes",
    "Join conversations from other servers" : "Unirse a conversacións doutros servidores",
    ...
    "Mentions" : "Mencións",
    "Meetings" : "Xuntanzas",
    "Sort conversations" : "Ordenar as conversacións",
    "By recent activity" : "Por actividade recente",
    "Alphabetically" : "Alfabeticamente",
    "Do not group by type" : "Non agrupar por tipo",
    "Show private ones first" : "Mostrar primeiro as privadas",
    "Show group ones first" : "Mostrar primeiro as de grupo",
    ...
    "SIP backend is not installed" : "O backend SIP non está instalado",
    ...
    "Enable noise suppression" : "Activar a supresión do ruído",
    "Reduce background noises for better voice quality" : "Reducir os ruídos de fondo para mellorar a calidade da voz",
    "Basic" : "Básico",
    "Advanced" : "Avanzado",
    "Enable echo cancellation" : "Activar cancelación de eco",
    "Minimize echo effect from own surrounding" : "Minimizar o efecto de eco do seu propio contorno",
    "Enable auto gain control" : "Activar o control automático de ganancia",
    "Dynamically adjust microphone volume for consistent level" : "Axusta dinamicamente o volume do micrófono para un nivel constante",
    ...
    "Recording backend is not installed" : "O backend de gravación non está instalado",
    ...
    "7 days" : "7 días",
    "30 days" : "30 días",
    "Until unpin" : "Ata que se desprenda",
    "Clear reminder – {timeLocale}" : "Limpar o lembrete – {timeLocale}",
    "Edited by {actor}" : "Editado por {actor}",
    "Pinned by you" : "Fixado por vostede",
    "Pinned by {actor}" : "Fixado por {actor}",
    "Until {absoluteDate}" : "Ata {absoluteDate}",
    ...
    "Pin message" : "Fixar a mensaxe",
    "Unpin message" : "Desprender a mensaxe",
    ...
    "Keep pinned for" : "Manter fixado para",
    "Set custom period" : "Definir un período personalizado",
    ...
    "This translation is AI generated and may contain mistakes." : "Esta tradución foi xerada por IA e pode conter erros.",
    "Copy translated text" : "Copiar o texto traducido",
    "Error when scheduling the message" : "Produciuse un erro ao programar a mensaxe",
    "Reschedule" : "Reprogramar",
    "Send now" : "Enviar agora",
    "Choose a time" : "Escolla unha hora",
    "Send at custom time" : "Enviar a unha hora personalizada",
    "Will be sent without notification" : "Enviarase sen notificación",
    ...
    "Reply to thread \"{threadTitle}\"" : "Responder ao fío «{threadTitle}»",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Votaches • %n voto","Votaches • %n votos"],
    "You voted" : "Votou",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Fai clic para votar • %n voto","Click to vote • %n votes"],
    "Click to vote" : "Fai clic para votar",
    ...
    "Generate summary with AI" : "Xerar resumo con IA",
    "{author} (pinned by you)" : "{author} (fixada por vostede)",
    ...
    "Default parameters are:" : "Os parámetros predeterminados son:",
    "These settings can be changed once the conversation is created." : "Estes axustes pódense cambiar unha vez creada a conversación.",
    ...
    "Message will be sent {datetimeString}" : "A mensaxe enviarase o/ás {datetimeString}",
    ...
    "Message was successfully scheduled" : "A mensaxe foi programada satisfactoriamente",
    ...
    "Show scheduled messages" : "Amosar as mensaxes programadas",
    "Cancel editing" : "Cancelar a edición",
    "Schedule message" : "Mensaxe programada",
    "{user} is out of office and might not respond." : "{user} está fóra da oficina e é posíbel que non responda.",
    ...
    "Voice message {time} ({conversation})" : "Mensaxe de voz {time} ({conversation})",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Resultados finais • %n voto","Resultados finais • %n votos"],
    "_%n vote • Your vote is anonymous_::_%n votes • Your vote is anonymous_" : ["%n voto • O teu voto é anónimo","%n votos • O teu voto é anónimo"],
    "Your vote is anonymous" : "O teu voto é anónimo",
    "You voted for this option" : "Vde. votou por esta opción",
    "End poll" : "Finalizar a enquisa",
    "Change your vote" : "Cambiar o seu voto",
    "Withdraw vote" : "Retirar o voto",
    "Results" : "Resultados",
    "Download as spreadsheet" : "Descargar como folla de cálculo",
    ...
    "Pinned by a deleted user" : "Fixado por un usuario eliminado",
    ...
    "I picked the list style" : "Escollín o estilo de lista",
    ...
    "Chat appearance" : "Aparencia da parola",
    "Messages list" : "Lista de mensaxes",
    "Message bubbles" : "Globos de mensaxe",
    ...
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "Actualmente non está dispoñíbel para iPhone e iPad por mor das restricións técnicas do fabricante",
    "Notification settings" : "Axustes de notificación",
    "Sounds for chat and call notifications" : "Sons para notificacións de parola e chamadas",
    "Invalid language ({languageId})" : "Idioma non válido {languageId}",
    "Default language" : "Idioma predeterminado",
    "Default language ({languageName})" : "Idioma predeterminado ({languageName})",
    "Error when trying to load the available live translation languages" : "Produciuse un erro ao tentar cargar os idiomas de tradución en directo dispoñíbeis",
    "Error when trying to set live translation language" : "Produciuse un erro ao tentar definir o idioma de tradución en directo",
    "Set language used to show the transcriptions" : "Definir o idioma empregado para amosar as transcricións",
    ...
    "Turn camera and microphone off by default" : "Desactivar a cámara e o micrófono de xeito predeterminado",
    "Blur camera background by default" : "Desenfocar o fondo da cámara de xeito predeterminado",
    "Skip device preview before joining a call" : "Omitir a vista previa do dispositivo antes de unirse a unha chamada",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "A cámara desactivarase ao unirse. Móstrase sempre se se require consentimento para a gravación.",
    "Appearance & Sounds" : "Aparencia e sons",
    "Privacy" : "Privacidade",
    "Send read receipts" : "Enviar acuses de recibimento",
    "When off, all read statuses will be hidden" : "Cando estea desactivado, agocharanse todos os estados de lectura",
    "Share typing status" : "Compartir o estado de escritura",
    ...
    "Return to Home screen" : "Volver á pantalla de inicio",
    "Shortcuts while in a chat" : "Atallos nunha parola",
    ...
    "The server was updated, you cannot start or join a call." : "O servidor foi actualizado, non podes iniciar nin unirte a unha chamada.",
    ...
    "Scheduled messages" : "Mensaxes programadas",
    ...
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Esta conversación eliminarase automaticamente para todos despois de %n día de inactividade.","Esta conversación eliminarase automaticamente para todos despois de %n días de inactividade."],
    ...
    "Scheduled {datetime}" : "Programada o/ás {datetime}",
    "Scheduled for {datetime}" : "Programada para {datetime}",
    "Search" : "Buscar",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Esta conversación abriuse noutra pestana. A versión actual do servidor non admite abrir unha conversación en varias pestanas.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Ei! Estás usando o estilo de lista ou as burbullas de mensaxes?",
    ...
    "Audio" : "Son",
    "Show all pinned messages" : "Amosar todas as mensaxes fixadas",
    ...
    "The server was updated." : "O servidor foi actualizado.",
    ...
    "The recording failed. Please contact your administrator." : "Produciuse un fallo na gravación. Póñase en contacto coa administración desta instancia.",
    ...
    "Error renaming tag" : "Produciuse un erro ao renomear a etiqueta",
    "Error deleting tag" : "Produciuse un erro ao eliminar a etiqueta",
    "Error reordering tags" : "Produciuse un erro ao reordenar as etiquetas",
    ...
    "The server is in maintenance mode." : "O servidor está en modo de mantemento.",
    "Federated server was updated." : "O servidor federado foi actualizado.",
    ...
    "Connecting is taking longer than expected …" : "A conexión está a levar máis tempo do agardado…",
    "Failed to connect. Retrying …" : "Produciuse un fallo ao conectar. Tentándoo de novo…",
    "Failed to connect. The signaling server may be set up incorrectly" : "Produciuse un fallo ao conectar O servidor de sinalización pode estar configurado incorrectamente",
    ...
    "Always shown if recording consent is required" : "Amosar sempre se é necesario o consentimento da gravación",
    ...
    "Enable live translation" : "Activar a tradución en directo",
    "_Open poll • %n vote • Your vote is anonymous_::_Open poll • %n votes • Your vote is anonymous_" : ["Enquisa aberta • %n voto • O teu voto é anónimo","Enquisa aberta • %n votos • O teu voto é anónimo"],
    "Open poll • You voted already • Your vote is anonymous" : "Enquisa aberta • Xa votaches • O teu voto é anónimo",
    "Open poll • Your vote is anonymous" : "Enquisa aberta • O teu voto é anónimo",
