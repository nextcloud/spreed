OC.L10N.register(
    ...
    "Checking TURN server {server}" : "Tarkistetaan TURN-palvelinta {server}",
    ...
    "Password request by %s" : "Salasanaa pyysi %s",
    ...
    "You were mentioned in a group conversation by a deleted user: %s" : "Sinut mainittiin ryhmäkeskustelussa poistetun käyttäjän toimesta: %s",
    "You were mentioned in a group conversation by a deleted user" : "Sinut mainittiin ryhmäkeskustelussa poistetun käyttäjän toimesta",
