OC.L10N.register(
    ...
    "{actor} closed the poll {poll}" : "{actor} sulki kyselyn {poll}",
    "You closed the poll {poll}" : "Suljit kyselyn {poll}",
    "%s (guest)" : "%s (vieras)",
    ...
    "Error when trying to set the messages expiration" : "Virhe asettaessa viestien vanhenemista",
