OC.L10N.register(
    ...
    "- Set a reminder on a chat message to be notified later again" : "- Aseta keskustelussa olevaan viestiin muistutus, jotta saat siitä ilmoituksen myöhemmin",
    ...
    "None" : "Ei mitään",
    "Speaker" : "Kaiutin",
    "Check devices" : "Tarkista laitteet",
    ...
    "Schedule meetings" : "Sovi tapaamisia",
    "You don't have any upcoming meetings" : "Sinulla ei ole tulevia tapaamisia",
    "Open calendar" : "Avaa kalenteri",
    "Unread mentions" : "Lukemattomat maininnat",
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Viestit, joissa sinut on mainittu, näkyvät tässä. Voit mainita henkilöitä kirjoittamalla @ -merkin ja sitten heidän nimensä",
    "Message reminders" : "Viestimuistutukset",
    "Set a reminder on a message to be notified" : "Aseta muistutus viestiin, jotta saat siitä ilmoituksen",
    ...
    "Subscribe to an existing thread or start your own." : "Seuraa olemassa olevaa keskusteluketjua tai aloita omasi.",
    ...
    "Filter conversations by" : "Suodata keskusteluja",
    "Unread messages" : "Lukemattomat viestit",
    "Meeting conversations" : "Kokouskeskustelut",
    ...
    "Back to conversations" : "Palaa keskusteluihin",
    ...
    "The meeting will start soon" : "Kokous alkaa pian",
    ...
    "Contact" : "Yhteystieto",
    "{stack} in {board}" : "{stack} puhelussa {board}",
    ...
    "Search in {name}" : "Etsi {name}",
    "{actor} in {conversation}" : "{actor} keskustelussa {conversation}",
    ...
    "Compact conversations list" : "Tiivis keskustelunäkymä",
    "Chat appearance" : "Keskustelun ulkoasu",
    "Play sounds when participants join or leave a call" : "Toista ääni kun osallistuja liittyy tai poistuu puhelusta",
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "Ei saatavilla tällä hetkellä iPhonelle tai iPadille valmistajan asettamien teknisten rajoitusten vuoksi",
    "Notification settings" : "Ilmoitusasetukset",
    "Sounds for chat and call notifications" : "Ääniasetukset keskustelu- ja puheluilmoituksille",
    ...
    "Turn camera and microphone off by default" : "Kamera ja mikrofoni oletuksena pois päältä",
    "Blur camera background by default" : "Kameran taustan sumennus oletuksena",
    "Skip device preview before joining a call" : "Ohita laiteasetusten esikatselu ennen puheluun liittymistä",
    "Appearance & Sounds" : "Ulkoasu & äänet",
    "Privacy" : "Yksityisyys",
    "Send read receipts" : "Lähetä \"luettu\" -kuittaukset",
    "When off, all read statuses will be hidden" : "Kun pois päältä, kaikki viestien \"luettu\" -kuittaukset piilotetaan",
    "Share typing status" : "Jaa \"kirjoittaa\" -ilmoitukset",
    "When off, all typing indicators will be hidden" : "Kun pois päältä, kaikki \"kirjoittaa\" -ilmoitukset piilotetaan",
    ...
    "Zoom-in / zoom-out a screen share" : "Lähennä tai loitonna näytönjakoa",
    ...
    "Local time: {time}" : "Paikallinen aika: {time}",
    "Search" : "Etsi",
    ...
    "Talk to %s" : "Keskustele käyttäjän %s kanssa",
    "Talk conversation for event" : "Tapahtuman Talk-keskustelu",
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Sovi tapaaminen kalenterissasi. Talk-keskustelu pitää asettaa sijainniksi, jotta se näkyy tässä",
