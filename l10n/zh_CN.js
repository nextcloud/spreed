OC.L10N.register(
    ...
    "_{user1}, {user2}, {user3} and %n other are typing …_::_{user1}, {user2}, {user3} and %n others are typing …_" : ["{user1}、{user2}、{user3}和其他%n人正在输入……"],
    ...
    "You and {user0} joined the call" : "你和 {user0} 加入通话",
    "_You, {user0} and %n more participant joined the call_::_You, {user0} and %n more participants joined the call_" : ["你、 {user0} 及另外 %n 个参与者加入通话"],
    "{user0} and {user1} joined the call" : "{user0} 和 {user1} 加入通话",
    "_{user0}, {user1} and %n more participant joined the call_::_{user0}, {user1} and %n more participants joined the call_" : ["{user0} 、 {user1} 及另外 %n 个参与者加入通话"],
    "You and {user0} left the call" : "你和 {user0} 离开通话",
    "_You, {user0} and %n more participant left the call_::_You, {user0} and %n more participants left the call_" : ["你、 {user0} 及另外 %n 个参与者离开通话"],
    "{user0} and {user1} left the call" : "{user0} 和 {user1} 离开通话",
    "_{user0}, {user1} and %n more participant left the call_::_{user0}, {user1} and %n more participants left the call_" : ["{user0} 、 {user1} 及另外 %n 个参与者离开通话"],
    "You promoted {user0} and {user1} to moderators" : "你将 {user0} 和 {user1} 设为主持人",
    "_You promoted {user0}, {user1} and %n more participant to moderators_::_You promoted {user0}, {user1} and %n more participants to moderators_" : ["你将 {user0} 、 {user1} 及另外%n人设为主持人"],
    "An administrator promoted you and {user0} to moderators" : "管理员将你和 {user0} 设为主持人",
    "{actor} promoted you and {user0} to moderators" : "{actor} 将你和 {user0} 设为主持人",
    "_An administrator promoted you, {user0} and %n more participant to moderators_::_An administrator promoted you, {user0} and %n more participants to moderators_" : ["管理员将你、 {user0} 及另外%n人设为主持人"],
    "_{actor} promoted you, {user0} and %n more participant to moderators_::_{actor} promoted you, {user0} and %n more participants to moderators_" : ["{actor} 将你、 {user0}  及另外%n人设为主持人"],
    "An administrator promoted {user0} and {user1} to moderators" : "管理员将 {user0} 和 {user1} 设为主持人",
    "{actor} promoted {user0} and {user1} to moderators" : "{actor} 将 {user0} 和 {user1} 设为主持人",
    "_An administrator promoted {user0}, {user1} and %n more participant to moderators_::_An administrator promoted {user0}, {user1} and %n more participants to moderators_" : ["管理员将 {user0} 、 {user1} 及另外%n人设为主持人"],
    "_{actor} promoted {user0}, {user1} and %n more participant to moderators_::_{actor} promoted {user0}, {user1} and %n more participants to moderators_" : ["{actor} 将 {user0} 、 {user1} 及另外%n人设为主持人"],
    "You demoted {user0} and {user1} from moderators" : "你取消了 {user0} 和 {user1} 的主持人身份",
    "_You demoted {user0}, {user1} and %n more participant from moderators_::_You demoted {user0}, {user1} and %n more participants from moderators_" : ["你取消了 {user0} 、 {user1} 及另外%n人的主持人身份"],
    "An administrator demoted you and {user0} from moderators" : "管理员取消了你和 {user0} 的主持人身份",
    ...
    "Failed to establish signaling connection. Retrying …" : "建立信令连接失败。重试中……",
    "Failed to establish signaling connection. Something might be wrong in the signaling server configuration" : "建立信令连接失败。信令服务器配置可能有误",
    ...
    "Please note that calls with more than 4 participants without external signaling server, participants can experience connectivity issues and cause high load on participating devices." : "请注意不使用外部的信令服务器而与超过4个参与者通话，参与者将遇到连接性问题并造成参与设备的高负载。",
    ...
    "The PHP settings 'upload_max_filesize' or 'post_max_size' only will allow to upload files up to {maxUpload}." : "PHP设置“upload_max_filesize”或“post_max_size”仅允许上传最大{maxUpload}的文件。",
    "Always show this dialog before joining a call in this conversation. The dialog will always be shown when the call is being recorded." : "在此对话中加入通话之前，一律显示此对话框。通话录制时将一律显示该对话框。",
    "Setup summary" : "设置概览"
},
"nplurals=1; plural=0;");
