OC.L10N.register(
    ...
    "- Emojis can now be autocompleted by typing a \":\"" : "- 现在可以通过输入“:”来自动补全表情符号",
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- 主持人现在可以置顶消息，使其始终在顶部显示",
    "- Schedule a message to send it at a later time" : "- 安排消息以便稍后发送",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- 对话标签、分组和排序功能用于整理对话列表",
    "- Voice-rooms to connect spontaneously" : "- 语音室可自发连接",
    "- Presets for quick conversation configuration during creation" : "- 创建过程中用于快速对话配置的预设",
    "- Direct calls from profile menus for calls within other apps" : "- 直接通过个人资料菜单发起通话，以在其他应用内进行通话",
    ...
    "An administrator renamed the conversation from \"%1$s\" to \"%2$s\"" : "管理员将对话从“%1$s”重命名为“%2$s”",
    "{actor} set the description" : "{actor} 设置了描述",
    "You set the description" : "你设置了描述",
    "An administrator set the description" : "管理员设置了描述",
    "{actor} removed the description" : "{actor} 移除了描述",
    "You removed the description" : "您移除了描述",
    "An administrator removed the description" : "管理员移除了描述",
    ...
    "An administrator unlocked the conversation" : "管理员解锁了对话",
    "{actor} locked the conversation" : "{actor}锁定了对话",
    "You locked the conversation" : "您锁定了对话",
    "An administrator locked the conversation" : "管理员锁定了对话",
    ...
    "{actor} preserved the conversation" : "{actor} 保留了对话",
    "You preserved the conversation" : "您保留了对话",
    "An administrator preserved the conversation" : "管理员保留了对话",
    "{actor} stopped preserving the conversation" : "{actor} 停止了保留对话",
    "You stopped preserving the conversation" : "您停止了保留对话",
    "An administrator stopped preserving the conversation" : "管理员停止了保留对话",
    ...
    "You restricted the conversation to moderators" : "您将对话限制到与主持人之间",
    ...
    "An administrator allowed guests" : "管理员允许了访客",
    "{actor} disallowed guests" : "{actor} 禁止了访客加入",
    "You disallowed guests" : "您禁止了访客加入",
    "An administrator disallowed guests" : "管理员禁止了访客",
    "{actor} set a password" : "{actor} 设置了密码",
    "You set a password" : "您设置了密码",
    "An administrator set a password" : "管理员设置了密码",
    "{actor} removed the password" : "{actor} 移除了密码",
    "You removed the password" : "您移除了密码",
    "An administrator removed the password" : "管理员移除了密码",
    "{actor} added {user}" : "{actor} 添加了 {user}",
    "System added you" : "系统添加了您",
    "System added {user}" : "系统添加了 {user}",
    ...
    "An administrator added you" : "管理员添加了您",
    "An administrator added {user}" : "管理员添加了 {user}",
    ...
    "An administrator removed you" : "管理员移除了您",
    "An administrator removed {user}" : "管理员移除了 {user}",
    "{actor} invited {federated_user}" : "{actor} 邀请了 {federated_user}",
    "You invited {federated_user}" : "您邀请了 {federated_user}",
    ...
    "An administrator added group {group}" : "管理员添加了小组 {group}",
    "{actor} removed group {group}" : "{actor} 删除了小组 {group}",
    "You removed group {group}" : "你删除了小组 {group}",
    "An administrator removed group {group}" : "管理员移除了小组 {group}",
    ...
    "An administrator promoted you to moderator" : "管理员将您设为了主持人",
    "An administrator promoted {user} to moderator" : "管理员将 {user} 设为了主持人",
    ...
    "An administrator demoted you from moderator" : "管理员取消了您的主持人身份",
    ...
    "Call %s" : "呼叫 %s",
    "Chat with %s" : "与 %s 聊天",
    "An error occurred. Please contact your administrator." : "发生错误。请联系您的管理员。",
    "App disabled" : "应用已禁用",
    "Conversation subfolders are disabled" : "对话子文件夹已禁用",
    "Storage quota exceeded" : "超出存储限额",
    "Could not prepare conversation folder" : "无法准备对话文件夹",
    "File not found" : "文件未找到",
    "Path must point to a file" : "路径必须指向文件",
    "File is not inside the conversation draft folder for this room" : "文件不在此聊天室的对话草稿文件夹中",
    ...
    "Missing %s field in header line" : "标题行中缺少 %s 字段",
    ...
    "Open Talk" : "打开通话应用",
    "Call via Talk" : "通过 Talk 通话",
    "Announcement" : "公告",
    "Conversation to inform a fixed audience, which can not be left." : "面向特定受众的对话，该受众无法离开。",
    "Channel" : "频道",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "面向广大受众的广播式对话，其中仅限主持人发布，且禁用了通话功能。",
    "Classified conversation" : "机密对话",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "锁定机密主题的对话，禁用公共访问、访客、SIP 和录音。",
    "Default" : "默认",
    "Send messages, create threads, and start voice and video calls." : "发送消息、创建线程以及开始语音和视频通话。",
    "Presentation" : "演示文稿",
    "Restricted conversation for internal presentations." : "仅限用于内部演示的受限对话。",
    "Voice room" : "语音室",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "直接加入通话，非常适合即时会议或自发会议。",
    "Webinar" : "网络研讨会",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "启用大厅功能的受限对话，非常适合公开网络研讨会。",
    "Conversations" : "对话",
    ...
    "Client Push" : "客户端推送",
    "Client Push is installed, this improves the punctuality of Talk notifications." : "客户端推送已安装，这将提高 Talk 通知的及时性。",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} 未安装。这可能会导致 Talk 通知延迟。",
    ...
    "Open in full application" : "在完整应用程序中打开",
    ...
    "Limit starting calls to certain groups" : "限制仅特定群组可发起通话",
    "Limit starting a call" : "限制开始一个通话",
    "Limit starting calls" : "限制开始通话",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "当至少选择一个群组时，只有这些群组的成员才能发起通话。此限制同样适用于主持人，而访客和联邦用户则不属于这些群组的成员。当没有选择任何群组时，则所有人均可发起通话。",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "对于托管在联合服务器上的对话，则适用该托管服务器的配置。",
    ...
    "Enable live transcription (generated by AI)" : "启用实时转录（由 AI 生成）",
    "Enable live transcription (Live transcriptions app is not installed)" : "启用实时转录（未安装实时转录应用）",
    "Disable live translation" : "禁用实时翻译",
    "Enable live translation (generated by AI)" : "启用实时翻译（由 AI 生成）",
    "Original language" : "原始语言",
    "Live translations app is not installed" : "未安装实时翻译应用",
    "Original language: {languageName}" : "原始语言：{languageName}",
    "Translated language" : "翻译语言",
    "Translated language: {languageName}" : "翻译语言：{languageName}",
    ...
    "Failed to enable live translations" : "无法启用实时翻译",
    "Failed to disable live translations" : "无法禁用实时翻译",
    ...
    "A participant raised their hand." : "参与者举手。 ",
    "Collapse participant bar" : "折叠参与者栏",
    "Expand participant bar" : "展开参与者栏",
    ...
    "You" : "您",
    "You are sharing a screen" : "您正在共享屏幕",
    "Sharing this window may cause a mirroring effect" : "共享此窗口可能会导致镜像效应",
    ...
    "Disable" : "禁用",
    "Enable" : "开启",
    "The bot is not available anymore" : "机器人不再可用",
    ...
    "Participants can use all available features." : "参与者可以使用所有可用功能。",
    "Restricted" : "受限",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "在主持人手动授予额外权限之前，参与者只能使用部分功能。",
    ...
    "Live transcriptions app is not installed" : "未安装实时转录应用",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "此对话已被保留。它无法被删除，其中的聊天消息也无法被清除。",
    ...
    "This setting can not be changed while the conversation is preserved." : "在保留对话期间，无法更改此设置。",
    ...
    "The entered token does not match the conversation token" : "输入的令牌与对话令牌不匹配",
    "Preserve conversation" : "保留对话",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "保留后，无法删除此对话，无法清除其聊天历史记录，也无法更改访客和可加入设置。",
    "Only the owner can change whether this conversation is preserved." : "只有所有者可以更改是否保留此对话。",
    ...
    "Stop preserving" : "停止保留",
    "Stop preserving conversation" : "停止保留对话",
    "Conversation token" : "对话令牌",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "如果您停止保留此对话，则可以将其删除，清除其聊天历史记录，并可以再次更改访客和可加入设置。",
    "Conversation" : "对话",
    "To confirm, type the conversation token into the field below:" : "如需确认，请在下方字段中输入对话令牌：",
    "Ongoing" : "正在进行",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "内容格式为逗号分隔值（CSV）：<br/>- 标题行是必需的，并且必须匹配 {sample1} 或仅匹配{sample2}<br/>- 每行一个条目（例如 {sample3}）",
    ...
    "Remove all tags" : "移除所有标签",
    "Rename tag" : "重命名标签",
    "Delete tag" : "删除标签",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "是否确定要删除“{name}”？带有此标签的对话将被移至“其他”。",
    "Move up" : "上移",
    "Move down" : "下移",
    "Pending invitations" : "待处理的邀请",
    "Join conversations from other servers" : "加入其他服务器的对话",
    ...
    "By recent activity" : "按最近的活动",
    "Alphabetically" : "按字母顺序",
    "Do not group by type" : "不按类型分组",
    "Show private ones first" : "先显示私人对话",
    "Show group ones first" : "先显示群组对话",
    ...
    "Enable noise suppression" : "启用噪声抑制",
    "Reduce background noises for better voice quality" : "减少背景噪音，提高语音质量",
    "Basic" : "基本",
    "Advanced" : "高级",
    "Enable echo cancellation" : "启用回声消除",
    "Minimize echo effect from own surrounding" : "尽量减少自身周围环境的回声效应",
    "Enable auto gain control" : "启用自动增益控制",
    ...
    "You can only join a voice room via a call." : "您只能通过通话加入语音室。",
    ...
    "Recording backend is not installed" : "未安装录制后端",
    ...
    "Pinned by you" : "由您置顶",
    "Pinned by {actor}" : "由 {actor} 置顶",
    "Until {absoluteDate}" : "直到 {absoluteDate}",
    ...
    "Keep pinned for" : "保持置顶",
    "Set custom period" : "设置自定义时段",
    ...
    "Translate to" : "翻译至",
    "Translating" : "正在翻译",
    "This translation is AI generated and may contain mistakes." : "此翻译是 AI 生成的，可能包含错误。",
    "Copy translated text" : "复制已翻译的文字",
    "Error when scheduling the message" : "安排消息时出错",
    "Reschedule" : "重新安排",
    "Send now" : "立即发送",
    "Choose a time" : "选择时间",
    "Send at custom time" : "在自定义时间发送",
    "Will be sent without notification" : "将不另行通知发送",
    ...
    "You cannot send messages to this conversation at the moment" : "您目前无法向此对话发送消息",
    "Could not update the message" : "无法更新消息",
    "Reply to thread \"{threadTitle}\"" : "回复帖子“{threadTitle}”",
    "_You voted • %n vote_::_You voted • %n votes_" : ["您已投票 • %n 票"],
    "You voted" : "您已投票",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["点击投票 • %n 票"],
    "Click to vote" : "点击投票",
    "_Poll draft • %n option_::_Poll draft • %n options_" : ["投票草稿 • %n 个选项"],
    "_%n vote_::_%n votes_" : ["%n 票"],
    ...
    "Generate summary with AI" : "使用 AI 生成摘要",
    "{author} (pinned by you)" : "{author}（由您置顶）",
    "{author} (pinned by {actor})" : "{author}（由 {actor} 置顶）",
    "Unpin" : "取消置顶",
    "Cancel search" : "取消搜索",
    ...
    "Conversation type" : "对话类型",
    "Default parameters are:" : "默认参数为：",
    "These settings can be changed once the conversation is created." : "对话创建后，这些设置可以更改。",
    ...
    "Message will be sent {datetimeString}" : "消息将于 {datetimeString} 发送",
    ...
    "Message was successfully scheduled" : "消息已成功安排",
    "Add emoji" : "添加 emoji",
    "Adding a mention will only notify users who did not read the message." : "添加提及只会通知未阅读消息的用户。",
    "Thread title" : "帖子‌标题",
    "Send later" : "稍后发送",
    "Show scheduled messages" : "显示已安排的消息",
    "Cancel editing" : "取消编辑",
    "Schedule message" : "安排消息",
    ...
    "Voice message {time} ({conversation})" : "语音信息 {time}（{conversation}）",
    ...
    "Send images without compression" : "发送不压缩的图片",
    "Send" : "发送",
    ...
    "Start a call" : "启动通话",
    "Skip the lobby" : "跳过大厅",
    "Can post messages" : "可以发布消息",
    "Can post messages and reactions" : "可以发布消息和回应",
    "Can add reactions" : "可以添加回应",
    ...
    "Withdraw vote" : "撤回投票",
    "Results" : "结果",
    "Download as spreadsheet" : "下载为电子表格",
    ...
    "Participants" : "参与者",
    "Pinned by a deleted user" : "由已删除用户置顶",
    ...
    "I picked the list style" : "我已选择列表样式",
    ...
    "Invalid language ({languageId})" : "无效语言（{languageId}）",
    "Default language" : "默认语言",
    "Default language ({languageName})" : "默认语言（{languageName}）",
    "Error when trying to load the available live translation languages" : "尝试加载可用的实时翻译语言时出错",
    "Error when trying to set live translation language" : "尝试设置实时翻译语言时出错",
    "Set language used to show the transcriptions" : "设置用于显示转录的语言",
    "Select location for attachments" : "选择附件的位置 ",
    "Error while setting attachment folder" : "设置附件文件夹时出错",
    "Error while setting read status privacy" : "设置阅读状态隐私时出错",
    "Error while setting typing status privacy" : "设置输入状态隐私时出错",
    ...
    "Camera will be turned off when joining. Always shown if recording consent is required." : "加入后摄像头将自动关闭。如果需要录制同意，则会始终显示。",
    ...
    "Start call" : "开始通话",
    "End call" : "结束通话",
    "The server was updated, you cannot start or join a call." : "服务器已更新，您无法开始或加入通话。",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["此对话将在 %n 分钟不活动后自动为所有参与者删除。"],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["此对话将在 %n 天不活动后自动对所有人删除。"],
    ...
    "Scheduled {datetime}" : "预定于 {datetime}",
    "Scheduled for {datetime}" : "预定于 {datetime}",
    "Search" : "搜索",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "此对话已在其他标签页中打开。当前服务器版本不支持在多个标签页中打开对话。",
    ...
    "Another user" : "其他用户",
    "Hey! Are you using the list style or message bubbles?" : "嘿！您是使用列表样式还是消息气泡？",
    ...
    "Audio" : "音频",
    "Show all pinned messages" : "显示所有已置顶的消息",
    ...
    "An administrator added you and {user0}" : "管理员添加了您和 {user0}",
    "{actor} added you and {user0}" : "{actor} 添加了你和 {user0}",
    "_An administrator added you, {user0} and %n more participant_::_An administrator added you, {user0} and %n more participants_" : ["管理员添加了您、{user0} 以及另外 %n 位参与者"],
    ...
    "An administrator added {user0} and {user1}" : "管理员添加了 {user0} 和 {user1}",
    "{actor} added {user0} and {user1}" : "{actor} 添加了 {user0} 和 {user1}",
    "_An administrator added {user0}, {user1} and %n more participant_::_An administrator added {user0}, {user1} and %n more participants_" : ["管理员添加了 {user0} 、 {user1} 以及另外 %n 位参与者"],
    ...
    "_An administrator removed you, {user0} and %n more participant_::_An administrator removed you, {user0} and %n more participants_" : ["管理员移除了您、{user0} 以及另外 %n 位参与者"],
    ...
    "_An administrator removed {user0}, {user1} and %n more participant_::_An administrator removed {user0}, {user1} and %n more participants_" : ["管理员移除了 {user0}、{user1} 以及另外 %n 位参与者"],
    ...
    "Error while changing the preserved status of the conversation" : "更改对话的保留状态时出错",
    ...
    "Error renaming tag" : "重命名标签时出错",
    "Error deleting tag" : "删除标签时出错",
    "Error reordering tags" : "重新排序标签时出错",
    ...
    "Failed to add reaction" : "无法添加回应",
    "Failed to remove reaction" : "无法移除回应",
    "The server is in maintenance mode." : "服务器处于维护模式。",
    "Federated server was updated." : "联合服务器已更新。",
    ...
    "Connecting is taking longer than expected …" : "连接时间比预期长…",
    "Failed to connect. Retrying …" : "无法连接，正在重试…",
    "Failed to connect. The signaling server may be set up incorrectly" : "无法连接，信令服务器可能设置不正确",
    ...
    "Enable live translation" : "启用实时翻译",
    "_Open poll • %n vote • Your vote is anonymous_::_Open poll • %n votes • Your vote is anonymous_" : ["公开投票 • %n 票 • 您的投票是匿名的"],
    "Open poll • You voted already • Your vote is anonymous" : "公开投票 • 您已投票 • 您的投票是匿名的",
