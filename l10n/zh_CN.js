OC.L10N.register(
    ...
    "Always notify" : "永远通知",
    "Notify on @-mention" : "@ 提到时通知",
    "Never notify" : "永远不通知",
    "Leave conversation" : "离开通话",
    "Share whole screen" : "共享整个屏幕",
    "Share a single window" : "共享一个窗口",
    "{actor} created the conversation" : "{actor} 创建了会话",
    "{actor} added you" : "{actor} 添加了你",
    "You added {user}" : "你添加了 {user}",
    "{actor} started a call" : "{actor} 开始了一个通话",
    "You started a call" : "你开始了一个通话",
    "{actor} left the call" : "{actor} 离开了通话",
    "You left the call" : "你离开了通话",
    "{actor} joined the call" : "{actor} 加入了通话",
    "You joined the call" : "你加入了通话",
    "You joined the conversation" : "你加入了会话",
    ...
    "Call with {user1}, {user2}, {user3}, {user4} and {user5} (Duration {duration})" : "Anruf mit {user1}, {user2}, {user3}, {user4} 和 {user5} 进行了通话 (时长 {duration})",
