OC.L10N.register(
    ...
    "The PHP settings 'upload_max_filesize' or 'post_max_size' only will allow to upload files up to {maxUpload}." : "PHP设置“upload_max_filesize”或“post_max_size”仅允许上传最大{maxUpload}的文件。",
    "Always show this dialog before joining a call in this conversation. The dialog will always be shown when the call is being recorded." : "在此对话中加入通话之前，一律显示此对答。通话录制时将一律显示该对答。",
    "Setup summary" : "设置概览"
},
"nplurals=1; plural=0;");
