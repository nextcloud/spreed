OC.L10N.register(
    ...
    "Today" : "Сьогодні",
    "Yesterday" : "Вчора",
    "Write message, @ to mention someone …" : "Написати повідомлення, @ кому згадати когось…",
    "Share files to the conversation" : "Поділитися файлами під час розмови",
    "Upload new files" : "Завантажити файли",
    "Share from Files" : "Поділитися із застосунку Файли",
