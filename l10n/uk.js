OC.L10N.register(
    ...
    "{actor} opened the conversation to registered users and users created with the Guests app" : "{actor} відкрив розмову для зареєстрованих користувачів та користувачів, створених у застосунку Гості",
    ...
    "You started breakout rooms" : "Ви запустили розділені кімнати",
    ...
    "Storage quota exceeded" : "Перевищено дозволений обсяг даних для збереження",
    ...
    "Following lines are invalid: %s" : "Наступні рядки є недійсними: %s",
    ...
    "Reminder: A guest in conversation {call}" : "Нагадування: Гість у розмові {call}.",
    ...
    "A guest reacted with {reaction} to your message in conversation {call}" : "Гість відреагував {reaction} на ваше повідомлення у розмові {call}.",
    ...
    "There is already a trial registered for this Nextcloud instance." : "Для цього примірника сервера хмари Nextcloud вже зареєстровано пробне використання.",
    ...
    "Share this file with others to discuss it" : "Поділітися цим файлом з іншими, щоб обговорити його",
    ...
    "We have detected multiple invalid password attempts from your IP. Therefore your next attempt is throttled up to 30 seconds." : "Ми виявили кілька хибних спроб введення пароля з вашої адреси IP. Спробуйте повторно авторизуватися через 30 секунд.",
    ...
    "Enable Federation in Talk app" : "Увімкнути застосунок об'єднані хмари для Talk",
    "Permissions" : "Дозволи ",
    "Allow users to be invited to federated conversations" : "Дозволити користувачам запрошувати вас до розмов з інших хмар",
    "Allow users to invite federated users into conversation" : "Дозвольте користувачам запрошувати користувачів з інших хмар до бесіди",
    ...
    "Integration into other apps" : "Інтеграція з іншими застосунками",
    ...
    "URL of this Nextcloud instance" : "Посилання на цей сервер хмари Nextcloud",
    ...
    "Allow participants to choose" : "Дозволити учасникам обирати",
    ...
    "Now" : "Зараз",
    "Invalid calendar selected" : "Вибрано недійсний календар",
    "Invalid start time selected" : "Вибрано недійсний час запуску",
    "Invalid end time selected" : "Вибрано недійсний час закінчення",
    ...
    "Leave conversation" : "Вийти з групи",
    ...
    "Chat messages can be expired after a certain time. Note: Files shared in chat will not be deleted for the owner, but will no longer be shared in the conversation." : "Повідомлення чату може бути вилучено через певний часу. Примітка: Файли, які було передано у чаті, не буде вилучено для власника, проте вони більше не будуть доступні в обговоренні.",
    ...
    "Copy password" : "Копіювати пароль",
    ...
    "Also open to users created with the Guests app" : "Також відкрито для користувачів, створених у застосунку Гості",
    ...
    "Allow participants to mention @all" : "Дозволити учасникам згадувати @all",
    ...
    "Hello, {displayName}" : "Вітання, {displayName}",
    "Start meeting now" : "Почати зустріч",
    "Give your meeting a title" : "Дайте назву вашій зустрічі",
    "Create and copy link" : "Посилання на зустріч",
    ...
    "_%n invalid email_::_%n invalid emails_" : ["%n недійсна ел.адреса","%n недійсні ел.адреси","%n недійсних ел.адрес","%n недійсних ел.адрес"],
    ...
    "Phone number could not be called: {error}" : "Не вдалося додзвонитися за номером телефону: {error}",
    ...
    "Copy message link" : "Копіювати посилання на повідомлення",
    ...
    "React with another emoji" : "Відреагувати іншим емодзі",
    ...
    "Remove {fileName}" : "Вилучити {fileName}",
    ...
    "_%n vote_::_%n votes_" : ["%n голосів","%n голосів","%n голосів","%n голосів"],
    ...
    "All messages have expired or have been deleted." : "Всі повідомлення втратили актуальність або їх було вилучено.",
    "Unpin" : "Відкріпити",
    ...
    "Create a new group conversation" : "Створити нову групу",
    ...
    "Replacement:" : "Заміна:",
    "Share from {nextcloud}" : "Поділітися з {nextcloud}",
    ...
    "Phone number copied to clipboard" : "Номер телефону скопійовано до буфера обміну",
    ...
    "Copy phone number" : "Копіювати номер телефону",
    ...
    "Chat" : "Чат",
    "Details" : "Докладно",
    "Shared items" : "Спільні ресурси",
    "Search in {name}" : "Шукати в {name}",
    "Threads in {name}" : "Гілки у {name}",
    ...
    "Display name: {name}" : "Ім'я для показу: {name}",
    ...
    "Error while setting attachment folder" : "Помилка під час встановлення каталогу для вкладень",
    ...
    "Deck card has been posted to {conversation}" : "Картку колоди опубліковано на {conversation}",
    ...
    "Location has been posted to {conversation}" : "Розташування було розміщено на {conversation}",
    ...
    "The server is misconfigured. Please contact your administration." : "Неправильні налаштування на сервері. Сконтактуйте з адміністратором.",
