OC.L10N.register(
    ...
    "Allow guests to use a public link to join this conversation." : "Дозволити гостям заходити в це обговорення за відкритим посиланням",
    ...
    "This conversation will be shown in search results" : "Ця розмова буде показана в результатах пошуку",
    ...
    "Calls" : "Виклики",
    "Allow participants to join from a phone." : "Дозволити підключатися по телефонній лінії",
    ...
    "Invitation was sent to {actorId}." : "Запрошення надіслано {actorId}.",
    "End meeting for all" : "Завершення зустрічі для всіх",
