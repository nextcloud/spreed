OC.L10N.register(
    ...
    "You removed {federated_user}" : "Eliminaste a {federated_user}",
    "{actor} added {phone}" : "{actor} agregó a {phone}",
    "You added {phone}" : "Agregaste a  {phone}",
    "{actor} removed {phone}" : "{actor} eliminó a {phone}",
    "You removed {phone}" : "Eliminaste a {phone}",
