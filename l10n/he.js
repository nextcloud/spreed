OC.L10N.register(
    ...
    "{actor} added {phone}" : "ההוספה של {phone} בוצעה על ידי {actor}",
    "You added {phone}" : "הוספת את {phone}",
    "An administrator added {phone}" : "ההנהלה הוסיפה את {phone}",
    ...
    "{option1} and {option2}" : "{option1} ו- {option2}",
    ...
    "Personal" : "אישי",
    "Leave conversation" : "עזיבת הדיון",
    ...
    "In {conversation}" : "בתוך {conversation}",
    "Join" : "הצטרף",
    "Error while creating the conversation" : "שגיאה ביצירת הדיון",
    "Hello, {displayName}" : "שלום, {displayName}",
    ...
    "Files" : "קבצים",
    "24 hours" : "24 שעות",
    "Until {absoluteDate}" : "עד {absoluteDate}",
    "Reply" : "תגובה",
    ...
    "Contact" : "איש/אשת קשר",
    "Remove {fileName}" : "להסיר את {fileName}",
    ...
    "Demote from moderator" : "הורדה מדרגת פיקו",
    "Remove" : "הסרה",
    ...
    "React with {reaction}" : "הגיבו עם {reaction}",
    ...
    "Audio" : "קובץ שמע",
    "Group" : "קבוצה",
    "You: {lastMessage}" : "אני: {lastMessage}",
