OC.L10N.register(
    ...
    "{actor} removed {federated_user}" : "{actor} fjarlægði {federated_user}",
    "You removed {federated_user}" : "Þú fjarlægðir {federated_user}",
    "{actor} added {phone}" : "{actor} bætti {phone} við",
    "You added {phone}" : "Þú bættir {phone} við",
    "{actor} removed {phone}" : "{actor} fjarlægði {phone}",
    "You removed {phone}" : "Þú fjarlægðir {phone}",
    ...
    "Call %s" : "Hringja í %s",
    "Storage quota exceeded" : "Geymslukvóti er uppurinn",
    ...
    "Messages" : "Skilaboð",
    "{user} in {conversation}" : "{user} á {conversation}",
    ...
    "Yes" : "Já",
    "No" : "Nei",
    "_%n user_::_%n users_" : ["%n notandi","%n notendur"],
    ...
    "Join" : "Taka þátt",
    "Hello, {displayName}" : "Halló, {displayName}",
    "Create conversation" : "Búa til samtal",
    ...
    "No conversations found" : "Engin samtöl fundust",
    ...
    "7 days" : "7 dagar",
    "Until {absoluteDate}" : "Til {absoluteDate}",
    ...
    "Remove {fileName}" : "Fjarlægja {fileName}",
    "You voted" : "Þú kaust",
    ...
    "Attachments folder" : "Viðhengjamappa",
    "Start call" : "Hefja samtal",
    "The call has been running for one hour." : "Símtalið hefur staðið yfir í eina klukkustund.",
    ...
    "Local time: {time}" : "Staðartími: {time}",
    "Search" : "Search",
    ...
    "Group" : "Hópur",
    "Team" : "Teymi",
    "You: {lastMessage}" : "Þú: {lastMessage}",
    "{relativeDate}, {absoluteDate}" : "{relativeDate}, {absoluteDate}",
    "{guest} (guest)" : "{guest} (gestur)",
    ...
    "_%n week_::_%n weeks_" : ["%n vika","%n vikur"],
