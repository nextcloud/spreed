OC.L10N.register(
    ...
    "- Presets for quick conversation configuration during creation" : "- Oluşturma sırasında hızlı konuşma yapılandırması için hazır ayarlar",
    ...
    "This setting can not be changed while the conversation is preserved." : "Konuşma korunurken bu ayar değiştirilemez.",
    ...
    "Only the owner can change whether this conversation is preserved." : "Bu konuşmanın korunup korunmayacağını yalnızca sahibi belirleyebilir.",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Konum burada görüntülendiği gibi bir konuşma bağlantısı bulunan takvim etkinlikleri",
    ...
    "These settings can be changed once the conversation is created." : "Konuşma oluşturulduktan sonra bu ayarlar değiştirilebilir.",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Bu görüşme başka bir sekmede de açılmış. Geçerli sunucu sürümü, bir konuşmanın birden fazla sekmede açılmasını desteklemiyor.",
