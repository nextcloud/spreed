OC.L10N.register(
    ...
    "- *Preview:* Calls can now be done in a federated way with other Talk servers (requires the High-performance backend)" : "- *Ön izleme:* Çağrıların diğer Talk sunucularıyla birleşik olarak yapılabilmesi sağlandı (yüksek başarımlı arka taraf gereklidir)",
    ...
    "Nextcloud Talk Federation was updated, please reload the page" : "Nextcloud Talk Federation güncellendi. Lütfen sayfayı yeniden yükleyin",
