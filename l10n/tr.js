OC.L10N.register(
    ...
    "- You can now directly reply to messages giving the other users more context what your message is about" : "- Artık diğer kullanıcılara iletinizin ne ile ilgili olduğu ile ilgili daha fazla bilgi vererek iletileri doğrudan yanıtlayabilirsiniz.",
    ...
    "- Text chatting can now be done in a federated way with other Talk servers" : "- Yazılı sohbetlerin diğer Konuş sunucularıyla birleşik olarak yapılabilmesi sağlandı",
    ...
    "- See more conversations on a first glance with the new compact list (enable in the Talk settings)" : "- Yeni dar listeyle daha fazla görüşmeyi bir kerede görün (Konuş ayarlarından açın)",
    ...
    "- Mark conversations as sensitive in the notification settings, to hide the message content from the conversation list and notifications" : "- İleti içeriğini görüşme listesinden ve bildirimlerden gizlemek için bildirim ayarlarında görüşmeleri ciddi olarak işaretleyebilirsiniz",
    ...
    "- Use threads to keep your chat and discussions organized" : "- Sohbetlerinizi ve tartışmalarınızı düzenli tutmak için yazışmaları kullanın",
    "- Live transcriptions now available during the call (requires the live-transcription ExApp and the High-performance backend)" : "- Arama sırasında artık canlı yazıya dönüştürme kullanılabilir (canlı yazıya dönüştürme ExApp ve Yüksek başarımlı arka uç gereklidir)",
    "- Moderators can now pin messages so they are kept at the top" : "- Sorumlular artık iletileri sabitleyerek en üstte kalmalarını sağlayabilir",
    "- Schedule a message to send it at a later time" : "- Bir iletiyi daha sonra gönderilmek üzere planlayın",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Görüşme listesini düzenlemek için görüşme etiketleri, gruplama ve sıralama",
    "- Voice-rooms to connect spontaneously" : "- Kendiliğinden bağlanılacak sesli odalar",
    ...
    "- Channels and announcements to broadcast information to a broader audience" : "- Daha geniş bir kitleye bilgi yayınlamak için kanallar ve duyurular",
    ...
    "{actor} created the conversation" : "{actor} görüşme oluşturdu",
    "You created the conversation" : "Görüşme oluşturdunuz",
    "System created the conversation" : "Sistem görüşme oluşturdu",
    "An administrator created the conversation" : "Bir yönetici görüşme oluşturdu",
    ...
    "{actor} preserved the conversation" : "{actor} görüşmeyi korudu",
    "You preserved the conversation" : "Görüşmeyi korudunuz",
    "An administrator preserved the conversation" : "Bir yönetici görüşmeyi korudu",
    "{actor} stopped preserving the conversation" : "{actor} görüşmenin korumasını kaldırdı",
    "You stopped preserving the conversation" : "Görüşmenin korumasını kaldırdınız",
    "An administrator stopped preserving the conversation" : "Bir yönetici görüşmenin korumasını kaldırdı",
    ...
    "System added you" : "Sistem sizi ekledi",
    "System added {user}" : "Sistem {user} kullanıcısını ekledi",
    ...
    "{actor} promoted {user} to owner" : "{actor}, {user} kullanıcısını sahipliğe yükseltti",
    "You promoted {user} to owner" : "{user} kullanıcısını sahipliğe yükselttiniz",
    "{actor} promoted you to owner" : "{actor}, sizi sahipliğe yükseltti",
    "An administrator promoted you to owner" : "Bir yönetici sizi sahipliğe yükseltti",
    "An administrator promoted {user} to owner" : "Bir yönetici, {user} kullanıcısını sahipliğe yükseltti",
    "{actor} demoted {user} from owner" : "{actor}, {user} kullanıcısını sahiplikten kaldırdı",
    "You demoted {user} from owner" : "{user} kullanıcısını sahiplikten kaldırdınız",
    "{actor} demoted you from owner" : "{actor}, sizi sahiplikten kaldırdı",
    "An administrator demoted you from owner" : "Bir yönetici sizi sahiplikten kaldırdı",
    "An administrator demoted {user} from owner" : "Bir yönetici, {user} kullanıcısını sahiplikten kaldırdı",
    ...
    "{actor} created thread {title}" : "{actor}, {title} yazışmasını oluşturdu",
    "You created thread {title}" : "{title} yazışmasını oluşturdunuz",
    "{actor} renamed thread {title}" : "{actor}, {title} yazışmasını yeniden adlandırdı",
    "You renamed thread {title}" : "{title} yazışmasını yeniden adlandırdınız",
    ...
    "Message of {user} in {conversation}" : "{conversation} görüşmesinde {user} iletisi",
    "Message of {user}" : "{user} iletisi",
    "Message of a deleted user in {conversation}" : "{conversation} görüşmesinde silinmiş bir kullanıcının iletisi",
    "Talk conversations" : "Konuş görüşmeleri",
    "Call %s" : "Çağrı gönder: %s",
    "Chat with %s" : "%s ile sohbet",
    "An error occurred. Please contact your administrator." : "Bir sorun çıktı. Lütfen BT yöneticiniz ile görüşün.",
    "App disabled" : "Uygulama etkisizleştirilmiş",
    "Conversation subfolders are disabled" : "Görüşme alt klasörleri kapatılmış",
    "Storage quota exceeded" : "Depolama alanı sınırına ulaşıldı",
    "Could not prepare conversation folder" : "Görüşme klasörü hazırlanamadı",
    "File not found" : "Dosya bulunamadı",
    "Path must point to a file" : "Yol bir dosyayı göstermelidir",
    "File is not inside the conversation draft folder for this room" : "Dosya bu odanın görüşme taslağı klasörünün içinde değil",
    ...
    "No image file provided" : "Herhangi bir görsel dosyası belirtilmemiş",
    ...
    "Say hi to your friends and colleagues!" : "Tanıdıklarınıza ve çalışma arkadaşlarınıza selam verin!",
    ...
    "Missing %s field in header line" : "Başlık satırında %s alanı eksik",
    ...
    "Accept" : "Kabul et",
    "Decline" : "Reddet",
    "{user1} invited you to a federated conversation" : "{user1} sizi bir birleşik görüşmeye davet etti",
    ...
    "Channel" : "Kanal",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Yalnızca sorumluların ileti gönderebileceği ve çağrı yapılamayan geniş bir kitle için görüşme yayını.",
    "Classified conversation" : "Gizli görüşme",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Gizli konular için kilitli görüşme, herkese açık erişim, konuklar ve SIP olmadan.",
    "Default" : "Varsayılan",
    "Send messages, create threads, and start voice and video calls." : "İletiler gönderin, yazışmalar oluşturun ve sesli veya görüntülü görüşmeler yapın.",
    "Presentation" : "Sunum",
    "Restricted conversation for internal presentations." : "İç sunumlar için kısıtlanmış görüşme.",
    "Voice room" : "Konuşma odası",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Görüşmeye doğrudan katılın, denk gelmeler veya anlık toplantılar için ideal.",
    "Webinar" : "İnternet sunumu",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Giriş ile kısıtlanmış görüşme, herkese açık internet toplantıları için ideal.",
    ...
    "# Welcome to Nextcloud Talk\n\nNextcloud Talk is a private and powerful messaging app that integrates with Nextcloud. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Nextcloud Konuş uygulamasına hoş geldiniz\n\nNextcloud Konuş, Nextcloud ile bütünleşik gizli ve güçlü bir iletişim uygulamasıdır. Kişisel veya grup görüşmelerinde sohbet edin, sesli ve görüntülü görüşmelerde iş birliği yapın, internet toplantıları ve etkinlikler düzenleyin, görüşmelerinizi gizli tutun ve diğer şeyleri yapın.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push kurulmuş. Talk bildirimlerinin dakikliği iyileştiriliyor.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} kurulmamış. Talk bildirimlerinde gecikmeler olabilir.",
    ...
    "Assigned Talk phone numbers must not start with + or 0. Please remove or update the following numbers:\n{list}" : "Atanmış Konuş telefon numaraları + veya 0 ile başlamamalıdır. Lütfen aşağıdaki numaraları kaldırın veya güncelleyin:\n{list}",
    ...
    "Error occurred when getting the conversation information" : "Görüşme bilgileri alınırken sorun çıktı",
    "Duplicate session" : "Çift oturum",
    "Discuss this file" : "Bu dosya ile ilgili görüş",
    "Loading …" : "Yükleniyor…",
    "Share this file with others to discuss it" : "Bu dosyayı üzerinde görüşmek için başkaları ile paylaş",
    ...
    "Open in full application" : "Tam uygulamada aç",
    ...
    "Limit starting calls to certain groups" : "Çağrı başlatma belirli gruplarla sınırlansın",
    "Limit starting a call" : "Bir çağrı başlatma sınırlansın",
    "Limit starting calls" : "Çağrı başlatma sınırlansın",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "En az bir grup seçildiğinde, yalnızca bu grupların üyeleri bir çağrı başlatabilir. Bu durum aynı zamanda sorumlular için de geçerlidir. Konuklar ve birleşik kullanıcılar ise asla bu grupların üyesi değildir. Hiçbir grup seçilmediğinde herkes bir çağrı başlatabilir.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "Birleşik bir sunucuda barındırılan görüşmeler için, bunun yerine ana sunucunun yapılandırması geçerlidir.",
    ...
    "The following bots are installed on this server. In the documentation you can find details how to {linkstart1}build your own bot{linkend} or a {linkstart2}list of bots{linkend} to enable on your server." : "Bu sunucuda şu botlar kurulu. Belgelerde, sunucunuzda kullanmak için {linkstart1}kendi botunuzu nasıl oluşturacağınız{linkend} ya da{linkstart2}bot listesi{linkend} ile ilgili ayrıntılı bilgi bulabilirsiniz.",
    "No bots are installed on this server. In the documentation you can find details how to {linkstart1}build your own bot{linkend} or a {linkstart2}list of bots{linkend} to enable on your server." : "Bu sunucuda herhangi bir bot kurulu değil. Belgelerde, sunucunuzda kullanmak için {linkstart1}kendi botunuzu nasıl oluşturacağınız{linkend} ya da{linkstart2}bot listesi{linkend} ile ilgili ayrıntılı bilgi bulabilirsiniz.",
    ...
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "Yüksek başarımlı arka uç hesabınızda STUN ve/veya TURN özelliği bulunuyorsa, ayarlar buna göre güncellenir.",
    ...
    "Limits" : "Sınırlar",
    "STUN included" : "STUN var",
    "Yes" : "Evet",
    "No" : "Hayır",
    "TURN included" : "TURN var",
    ...
    "Do not show SIP Dial-out caller number" : "SIP giden arama numarası görüntülenmesin",
    "Anonymous number should appear as \"unknown\" or \"withheld number\" to call recipient" : "Alıcıyı aramak için anonim numara \"bilinmiyor\" veya \"gizli numara\" olarak görünmeli",
    "Dial-out number" : "Giden arama numarası",
    "E164 formatted number used as a fallback caller number for outgoing calls" : "Giden aramalar için varsayılan arayan numara olarak kullanılacak E164 biçiminde numara",
    "Dial-out prefix" : "Giden arama ön eki",
    "Prefix to configured user number for outgoing calls (default is `+`)" : "Giden aramalar için yapılandırılmış kullanıcı numarası ön eki (varsayılan `+`)",
    ...
    "Done" : "Tamam",
    "Disable live transcription" : "Canlı yazıya dönüştürmeyi kapat",
    "Enable live transcription (generated by AI)" : "Canlı yazıya dönüştürmeyi aç (yapar zeka ile)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Canlı yazıya dönüştürmeyi aç (Canlı yazıya dönüştürme uygulaması kurulmamış)",
    "Disable live translation" : "Canlı çeviriyi kapat",
    "Enable live translation (generated by AI)" : "Canlı çeviriyi aç (yapay zeka ile)",
    "Original language" : "Özgün dil",
    "Live translations app is not installed" : "Canlı çeviriler uygulaması kurulmamış",
    "Original language: {languageName}" : "Özgün dil: {languageName}",
    "Translated language" : "Çevrilmiş dil",
    "Translated language: {languageName}" : "Çevrilmiş dil: {languageName}",
    "Exit full screen (F)" : "Tam ekrandan çık (F)",
    "Full screen (F)" : "Tam ekran (F)",
    "Grid view" : "Izgara görünümü",
    "Speaker view" : "Konuşmacı görünümü",
    "Multi-speaker view" : "Çok konuşmacı görünümü",
    "Error when trying to load the available live transcription languages" : "Canlı yazıya dönüştürme için kullanılabilecek diller yüklenirken sorun çıktı",
    "Failed to enable live transcription" : "Canlı yazıya dönüştürme açılamadı",
    "Failed to enable live translations" : "Canlı çeviriler açılamadı",
    "Failed to disable live translations" : "Canlı çeviriler kapatılamadı",
    ...
    "Mute audio (M)" : "Sesi kapat (M)",
    "Unmute audio" : "Sesi aç",
    "Unmute audio (M)" : "Sesi aç (M)",
    "None" : "Yok",
    "Microphone" : "Mikrofon",
    "Speaker" : "Hoparlör",
    "Microphone settings" : "Mikrofon ayarları",
    ...
    "You have been muted by a moderator" : "Sesiniz sorumlu tarafından kapatıldı",
    ...
    "You" : "Siz",
    "You are sharing a screen" : "Bir ekran paylaşıyorsunuz",
    "Sharing this window may cause a mirroring effect" : "Bu pencereyi paylaşmak ayna etkisine neden olabilir",
    ...
    "Enable" : "Aç",
    "The bot is not available anymore" : "Bot artık kullanılamıyor",
    ...
    "Participants can use all available features." : "Katılımcılar var olan tüm özellikleri kullanabilir.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Katılımcılar, bir sorumlu el ile ek izinler verene kadar azaltılmış bir özellik kümesi kullanır.",
    ...
    "Live transcription" : "Canlı yazıya dönüştürme",
    "Live transcriptions app is not installed" : "Canlı yazıya dönüştürme uygulaması kurulmamış",
    "Enable live transcription" : "Canlı yazıya dönüştürmeyi aç",
    "Breakout Rooms" : "Çalışma odaları",
    ...
    "Leave conversation" : "Görüşmeden çık",
    "You need to promote a new moderator before you can leave the conversation" : "Görüşmeden çıkmadan önce başka bir kullanıcıyı sorumluluğa yükseltmelisiniz",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Bu görüşme korunuyor. Görüşme ve sohbet iletileri silinemez.",
    ...
    "Message expiration" : "İleti süresi",
    ...
    "This setting can not be changed while the conversation is preserved." : "Görüşme korunurken bu ayar değiştirilemez.",
    ...
    "Set language spoken in calls" : "Çağrılarda konuşulan dili ayarlayın",
    "Languages could not be loaded" : "Diller yüklenemedi",
    "Loading languages …" : "Diller yükleniyor…",
    "Invalid language" : "Dil geçersiz",
    "Default language (English)" : "Varsayılan dil (İngilizce)",
    "Default live transcription language set" : "Varsayılan canlı yazıya dönüştürme dili ayarlandı",
    "Live transcription language set: {languageName}" : "Ayarlanmış canlı yazıya dönüştürme dili: {languageName}",
    "Error when trying to set live transcription language" : "Canlı yazıya dönüştürme dili ayarlanırken sorun çıktı",
    ...
    "More info on Matterbridge" : "Matterbridge ile ilgili ayrıntılı bilgiler",
    ...
    "The entered token does not match the conversation token" : "Yazdığınız kod görüşme kodu ile eşleşmiyor",
    "Preserve conversation" : "Görüşmeyi koru",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Korunduğunda, bu görüşme silinemez, sohbet geçmişi temizlenemez ve konuklar ile katılma ayarları değiştirilemez.",
    "Only the owner can change whether this conversation is preserved." : "Bu görüşmenin korunup korunmayacağını yalnızca sahibi belirleyebilir.",
    ...
    "Stop preserving" : "Korumayı kaldır",
    "Stop preserving conversation" : "Görüşme korumasını kaldır",
    "Conversation token" : "Görüşme kodu",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Bu görüşmenin korumasını kaldırırsanız görüşme silinebilir, sohbet geçmişi temizlenebilir ve konuklar ile katılma ayarları değiştirilebilir.",
    "Conversation" : "Görüşme",
    "To confirm, type the conversation token into the field below:" : "Onaylamak için görüşme kodunu aşağıdaki alana yazın:",
    "Ongoing" : "Sürüyor",
    ...
    "Join conversations" : "Görüşmelere katıl",
    "Call a phone number" : "Bir telefon numarasını ara",
    "Scroll backward" : "Geriye kaydır",
    "Scroll forward" : "İleriye kaydır",
    "Schedule meetings" : "Toplantı zamanla",
    "You don't have any upcoming meetings" : "Yaklaşan bir toplantınız yok",
    ...
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Anıldığınız iletiler burada görüntülenir. @ ve ardından adlarını yazarak insanları anabilirsiniz",
    "Upcoming reminders" : "Yaklaşan anımsatıcılar",
    "Message reminders" : "İleti anımsatıcıları",
    "Set a reminder on a message to be notified" : "Daha sonra yeniden bilgilendirilmek için bir iletiye bir anımsatıcı ayarlayın",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "İçerik biçimi virgül ile ayrılmış değerlerdir (CSV):<br/>- Başlık satırı zorunludur ve {sample1} ya da yalnızca {sample2} ile eşleşmelidir<br/>- Her satıra bir kayıt yazın (örnek: {sample3})",
    ...
    "Hide message text" : "İleti yazısı gizlensin",
    "Remove all tags" : "Tüm etiketleri kaldır",
    "Rename tag" : "Etiketi yeniden adlandır",
    "Delete tag" : "Etiketi sil",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "\"{name}\" etiketini silmek istediğinize emin misiniz? Bu etiketi kullanan görüşmeler \"Diğer\" içine taşınacak.",
    "Move up" : "Yukarı taşı",
    "Move down" : "Aşağı taşı",
    "Pending invitations" : "Bekleyen davetler",
    "Join conversations from other servers" : "Başka sunuculardaki görüşmelere katıl",
    ...
    "Sort conversations" : "Görüşmeleri sırala",
    "By recent activity" : "Son etkinliğe göre",
    "Alphabetically" : "Alfabetik",
    "Do not group by type" : "Türe göre gruplanmasın",
    "Show private ones first" : "Özel olanlar üstte sıralansın",
    "Show group ones first" : "Grup olanlar üstte sıralansın",
    "No followed threads" : "Takip edilen bir yazışma yok",
    ...
    "Subscribe to an existing thread or start your own." : "Var olan bir yazışmaya abone olun ya da kendi yazışmanızı başlatın.",
    ...
    "SIP backend is not installed" : "SIP arka ucu kurulmamış",
    ...
    "Enable noise suppression" : "Gürültü engellemeyi aç",
    "Reduce background noises for better voice quality" : "Daha iyi ses kalitesi için arka plan gürültüsünü azaltır",
    "Basic" : "Temel",
    "Advanced" : "Gelişmiş",
    "Enable echo cancellation" : "Yansıma engellemeyi aç",
    "Minimize echo effect from own surrounding" : "Çevrenizden kaynaklanan yankı etkisini en aza indirir",
    "Enable auto gain control" : "Otomatik güçlendirmeyi aç",
    ...
    "You can only join a voice room via a call." : "Bir sesli odaya yalnızca arama ile katılabilirsiniz.",
    ...
    "Start recording immediately with the call" : "Çağrı başlangıcında kayıt başlatılsın",
    "Recording backend is not installed" : "Kayıt arka ucu kurulmamış",
    "Notify all participants about this call" : "Bu çağrı tüm katılımcılara bildirilsin",
    ...
    "7 days" : "7 gün",
    "30 days" : "30 gün",
    "Until unpin" : "Sabitleme kaldırılana kadar",
    "Clear reminder – {timeLocale}" : "Anımsatıcıyı temizle – {timeLocale}",
    "Edited by {actor}" : "{actor} tarafından düzenlendi",
    "Pinned by you" : "Sabitledikleriniz",
    "Pinned by {actor}" : "{actor} tarafından sabitlenmişler",
    "Until {absoluteDate}" : "{absoluteDate} tarihine kadar",
    ...
    "Unpin message" : "İletinin sabitlemesini kaldır",
    ...
    "Edit thread details" : "Yazışma ayrıntılarını düzenle",
    "Forward message" : "İletiyi ilet",
    "Translate" : "Çevir",
    "Set custom reminder" : "Özel anımsatıcı ayarla",
    "Keep pinned for" : "Şu kadar sabitlensin",
    "Set custom period" : "Özel aralık ayarla",
    ...
    "This translation is AI generated and may contain mistakes." : "Bu çeviri yapay zeka tarafından oluşturulmuştur ve hatalar olabilir.",
    "Copy translated text" : "Çevrilmiş yazıyı kopyala",
    "Error when scheduling the message" : "İleti zamanlanırken sorun çıktı",
    "Reschedule" : "Yeniden zamanla",
    "Send now" : "Şimdi gönder",
    "Choose a time" : "Bir zaman seçin",
    "Send at custom time" : "Özel bir zamanda gönderilsin",
    "Will be sent without notification" : "Bildirim olmadan gönderilecek",
    ...
    "Reply to thread \"{threadTitle}\"" : "\"{threadTitle}\" yazışmasını yanıtla",
    ...
    "Generate summary with AI" : "Yapay zeka ile özet oluştur",
    "{author} (pinned by you)" : "{author} (siz sabitlemişsiniz)",
    "{author} (pinned by {actor})" : "{author} ({actor} sabitlemiş)",
    ...
    "Conversation type" : "Dönüştürme türü",
    "Default parameters are:" : "Varsayılan parametreler:",
    "These settings can be changed once the conversation is created." : "Görüşme oluşturulduktan sonra bu ayarlar değiştirilebilir.",
    ...
    "Create a thread silently" : "Sessizce bir yazışma oluştur",
    "Create a thread" : "Bir yazışma oluştur",
    "Send message silently" : "Sessizce ileti gönder",
    ...
    "Message will be sent {datetimeString}" : "İleti {datetimeString} zamanında gönderilecek",
    "Thread title is required" : "Yazışma başlığı yazılmalıdır",
    "Message text is required" : "İleti içeriği yazılmalıdır",
    ...
    "Message was successfully scheduled" : "İleti zamanlandı",
    ...
    "Thread title" : "Yazışma başlığı",
    "Send later" : "Daha sonra gönder",
    "Show scheduled messages" : "Zamanlanmış iletileri görüntüle",
    "Cancel editing" : "Düzenlemeyi iptal et",
    "Schedule message" : "İletiyi zamanla",
    ...
    "Voice message {time} ({conversation})" : "Sesli ileti {time} ({conversation})",
    ...
    "Standard image quality" : "Standart görsel kalitesi",
    "Original image quality" : "Özgün görsel kalitesi",
    "View-only for others" : "Diğerleri için yalnızca görüntüleme",
    "Editable by others" : "Diğerleri düzenleyebilir",
    ...
    "Start a call" : "Bir çağrı başlatma",
    "Skip the lobby" : "Girişi atlama",
    "Post messages" : "İleti gönderme",
    "Post messages and reactions" : "İleti ve tepki gönderme",
    "Add reactions" : "Tepki ekleme",
    "Enable the microphone" : "Mikrofonu açma",
    "Enable the camera" : "Kamerayı açma",
    "Share the screen" : "Ekranı paylaşma",
    ...
    "Settings" : "Ayarlar",
    "Show names on voted options" : "Oy verilmiş seçeneklerde adlar görüntülensin",
    ...
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n oy • Adınız oy verilen seçeneklerde görüntülenecek","%n oy • Adınız oy verilen seçeneklerde görüntülenecek"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n oy • Adınız oy verilen seçeneklerde görüntülenmeyecek","%n oy • Adınız oy verilen seçeneklerde görüntülenmeyecek"],
    "Your name will not be shown on voted options" : "Adınız oy verilen seçeneklerde görüntülenmeyecek",
    "You voted for this option" : "Bu seçenek için oy verdiniz",
    "End poll" : "Anketi sonlandır",
    "Change your vote" : "Oyunuzu değiştirin",
    "Withdraw vote" : "Oyu geri çek",
    "Results" : "Sonuçlar",
    "Download as spreadsheet" : "Elektronik tablo olarak indir",
    "Download as CSV" : "CSV olarak indir",
    ...
    "The text must be less than or equal to {maxLength} characters long. Your current text is {charactersCount} characters long." : "Yazı {maxLength} ya da daha az karakter uzunluğunda olmalıdır. Şu andaki yazı uzunluğu {charactersCount} karakter.",
    ...
    "The last moderator of a conversation can not be demoted" : "Bir görüşmedeki son sorumlunun yetkisi kaldırılamaz",
    "Could not change the type of the participant" : "Katılımcının türü değiştirilemedi",
    ...
    "Phone number could not be muted" : "Telefon numarasının sesi kapatılamadı",
    ...
    "Promote to owner" : "Sahipliğe yükselt",
    "Demote from moderator" : "Sorumluluktan çıkar",
    "Promote to moderator" : "Sorumluluğa yükselt",
    "Demote from owner to moderator" : "Sahiplikten sorumluluğa düşür",
    "Demote from owner to participant" : "Sahiplikten katılımcılığa düşür",
    ...
    "Pinned by a deleted user" : "Silinmiş bir kullanıcı sabitlemiş",
    ...
    "Threads in {name}" : "{name} içindeki yazışmalar",
    ...
    "Search conversations or users" : "Görüşme ya da kullanıcı ara",
    ...
    "I picked the list style" : "Liste biçemini seçtim",
    ...
    "Compact conversations list" : "Dar görüşmeler listesi",
    "Chat appearance" : "Sohbet görünümü",
    "Messages list" : "İleti listesi",
    "Message bubbles" : "İleti balonları",
    ...
    "Invalid language ({languageId})" : "Dil geçersiz ({languageId})",
    "Default language" : "Varsayılan dil",
    "Default language ({languageName})" : "Varsayılan dil ({languageName})",
    "Error when trying to load the available live translation languages" : "Canlı çeviri için kullanılabilecek diller yüklenirken sorun çıktı",
    "Error when trying to set live translation language" : "Canlı çeviri dili ayarlanırken sorun çıktı",
    "Set language used to show the transcriptions" : "Çevirilerin görüntüleneceği dili seçin",
    ...
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Katılırken kamera kapatılacak. Kayıt için onay verilmesi gerekiyorsa her zaman görüntülenir.",
    ...
    "Push to talk or push to mute" : "Bas konuş ya da bas kapat",
    ...
    "The server was updated, you cannot start or join a call." : "Sunucu güncellenmiş. Bir çağrı başlatamaz ya da katılamazsınız.",
    ...
    "Scheduled messages" : "Zamanlanmış iletiler",
    ...
    "Select virtual background" : "Sanal arka planı seçin",
    "Show your screen" : "Ekranımı görüntüle",
    "Mute others" : "Diğerlerinin sesini kapat",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Bu görüşme, %n dakika boyunca etkileşim olmazsa herkesten otomatik olarak silinecek.","Bu görüşme, %n dakika boyunca etkileşim olmazsa herkesten otomatik olarak silinecek."],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Bu görüşme, %n gün boyunca etkileşim olmazsa herkesten otomatik olarak silinecek.","Bu görüşme, %n gün boyunca etkileşim olmazsa herkesten otomatik olarak silinecek."],
    ...
    "Scheduled {datetime}" : "{datetime} zamanına ayarlanmış",
    "Scheduled for {datetime}" : "{datetime} için zamanlanmış",
    "Search" : "Ara",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Bu görüşme başka bir sekmede de açılmış. Geçerli sunucu sürümü, bir görüşmenin birden fazla sekmede açılmasını desteklemiyor.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Liste biçimini mi ileti balonları biçemini mi kullanıyorsunuz?",
    ...
    "Follow conversation settings" : "Görüşme ayarları kullanılsın",
    "Group" : "Grup",
    "Team" : "Takım",
    ...
    "The server was updated." : "Sunucu güncellenmiş.",
    ...
    "Deck card has been posted to {conversation}" : "{conversation} görüşmesine Deste kartı yapıştırıldı",
    "An error occurred while posting deck card to conversation" : "Deste kartı seçilmiş görüşmeye gönderilirken bir sorun çıktı",
    ...
    "Error while changing the preserved status of the conversation" : "Görüşmenin korunma durumu değiştirilirken sorun çıktı",
    ...
    "Failed to rename the thread" : "Yazışma yeniden adlandırılamadı",
    "Error renaming tag" : "Etiket yeniden adlandırılırken sorun çıktı",
    "Error deleting tag" : "Etiket silinirken sorun çıktı",
    "Error reordering tags" : "Etiketler yeniden sıralanırken sorun çıktı",
    ...
    "The server is in maintenance mode." : "Sunucu bakım kipinde.",
    "Federated server was updated." : "Birleşik sunucu güncellenmiş.",
    ...
    "Set time for later today" : "Bugün daha sonrası için ayarla",
    "Tomorrow – {timeLocale}" : "Yarın – {timeLocale}",
    "Set time for tomorrow" : "Yarın için ayarla",
    ...
    "Select a microphone" : "Bir mikrofon seçin",
    "Select a speaker" : "Bir hoparlör seçin",
    "Select a video device" : "Bir görüntü aygıtı seçin",
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Takviminizde bir toplantı zamanlayın. Burada görüntülenmesi için bir Konuş görüşmesinin konum olarak ayarlanması gerekir",
    ...
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["Açık anket • %n oy • Adınız oy verilen seçeneklerde görüntülenecek","Açık anket • %n oy • Adınız oy verilen seçeneklerde görüntülenecek"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["Açık anket • %n oy • Adınız oy verilen seçeneklerde görüntülenmeyecek","Açık anket • %n oy • Adınız oy verilen seçeneklerde görüntülenmeyecek"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "Açık anket • Zaten oy vermişsiniz • Adınız oy verilen seçeneklerde görüntülenmeyecek",
    "Open poll • Your name will not be shown on voted options" : "Açık anket • Adınız oy verilen seçeneklerde görüntülenmeyecek",
