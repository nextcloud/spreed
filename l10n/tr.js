OC.L10N.register(
    ...
    "Limit to groups" : "Gruplarla sınırla",
    "When at least one group is selected, only people of the listed groups can be part of conversations." : "En az bir grup seçildiğinde, yalnızca listelenen gruplardan kişiler sohbetlerin bir parçası olabilir.",
    "Guests can still join public conversations." : "Konuklar hala herkese açık konuşmalara katılabilir.",
    "Users that can not use Talk anymore will still be listed as participants in their previous conversations and also their chat messages will be kept." : "Artık Talk kullanamayan kullanıcılar, önceki konuşmalarına katılanlar olarak listelenecek ve sohbet mesajları da saklanacaktır.",
    "Limit app usage to groups." : "Uygulama kullanımını gruplarla sınırlandırın.",
