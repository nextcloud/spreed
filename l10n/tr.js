OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Görüşmelerin akmasına izin verin: Kullanıcıları anın, iletilere tepki verin ve diğer şeyleri yapın\n\nGörüşmedeki herkesi @all olarak anabilir veya \"@\" yazıp listeden adlarını seçerek belirli katılımcıları anabilirsiniz.",
    ...
    "Talk Backend URL" : "Konuş arka tarafı adresi",
    ...
    "- Unsent message drafts are now saved in your browser " : "- Gönderilmemiş ileti taslaklarının tarayıcınıza kaydedilmesi sağlandı",
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "- *Ön izleme:* Metin sohbetlerinin diğer Konuş sunucularıyla birleşik olarak yapılabilmesi sağlandı",
    ...
    "Channel ID or name" : "Kanal kimliği ya da adı",
    "Loading" : "Yükleniyor",
    "Close" : "Kapat",
