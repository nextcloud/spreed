OC.L10N.register(
    ...
    "- Moderators can now create breakout rooms (requires the High-performance backend)" : "- Sorumlular çalışma odaları oluşturabilir (yüksek başarımlı arka taraf gereklidir)",
    "- Calls can now be recorded (requires the High-performance backend)" : "- Çağrılar kaydedilebilir (yüksek başarımlı arka taraf gereklidir)",
    ...
    "- Archive conversations to stay focused" : "- Odaklanmak için konuşmaları arşivleyin",
    ...
    "Talk mentions" : "Talk bahsetmeleri",
    ...
    "The hosted signaling server was removed and will not be used anymore." : "Barındırılan signaling sunucusu silindi ve devre dışı bırakıldı.",
    ...
    "Talk configuration values" : "Talk yapılandırma değerleri",
    ...
    "Federation" : "Birleşim",
    "It is highly recommended to configure \"memcache.locking\" when Talk Federation is enabled." : "Talk birleştirme etkinleştirildiğinde \"memcache.locking\" yapılandırmasının yapılması önemle önerilir.",
    ...
    "Recording backend" : "Kaydetme arka tarafı",
    "Using the recording backend requires a High-performance backend." : "Kayıt arka tarafının kullanılabilmesi için bir yüksek başarımlı arka taraf gereklidir.",
    "No recording backend configured" : "Herhangi bir kayıt arka tarafı yapılandırılmamış",
    "SIP configuration" : "SIP yapılandırması",
    "Using the SIP functionality requires a High-performance backend." : "SIP özelliğinin kullanılabilmesi için bir yüksek başarımlı arka taraf gereklidir.",
    "No SIP backend configured" : "Herhangi bir SIP arka tarafı yapılandırılmamış.",
    ...
    "@-mentions only" : "Yalnızca @-bahsetmeleri",
    "Off" : "Kapalı",
    ...
    "End-to-end encrypted calls with a configured SIP bridge require a newer version of the High-performance backend and SIP bridge." : "Yapılandırılmış bir SIP köprüsü ile uçtan uca şifrelenmiş çağrılar için, yüksek başarımlı arka uç ve SIP köprüsünün daha yeni bir sürümü gerekir.",
    ...
    "Hosted High-performance backend" : "Barındırılan yüksek başarımlı arka uç",
    ...
    "Recording backend URL" : "Kaydetme arka tarafı adresi",
    ...
    "Recording backend settings saved" : "Kaydetme arka tarafı ayarları kaydedildi",
    ...
    "Recording backend configuration is only possible with a High-performance backend." : "Kaydetme arka taraf yapılandırması yalnızca yüksek başarımlı arka taraf ile kullanılabilir.",
    ...
    "Only users of the following groups can enable SIP in conversations they moderate" : "Yalnızca aşağıdaki grupların kullanıcıları sorumlu oldukları görüşmelerde SIP özelliğini etkinleştirebilir",
    ...
    "Talk Backend URL" : "Talk arka tarafı adresi",
    ...
    "Enable video - Your connection will be briefly interrupted when enabling the video for the first time" : "Görüntüyü etkinleştir - Görüntü ilk kez etkinleştirilirken bağlantınız bir an kesilecek",
    ...
    "Picture" : "Fotoğraf",
    "The following bots can be enabled in this conversation. Reach out to your administration to get more bots installed on this server." : "Bu görüşmede şu botlar etkinleştirilebilir. Bu sunucuya daha fazla bot kurması için yöneticiniz ile görüşün.",
    ...
    "Enable phone and SIP dial-in" : "Telefon ve SIP çevirme özelliğini etkinleştir",
    ...
    "Talk setup incomplete" : "Talk kurulumu tamamlanmamış",
    ...
    "Failed to join the conversation." : "Görüşmeye katılınamadı.",
    ...
    "Filter unread mentions" : "Okunmamış bahsetmeleri süz",
