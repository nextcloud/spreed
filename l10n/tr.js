OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Görüşmelerin akmasına izin verin: Kullanıcıları anın, iletilere tepki verin ve diğer şeyleri yapın\n\nGörüşmedeki herkesi %s olarak anabilir veya \"@\" yazıp listeden adlarını seçerek belirli katılımcıları anabilirsiniz.",
