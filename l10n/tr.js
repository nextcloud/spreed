OC.L10N.register(
    ...
    "Screensharing is about to start…" : "Ekran paylaşımı başlatılıyor...",
    ...
    "The screensharing request has been cancelled." : "Ekran paylaşımı isteği iptal edildi.",
    ...
    "_%n other guest_::_%n other guests_" : ["%n diğer ziyaretçi","%n diğer ziyaretçi"],
    "_%n guest_::_%n guests_" : ["%n ziyaretçi","%n ziyaretçi"],
    ", " : ",",
