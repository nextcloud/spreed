OC.L10N.register(
    ...
    "Set up an external signaling server for a better call experience." : "Görüşme deneyimini iyileştirmek için bir dış signaling sunucusu kurun.",
    ...
    "Please note that calls with more than 4 participants without external signaling server, participants can experience connectivity issues and cause high load on participating devices. Learn more about external signaling and other benefits of the Nextcloud Talk High Performance Back-end on {link}." : "Bir dış signaling sunucusu olmadan 4 kişiden fazlası ile yapılan görüşmelerde bağlantı sorunları yaşanabilir ve bağlanan aygıtlarda aşırı işlem yükü oluşabilir. Dış signaling kullanımı ve Yüksek Başarımlı Nextcloud Talk arka planı hakkında ayrıntılı bilgileri {link} üzerinden alabilirsiniz.",
