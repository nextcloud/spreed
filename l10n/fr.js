OC.L10N.register(
    ...
    "- You can now change your camera and microphone while being in a call" : "- Vous pouvez maintenant modifier votre microphone et votre caméra pendant l'appel",
    ...
    "- Search for messages of the current conversation directly in the right sidebar" : "- Rechercher des messages de la conversation actuelle directement depuis le panneau latéral de droite",
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Les modérateurs peuvent désormais épingler des messages afin qu'ils restent en haut de la page. ",
    "- Schedule a message to send it at a later time" : "- Programmer un message pour l'envoyer plus tard",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Étiquettes de conversation, regroupement et tri pour mieux organiser la liste des conversations",
    "- Voice-rooms to connect spontaneously" : "- Salons vocaux pour échanger spontanément",
    "- Presets for quick conversation configuration during creation" : "- Configurations prédéfinies pour créer rapidement une conversation",
    "- Direct calls from profile menus for calls within other apps" : "- Appels directs depuis les menus de profil pour appeler dans les autres applications",
    "- Classified conversations for better discussions around sensitive topics" : "- Conversations confidentielles pour des discussions plus appropriées autour de sujets sensibles",
    "- Channels and announcements to broadcast information to a broader audience" : "- Canaux et annonces pour diffuser de l'information à une audience plus large",
    "- Owners can preserve a conversation, preventing deletion and chat purging" : "- Les propriétaires peuvent préserver une conversation, empêchant sa suppression et la purge de la discussion",
    ...
    "{actor} preserved the conversation" : "{actor} a placé la conversation en conservation",
    "You preserved the conversation" : "Vous avez placé la conversation en conservation",
    "An administrator preserved the conversation" : "Un administrateur a placé la conversation en conservation",
    "{actor} stopped preserving the conversation" : "{actor} a mis fin à la conservation de la conversation",
    "You stopped preserving the conversation" : "Vous avez mis fin à la conservation de la conversation",
    "An administrator stopped preserving the conversation" : "Un administrateur a mis fin à la conservation de la conversation",
    ...
    "System added you" : "Le système vous a ajouté",
    "System added {user}" : "Le système a ajouté {user}",
    ...
    "{actor} promoted {user} to owner" : "{actor} a promu {user} propriétaire",
    "You promoted {user} to owner" : "Vous avez promu {user} propriétaire",
    "{actor} promoted you to owner" : "{actor} vous a promu propriétaire",
    "An administrator promoted you to owner" : "Un administrateur vous a promu propriétaire",
    "An administrator promoted {user} to owner" : "Un administrateur a promu {user} propriétaire",
    "{actor} demoted {user} from owner" : "{actor} a retiré à {user} le rôle de propriétaire",
    "You demoted {user} from owner" : "Vous avez retiré à {user} son rôle de propriétaire",
    "{actor} demoted you from owner" : "{actor} vous a retiré le rôle de propriétaire",
    "An administrator demoted you from owner" : "Un administrateur vous a retiré le rôle de propriétaire",
    "An administrator demoted {user} from owner" : "Un administrateur a retiré à {user} le rôle de propriétaire",
    ...
    "{actor} pinned a message" : "{actor} a épinglé un message",
    "You pinned a message" : "Vous avez épinglé un message",
    "{actor} unpinned a message" : "{actor} a désépinglé un message",
    "Message was automatically unpinned" : "Le message a été désépinglé automatiquement",
    "You unpinned a message" : "Vous avez désépinglé un message",
    ...
    "Conversation subfolders are disabled" : "Sous-dossiers de conversation désactivés",
    "Storage quota exceeded" : "Quota de stockage dépassé",
    "Could not prepare conversation folder" : "Impossible de préparer le dossier de conversation",
    "File not found" : "Fichier introuvable",
    "Path must point to a file" : "Le chemin doit pointer vers un fichier",
    "File is not inside the conversation draft folder for this room" : "Le fichier n'est pas à l'intérieur du dossier brouillon de conversation pour cette salle",
    ...
    "Missing %s field in header line" : "Le champ %s est manquant dans la ligne d’en-tête",
    ...
    "Scheduled time" : "Horaire programmé",
    ...
    "Call via Talk" : "Appeler via Talk",
    "Announcement" : "Annonce",
    "Conversation to inform a fixed audience, which can not be left." : "Conversation destinée à informer une audience fixe, qui ne peut pas être quittée.",
    "Channel" : "Canal",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Conversation diffusée auprès d'une large audience, dans laquelle seuls les modérateurs peuvent publier et où les appels sont désactivés.",
    "Classified conversation" : "Conversation classifiée",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Conversation sécurisée pour les sujets confidentiels, avec l'accès public, les invités, le SIP et les enregistrements désactivés.",
    "Default" : "Par défaut",
    "Send messages, create threads, and start voice and video calls." : "Envoyer des messages, créer des sujets et démarrer des appels audio et vidéo.",
    "Presentation" : "Présentation",
    "Restricted conversation for internal presentations." : "Conversation restreinte pour présentations internes.",
    "Voice room" : "Salon vocal",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Rejoindre l'appel directement, idéal pour rattraper une conversation ou pour les réunions spontanées.",
    "Webinar" : "Webinaire",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Conversation restreinte avec lobby activé, idéal pour les webinaires public.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push est installé, cela améliore la ponctualité des notifications Talk.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} n'est pas installé. Cela peut entraîner un retard dans les notifications Talk.",
    ...
    "Assigned Talk phone numbers must not start with + or 0. Please remove or update the following numbers:\n{list}" : "Les numéros de téléphone Talk assignés ne doivent pas commencer par + ou 0. Merci de retirer ou corriger les numéros suivants :\n{list}",
    ...
    "Open in full application" : "Ouvrir dans l'application complète",
    ...
    "Limit starting calls to certain groups" : "Limiter le lancement d'appel à certains groupes",
    "Limit starting a call" : "Limiter le lancement d'appel",
    "Limit starting calls" : "Limiter le lancement  des appels",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Lorsqu'au moins un groupe est sélectionné, seuls les membres de ces groupes peuvent démarrer un appel. Cette règle s'applique également aux modérateurs. Les invités et les utilisateurs fédérés ne peuvent jamais être membres de ces groupes. Si aucun groupe n'est sélectionné, tout le monde peut démarrer un appel.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "Pour les conversations hébergées sur un serveur fédéré, la configuration du serveur hôte s'applique.",
    ...
    "Beta" : "Bêta",
    "Federated chats and calls work already. Attachment handling is coming in a future version." : "Les discussions et les appels fédérés fonctionnent déjà. La gestion des pièces jointes sera disponible dans une future version.",
    ...
    "Enable live transcription (generated by AI)" : "Activer la retranscription immédiate (générée par IA)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Activer la retranscription immédiate (l'application de retranscription immédiate n'est pas installée)",
    "Disable live translation" : "Désactiver la traduction en direct",
    "Enable live translation (generated by AI)" : "Activer la traduction immédiate (générée par IA)",
    "Original language" : "Langue originale",
    "Live translations app is not installed" : "L'application de traduction immédiate n'est pas installée",
    "Original language: {languageName}" : "Langue d'origine : {languageName}",
    "Translated language" : "Langue traduite",
    "Translated language: {languageName}" : "Langue traduite : {languageName}",
    ...
    "Multi-speaker view" : "Vue multi-intervenants",
    ...
    "Failed to enable live translations" : "Échec de l'activation des traductions en direct",
    "Failed to disable live translations" : "Échec de la désactivation des traductions en direct",
    ...
    "Microphone settings" : "Réglages du microphone",
    ...
    "You" : "Vous",
    "You are sharing a screen" : "Vous partagez un écran",
    "Sharing this window may cause a mirroring effect" : "Le partage de cette fenêtre peut provoquer un effet de miroir",
    ...
    "Disable" : "Désactiver",
    "Enable" : "Activer",
    "The bot is not available anymore" : "Le robot n'est plus disponible",
    ...
    "Participants can use all available features." : "Les participants peuvent utiliser toutes les fonctionnalités disponibles.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Les participants disposent d'un nombre réduit de fonctionnalités jusqu'à ce qu'un modérateur accorde manuellement des permissions supplémentaires",
    ...
    "Live transcriptions app is not installed" : "L'application de retranscription immédiate n'est pas installée",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Cette conversation est conservée. Elle ne peut pas être supprimée et ses messages ne peuvent pas être effacés.",
    ...
    "This setting can not be changed while the conversation is preserved." : "Ce paramètre ne peut pas être modifié tant que la conversation est conservée.",
    ...
    "The entered token does not match the conversation token" : "Le jeton saisi ne correspond pas au jeton de la conversation",
    "Preserve conversation" : "Conserver la conversation",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Tant qu’elle est conservée, cette conversation ne peut pas être supprimée, son historique ne peut pas être effacé et les paramètres relatifs aux invités et à la possibilité de la rejoindre ne peuvent pas être modifiés.",
    "Only the owner can change whether this conversation is preserved." : "Seul le propriétaire peut décider si cette conversation doit être conservée.",
    ...
    "Stop preserving" : "Mettre fin à la conservation",
    "Stop preserving conversation" : "Mettre fin à la conservation de la conversation",
    "Conversation token" : "Jeton de conversation",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Si vous mettez fin à la conservation de cette conversation, elle pourra être supprimée, son historique pourra être effacé et les paramètres relatifs aux invités et à la possibilité de la rejoindre pourront de nouveau être modifiés.",
    "Conversation" : "Conversation",
    "To confirm, type the conversation token into the field below:" : "Pour confirmer, saisissez le jeton de la conversation dans le champ ci-dessous :",
    "Ongoing" : "En cours",
    ...
    "Join conversations" : "Rejoindre les conversations",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Les événements du calendrier avec un lien de conversation comme lieu sont visibles ici",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Le contenu doit être au format valeurs séparées par des virgules (CSV) :<br/>- Une ligne d’en-tête est obligatoire et doit correspondre à {sample1} ou simplement à {sample2}<br/>- Une entrée par ligne (par exemple {sample3})",
    ...
    "Remove all tags" : "Retirer toutes les étiquettes",
    "Rename tag" : "Renommer l'étiquette",
    "Delete tag" : "Supprimer l'étiquette",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Voulez-vous vraiment supprimer \"{name}\" ? Les conversations avec cette étiquette seront déplacées vers \"Autre\".",
    "Move up" : "Monter",
    "Move down" : "Descendre",
    "Pending invitations" : "Invitations en attente",
    "Join conversations from other servers" : "Rejoindre les conversations d'autres serveurs",
    ...
    "Mentions" : "Mentions",
    "Meetings" : "Réunions",
    "Sort conversations" : "Trier les conversations",
    "By recent activity" : "Par activité récente",
    "Alphabetically" : "Ordre alphabétique",
    "Do not group by type" : "Ne pas grouper par type",
    "Show private ones first" : "Montrer les privées d'abord",
    "Show group ones first" : "Afficher les conversations de groupe en premier",
    ...
    "Search in app" : "Rechercher dans l'application",
    ...
    "SIP backend is not installed" : "Serveur SIP non installé",
    ...
    "Open conversations" : "Discussions en cours",
    ...
    "Enable noise suppression" : "Activer la suppression du bruit",
    "Reduce background noises for better voice quality" : "Réduisez les bruits de fond pour une meilleure qualité vocale",
    "Basic" : "Basique",
    "Advanced" : "Avancé",
    "Enable echo cancellation" : "Activer la suppression de l'écho",
    "Minimize echo effect from own surrounding" : "Minimiser l'effet d'écho provenant de l'environnement",
    "Enable auto gain control" : "Activer le contrôle automatique du gain",
    "Dynamically adjust microphone volume for consistent level" : "Ajuster dynamiquement le volume du microphone pour un niveau constant",
    ...
    "Select a device" : "Sélectionner un périphérique",
    "Playing …" : "Lecture...",
    ...
    "You can only join a voice room via a call." : "Vous ne pouvez rejoindre un salon vocal qu’au moyen d’un appel.",
    ...
    "Recording backend is not installed" : "Le serveur d'enregistrement n'est pas installé",
    ...
    "Keep pinned for" : "Garder épinglé pendant",
    "Set custom period" : "Choisir une période spécifique",
    ...
    "This translation is AI generated and may contain mistakes." : "Cette traduction est générée par IA et peut contenir des erreurs.",
    "Copy translated text" : "Copier le texte traduit",
    "Error when scheduling the message" : "Erreur lors de la planification du message",
    "Reschedule" : "Reprogrammer",
    "Send now" : "Envoyer immédiatement",
    "Choose a time" : "Choisir un horaire",
    "Send at custom time" : "Envoyer à un horaire spécifique",
    "Will be sent without notification" : "Sera envoyé sans notification",
    ...
    "Reply to thread \"{threadTitle}\"" : "Répondre dans le fil de discussion \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Vous avez voté • %n vote","Vous avez voté • %n votes","Vous avez voté • %n votes"],
    "You voted" : "Vous avez voté",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Cliquer pour voter • %n vote","Cliquer pour voter • %n votes","Cliquer pour voter • %n votes"],
    ...
    "_%n vote_::_%n votes_" : ["%n vote","%n votes","%n vote(s)"],
    ...
    "Generate summary with AI" : "Générer un résumé par IA",
    "{author} (pinned by you)" : "{author} (épinglé par vous)",
    "{author} (pinned by {actor})" : "{author} (épinglé par {actor})",
    "Unpin" : "Détacher",
    ...
    "Default parameters are:" : "Les paramètres par défaut sont : ",
    "These settings can be changed once the conversation is created." : "Ces paramètres peuvent être changés une fois que la conversation est créée.",
    ...
    "Message will be sent {datetimeString}" : "Le message sera envoyé le {datetimeString}",
    ...
    "Message was successfully scheduled" : "Message programmé avec succès",
    ...
    "Access to the microphone was denied" : "L'accès au microphone n'est pas autorisé",
    ...
    "Voice message {time} ({conversation})" : "Message vocal {time} ({conversation})",
    ...
    "Standard image quality" : "Qualité d’image standard",
    "Original image quality" : "Qualité d’image d’origine",
    "View-only for others" : "Lecture seule pour les autres",
    "Editable by others" : "Modifiable par les autres",
    ...
    "Post messages" : "Envoyer des messages",
    "Post messages and reactions" : "Envoyer des messages et des réactions",
    "Add reactions" : "Ajouter des réactions",
    "Enable the microphone" : "Activer le microphone",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Résultats finaux • %n vote","Résultats finaux • %n votes","Résultats finaux • %n votes"],
    ...
    "Withdraw vote" : "Retirer le vote",
    "Results" : "Résultats",
    "Download as spreadsheet" : "Télécharger comme feuille de calcul",
    "Download as CSV" : "Télécharger comme CSV",
    ...
    "The last moderator of a conversation can not be demoted" : "Le dernier modérateur d’une conversation ne peut pas perdre son rôle de modérateur",
    "Could not change the type of the participant" : "Impossible de modifier le type du participant",
    ...
    "Promote to owner" : "Promouvoir comme propriétaire",
    "Demote from moderator" : "Retirer le statut de modérateur",
    "Promote to moderator" : "Promouvoir comme modérateur",
    "Demote from owner to moderator" : "Rétrograder de propriétaire à modérateur",
    "Demote from owner to participant" : "Rétrograder de propriétaire à participant",
    ...
    "Add emails" : "Ajouter des adresses e-mail",
    ...
    "Pinned by a deleted user" : "Épinglé par un utilisateur supprimé",
    ...
    "Projects" : "Projets",
    "No shared items" : "Pas d'éléments partagés",
    ...
    "Select conversation" : "Sélectionner une conversation",
    ...
    "I picked message bubbles" : "J'ai choisi des bulles de message",
    "I picked the list style" : "J'ai choisi le style de liste",
    ...
    "Compact conversations list" : "Liste compacte des conversations",
    "Chat appearance" : "Apparence de la discussion",
    ...
    "Error when trying to load the available live translation languages" : "Erreur lors du chargement des langues disponibles pour la traduction en direct",
    "Error when trying to set live translation language" : "Erreur lors de la tentative de configuration de la langue de traduction en direct",
    "Set language used to show the transcriptions" : "Définir la langue utilisée pour afficher les transcriptions",
    ...
    "Turn camera and microphone off by default" : "Désactiver par défaut la caméra et le microphone",
    "Blur camera background by default" : "Flouter l'arrière-plan de la caméra par défaut",
    "Skip device preview before joining a call" : "Ignorer l'aperçu du périphérique avant de rejoindre un appel",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "La caméra sera éteinte pendant la connexion. Toujours montré si le consentement à l'enregistrement est demandé.",
    "Appearance & Sounds" : "Apparence et sons",
    "Privacy" : "Confidentialité",
    "Send read receipts" : "Envoyer des accusés de lecture",
    "When off, all read statuses will be hidden" : "Si désactivé, tous les statuts de lecture seront cachés",
    "Share typing status" : "Partager le statut de frappe",
    "When off, all typing indicators will be hidden" : "Si désactivé, tous les statuts de frappe seront cachés",
    "Attachments folder" : "Dossier des pièces jointes",
    "Toggle full screen" : "Basculer en mode plein écran",
    "Return to Home screen" : "Retourner à l'écran d'accueil",
    "Shortcuts while in a chat" : "Raccourci pendant la conversation",
    ...
    "The server was updated, you cannot start or join a call." : "Le serveur a été mis à jour, vous ne pouvez pas démarrer ou rejoindre un appel.",
    ...
    "The call has been running for one hour." : "L'appel est en cours depuis une heure.",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Cette conversation sera automatiquement supprimée pour tout le monde après %n minute d'inactivité.","Cette conversation sera automatiquement supprimée pour tout le monde après %n minutes d'inactivité.","Cette conversation sera automatiquement supprimée pour tout le monde après %n minutes d'inactivité."],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["La conversation sera automatiquement supprimée pour tout le monde après %n jour d'inactivité.","La conversation sera automatiquement supprimée pour tout le monde après %n jours d'inactivité.","La conversation sera automatiquement supprimée pour tout le monde après %n jours d'inactivité."],
    ...
    "Scheduled {datetime}" : "Programmé {datetime}",
    "Scheduled for {datetime}" : "Programmé pour {datetime}",
    "Search" : "Recherche",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "La conversation a été ouverte dans un autre onglet. La version actuelle du serveur ne supporte pas l'ouverture d'une conversation dans plusieurs onglets.",
    "Creating and joining a conversation with \"{userid}\"" : "Création et intégration d’une conversation avec « {userid} »",
    "Join a conversation or start a new one" : "Rejoignez une conversation ou lancez-en une nouvelle",
    "Error while joining the conversation" : "Erreur lors de l’intégration à la conversation",
    "Another user" : "Autre utilisateur",
    "Hey! Are you using the list style or message bubbles?" : "Hey ! Utilisez-vous le style \"liste\" ou \"bulles de message\" ?",
    ...
    "Audio" : "Audio",
    "Show all pinned messages" : "Montrer tous les messages épinglés",
    ...
    "The server was updated." : "Le serveur a été mis à jour.",
    ...
    "Error while changing the preserved status of the conversation" : "Erreur lors de la modification de l’état de conservation de la conversation",
    ...
    "Error renaming tag" : "Erreur en renommant l'étiquette",
    "Error deleting tag" : "Erreur à la suppression de l'étiquette",
    "Error reordering tags" : "Erreur en triant les étiquettes",
    ...
    "Federated server was updated." : "Le serveur fédéré a été mis à jour.",
    ...
    "Set time for later today" : "Sélectionner l'horaire pour plus tard aujourd'hui",
    "Tomorrow – {timeLocale}" : "Demain – {timeLocale}",
    "Set time for tomorrow" : "Sélectionner l'horaire pour demain",
    "This weekend – {timeLocale}" : "Ce week-end – {timeLocale}",
    "Set time for this weekend" : "Sélectionner l'horaire pour ce week-end",
    "Next week – {timeLocale}" : "La semaine prochaine – {timeLocale}",
    "Set time for next week" : "Sélectionner l'horaire pour la semaine prochaine",
    ...
    "__language_name__" : "__nom_de_la_langue__",
    ...
    "Select a microphone" : "Sélectionner un microphone",
    ...
    "Always shown if recording consent is required" : "Toujours visible si le consentement à l'enregistrement est requis",
