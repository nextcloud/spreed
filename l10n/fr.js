OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Laissez les conversations s'animer : mentionnez des utilisateurs, réagissez aux messages et plus encore\n\nVous pouvez mentionner tout le monde dans une conversation avec @all ou mentionnez un participant spécifique en tapant \"@\" et en choisissant son nom dans la liste.",
    ...
    "End-to-end encrypted calls" : "Appels encryptés de bout en bout",
    "Enable encryption" : "Activer le chiffrement",
    "End-to-end encrypted calls with a configured SIP bridge require a newer version of the High-performance backend and SIP bridge." : "Les appels encryptés de bout en bout avec une passerelle SIP nécessitent une nouvelle version du serveur haute-performance et de la passerelle SIP",
    "Mobile clients do not support end-to-end encrypted calls at the moment." : "Les clients mobiles ne supportent pas les appels encryptés de bout en bout pour le moment.",
    ...
    "Invite all users and emails" : "Inviter tous les utilisateurs et participants par email",
    ...
    "Generating summary of unread messages ..." : "Génération d'un résumé des messages non-lus...",
