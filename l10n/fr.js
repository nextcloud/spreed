OC.L10N.register(
    ...
    "- Introducing the Nextcloud Talk desktop client for Windows, macOS and Linux: %s" : "- Présente le client Nextcloud Talk pour Windows, macOS et Linux: %s",
    "- Summarize call recordings and unread messages in chats with the Nextcloud Assistant" : "- Résume les enregistrements d'appel et les messages non lus dans les discussion avec l'Assistant Nextcloud",
    ...
    "- Archive conversations to stay focused" : "- Archive les conversations pour rester concentré",
