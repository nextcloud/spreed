OC.L10N.register(
    ...
    "{user} sent a message in conversation {call}" : "{user} vam pošlje sporočilo v pogovor {call} ",
    ...
    "Navigating away from the page will leave the call in {conversation}" : "Odhod s strani pusti odprt klic {conversation}",
    ...
    "Scroll to bottom" : "Podrsaj do dna",
    ...
    "Remove team and members" : "Odstrani skupino in člane",
    ...
    "Search in {name}" : "Poišči v kategoriji {name}",
    "{actor} in {conversation}" : "{actor} v pogovoru {conversation}",
