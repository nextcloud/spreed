OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Los moderadores ahora pueden fijar mensajes para que se mantengan en la parte superior",
    "- Schedule a message to send it at a later time" : "- Programa un mensaje para enviarlo después",
    ...
    "{actor} pinned a message" : "{actor} ha fijado un mensaje",
    "You pinned a message" : "Has fijado un mensaje",
    "{actor} unpinned a message" : "{actor} ha desfijado un mensaje",
    "Message was automatically unpinned" : "El mensaje se ha desfijado automáticamente",
    "You unpinned a message" : "Has desfijado un mensaje",
    ...
    "Error: Running version: {version}; Server needs to be updated to be compatible with this version of Talk" : "Error: Versión en ejecución: {version}; El servidor necesita ser actualizado para ser compatible con esta versión de Talk",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push está instalado, esto mejora la puntualidad de las notificaciones de Talk.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} no está instalado. Esto puede llevar a retrasos en las notificaciones de Talk.",
    ...
    "Disable live translation" : "Desactivar traducción en vivo",
    ...
    "The meeting will start soon" : "La reunión empezará en breve",
    ...
    "_%n vote_::_%n votes_" : ["%n voto","%n votos","%n votos"],
    ...
    "{author} (pinned by you)" : "{author} (fijado por ti)",
    "Unpin" : "No fijar",
    ...
    "Create a new group conversation" : "ueva conversación en grupo",
    ...
    "{actor} removed {user0} and {user1}" : "{actor} eliminó a {user0} y a {user1}",
