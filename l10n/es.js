OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Deja que las conversaciones fluyan: menciona usuarios, reacciona a mensajes y más\n\nPuedes mencionar a todos los participantes con @all o a personas concretas escribiendo \"@\" y seleccionando su nombre de la lista.",
