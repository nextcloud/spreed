OC.L10N.register(
    ...
    "- Summarize call recordings and unread messages in chats with the Nextcloud Assistant" : "- Resuma grabaciones de llamadas y mensajes de chat no leídos con el Asistente Nextcloud",
    ...
    "It is highly recommended to configure a memory cache when running Nextcloud Talk with a High-performance backend." : "Es altamente recomendado que se configure un caché de memoria cuando se ejecuta Nextcloud Talk con un backend de alto rendimiento.",
    ...
    "Nextcloud Talk setup not complete" : "La configuración de Nextcloud Talk no está completa",
    ...
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk with a High-performance backend." : "Es altamente recomendable configurar una caché distribuida al utilizar Nextcloud Talk con un backend de alto rendimiento.",
    ...
    "Nextcloud Talk was updated, you cannot start or join a call." : "Se ha actualizado Nextcloud Talk, no puede iniciar o unirse a una llamada.",
    ...
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "- *Vista previa:* El chat via texto puede hacerse de manera federada con otros servidores Talk",
    ...
    "Commands are a new beta feature in Nextcloud Talk. They allow you to run scripts on your Nextcloud server. You can define them with our command line interface. An example of a calculator script can be found in our {linkstart}documentation{linkend}." : "Los comandos son una nueva característica en beta de Nextcloud Talk. Permiten ejecutar scripts en su servidor Nextcloud. Puede definirlos con nuestra interfaz de línea de comandos. Un ejemplo de un script de calculadora se puede encontrar en nuestra {linkstart}documentación{linkend}.",
    ...
    "Hosted high-performance backend" : "Backend de alto rendimiento gestionado",
    "SIP configuration is only possible with a high-performance backend." : "La configuración SIP solo es posible con un backend de alto rendimiento.",
    "Missing high-performance backend warning hidden" : "La advertencia acerca de la ausencia del backend de alto rendimiento ha sido ocultada",
    "An external signaling server should optionally be used for larger installations. Leave empty to use the internal signaling server." : "Un servidor de señalización externo debe usarse opcionalmente para instalaciones más grandes. Déjelo vacío para usar el servidor de señalización interno.",
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk together with a High Performance Back-end." : "Es altamente recomendable configurar un caché distribuido al utilizar Nextcloud Talk con un backend de alto rendimiento.",
    ...
    "Don't warn about connectivity issues in calls with more than 4 participants" : "No advertir acerca de problemas de conectividad en llamadas con más de 4 participantes",
    ...
    "Specify commands the users can use in chats" : "Especificar comandos que los usuarios pueden usar en los chats",
    ...
    "An external signaling server can optionally be used for larger installations. Leave empty to use the internal signaling server." : "Opcionalmente, se puede usar un servidor de señalización externo para instalaciones más grandes. Déjelo vacío para usar el servidor de señalización interno.",
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Deje que las conversaciones fluyan: mencione usuarios, reaccione a mensajes y más\n\nPuede mencionar a todos en la conversación %s o a participantes específicos escribiendo \"@\" y seleccionando su nombre de la lista."
},
