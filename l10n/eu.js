OC.L10N.register(
    ...
    "Message of a deleted user in {conversation}" : "Ezabatutako erabiltzaile baten mezua {conversation} atalean",
    ...
    "The recording for the call in {call} was uploaded to {file}." : "{call} deiaren grabazioa {file}-ra igo da.",
    ...
    "{guest} (guest) mentioned everyone in conversation {call}" : "{guest} (gonbidatuak) guztiak aipatu ditu {call} elkarrizketan",
    ...
    "Conversation not found" : "Ez da elkarrizketa aurkitu",
    ...
    "Hello, {displayName}" : "Kaixo, {displayName}",
    ...
    "Until {absoluteDate}" : "{absoluteDate}-ra",
    ...
    "_%n vote_::_%n votes_" : ["Boto %n","%n boto"],
    ...
    "Search in {name}" : "Bilatu {name}(e)n",
    "{actor} in {conversation}" : "{actor} erabiltzailea {conversation} elkarrizketan",
    "Until" : "Arte",
    ...
    "Cancel recording start" : "Utzi grabazioaren hasiera",
    ...
    "Local time: {time}" : "Ordu lokala: {time}",
    "Search" : "Bilatu",
    ...
    "The recording failed. Please contact your administrator." : "Grabazioak huts egin du. Jarri zure administratzailearekin harremanetan.",
