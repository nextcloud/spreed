OC.L10N.register(
    ...
    "Expire chat messages after a certain time. Note files shared into the chat will only be unshared from the conversation but are not deleted for the owner." : "Iraungi txat-mezuak denbora jakin baten ondoren. Kontuan izan: txatean partekatutako fitxategiak elkarrizketatik soilik partekatuko dira baina ez dira jabearentzat ezabatuko.",
    ...
    "Error when trying to set the messages expiration" : "Errore bat gertatu da mezuen iraungipena ezartzen saiatzean",
    ...
    "An error occurred while closing the poll" : "Errore bat gertatu da galdeketa ixtean",
