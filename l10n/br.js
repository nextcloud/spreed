OC.L10N.register(
    ...
    "{actor} removed {federated_user}" : "{actor} en deus lemet {federated_user}",
    "You removed {federated_user}" : "Lamet ho peus {federated_user}",
    "An administrator removed {federated_user}" : "Ur merour en deus lamet {federated_user}",
    "{actor} added {phone}" : "{actor} en deus ouzhpennet {phone}",
    "You added {phone}" : "Ouzhpennet ho peus {phone}",
    "An administrator added {phone}" : "Ur merour en deus uzhpennet {phone}",
    "{actor} removed {phone}" : "{actor} en deus lemet {phone}",
    "You removed {phone}" : "Lamet ho peus {phone}",
    "An administrator removed {phone}" : "Ur merour en deus lamet {phone}",
    ...
    "Dismiss notification" : "Disteurel ar gemennadenn",
    "Accept" : "Asantiñ",
    ...
    "{user} mentioned you in a private conversation" : "{user} en deus meneget ac'hanoc'h en un diviz prevez",
    ...
    "{email} is requesting the password to access {file}" : "{email} a goulenn ar ger-tremen evit tizout {file}",
    "{email} tried to request the password to access {file}" : "{email} en deus goulennet ar ger-tremen evit tizout {file}",
    "Someone is requesting the password to access {file}" : "Unan bennak a zo o gouelnn ar ger tremen evit tizout {file}",
    ...
    "Korea, Democratic People's Republic of" : "Korea, Republik Poblel ha Demokratel",
    "Korea, Republic of" : "Republik Korea",
    "Kuwait" : "Koweit",
    "Cayman Islands" : "Inizi Cayman",
    "Kazakhstan" : "Kazakstan",
    "Lao People's Democratic Republic" : "Lao, Republik Demokratel ar Bobl",
    "Lebanon" : "Liban",
    ...
    "Leave call" : "Kuitaat ar gemenadenn",
    "Navigating away from the page will leave the call in {conversation}" : "Kuitaat ar bajenn a laosko ar pelgomzadenn e {conversation}",
    ...
    "Default notification settings" : "Arventennoù kemenadennoù dre ziouer",
    ...
    "Full name of the user requesting the trial" : "Anv klok an implijer a c'houlenn an taol esae",
    "Language" : "Yezh",
    ...
    "Delete this server" : "Dilemel ar servijer-mañ",
    ...
    "{option1} and {option2}" : "{option1} ha {option2}",
    ...
    "Personal" : "Personel",
    "Leave conversation" : "Kuitaat ar gemenadenn",
    ...
    "Demote from moderator" : "Tennañ ar gwirioù kerreizhañ",
    ...
    "Participants" : "Tud",
    "Details" : "Munudoù",
    "Search in {name}" : "Klask e {name}",
    "{actor} in {conversation}" : "{actor} e {conversation}",
    ...
    "Do not disturb" : "Arabat direnkañ",
    "Away" : "Pell",
