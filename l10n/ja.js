OC.L10N.register(
    ...
    "- Moderators can now create breakout rooms (requires the external signaling server)" : "- モデレータはブレイクアウト ルーム(子会議室)を作成できるようになりました (外部シグナリング サーバーが必要です)",
    "- Calls can now be recorded (requires the external signaling server)" : "- 通話を録画できるようになりました (外部シグナリング サーバーが必要です)",
    ...
    "Missing high-performance backend warning hidden" : "隠された高性能バックエンドの警告が見つかりません",
    ...
    "Copy formatted message" : "フォーマットされたメッセージをコピーする",
