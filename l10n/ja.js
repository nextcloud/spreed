OC.L10N.register(
    ...
    "Enable blur background by default for all conversation" : "すべての会話でデフォルトで背景のぼかしを有効にする",
    ...
    "Browse …" : "参照...",
    "Appearance" : "表示",
    "Show conversations list in compact mode" : "会話リストをコンパクトモードで表示する",
    ...
    "Background blur for Nextcloud instance can be adjusted in the theming settings." : "Nextcloud インスタンスの背景のぼかしは、テーマ設定で調整できます。",
