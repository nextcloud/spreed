OC.L10N.register(
    ...
    "Enable blur background by default for all conversations" : "すべての会話で背景をぼかす機能をデフォルトで有効にする",
    "Do not show the device preview screen before joining a call" : "通話に参加する前にデバイスのプレビュー画面を表示しない",
    "Preview screen will still be shown if recording consent is required" : "録画の同意が必要な場合でも、プレビュー画面は表示されます",
