OC.L10N.register(
    ...
    "{user} invited you to a group conversation: {call}" : "{user}は、グループ会話{call}にあなたを招待しました。",
    "Answer call" : "応答",
    ...
    "Response to" : "への反応",
    "Enabled for" : "に対して有効",
    "Commands are a new beta feature in Nextcloud Talk. They allow you to run scripts on your Nextcloud server. You can define them with our command line interface. An example of a calculator script can be found in our <a {attributes}>documentation ↗</a>." : "コマンドはNextcloud Talkの新しいベータ機能です。スクリプトをNextcloudサーバー上で実行することができます。\nコマンドラインインターフェイスを使用して定義できます。\n計算スクリプトの例は、<a {attributes}>ドキュメント</a>に記載されています。",
