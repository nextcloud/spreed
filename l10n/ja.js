OC.L10N.register(
    ...
    "Schedule a meeting" : "会議をスケジュールする",
    "From" : "差出人",
    "To" : "宛先",
    "Calendar" : "カレンダー",
    "Attendees" : "参加者",
    ...
    "Check devices" : "デバイスを確認する",
    "Schedule meetings" : "会議をスケジュールする",
    "You don't have any upcoming meetings" : "今後の会議はありません",
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "カレンダーから会議をスケジュールします。ここに表示するには、Talkの会話を場所として設定する必要があります。",
