OC.L10N.register(
    ...
    "- Calls can now be recorded (requires the High-performance backend)" : "- Звонки теперь можно записывать (требуется Высокопроизводительный сервер)",
    ...
    "- Upcoming calls from linked calendar events and out-of-office replacements are now shown in conversations" : "- Предстоящие звонки из связанных с календарем событий и замены вне офиса теперь отображаются в обсуждениях",
    "- Calls can now be done in a federated way with other Talk servers (requires the High-performance backend)" : "- Звонки теперь можно совершать через федерации с другими Talk серверами (требуется Высокопроизводительный сервер)",
    ...
    "{actor} opened the conversation to registered users and users created with the Guests app" : "{actor} открыл обсуждение зарегистрированным пользователям и пользователям, созданным приложением Гости",
    "You opened the conversation to registered users and users created with the Guests app" : "Вы открыли обсуждение зарегистрированным пользователям и пользователям, созданным приложением Гости",
    "An administrator opened the conversation to registered users and users created with the Guests app" : "Администратор открыл обсуждение зарегистрированным пользователям и пользователям, созданным приложением Гости",
    ...
    "{actor} invited {federated_user}" : "{actor} пригласил(а) пользователя {federated_user}",
    "You invited {federated_user}" : "Вы пригласили пользователя {federated_user}",
    ...
    "An administrator invited {federated_user}" : "Администратор пригласил пользователя {federated_user} ",
    ...
    "Allow participants to mention @all" : "Разрешить участникам упоминать @all",
    "Mention permissions" : "Упоминание разрешений",
    "Only moderators are allowed to mention @all" : "Только модераторы могут упоминать @all",
    "All participants are allowed to mention @all" : "Все участники могут упоминать @all",
    "Participants are now allowed to mention @all." : "Теперь участники могут упоминать @all",
    "Mentioning @all has been limited to moderators." : " Упоминание @all было ограничено до модераторов",
    ...
    "Edit your last message" : "Редактировать ваше последнее сообщение",
    ...
    "This call has just ended" : "Этот звонок только что закончился",
    ...
    "{actor} removed you and {user0}" : "{actor} исключил вас и {user0}",
    ...
    "{actor} removed {user0} and {user1}" : "{actor} исключил {user0} и {user1}",
    ...
    "_{actor} promoted you, {user0} and %n more participant to moderators_::_{actor} promoted you, {user0} and %n more participants to moderators_" : ["{actor} назначил Вас, {user0} и ещё %n участника модераторами","{actor} назначил Вас, {user0} и ещё %n участников модераторами","{actor} назначил Вас, {user0} и ещё %n участников модераторами","{actor} назначил Вас, {user0} и ещё %n участников модераторами"],
    ...
    "_{actor} promoted {user0}, {user1} and %n more participant to moderators_::_{actor} promoted {user0}, {user1} and %n more participants to moderators_" : ["{actor} назначил {user0}, {user1} и ещё %n участника модераторами","{actor} назначил {user0}, {user1} и ещё %n участников модераторами","{actor} назначил {user0}, {user1} и ещё %n участников модераторами","{actor} назначил {user0}, {user1} и ещё %n участников модераторами"],
    ...
    "_{actor} demoted you, {user0} and %n more participant from moderators_::_{actor} demoted you, {user0} and %n more participants from moderators_" : ["{actor} исключил Вас, {user0} и ещё %n участника из модераторов","{actor} исключил Вас, {user0} и ещё %n участников из модераторов","{actor} исключил Вас, {user0} и ещё %n участников из модераторов","{actor} исключил Вас, {user0} и ещё %n участников из модераторов"],
    ...
    "_{actor} demoted {user0}, {user1} and %n more participant from moderators_::_{actor} demoted {user0}, {user1} and %n more participants from moderators_" : ["{actor} исключил {user0}, {user1} и ещё %n участника из модераторов","{actor} исключил {user0}, {user1} и ещё %n участников из модераторов","{actor} исключил {user0}, {user1} и ещё %n участников из модераторов","{actor} исключил {user0}, {user1} и ещё %n участников из модераторов"],
    ...
    "{actor} removed circle {circle}" : "{actor} исключил(а) круг {circle}",
    "You removed circle {circle}" : "Вы исключили круг {circle}",
    "An administrator removed circle {circle}" : "Администратор исключил круг {circle}",
    ...
    "Phone number could not be hanged up" : "Номер телефона не может быть повешен",
    "Phone number could not be putted on hold" : "Номер телефона не может быть поставлен на удержание",
