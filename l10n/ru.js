OC.L10N.register(
    ...
    "{actor} demoted {user} from owner" : "{actor} исключил(а) пользователя {user} из владельцев",
    "You demoted {user} from owner" : "Вы исключили {user} из владельцев",
    "{actor} demoted you from owner" : "{actor} исключил(а) Вас из владельцев",
    "An administrator demoted you from owner" : "Администратор исключил Вас из владельцев",
    "An administrator demoted {user} from owner" : "Администратор исключил {user} из владельцев",
    ...
    "Channel" : "Канал",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Обсуждение для трансляции на большую аудиторию, где только модераторы могуть оставлять сообщения, и звонки отключены.",
    "Classified conversation" : "Засекреченное обсуждение",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Защищенное обсуждение для конфиденциальных тем: публичный доступ, SIP вызовы и запись вызовов отключены.",
    ...
    "The last moderator of a conversation can not be demoted" : "Последний модератор в обсуждении не может быть исключен",
    ...
    "Promote to owner" : "Сделать владельцем",
