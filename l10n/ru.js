OC.L10N.register(
    ...
    "Conversation to inform a fixed audience, which can not be left." : "Обсуждение для информирования определенной аудитории, которое нельзя покинуть.",
    "Channel" : "Канал",
    ...
    "Webinar" : "Вебинар",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Ограниченное обсуждение с включенным лобби, идеально подходит для публичных вебинаров.",
    ...
    "Limit starting calls to certain groups" : "Ограничить возможность начинать вызов только определенным группам",
    ...
    "This will also terminate the ongoing call." : "Это также прервет текущий вызов.",
