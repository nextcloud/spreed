OC.L10N.register(
    ...
    "{user} mentioned you in conversation {call}" : "Пользователь {user} упомянул(а) Вас в групповой беседе «{call}»",
    ...
    "{actor} invited you to a private call" : "{actor} пригласил(а) Вас в закрытый вызов",
    "{actor} invited you to a group call" : "{actor} пригласил(а) Вас в групповой вызов",
    "{actor} invited you to the call {call}" : "{actor} пригласил(а) Вас в вызов {call}",
    ...
    "%s invited you to a private call" : "%s пригласил(а) Вас в закрытый вызов",
    "{user} invited you to a private call" : "{user} пригласил(а) Вас в закрытый вызов",
    "%s invited you to a group call: %s" : "%s пригласил(а) Вас в групповой вызов «%s»",
    "{user} invited you to a group call: {call}" : "{user} пригласил(а) Вас в групповой вызов «{call}»",
    "%s invited you to a group call" : "%s пригласил(а) Вас в групповой вызов",
    "{user} invited you to a group call" : "{user} пригласил(а) Вас в групповой вызов",
