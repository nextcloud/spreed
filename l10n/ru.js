OC.L10N.register(
    ...
    "## New in Talk %s" : "## Новое в приложении «Конференции» %s",
    ...
    "- You can now mention guests in the chat" : "- Возможность упоминать гостей в сообщениях",
    ...
    "- A preview of your audio and video is shown before joining a call" : "- Перед подключением к вызову отображается предварительный просмотр аудио- и видео c камеры",
    ...
    "- Classified conversations for better discussions around sensitive topics" : "- Засекреченные обсуждения для деликатных тем",
    "- Channels and announcements to broadcast information to a broader audience" : "- Каналы и оповещения для распространения информации среди широкой аудитории",
    "- Owners can preserve a conversation, preventing deletion and chat purging" : "- Владельцы могут защитить обсуждение, чтобы предотвратить удаление и очистку истории сообщений",
    ...
    "{actor} removed the description" : "{actor} удалил(а) описание",
    ...
    "{actor} limited the conversation to the current participants" : "{actor} ограничил(а) доступ к обсуждению только текущим участникам",
    "You limited the conversation to the current participants" : "Вы ограничили доступ к обсуждению только текущим участникам",
    "An administrator limited the conversation to the current participants" : "Администратор ограничил доступ к обсуждению только текущим участникам",
    ...
    "{actor} opened the conversation to registered users and users created with the Guests app" : "{actor} открыл(а) обсуждение для зарегистрированных пользователей и пользователей, созданных через приложение «Гости»",
    ...
    "{actor} promoted {user} to owner" : "{actor} назначил(а) пользователя {user} владельцем",
    "You promoted {user} to owner" : "Вы назначили {user} владельцем",
    "{actor} promoted you to owner" : "{actor} назначил(а) Вас владельцем",
    "An administrator promoted you to owner" : "Администратор назначил Вас владельцем",
    "An administrator promoted {user} to owner" : "Администратор назначил {user} владельцем",
    "{actor} demoted {user} from owner" : "{actor} понизил(а) пользователя {user} из владельцев",
    "You demoted {user} from owner" : "Вы понизили {user} из владельцев",
    "{actor} demoted you from owner" : "{actor} понизил(а) Вас из владельцев",
    "An administrator demoted you from owner" : "Администратор понизил Вас из владельцев",
    "An administrator demoted {user} from owner" : "Администратор понизил {user} из владельцев",
    ...
    "{actor} demoted {user} from moderator" : "{actor} понизил(а) пользователя {user} из модераторов",
    "You demoted {user} from moderator" : "Вы понизили {user} из модераторов",
    "{actor} demoted you from moderator" : "{actor} понизил(а) Вас из модераторов",
    "An administrator demoted you from moderator" : "Администратор понизил Вас из модераторов",
    "An administrator demoted {user} from moderator" : "Администратор понизил {user} из модераторов",
    ...
    "File shares are currently not supported in federated conversations" : "Обмен файлами в федеративных обсуждениях в настоящее время не поддерживается",
    ...
    "{actor} renamed thread {title}" : "{actor} переименовал(а) тему {title}",
    ...
    "{actor} disabled message expiration" : "{actor} отключил(а) срок жизни сообщений",
    ...
    "{actor} set the conversation picture" : "{actor} установил(а) изображение обсуждения",
    "You set the conversation picture" : "Вы установили изображение обсуждения",
    "{actor} removed the conversation picture" : "{actor} удалил(а) изображение обсуждения",
    ...
    "{actor} stopped the video recording" : "{actor} остановил(а) запись видео",
    ...
    "{actor} stopped the audio recording" : "{actor} остановил(а) запись аудио",
    ...
    "File is not inside the conversation draft folder for this room" : "Файл не находится в черновой папке для этого обсуждения",
    ...
    "You can also dial-in via phone with the following details" : "Вы можете присоединиться к вызову с телефона, используя приведённые ниже данные",
    ...
    "Call recording now available" : "Доступна запись вызова",
    ...
    "Failed to transcript call recording" : "Не удалось расшифровать запись вызова",
    ...
    "{user1} invited you to join {roomName} on {remoteServer}" : "{user1} пригласил(а) Вас присоединиться к обсуждению {roomName} на {remoteServer}",
    "Accept" : "Принять",
    "Decline" : "Отклонить",
    "{user1} invited you to a federated conversation" : "{user1} пригласил(а) Вас в федеративное обсуждение",
    ...
    "Hosted signaling server removed" : "Размещённый сигнальный сервер удалён",
    "The hosted signaling server was removed and will not be used anymore." : "Размещённый сигнальный сервер был удалён и больше не будет использоваться.",
    "Hosted signaling server changed" : "Размещённый сигнальный сервер изменён",
    ...
    "error" : "ошибка",
    "The certificate of {host} expires in {days} days" : "Сертификат {host} истечёт через {days} дней",
    ...
    "Call via Talk" : "Вызов через Talk",
    "Announcement" : "Оповещение",
    "Conversation to inform a fixed audience, which can not be left." : "Обсуждение для информирования определённой аудитории, которое нельзя покинуть.",
    "Channel" : "Канал",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Обсуждение для трансляции на большую аудиторию, где только модераторы могут оставлять сообщения, и звонки отключены.",
    "Classified conversation" : "Засекреченное обсуждение",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Защищенное обсуждение для конфиденциальных тем: публичный доступ, гости, SIP вызовы и запись вызовов отключены.",
    ...
    "Restricted conversation for internal presentations." : "Ограниченное обсуждение для внутренних презентаций.",
    ...
    "Webinar" : "Вебинар",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Ограниченное обсуждение с включённым лобби, идеально подходит для публичных вебинаров.",
    ...
    "Failed to fetch account information because the trial server behaved wrongly. Please check back later." : "Не удалось получить данные об учётной записи, так как сервис пробного периода вернул некорректные данные. Попытайтесь повторить запрос через некоторое время.",
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in the conversation by using %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Пусть обсуждения идут своим чередом: упоминайте пользователей, реагируйте на сообщения и многое другое\n\nВы можете упомянуть всех участников обсуждения при помощи «%s», или конкретных участников, набрав «@» и выбрав имя из списка.",
    ...
    "It is highly recommended to configure a memory cache when running Nextcloud Talk with a High-performance backend." : "Настойчиво рекомендуется настроить распределённый кэш для использования Nextcloud Talk совместно с Высокопроизводительным сервером.",
    ...
    "Limit starting calls to certain groups" : "Ограничить возможность начинать вызов только определённым группам",
    "Limit starting a call" : "Ограничить возможность начинать вызов",
    "Limit starting calls" : "Ограничить возможность начинать вызов",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Если выбрана хотя бы одна группа, только участники этих групп могут начать вызов. Это правило распространяется и на модераторов, тогда как гости и федеративные пользователи никогда не являются участниками таких групп. Если ни одна группа не выбрана, вызов может начать любой пользователь.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "Для федеративных обсуждений, вместо этого применяются настройки хост-сервера.",
    ...
    "Allow users to be invited to federated conversations" : "Разрешить пользователям быть приглашёнными в федеративные обсуждения",
    ...
    "_%n user_::_%n users_" : ["%n пользователь","%n пользователя","%n пользователей","%n пользователей"],
    ...
    "Error: Server seems to be a Signaling server" : "Ошибка: сервер является сигнальным сервером",
    ...
    "Recording backend settings saved" : "Настройки сервера записи вызовов сохранены",
    ...
    "Anonymous number should appear as \"unknown\" or \"withheld number\" to call recipient" : "Анонимный номер должен отображаться как \"Неизвестный\" или \"Номер скрыт\" для получателя вызова",
    ...
    "Enable SIP configuration" : "Включить конфигурацию SIP",
    "Only users of the following groups can enable SIP in conversations they moderate" : "Разрешить использование протокола SIP только пользователям указанных групп в модерируемых ими обсуждениях",
    ...
    "The High-performance backend is required for calls and conversations with multiple participants. Without the backend, all participants have to upload their own video individually for each other participant, which will most likely cause connectivity issues and a high load on participating devices." : "Высокопроизводительный сервер необходим для вызовов и обсуждений с несколькими участниками. Без сервера всем участникам придётся загружать свое видео отдельно для каждого собеседника, что, скорее всего, приведёт к проблемам со связью и высокой нагрузке на используемые устройства.",
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk with a High-performance backend." : "Настойчиво рекомендуется настроить распределённый кэш для использования Nextcloud Talk совместно с Высокопроизводительным сервером.",
    ...
    "Speaker view" : "Вид спикера",
    "Multi-speaker view" : "Вид нескольких спикеров",
    ...
    "Lobby is still active and you're not a moderator" : "Лобби ещё активно и Вы не являетесь модератором",
    ...
    "Collapse participant bar" : "Скрыть галерею участников",
    "Expand participant bar" : "Показать галерею участников",
    ...
    "You can invite others in the participant tab of the sidebar" : "Вы можете приглашать других участников на вкладке «Участники» боковой панели",
    ...
    "You have been muted by a moderator" : "Ваш микрофон был отключён модератором",
    ...
    "Enable video - Your connection will be briefly interrupted when enabling the video for the first time" : "Включить видео - Ваше соединение будет прервано, когда включаете видео в первый раз",
    ...
    "You" : "Вы",
    "You are sharing a screen" : "Вы делитесь экраном",
    "Sharing this window may cause a mirroring effect" : "Демонстрация этого окна может вызвать эффект зеркала",
    ...
    "No bots are installed on this server. Reach out to your administration to get bots installed on this server." : "Ни один бот не установлен на этом сервере. Свяжитесь с Вашей администрацией, чтобы установить ботов на этом сервере.",
    "Disable" : "Отключить",
    "Enable" : "Включить",
    ...
    "Choose conversation picture from files" : "Выбрать изображение обсуждения из Файлов",
    ...
    "Permanently delete this conversation." : "Безвозвратно удалить это обсуждение.",
    ...
    "Message expiration disabled" : "Срок жизни сообщений отключён",
    ...
    "Chat messages can be expired after a certain time. Note: Files shared in chat will not be deleted for the owner, but will no longer be shared in the conversation." : "Сообщения чата могут быть удалены по истечении определённого времени. Примечание: Файлы, переданные в чате, не будут удалены для владельца, но больше не будут доступны в обсуждении.",
    ...
    "This conversation is limited to the current participants" : "Обсуждение ограничено текущим участникам",
    ...
    "This will also terminate the ongoing call." : "Это также прервёт текущий вызов.",
    ...
    "You can bridge channels from various instant messaging systems with Matterbridge." : "Matterbridge позволяет настроить обмен сообщениями с различными службами моментальных сообщений.",
    "More info on Matterbridge" : "Дополнительные сведения о Matterbridge",
    "Messaging systems" : "Системы обмена сообщениями",
    "Enable bridge" : "Включить обмен сообщениями",
    ...
    "Mention permissions" : "Разрешения на упоминания",
    ...
    "Message preview will be disabled in conversation list and notifications" : "Предварительный просмотр сообщений будет отключён в списке обсуждений и уведомлениях",
    ...
    "Conversation token" : "Токен обсуждения",
    ...
    "Join conversations" : "Присоединиться к обсуждениям",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Здесь показаны события календаря со ссылкой на обсуждение в качестве места",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Содержимое в формате «comma-separated values» (CSV):<br/>- Строка заголовка обязательна и должна совпадать с {sample1} или только {sample2}<br/>- Одна запись на строку (например, {sample3})",
    ...
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Вы действительно хотите удалить \"{name}\"? Обсуждения с этим тегом будут перемещены в раздел «Другое».",
    ...
    "From {user} at {remoteServer}" : "От {user} на {remoteServer}",
    ...
    "Search in app" : "Искать в приложении",
    ...
    "You can only join a voice room via a call." : "Вы можете присоединиться к голосовой комнате только посредством вызова.",
    ...
    "Cancel quote" : "Отменить цитирование",
    "24 hours" : "24 часа",
    "7 days" : "7 дней",
    "30 days" : "30 дней",
    ...
    "Keep pinned for" : "Держать закреплённым:",
    ...
    "This translation is AI generated and may contain mistakes." : "Перевод сгенерирован при помощи ИИ и может быть неточным",
    "Copy translated text" : "Копировать переведённый текст",
    ...
    "Message could not be deleted because it is too old" : "Сообщение не удалось удалить, так как оно слишком старое",
    ...
    "Not enough free space to upload file" : "Недостаточно свободного места для загрузки файла",
    "You cannot send messages to this conversation at the moment" : "Вы не можете отправлять сообщения в это обсуждение сейчас",
    ...
    "All messages have expired or have been deleted." : "Срок жизни сообщений истёк или они были удалены.",
    ...
    "These settings can be changed once the conversation is created." : "Эти настройки можно изменить после создания обсуждения.",
    ...
    "Record voice message" : "Запись голосового сообщения",
    ...
    "Microphone either not available or disabled in settings" : "Микрофон недоступен или отключён",
    ...
    "Standard image quality" : "Стандартное качество изображений",
    "Original image quality" : "Оригинальное качество изображений",
    "View-only for others" : "Запретить изменения остальным",
    "Editable by others" : "Разрешить изменения остальным",
    ...
    "Post messages and reactions" : "Отправлять сообщения и реакции",
    ...
    "Settings" : "Настройки",
    "Show names on voted options" : "Показывать имена проголосовавших",
    ...
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n голос • Ваше имя будет показано напротив голоса","%n голоса • Ваше имя будет показано напротив голоса","%n голосов • Ваше имя будет показано напротив голоса","%n голосов • Ваше имя будет показано напротив голоса"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n голос • Ваше имя не будет показано напротив голоса","%n голоса • Ваше имя не будет показано напротив голоса","%n голосов • Ваше имя не будет показано напротив голоса","%n голосов • Ваше имя не будет показано напротив голоса"],
    "Your name will not be shown on voted options" : "Ваше имя не будет показано напротив голоса",
    ...
    "Message all rooms" : "Отправить сообщение всем комнатам",
    ...
    "Raised their hand" : "Рука поднята",
    "Joined with video" : "Передача видео включена",
    "Joined via phone" : "Телефонное соединение",
    "Joined with audio" : "Передача звука включена",
    "The text must be less than or equal to {maxLength} characters long. Your current text is {charactersCount} characters long." : "Описание должно быть не длиннее {maxLength} символов. Длина введённого текста: {charactersCount} символов.",
    ...
    "The last moderator of a conversation can not be demoted" : "Последнего модератора обсуждения нельзя понизить в должности",
    "Could not change the type of the participant" : "Не удалось изменить роль для участника",
    ...
    "Phone number could not be hung up" : "Не удалось завершить вызов",
    "Phone number could not be put on hold" : "Номер телефона не может быть поставлен на удержание",
    "Phone number could not be muted" : "Звук для номера телефона не может быть отключён",
    "Phone number could not be unmuted" : "Звук для номера телефона не может быть включён",
    ...
    "Hang up phone" : "Завершить вызов",
    "Move back to lobby" : "Переместить обратно в лобби",
    "Move to conversation" : "Переместить в обсуждение",
    "Dial-in PIN" : "PIN для звонка",
    "Promote to owner" : "Назначить владельцем",
    "Demote from moderator" : "Понизить из модераторов",
    "Promote to moderator" : "Сделать модератором",
    "Demote from owner to moderator" : "Понизить с владельца до модератора",
    "Demote from owner to participant" : "Понизить с владельца до участника",
    ...
    "Also ban from this conversation" : "Также заблокировать в этом обсуждении",
    "Internal note (reason to ban)" : "Внутренняя заметка (причина бана)",
    "Remove" : "Удалить",
    ...
    "Add users or groups" : "Добавлять пользователей или группы",
    ...
    "Pinned by a deleted user" : "Закреплено удалённым пользователем",
    ...
    "Error while setting default media state" : "Ошибка при сохранении состояния медиа по умолчанию",
    ...
    "Push to talk or push to mute" : "«Нажми и говори» / Нажми для отключения микрофона",
    ...
    "The server was updated, you cannot start or join a call." : "Сервер был обновлён, Вы не можете начать или присоединиться к вызову.",
    "This call has just ended" : "Этот вызов только что завершён",
    "You will be able to join the call only after a moderator starts it." : "Вы сможете присоединиться к вызову только после того, как его начнёт модератор.",
    ...
    "Your internet connection or computer are busy and other participants might be unable to understand and see you. To improve the situation try to disable the background blur or your video while doing a screenshare." : "Ваше интернет соединение или компьютер перегружены, и другие участники не могут понимать и видеть Вас. Чтобы исправить, попробуйте отключить размытие фона или видео во время трансляции экрана.",
    ...
    "Your internet connection or computer are busy and other participants might be unable to understand and see you. To improve the situation try to disable the background blur or your video." : "Ваше интернет соединение или компьютер перегружены, и другие участники не могут понимать и видеть Вас. Чтобы исправить, попробуйте отключить размытие фона или видео.",
    ...
    "Screen sharing is not supported by your browser." : "Ваш браузер не поддерживает трансляцию экрана.",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Обсуждение будет автоматически удалено для всех после %n минуты отсутствия активности.","Обсуждение будет автоматически удалено для всех после %n минут отсутствия активности.","Обсуждение будет автоматически удалено для всех после %n минут отсутствия активности.","Обсуждение будет автоматически удалено для всех после %n минут отсутствия активности."],
    ...
    "Tenant ID" : "Идентификатор арендатора (Tenant ID)",
    ...
    "Audio" : "Звук",
    "Show all pinned messages" : "Показать все закреплённые сообщения",
    ...
    "You demoted {user0} and {user1} from moderators" : "Вы понизили {user0} и {user1} из модераторов",
    "_You demoted {user0}, {user1} and %n more participant from moderators_::_You demoted {user0}, {user1} and %n more participants from moderators_" : ["Вы понизили {user0}, {user1} и ещё %n участника из модераторов","Вы понизили {user0}, {user1} и ещё %n участников из модераторов","Вы понизили {user0}, {user1} и ещё %n участников из модераторов","Вы понизили {user0}, {user1} и ещё %n участников из модераторов"],
    "An administrator demoted you and {user0} from moderators" : "Администратор понизил Вас и {user0} из модераторов",
    "{actor} demoted you and {user0} from moderators" : "{actor} понизил(а) Вас и {user0} из модераторов",
    "_An administrator demoted you, {user0} and %n more participant from moderators_::_An administrator demoted you, {user0} and %n more participants from moderators_" : ["Администратор понизил Вас, {user0} и ещё %n участника из модераторов","Администратор понизил Вас, {user0} и ещё %n участников из модераторов","Администратор понизил Вас, {user0} и ещё %n участников из модераторов","Администратор понизил Вас, {user0} и ещё %n участников из модераторов"],
    "_{actor} demoted you, {user0} and %n more participant from moderators_::_{actor} demoted you, {user0} and %n more participants from moderators_" : ["{actor} понизил(а) Вас, {user0} и ещё %n участника из модераторов","{actor} понизил(а) Вас, {user0} и ещё %n участников из модераторов","{actor} понизил(а) Вас, {user0} и ещё %n участников из модераторов","{actor} понизил(а) Вас, {user0} и ещё %n участников из модераторов"],
    "An administrator demoted {user0} and {user1} from moderators" : "Администратор понизил {user0} и {user1} из модераторов",
    "{actor} demoted {user0} and {user1} from moderators" : "{actor} понизил(а) {user0} и {user1} из модераторов",
    "_An administrator demoted {user0}, {user1} and %n more participant from moderators_::_An administrator demoted {user0}, {user1} and %n more participants from moderators_" : ["Администратор понизил {user0}, {user1} и ещё %n участника из модераторов","Администратор понизил {user0}, {user1} и ещё %n участников из модераторов","Администратор понизил {user0}, {user1} и ещё %n участников из модераторов","Администратор понизил {user0}, {user1} и ещё %n участников из модераторов"],
    "_{actor} demoted {user0}, {user1} and %n more participant from moderators_::_{actor} demoted {user0}, {user1} and %n more participants from moderators_" : ["{actor} понизил(а) {user0}, {user1} и ещё %n участника из модераторов","{actor} понизил(а) {user0}, {user1} и ещё %n участников из модераторов","{actor} понизил(а) {user0}, {user1} и ещё %n участников из модераторов","{actor} понизил(а) {user0}, {user1} и ещё %n участников из модераторов"],
    "You:" : "Вы:",
    "You: {lastMessage}" : "Вы: {lastMessage}",
    "{actor}:" : "{actor}:",
    "{relativeDate}, {absoluteDate}" : "{relativeDate}, {absoluteDate}",
    "The server was updated." : "Сервер был обновлён.",
    "(edited by you)" : "(изменено Вами)",
    "(edited by a deleted user)" : "(изменено удалённым пользователем)",
    ...
    "Federated server was updated." : "Федеративный сервер был обновлён.",
    "Error while uploading file \"{fileName}\"" : "Не удалось передать на сервер файл «{fileName}»",
    "Not enough free space to upload file \"{fileName}\"" : "Недостаточно свободного места для загрузки файла «{fileName}» ",
    ...
    "High-performance backend needs to be updated." : "Высокопроизводительный сервер требует обновления.",
    "The server is misconfigured. Please contact your administration." : "Сервер сконфигурирован неверно. Пожалуйста, обратитесь к администратору.",
    ...
    "Your default media state has been saved" : "Состояние медиа по умолчанию сохранено",
    ...
    "Nextcloud Talk was updated, you cannot start or join a call." : "Nextcloud Talk был обновлён, Вы не можете начать или присоединиться к вызову.",
    "Search …" : "Поиск …",
    ...
    "Nextcloud Talk was updated." : "Nextcloud Talk был обновлён.",
