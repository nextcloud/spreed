OC.L10N.register(
    ...
    "- You can now add custom user groups to conversations when the circles app is installed" : "- 現在，您可以在安裝社交圈子應用程式後將自訂用戶群組添加到對話中",
    ...
    "- Text chatting can now be done in a federated way with other Talk servers" : "- 文字聊天現在可以透過聯邦方式與其他 Talk 伺服器通訊",
    ...
    "- Calls can now be done in a federated way with other Talk servers (requires the High-performance backend)" : "- 通話現在可以透過聯邦方式與其他 Talk 伺服器通訊（需要高效能後端）",
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- 主持人現在可以將訊息釘選，讓它們固定顯示在最上方",
    "- Schedule a message to send it at a later time" : "- 安排訊息於稍後傳送",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- 對話標籤、分組及排序功能，方便整理對話清單",
    ...
    "{actor} preserved the conversation" : "{actor} 已保留此對話",
    "You preserved the conversation" : "你已保留此對話",
    "An administrator preserved the conversation" : "管理員已保留此對話",
    "{actor} stopped preserving the conversation" : "{actor} 已停止保留此對話",
    "You stopped preserving the conversation" : "你已停止保留此對話",
    "An administrator stopped preserving the conversation" : "管理員已停止保留此對話",
    ...
    "System added you" : "系統已加入你",
    "System added {user}" : "系統已加入 {user}",
    ...
    "{actor} promoted {user} to owner" : "{actor} 已將 {user} 提升為擁有者",
    "You promoted {user} to owner" : "你已將 {user} 提升為擁有者",
    "{actor} promoted you to owner" : "{actor} 已將你提升為擁有者",
    "An administrator promoted you to owner" : "管理員已將你提升為擁有者",
    "An administrator promoted {user} to owner" : "管理員已將 {user} 提升為擁有者",
    "{actor} demoted {user} from owner" : "{actor} 已將 {user} 從擁有者降級",
    "You demoted {user} from owner" : "你已將 {user} 從擁有者降級",
    "{actor} demoted you from owner" : "{actor} 已將你從擁有者降級",
    "An administrator demoted you from owner" : "管理員已將你從擁有者降級",
    "An administrator demoted {user} from owner" : "管理員已將 {user} 從擁有者降級",
    ...
    "File shares are currently not supported in federated conversations" : "在聯邦對話中目前不支援檔案共享",
    ...
    "{actor} pinned a message" : "{actor} 釘選了訊息",
    "You pinned a message" : "您釘選了訊息",
    "{actor} unpinned a message" : "{actor} 取消釘選了訊息",
    "Message was automatically unpinned" : "訊息已自動取消釘選",
    "You unpinned a message" : "您取消釘選了訊息",
    ...
    "App disabled" : "已停用應用程式",
    "Conversation subfolders are disabled" : "已停用對話子資料夾",
    "Storage quota exceeded" : "超過儲存空間配額",
    "Could not prepare conversation folder" : "無法準備對話資料夾",
    "File not found" : "找不到檔案",
    "Path must point to a file" : "路徑必須指向檔案",
    "File is not inside the conversation draft folder for this room" : "檔案不在此聊天室的草稿資料夾中",
    ...
    "Missing %s field in header line" : "標題列缺少 %s 欄位",
    ...
    "Accept" : "接受",
    "Decline" : "婉拒",
    "{user1} invited you to a federated conversation" : "{user1} 邀請您加入聯邦對話",
    ...
    "Deleted user in {call}" : "{call} 中的已刪除用戶",
    ...
    "A deleted user reacted with {reaction} to your message in conversation {call}" : "已刪除用戶在對話 {call} 中對你的訊息加了 {reaction}",
    "{guest} (guest) reacted with {reaction} to your message in conversation {call}" : "來賓 {guest} 在對話 {call} 中對您的訊息做出了 {reaction} 反應",
    "A guest reacted with {reaction} to your message in conversation {call}" : "訪客在對話 {call} 中對你的訊息加了 {reaction}",
    ...
    "Channel" : "頻道",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "面向廣大受眾的廣播式對話，僅限主持人發文，且無法進行語音通話。",
    "Classified conversation" : "機密對話",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "針對機密話題設定為「鎖定」對話，同時停用公開存取、訪客、SIP 及錄音功能。",
    "Default" : "默認",
    "Send messages, create threads, and start voice and video calls." : "傳送訊息、建立討論串、開始音訊與視訊通話。",
    "Presentation" : "簡報",
    "Restricted conversation for internal presentations." : "此為內部簡報的受限對話。",
    "Voice room" : "語音聊天室",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "直接加入通話，非常適合閒聊或臨時開會。",
    "Webinar" : "網絡研討會",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "啟用大廳功能的受限對話，非常適合公開網路研討會。",
    "Conversations" : "對話",
    ...
    "Federation" : "聯邦",
    "It is highly recommended to configure \"memcache.locking\" when Talk Federation is enabled." : "強烈建議在啟用聯邦 Talk 時設定「memcache.locking」。",
    ...
    "Open in full application" : "在完整應用程式中開啟",
    ...
    "Limit starting calls to certain groups" : "僅允許特定群組發起通話",
    "Limit starting a call" : "限制撥打通話",
    "Limit starting calls" : "限制撥打通話",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "當至少選擇一個群組時，只有這些群組的成員才可發起通話。此限制亦適用於主持人，而訪客及聯邦用戶永遠不會屬於這些群組。若未選擇任何群組，則所有人仍可發起通話。",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "對於託管於聯邦伺服器上的對話，將改為套用主機伺服器的配置。",
    ...
    "Trusted servers can be configured at {linkstart}Sharing settings page{linkend}." : "可以在{linkstart}分享設定頁面{linkend}設定信任伺服器。",
    "Beta" : "Beta 測試版",
    "Federated chats and calls work already. Attachment handling is coming in a future version." : "聯邦聊天與通話已經可以運作。附件處理將在未來的版本中推出。",
    "Enable Federation in Talk app" : "啟用 Talk 應用程式中的聯邦功能",
    "Permissions" : "權限",
    "Allow users to be invited to federated conversations" : "允許邀請用戶加入聯邦對話",
    "Allow users to invite federated users into conversation" : "允許用戶邀請聯邦用戶加入對話",
    "Only allow to federate with trusted servers" : "僅允許與信任的伺服器聯邦",
    "When at least one group is selected, only people of the listed groups can invite federated users to conversations." : "選擇一或多個群組後，只有所選群組中的人才能邀請聯邦用戶到對話中。",
    "Groups allowed to invite federated users" : "允許邀請聯邦用戶的群組",
    "Select groups …" : "選取群組 …",
    "All messages" : "全部消息",
    ...
    "Enable live transcription (generated by AI)" : "啟用即時轉錄（由人工智能產生）",
    "Enable live transcription (Live transcriptions app is not installed)" : "啟用即時轉錄（未安裝即時轉錄應用程式）",
    "Disable live translation" : "停用即時翻譯",
    "Enable live translation (generated by AI)" : "啟用即時翻譯（由人工智能產生）",
    "Original language" : "原先的語言",
    "Live translations app is not installed" : "未安裝即時翻譯應用程式",
    "Original language: {languageName}" : "原文語言：{languageName}",
    "Translated language" : "翻譯語言",
    "Translated language: {languageName}" : "翻譯語言：{languageName}",
    "Exit full screen (F)" : "離開全螢幕（F）",
    "Full screen (F)" : "全螢幕（F）",
    "Grid view" : "網格檢視",
    "Speaker view" : "演講者視圖",
    "Multi-speaker view" : "多講者檢視",
    ...
    "Failed to enable live translations" : "無法啟用即時翻譯",
    "Failed to disable live translations" : "無法停用即時翻譯",
    "End call" : "結束通話",
    "More actions" : "更多操作",
    ...
    "Disable" : "停用",
    "Enable" : "啟用",
    "The bot is not available anymore" : "該機器人已不再提供服務",
    ...
    "Participants can use all available features." : "參與者可以使用所有可用的功能。",
    "Restricted" : "受限",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "參與者在管理員手動授予額外權限前，只能使用受限的功能。",
    ...
    "Live transcriptions app is not installed" : "未安裝即時轉錄應用程式",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "此對話已被保留，無法刪除，亦無法清除聊天訊息。",
    ...
    "This setting can not be changed while the conversation is preserved." : "保留對話期間無法變更此設定。",
    ...
    "The entered token does not match the conversation token" : "輸入的權杖與對話權杖不符",
    "Preserve conversation" : "保留對話",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "保留期間，此對話無法刪除、聊天記錄無法清除，且訪客及可加入設定亦無法變更。",
    "Only the owner can change whether this conversation is preserved." : "只有擁有者可以變更是否保留此對話。",
    ...
    "Stop preserving conversation" : "停止保留對話",
    "Conversation token" : "對話權杖",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "若你停止保留此對話，它便可以被刪除、聊天記錄可以被清除，而訪客及可加入設定亦可再次變更。",
    "Conversation" : "對話",
    "To confirm, type the conversation token into the field below:" : "如要確認，請在下方欄位輸入對話權杖：",
    "Ongoing" : "持續進行",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "內容格式為逗號分隔值（CSV）：<br/>- 必須包含標題列，且須符合 {sample1} 或僅符合 {sample2}<br/>- 每行一個項目（例如 {sample3}）",
    ...
    "Remove all tags" : "移除所有標籤",
    "Rename tag" : "重新命名標籤",
    "Delete tag" : "刪除標籤",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "您真的想要刪除「{name}」嗎？有此標籤的對話將會移動到「其他」。",
    "Move up" : "上移",
    "Move down" : "下移",
    "Pending invitations" : "擱置中的邀請",
    "Join conversations from other servers" : "加入其他伺服器的對話",
    ...
    "By recent activity" : "按最近活動排序",
    "Alphabetically" : "按字母順序",
    "Do not group by type" : "請勿按類型分組",
    "Show private ones first" : "先顯示私人訊息",
    "Show group ones first" : "先顯示群組訊息",
    ...
    "SIP backend is not installed" : "未安裝 SIP 後端",
    ...
    "Enable noise suppression" : "啟用降噪",
    "Reduce background noises for better voice quality" : "減少背景噪音，以提升語音品質",
    "Basic" : "基本",
    "Advanced" : "進階",
    "Enable echo cancellation" : "啟用回音消除",
    "Minimize echo effect from own surrounding" : "降低周圍環境造成的回音效果",
    "Enable auto gain control" : "啟用自動增益控制",
    ...
    "You can only join a voice room via a call." : "你只能透過通話加入語音房間。",
    ...
    "Recording backend is not installed" : "未安裝錄製後端",
    ...
    "Keep pinned for" : "置頂保留期限",
    "Set custom period" : "設定自訂期限",
    ...
    "Translate to" : "翻譯至",
    "Translating" : "正在翻譯",
    "This translation is AI generated and may contain mistakes." : "此翻譯為人工智能產生，可能會出錯。",
    ...
    "Message deleted successfully" : "成功刪除了消息",
    ...
    "Reply to thread \"{threadTitle}\"" : "回覆討論串「{threadTitle}」",
    "_You voted • %n vote_::_You voted • %n votes_" : ["您已投票 • %n 票"],
    "You voted" : "您已投票",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["點選以投票 • %n 票"],
    "Click to vote" : "點選以投票",
    ...
    "Generate summary with AI" : "使用人工人工智能產生摘要",
    "{author} (pinned by you)" : "{author}（由你置頂）",
    "{author} (pinned by {actor})" : "{author}（由 {actor} 置頂）",
    "Unpin" : "取消固定",
    "Cancel search" : "取消搜尋",
    ...
    "Create a new group conversation" : "建立新的群組對話",
    "Add participants" : "添加參與者",
    "Maximum length exceeded ({maxlength} characters)" : "超出最大長度（{maxlength} 個字元）",
    "Conversation type" : "對話類型",
    "Default parameters are:" : "默認參數為：",
    "These settings can be changed once the conversation is created." : "建立對話後，即可變更這些設定。",
    ...
    "Voice message {time} ({conversation})" : "從 {time} 開始的語音訊息（{conversation}）",
    ...
    "Standard image quality" : "標準影像畫質",
    "Original image quality" : "原始影像畫質",
    "View-only for others" : "其他人僅可檢視",
    "Editable by others" : "其他人可編輯",
    ...
    "Post messages" : "發佈訊息",
    "Post messages and reactions" : "發佈訊息及反應",
    "Add reactions" : "添加反應",
    ...
    "Add answer" : "添加答案",
    "Settings" : "設定",
    "Show names on voted options" : "在已投票的選項上顯示姓名",
    "Multiple answers" : "多個答案",
    "Save as draft" : "保存為草稿",
    "Export draft to file" : "將草稿匯出至檔案",
    "_Final results • %n vote_::_Final results • %n votes_" : ["最終結果 • %n 票"],
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n 票 • 你的姓名會顯示在已投票的選項上"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n 票 • 你的姓名不會顯示在已投票的選項上"],
    "Your name will not be shown on voted options" : "你的姓名不會顯示在已投票的選項上",
    "You voted for this option" : "您投了此選項一票",
    "End poll" : "結束民意調查",
    "Change your vote" : "更改您的投票",
    "Withdraw vote" : "撤回投票",
    "Results" : "結果",
    "Download as spreadsheet" : "下載為試算表",
    ...
    "Remove group and members" : "移除群組及成員",
    ...
    "The last moderator of a conversation can not be demoted" : "無法將對話中的最後一名主持人降級",
    "Could not change the type of the participant" : "無法更改參與者類型",
    ...
    "Dial-in PIN" : "撥入 PIN",
    "Promote to owner" : "提升為擁有者",
    "Demote from moderator" : "從主持人降級",
    "Promote to moderator" : "晉升為主持人",
    "Demote from owner to moderator" : "從擁有者降級為主持人",
    "Demote from owner to participant" : "從擁有者降級為參與者",
    ...
    "You can search or add participants via name, email, or Federated Cloud ID" : "您可以透過名稱、電郵地址或雲端聯邦 ID 搜尋或新增參與者",
    ...
    "Participants" : "參與者",
    "Pinned by a deleted user" : "由已刪除的用戶置頂",
    ...
    "Save name" : "保存名字",
    "I picked message bubbles" : "已選擇訊息氣泡",
    "I picked the list style" : "我挑選了清單樣式",
    "Error while setting personal setting" : "設置您的個人設置時發生錯誤",
    "Error while saving sounds setting" : "儲存聲音設置時發生錯誤",
    "Compact conversations list" : "簡潔對話清單",
    "Chat appearance" : "聊天外觀",
    "Messages list" : "訊息清單",
    "Message bubbles" : "訊息氣泡",
    "Play sounds when participants join or leave a call" : "參與者加入或離開通話時播放聲音",
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "由於製造商的技術限制，目前在 iPhone 與 iPad 上無法使用",
    "Notification settings" : "通告設定",
    "Sounds for chat and call notifications" : "聊天與通話通知的音效",
    "Invalid language ({languageId})" : "無效的語言（{languageId}）",
    "Default language" : "預設語言",
    "Default language ({languageName})" : "預設語言（{languageName}）",
    "Error when trying to load the available live translation languages" : "載入可用的即時翻譯語言時發生錯誤",
    "Error when trying to set live translation language" : "設定即時翻譯語言時發生錯誤",
    "Set language used to show the transcriptions" : "設定顯示轉錄內容所使用的語言",
    ...
    "Turn camera and microphone off by default" : "預設關閉相機與麥克風",
    "Blur camera background by default" : "預設模糊相機背景",
    "Skip device preview before joining a call" : "略過加入通話前的裝置預覽",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "加入時將關閉相機。如需錄影同意，則會一直顯示。",
    "Appearance & Sounds" : "外觀與音效",
    "Privacy" : "私隱",
    "Send read receipts" : "傳送讀取回條",
    "When off, all read statuses will be hidden" : "關閉時，所有讀取狀態都會被隱藏",
    "Share typing status" : "分享輸入狀態",
    "When off, all typing indicators will be hidden" : "關閉時，所有輸入指示器都會被隱藏",
    "Attachments folder" : "附件資料夾",
    "Toggle full screen" : "切換全螢幕",
    "Return to Home screen" : "回到主畫面",
    "Shortcuts while in a chat" : "聊天中的捷徑",
    ...
    "Start call" : "開始通話",
    "The server was updated, you cannot start or join a call." : "伺服器已更新，您無法開始或加入通話。",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["此對話在閒置 %n 分鐘後將會自動為所有人刪除"],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["此對話在閒置 %n 天後將會自動為所有人刪除"],
    ...
    "Scheduled {datetime}" : "預定於 {datetime}",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "此對話已在另一個分頁開啟。目前的伺服器版本不支援同一個對話同時在多個分頁開啟。",
    "Creating and joining a conversation with \"{userid}\"" : "使用「{userid}」建立並加入對話",
    "Join a conversation or start a new one" : "加入或者開一個新的對話",
    "Error while joining the conversation" : "加入對話時發生錯誤",
    "Another user" : "另一個用戶",
    "Hey! Are you using the list style or message bubbles?" : "嘿！你用的是清單樣式還是訊息泡泡樣式呢？",
    ...
    "Audio" : "音頻",
    "Show all pinned messages" : "顯示所有置頂訊息",
    ...
    "{actor} promoted you and {user0} to moderators" : "{actor} 將您與 {user0} 升級為主持人",
    ...
    "{actor} demoted you and {user0} from moderators" : "{actor} 將您與 {user0} 由主持人降級",
    ...
    "Error while changing the preserved status of the conversation" : "變更對話保留狀態時發生錯誤",
    ...
    "Error renaming tag" : "重新命名標籤時發生錯誤",
    "Error deleting tag" : "刪除標籤時發生錯誤",
    "Error reordering tags" : "重新排序標籤時發生錯誤",
    ...
    "The server is in maintenance mode." : "伺服器正處於維護模式。",
    "Federated server was updated." : "聯邦伺服器已更新。",
    ...
    "Connecting is taking longer than expected …" : "連線時間比預期長⋯⋯",
    "Failed to connect. Retrying …" : "連線失敗，正在重試⋯⋯",
    "Failed to connect. The signaling server may be set up incorrectly" : "連線失敗，訊號伺服器可能設定不正確",
    "High-performance backend needs to be updated." : "需要更新高效能後端。",
    "The server is misconfigured. Please contact your administration." : "伺服器設定錯誤。請聯絡您的管理員。",
    ...
    "Always shown if recording consent is required" : "若需取得錄影同意，此提示將一律顯示",
    ...
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["開放投票 • %n 票 • 你的姓名會顯示在已投票的選項上"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["開放投票 • %n 票 • 你的姓名不會顯示在已投票的選項上"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "投票進行中 • 你已投票 • 你的姓名不會顯示在已投票的選項上",
    "Open poll • Your name will not be shown on voted options" : "投票進行中 • 你的姓名不會顯示在已投票的選項上",
