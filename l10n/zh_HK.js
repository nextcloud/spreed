OC.L10N.register(
    ...
    "Recording for the call in {call} was uploaded to {file}." : "{call} 中的通話錄音已上傳到 {file}。",
    ...
    "Favorite" : "我的最愛",
    "Setup breakout rooms for this conversation" : "在此對話中設置分組討論室",
