OC.L10N.register(
    ...
    "Expire chat messages after a certain time. Note files shared into the chat will only be unshared from the conversation but are not deleted for the owner." : "在一定時間後將聊天消息設置為“過期”。 請注意，聊天中共享的文件只會從對話中取消共享，但不會為所有者刪除。",
    "Custom expiration time" : "自訂定到期日",
    "Message expiration disabled" : "訊息過期功能已禁用",
    "Message expiration set: {duration}" : "訊息過期設置：{duration}",
    "Error when trying to set the messages expiration" : "嘗試設置訊息過期時出錯",
    ...
    "An error occurred while closing the poll" : "關閉投票時出錯",
