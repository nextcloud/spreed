OC.L10N.register(
    ...
    "Now" : "現在",
    "Error: Invalid calendar selected" : "錯誤：所選的日曆無效",
    "Error: Invalid start time selected" : "錯誤：所選的開始時間無效",
    "Error: Invalid end time selected" : "錯誤：所選的結束時間無效",
    ...
    "To" : "至",
    "Calendar" : "日曆",
    "Invite all users and email guests" : "邀請所有用戶及電郵訪客",
    "Select attendees" : "選擇與會者",
    "Save" : "儲存",
    "Search participants" : "搜尋參與者",
    "No results" : "沒有符合搜尋的項目",
    "_Sending %n invitation_::_Sending %n invitations_" : ["正在發送 %n 個邀請"],
