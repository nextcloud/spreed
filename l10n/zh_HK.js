OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "💭 讓對話流暢進行：提及用戶、對消息進行反應等\n\n您可以在對話 %s 中提及所有人或通過輸入 \"@\" 並從清單中選擇特定參與者的名字來提及特定用戶。",
