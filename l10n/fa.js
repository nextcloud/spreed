OC.L10N.register(
    ...
    "- Use threads to keep your chat and discussions organized" : "- Use threads to keep your chat and discussions organized",
    "- Live transcriptions now available during the call (requires the live-transcription ExApp and the High-performance backend)" : "- Live transcriptions now available during the call (requires the live-transcription ExApp and the High-performance backend)",
    "- Moderators can now pin messages so they are kept at the top" : "- Moderators can now pin messages so they are kept at the top",
    "- Schedule a message to send it at a later time" : "- Schedule a message to send it at a later time",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Conversation tags, grouping and sorting to organize the conversation list",
    ...
    "{actor} created thread {title}" : "{actor} created thread {title}",
    "You created thread {title}" : "You created thread {title}",
    "{actor} renamed thread {title}" : "{actor} renamed thread {title}",
    "You renamed thread {title}" : "You renamed thread {title}",
    ...
    "{actor} pinned a message" : "{actor} pinned a message",
    "You pinned a message" : "You pinned a message",
    "{actor} unpinned a message" : "{actor} unpinned a message",
    "Message was automatically unpinned" : "Message was automatically unpinned",
    "You unpinned a message" : "You unpinned a message",
    ...
    "Conversation subfolders are disabled" : "Conversation subfolders are disabled",
    "Storage quota exceeded" : "از سهمیه فضای ذخیره سازی فراتر رفت",
    "Could not prepare conversation folder" : "Could not prepare conversation folder",
    "File not found" : "فایل یافت نشد",
    "Path must point to a file" : "Path must point to a file",
    "File is not inside the conversation draft folder for this room" : "File is not inside the conversation draft folder for this room",
    ...
    "Missing %s field in header line" : "Missing %s field in header line",
    ...
    "Open Talk" : "Open Talk",
    "Call via Talk" : "Call via Talk",
    "Default" : "پیش‌گزیده",
    "Send messages, create threads, and start voice and video calls." : "Send messages, create threads, and start voice and video calls.",
    "Presentation" : "ارائه",
    "Restricted conversation for internal presentations." : "Restricted conversation for internal presentations.",
    "Voice room" : "Voice room",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Directly join the call, ideal for catch-ups or spontaneous meetings.",
    "Webinar" : "Webinar",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Restricted conversation with lobby enabled, ideal for public webinars.",
    "Conversations" : "گفتگو",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push is installed, this improves the punctuality of Talk notifications.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} is not installed. This may lead to delayed Talk notifications.",
    ...
    "Error occurred when getting the conversation information" : "Error occurred when getting the conversation information",
    ...
    "Open in full application" : "Open in full application",
    ...
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly.",
    ...
    "Limits" : "Limits",
    "STUN included" : "STUN included",
    "Yes" : "بله",
    "No" : "خیر",
    "TURN included" : "TURN included",
    ...
    "Done" : "Done",
    "Disable live transcription" : "Disable live transcription",
    "Enable live transcription (generated by AI)" : "Enable live transcription (generated by AI)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Enable live transcription (Live transcriptions app is not installed)",
    "Disable live translation" : "Disable live translation",
    "Enable live translation (generated by AI)" : "Enable live translation (generated by AI)",
    "Original language" : "Original language",
    "Live translations app is not installed" : "Live translations app is not installed",
    "Original language: {languageName}" : "Original language: {languageName}",
    "Translated language" : "Translated language",
    "Translated language: {languageName}" : "Translated language: {languageName}",
    "Exit full screen (F)" : "Exit full screen (F)",
    "Full screen (F)" : "Full screen (F)",
    "Speaker view" : "Speaker view",
    "Grid view" : "نمایش گرید",
    "Error when trying to load the available live transcription languages" : "Error when trying to load the available live transcription languages",
    "Failed to enable live transcription" : "Failed to enable live transcription",
    "Failed to enable live translations" : "Failed to enable live translations",
    "Failed to disable live translations" : "Failed to disable live translations",
    ...
    "Enable video. Your connection will be briefly interrupted when enabling the video for the first time" : "Enable video. Your connection will be briefly interrupted when enabling the video for the first time",
    "Select a video device" : "Select a video device",
    ...
    "Enable" : "فعالسازی",
    "The bot is not available anymore" : "The bot is not available anymore",
    ...
    "Participants can use all available features." : "Participants can use all available features.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Participants get a reduced feature set until a moderator manually grants additional permissions.",
    ...
    "Live transcriptions app is not installed" : "Live transcriptions app is not installed",
    "Enable live transcription" : "Enable live transcription",
    "Breakout Rooms" : "Breakout Rooms",
    ...
    "Set language spoken in calls" : "Set language spoken in calls",
    "Languages could not be loaded" : "Languages could not be loaded",
    "Loading languages …" : "Loading languages …",
    "Invalid language" : "Invalid language",
    "Default language (English)" : "Default language (English)",
    "Default live transcription language set" : "Default live transcription language set",
    "Live transcription language set: {languageName}" : "Live transcription language set: {languageName}",
    "Error when trying to set live transcription language" : "Error when trying to set live transcription language",
    ...
    "You don't have any upcoming meetings" : "You don't have any upcoming meetings",
    "Calendar events with a conversation link as the location are shown here" : "Calendar events with a conversation link as the location are shown here",
    "Open calendar" : "Open calendar",
    "Unread mentions" : "اشاره‌های خوانده‌نشده",
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name",
    "Upcoming reminders" : "Upcoming reminders",
    "Message reminders" : "Message reminders",
    "Set a reminder on a message to be notified" : "Set a reminder on a message to be notified",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})",
    ...
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\".",
    "Move up" : "حرکت به بالا",
    "Move down" : "حرکت به پایین",
    "Pending invitations" : "Pending invitations",
    "Join conversations from other servers" : "Join conversations from other servers",
    ...
    "By recent activity" : "By recent activity",
    "Alphabetically" : "الفبایی",
    "Do not group by type" : "Do not group by type",
    "Show private ones first" : "Show private ones first",
    "Show group ones first" : "Show group ones first",
    "No followed threads" : "No followed threads",
    ...
    "Subscribe to an existing thread or start your own." : "Subscribe to an existing thread or start your own.",
    ...
    "SIP backend is not installed" : "SIP backend is not installed",
    ...
    "Enable auto gain control" : "Enable auto gain control",
    "Dynamically adjust microphone volume for consistent level" : "Dynamically adjust microphone volume for consistent level",
    ...
    "You can only join a voice room via a call." : "You can only join a voice room via a call.",
    ...
    "Recording backend is not installed" : "Recording backend is not installed",
    "Notify all participants about this call" : "Notify all participants about this call",
    ...
    "Edit thread details" : "Edit thread details",
    "Forward message" : "Forward message",
    "Translate" : "ترجمه",
    "Set custom reminder" : "Set custom reminder",
    "Keep pinned for" : "Keep pinned for",
    "Set custom period" : "Set custom period",
    ...
    "This translation is AI generated and may contain mistakes." : "This translation is AI generated and may contain mistakes.",
    ...
    "Reply to thread \"{threadTitle}\"" : "Reply to thread \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["You voted • %n vote","You voted • %n votes"],
    "You voted" : "You voted",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Click to vote • %n vote","Click to vote • %n votes"],
    ...
    "Generate summary with AI" : "Generate summary with AI",
    "{author} (pinned by you)" : "{author} (pinned by you)",
    "{author} (pinned by {actor})" : "{author} (pinned by {actor})",
    ...
    "These settings can be changed once the conversation is created." : "These settings can be changed once the conversation is created.",
    ...
    "Voice message {time} ({conversation})" : "Voice message {time} ({conversation})",
    ...
    "Can add reactions" : "Can add reactions",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Final results • %n vote","Final results • %n votes"],
    "_%n vote • Your vote is anonymous_::_%n votes • Your vote is anonymous_" : ["%n vote • Your vote is anonymous","%n votes • Your vote is anonymous"],
    "Your vote is anonymous" : "Your vote is anonymous",
    "You voted for this option" : "You voted for this option",
    "End poll" : "End poll",
    "Change your vote" : "Change your vote",
    "Withdraw vote" : "Withdraw vote",
    "Results" : "نتایج.",
    "Download as spreadsheet" : "Download as spreadsheet",
    ...
    "Pinned by a deleted user" : "Pinned by a deleted user",
    ...
    "Save name" : "Save name",
    "I picked message bubbles" : "I picked message bubbles",
    "I picked the list style" : "I picked the list style",
    ...
    "Sounds for chat and call notifications" : "Sounds for chat and call notifications",
    "Invalid language ({languageId})" : "Invalid language ({languageId})",
    "Default language" : "زبان پیش فرض",
    "Default language ({languageName})" : "Default language ({languageName})",
    "Error when trying to load the available live translation languages" : "Error when trying to load the available live translation languages",
    "Error when trying to set live translation language" : "Error when trying to set live translation language",
    "Set language used to show the transcriptions" : "Set language used to show the transcriptions",
    ...
    "Turn camera and microphone off by default" : "Turn camera and microphone off by default",
    "Blur camera background by default" : "Blur camera background by default",
    "Skip device preview before joining a call" : "Skip device preview before joining a call",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Camera will be turned off when joining. Always shown if recording consent is required.",
    "Appearance & Sounds" : "Appearance & Sounds",
    "Privacy" : "حریم خصوصی",
    "Send read receipts" : "Send read receipts",
    "When off, all read statuses will be hidden" : "When off, all read statuses will be hidden",
    "Share typing status" : "Share typing status",
    "When off, all typing indicators will be hidden" : "When off, all typing indicators will be hidden",
    "Attachments folder" : "Attachments folder",
    "Toggle full screen" : "Toggle full screen",
    "Return to Home screen" : "Return to Home screen",
    "Search" : "جستجو کردن",
    "Shortcuts while in a chat" : "Shortcuts while in a chat",
    ...
    "End call" : "End call",
    "The server was updated, you cannot start or join a call." : "The server was updated, you cannot start or join a call.",
    ...
    "Select virtual background" : "Select virtual background",
    ...
    "Scheduled for {datetime}" : "Scheduled for {datetime}",
    "Search …" : "Search …",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hey! Are you using the list style or message bubbles?",
    ...
    "Audio" : "صدا",
    "Show all pinned messages" : "Show all pinned messages",
    ...
    "Follow conversation settings" : "Follow conversation settings",
    "Group" : "گروه",
    "Team" : "تیم",
    ...
    "The server was updated." : "The server was updated.",
    ...
    "Failed to rename the thread" : "Failed to rename the thread",
    "Error renaming tag" : "Error renaming tag",
    "Error deleting tag" : "Error deleting tag",
    "Error reordering tags" : "Error reordering tags",
    ...
    "The server is in maintenance mode." : "The server is in maintenance mode.",
    "Federated server was updated." : "Federated server was updated.",
    ...
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here",
    ...
    "Enable live translation" : "Enable live translation",
    "_Open poll • %n vote • Your vote is anonymous_::_Open poll • %n votes • Your vote is anonymous_" : ["Open poll • %n vote • Your vote is anonymous","Open poll • %n votes • Your vote is anonymous"],
    "Open poll • You voted already • Your vote is anonymous" : "Open poll • You voted already • Your vote is anonymous",
