OC.L10N.register(
    ...
    "Other activities" : "Citas darbības",
    "Guest" : "Viesis",
    ...
    "System added you" : " Sistēma Tevi pievienoja",
    ...
    "An administrator added you" : "Pārvaldītājs pievienoja Tevi",
    ...
    "{actor} removed {federated_user}" : "{actor} noņēma {federated_user}",
    "You removed {federated_user}" : "Tu noņēmi {federated_user}",
    "You added group {group}" : "Tu pievienoji kopu {group}",
    "You added team {circle}" : "Tu pievienoji komandu {circle}",
    "{actor} added {phone}" : "{actor} pievienoja {phone}",
    "You added {phone}" : "Tu pievienoji {phone}",
    "{actor} removed {phone}" : "{actor} noņēma {phone}",
    ...
    "You deleted a message" : "Tu izdzēsi ziņojumu",
    "You deleted a reaction" : "Tu izdzēsi reakciju",
    ...
    "{option1} and {option2}" : "{option1} un {option2}",
    ...
    "Share this link to invite others!" : "Kopīgo šo saiti, lai uzaicinātu citus!",
    ...
    "Delete" : "Delete",
    "Join" : "Pievienoties",
    "Hello, {displayName}" : "Sveiciens, {displayName}!",
    ...
    "Open chat" : "Atvērt tērzēšanu",
    "Details" : "Informācija",
    "Search in {name}" : "Meklēt {name}",
    ...
    "Group" : "Grupa",
    "Team" : "Komanda",
    "You added {user0} and {user1}" : "Tu pievienoji {user0} un {user1}",
    "_You added {user0}, {user1} and %n more participant_::_You added {user0}, {user1} and %n more participants_" : ["Tu pievienoji {user0}, {user1} un vēl %n dalībniekus","Tu pievienoji {user0}, {user1} un vēl %n dalībnieku","Tu pievienoji {user0}, {user1} un vēl %n dalībniekus"],
    "An administrator added you and {user0}" : "Pārvaldītājs pievienoja Tevi un {user0}",
    "{actor} added you and {user0}" : "{actor} pievienoja Tevi un {user0}",
    "_An administrator added you, {user0} and %n more participant_::_An administrator added you, {user0} and %n more participants_" : ["Pārvaldītājs pievienoja Tevi, {user0} un vēl %n dalībniekus","Pārvaldītājs pievienoja Tevi, {user0} un vēl %n dalībnieku","Pārvaldītājs pievienoja Tevi, {user0} un vēl %n dalībniekus"],
    "_{actor} added you, {user0} and %n more participant_::_{actor} added you, {user0} and %n more participants_" : ["{actor} pievienoja Tevi, {user0} un vēl %n dalībniekus","{actor} pievienoja Tevi, {user0} un vēl %n dalībnieku","{actor} pievienoja Tevi, {user0} un vēl %n dalībniekus"],
