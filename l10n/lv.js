OC.L10N.register(
    ...
    "TURN candidate generation failed, please check the settings." : "TURN kandidātu ģenerēšana neizdevās. Lūdzu, pārbaudiet iestatījumus.",
    "The TURN server settings are valid." : "TURN servera iestatījumi ir derīgi.",
    "Checking TURN server {server}" : "TURN servera pārbaude {server}",
    ...
    "Password request by %s" : "Paroles pieprasījums no %s",
    "_%n other guest_::_%n other guests_" : ["%n citi viesi","%n citi viesi","%n citi viesi"],
    ", " : ", ",
    "%s mentioned you in a private conversation" : "%s tevi pieminēja privātā sarunā",
    "%s mentioned you in a group conversation: %s" : "%s tevi pieminēja grupas sarunā: %s",
    "{user} mentioned you in a group conversation: {call}" : "{user} tevi pieminēja grupas sarunā: {call}",
    "%s mentioned you in a group conversation" : "%s tevi pieminēja grupas sarunā",
    "{user} mentioned you in a group conversation" : "{user} tevi pieminēja grupas sarunā",
    "You were mentioned in a group conversation by a deleted user: %s" : "Jūs grupas sarunā pieminēja izdzēsts lietotājs: %s",
    "You were mentioned in a group conversation by a deleted user: {call}" : "Jūs grupas sarunā pieminēja izdzēsts lietotājs: {call}",
    "You were mentioned in a group conversation by a deleted user" : "Jūs grupas sarunā pieminēja izdzēsts lietotājs",
    ...
    "{email} requested the password to access a share" : "{email} pieprasīja paroli, lai piekļūtu koplietojumam",
