OC.L10N.register(
    ...
    "- You can now notify all participants by posting \"@all\" into the chat" : "- Jetzt können alle Teilnehmer durch das Posten von \"@all\" im Chat benachrichtigt werden",
    ...
    "- Talk can now have commands, send \"/help\" as a chat message to see if your administrator configured some" : "- Talk beherrscht jetzt Befehle. \"/help\" als Nachricht senden, um zu prüfen, ob die Administration Befehle eingerichtet hat",
    "- With projects you can create quick links between conversations, files and other items" : "- Mit Projekten können einfach und schnell Verknüpfungen zwischen Unterhaltungen, Dateien und anderen Elementen erstellt werden",
    "- You can now mention guests in the chat" : "- Es können nun Gäste im Chat erwähnt werden",
    "- Conversations can now have a lobby. This will allow moderators to join the chat and call already to prepare the meeting, while users and guests have to wait" : "- Unterhaltungen können jetzt eine Lobby haben. Dies erlaubt der Moderation dem Chat und dem Anruf beizutreten, um das Meeting vorzubereiten, während andere Benutzer und Gäste warten müssen",
    ...
    "- Check out the new grid and call view" : "- Sehe dir die neue Kachel- und Sprecheransicht an",
    "- You can now upload and drag'n'drop files directly from your device into the chat" : "- Es können jetzt Dateien direkt von deinem Gerät in den Chat hochgeladen und per Drag'n'Drop übertragen werden.",
    ...
    "- Spice up your messages with emojis from the emoji picker" : "- Nachrichten mit Emojis aus der Emoji-Auswahl aufpeppen",
    "- You can now change your camera and microphone while being in a call" : "- Während einer Unterhaltung können nun Mikrofon und Kamera gewechselt werden",
    "- Give your conversations some context with a description and open it up so logged in users can find it and join themselves" : "- Mit einer Beschreibung Unterhaltungen einen Kontext geben und diese öffnen , damit eingeloggte Benutzer diese finden und selbst teilnehmen können",
    ...
    "- Add groups to a conversation and new group members will automatically be added as participants" : "- Gruppen zu einer Unterhaltung hinzufügen und die Gruppenmitglieder werden automatisch als Teilnehmer hinzugefügt",
    ...
    "- Moderators can now assign general and individual permissions to participants" : "- Die Moderation kann nun allgemeine und individuelle Berechtigungen an Teilnehmer vergeben",
    ...
    "- Configure an expiration time for chat messages" : "- Ablaufdatum für Chatnachrichten einrichten",
    "- Start calls without notifying others in big conversations. You can send individual call notifications once the call has started." : "- Anrufe starten, ohne andere in großen Gesprächen zu benachrichtigen. Du kannst einzelne Anrufbenachrichtigungen senden, sobald der Anruf gestartet hat.",
    ...
    "- Moderators can now create breakout rooms (requires the High-performance backend)" : "- Die Moderation kann jetzt Gruppenräume erstellen (erfordert das Hochleistungs-Backend)",
    ...
    "- Call recordings are automatically transcribed if a transcription provider app is registered" : "- Anrufaufnahmen werden automatisch transkribiert, wenn eine entsprechende Anbieter-App registriert ist",
    ...
    "- Set a reminder on a chat message to be notified later again" : "- Eine Erinnerung für eine Chatnachricht festlegen, um später erneut benachrichtigt zu werden",
    "- Use the **Note to self** conversation to take notes and share information between your devices" : "- **Notiz an mich**-Unterhaltung verwenden, um Notizen zu machen und Informationen zwischen deinen Geräten auszutauschen",
    ...
    "- Messages can now be edited by logged-in authors and moderators for 6 hours" : "- Nachrichten können jetzt 6 Stunden lang von angemeldeten Autoren und der Moderation bearbeitet werden",
    "- Unsent message drafts are now saved in your browser" : "- Nicht gesendete Nachrichtenentwürfe werden jetzt im Browser gespeichert",
    ...
    "- Moderators can now ban accounts and guests to prevent them from rejoining a conversation" : "- Die Moderation kann jetzt Konten und Gäste sperren, um zu verhindern, dass sie erneut an einer Unterhaltung teilnehmen",
    ...
    "- Add other participants to a one-to-one call to create a new group call on the fly" : "- Andere Teilnehmer zu einem Einzelgespräch hinzufügen, um im Handumdrehen ein neues Gruppengespräch zu erstellen.",
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Die Moderation kann jetzt Nachrichten anheften, sodass diese oben bleiben",
    "- Schedule a message to send it at a later time" : "- Den Versand einer Nachricht zu einem späteren Zeitpunkt planen",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Unterhaltungs-Schlagworte, Gruppierung und Sortierung zum Organisieren der Unterhaltungsliste",
    "- Voice-rooms to connect spontaneously" : "- Unterhaltungs-Räume um sich spontan zu verbinden",
    ...
    "Incoming silent call" : "Eingehender stiller Anruf",
    "You started a call" : "Du hast einen Anruf gestartet",
    "Outgoing call" : "Ausgehender Anruf",
    "{actor} started a call" : "{actor} hat einen Anruf gestartet",
    ...
    "You limited the conversation to the current participants" : "Du hast die Unterhaltung auf die aktuellen Teilnehmer beschränkt",
    ...
    "{actor} preserved the conversation" : "{actor} hat die Unterhaltung aufbewahrt",
    "You preserved the conversation" : "Du hast die Unterhaltung aufbewahrt",
    "An administrator preserved the conversation" : "Die Administration hat die Unterhaltung aufbewahrt",
    "{actor} stopped preserving the conversation" : "{actor} hat die Aufbewahrung der Unterhaltung gestoppt",
    "You stopped preserving the conversation" : "Du hast die Aufbewahrung der Unterhaltung gestoppt",
    "An administrator stopped preserving the conversation" : "Die Administration hat die Aufbewahrung der Unterhaltung gestoppt",
    ...
    "{actor} restricted the conversation to moderators" : "{actor} hat die Unterhaltung auf die Moderation beschränkt",
    "You restricted the conversation to moderators" : "Du hast die Unterhaltung auf die Moderation beschränkt",
    ...
    "An administrator allowed guests" : "Die Administration hat Gäste erlaubt",
    "{actor} disallowed guests" : "{actor} hat Gäste untersagt",
    "You disallowed guests" : "Du hast Gäste untersagt",
    "An administrator disallowed guests" : "Die Administration hat den Gastzugriff untersagt",
    "{actor} set a password" : "{actor} hat ein Passwort vergeben",
    "You set a password" : "Du hast ein Passwort vergeben",
    "An administrator set a password" : "Die Administration hat ein Passwort gesetzt",
    "{actor} removed the password" : "{actor} hat das Passwort entfernt",
    "You removed the password" : "Du hast das Passwort entfernt",
    "An administrator removed the password" : "Die Administration hat das Passwort entfernt",
    "{actor} added {user}" : "{actor} hat {user} hinzugefügt",
    "System added you" : "System hat dich hinzugefügt",
    "System added {user}" : "System hat {user} hinzugefügt",
    ...
    "An administrator added you" : "Die Administration hat dich hinzugefügt",
    "An administrator added {user}" : "Die Administration hat {user} hinzugefügt",
    ...
    "An administrator removed you" : "Die Administration hat dich entfernt",
    "An administrator removed {user}" : "Die Administration hat {user} entfernt",
    ...
    "An administrator removed {federated_user}" : "Die Administration hat {federated_user} entfernt",
    ...
    "An administrator added group {group}" : "Die Administration hat die Gruppe {group} hinzugefügt",
    "{actor} removed group {group}" : "{actor} hat die Gruppe {group} entfernt",
    "You removed group {group}" : "Du hast die Gruppe {group} entfernt",
    "An administrator removed group {group}" : "Die Administration hat die Gruppe {group} entfernt",
    ...
    "An administrator added {phone}" : "Die Administration hat {phone} hinzugefügt",
    ...
    "{actor} promoted {user} to owner" : "{actor} hat {user} zum Besitzer ernannt",
    "You promoted {user} to owner" : "Du hast {user} zum Besitzer ernannt",
    "{actor} promoted you to owner" : "{actor} hat dich zum Besitzer ernannt",
    "An administrator promoted you to owner" : "Die Administration hat dich zum Besitzer ernannt",
    "An administrator promoted {user} to owner" : "Die Administration hat {user} zum Besitzer ernannt",
    "{actor} demoted {user} from owner" : "{actor} hat {user} die Besitzrechte entzogen",
    "You demoted {user} from owner" : "Du hast {user} die Besitzrechte entzogen",
    "{actor} demoted you from owner" : "{actor} hat dir die Besitzrechte entzogen",
    "An administrator demoted you from owner" : "Die Administration hat dir die Besitzrechte entzogen",
    "An administrator demoted {user} from owner" : "Die Administration hat {user} die Besitzrechte entzogen",
    "{actor} promoted {user} to moderator" : "{actor} hat {user} Moderationsrechte zugeteilt",
    "You promoted {user} to moderator" : "Du hast {user} Moderationsrechte zugeteilt",
    "{actor} promoted you to moderator" : "{actor} hat dir Moderationsrechte zugeteilt",
    "An administrator promoted you to moderator" : "Die Administration hat dir Moderationsrechte zugeteilt",
    "An administrator promoted {user} to moderator" : "Die Administration hat {user} Moderationsrechte zugeteilt",
    "{actor} demoted {user} from moderator" : "{actor} hat {user} Moderationsrechte entzogen",
    "You demoted {user} from moderator" : "Du hast {user} Moderationsrechte entzogen",
    ...
    "{actor} created thread {title}" : "{actor} hat das Thema {title} erstellt",
    "You created thread {title}" : "Du hast das Thema {title} erstellt",
    "{actor} renamed thread {title}" : "{actor} hat das Thema {title} umbenannt",
    "You renamed thread {title}" : "Du hast das Thema {title} umbenannt",
    ...
    "{actor} pinned a message" : "{actor} hat eine Nachricht angepinnt",
    "You pinned a message" : "Du hast eine Nachricht angepinnt",
    "{actor} unpinned a message" : "{actor} hat eine Nachricht abgelöst",
    "Message was automatically unpinned" : "Die Nachricht wurde automatisch abgelöst",
    "You unpinned a message" : "Du hast eine Nachricht abgelöst",
    ...
    "Conversation subfolders are disabled" : "Unterhaltungsunterordner sind deaktiviert",
    "Storage quota exceeded" : "Speicherkontingent überschritten",
    "Could not prepare conversation folder" : "Unterhaltungsordner konnten nicht vorbereitet werden",
    "File not found" : "Datei nicht gefunden",
    "Path must point to a file" : "Der Pfad muss auf eine Datei verweisen",
    "File is not inside the conversation draft folder for this room" : "Die Datei befindet sich nicht im Unterhaltungsentwurfsordner für diesen Raum",
    "File is not shared, or shared but not with the user" : "Datei ist nicht, oder nicht mit dem Benutzer geteilt",
    ...
    "No image file provided" : "Kein Bilddatei zur Verfügung gestellt",
    ...
    "Missing %s field in header line" : "Fehlendes Feld %s in der Kopfzeile",
    ...
    "Failed to transcript call recording" : "Anrufaufzeichnung konnte nicht transkribiert werden",
    ...
    "Call summary now available" : "Anrufzusammenfassung jetzt verfügbar",
    ...
    "Failed to summarize call recording" : "Anrufaufzeichnung konnte nicht zusammengefasst werden",
    ...
    "{user} reacted with {reaction}" : "{user} hat mit {reaction} reagiert",
    "{user} reacted with {reaction} in {call}" : "{user} hat mit {reaction} in {call} reagiert",
    "Deleted user reacted with {reaction} in {call}" : "Gelöschter Benutzer hat mit {reaction} in {call} reagiert",
    "{guest} (guest) reacted with {reaction} in {call}" : "{guest} (Gast) hat mit {reaction} in {call} reagiert",
    "Guest reacted with {reaction} in {call}" : "Gast hat mit {reaction} in {call} reagiert",
    ...
    "Conversation to inform a fixed audience, which can not be left." : "Unterhaltung, um ein bestimmtes Publikum zu informieren, welche nicht verlassen werden kann.",
    "Channel" : "Kanal",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Broadcast-Unterhaltung für ein großes Publikum, in der nur die Moderation Beiträge verfassen kann und Anrufe deaktiviert sind.",
    "Classified conversation" : "Geheime Unterhaltung",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Geschützte Unterhaltung für vertrauliche Themen, bei der der öffentliche Zugriff, Gäste, SIP und Aufzeichnungen deaktiviert sind.",
    "Default" : "Standard",
    ...
    "Restricted conversation for internal presentations." : "Eingeschränkte Unterhaltung für interne Präsentationen.",
    "Voice room" : "Sprachraum",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Direkt am Anruf teilnehmen, ideal für Nachholtermine oder spontane Treffen.",
    "Webinar" : "Webinar",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Eingeschränkte Unterhaltung mit aktivierter Lobby, ideal für öffentliche Webinare.",
    ...
    "Favorites" : "Favoriten",
    "Other" : "Sonstige",
    "Failed to request trial because the trial server is unreachable. Please try again later." : "Testversion konnte nicht angefordert werden, da der Testserver nicht erreichbar ist. Bitte später erneut versuchen.",
    ...
    "There is a problem with the request of the trial. Please check your logs for further information." : "Es gibt ein Problem mit der Anfrage für die Testversion. Bitte die Protokolldateien für weitere Informationen überprüfen.",
    ...
    "Failed to request trial because the trial server behaved wrongly. Please try again later." : "Die Testversion konnte nicht angefordert werden, da der Testserver sich falsch verhalten hat. Bitte  später erneut versuchen.",
    "Trial requested but failed to get account information. Please check back later." : "Testversion angefordert, aber keine Kontoinformationen erhalten. Bitte später erneut versuchen.",
    ...
    "Failed to fetch account information because the trial server behaved wrongly. Please check back later." : "Die Kontoinformationen konnten nicht abgerufen werden, weil sich der Testserver falsch verhalten hat. Bitte später erneut versuchen.",
    ...
    "Failed to fetch account information because the trial server is unreachable. Please check back later." : "Kontoinformationen konnten nicht abgerufen werden, da der Testserver nicht erreichbar ist. Bitte später erneut versuchen.",
    "Deleting the hosted signaling server account failed. Please check back later." : "Fehler beim Löschen des Singnalisierungsserver-Kontos. Bitte später erneut versuchen.",
    "Failed to delete the account because the trial server behaved wrongly. Please check back later." : "Konto konnte nicht gelöscht werden, da sich der Testserver falsch verhalten hat. Bitte später erneut versuchen.",
    ...
    "Failed to delete the account because the trial server is unreachable. Please check back later." : "Konto konnte nicht gelöscht werden, da der Testserver nicht erreichbar ist. Bitte später erneut versuchen.",
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in the conversation by using %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Unterhaltungen ihren Lauf lassen: Nutzer erwähnen, auf Nachrichten reagieren und mehr\n\nAlle Teilnehmer einer Unterhaltung mit können mit %s erwähnt werden, oder bestimmte Teilnehmer, indem \"@\" eingegeben und deren Name aus der Liste ausgewählt wird.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from Nextcloud apps, GIFs, map locations, AI generated content and much more." : "## ✨ Mehr erledigen mit dem Smart Picker\n\nEinfach \"/\" eingeben oder das Menü \"+\" auswählen, um den Smart Picker zu öffnen, mit dem verschiedene Inhalte an Nachrichten angehängt werden können. Der Smart Picker kann so eingerichtet werden, dass Elemente aus Nextcloud-Apps, GIFs, Kartenpositionen, KI-generierte Inhalte und vieles mehr hinzugefügt werden können.",
    "## ⚙️ Manage conversation settings\n\nIn the conversation menu, you can access various settings to manage your conversations, such as:\n* Edit conversation info\n* Manage notifications\n* Apply numerous moderation rules\n* Configure access and security\n* Enable bots\n* and more!" : "## ⚙️ Gesprächseinstellungen verwalten\n\nIm Menü \"Unterhaltung\" kann auf verschiedene Einstellungen zur Verwaltung der Unterhaltungen zugegriffen werden, wie z. B.:\n* Unterhaltungsinformationen bearbeiten\n* Verwalten von Benachrichtigungen\n* Zahlreiche Moderationsregeln anwenden\n* Zugang und Sicherheit konfigurieren\n* Aktivieren von Bots\n* und mehr!",
    "Andorra" : "Andorra",
    ...
    "Guyana" : "Guyana",
    "Hong Kong" : "Hongkong",
    "Heard Island and McDonald Islands" : "Heard- und die McDonald-Inseln",
    "Honduras" : "Honduras",
    "Croatia" : "Kroatien",
    "Haiti" : "Haiti",
    "Hungary" : "Ungarn",
    ...
    "Ukraine" : "Ukraine",
    "Uganda" : "Uganda",
    "United States Minor Outlying Islands" : "Kleinere Außengebiete der Vereinigten Staaten",
    ...
    "Could not check for WASM loading support. Please check manually if your web server serves `.wasm` files." : "Es konnte nicht geprüft werden, ob WASM-Ladeunterstützung verfügbar ist. Bitte manuell prüfen, ob dein Webserver `.wasm`-Dateien bereitstellt.",
    ...
    "Forcing a call duration is only supported with system cron. Please enable system cron or remove the `max_call_duration` configuration." : "Das Erzwingen einer Anrufdauer wird nur mit System-Cron unterstützt. Bitte System-Cron aktivieren oder die Konfiguration `max_call_duration` entfernen.",
    ...
    "It is highly recommended to configure \"memcache.locking\" when Talk Federation is enabled." : "Es wird dringend empfohlen, \"memcache.locking\" einzurichten, wenn Talk-Federation aktiviert ist.",
    "High-performance backend" : "Hochleistungs-Backend",
    "No High-performance backend configured - Running Nextcloud Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "Kein Hochleistungs-Backend eingerichtet – Ohne das Hochleistungs-Backend skaliert Talk nur für kleinere Meetings (max. 2–3 Teilnehmer). Bitte das Hochleistungs-Backend einrichten, um sicherzustellen, dass Meetings mit mehreren Teilnehmern reibungslos funktionieren.",
    "Defining multiple High-performance backends is deprecated and will no longer be supported in the upcoming version. Instead a load-balancer should be set up together with clustered signaling servers and configured in the Talk settings." : "Das Definieren mehrerer Hochleistungs-Backends ist veraltet und wird in der nächsten Version nicht mehr unterstützt. Stattdessen sollte ein Load Balancer zusammen mit geclusterten Signalservern eingerichtet und in den Talk-Einstellungen eingerichtet werden.",
    "The stored public key for used algorithm %1$s does not match the stored private key. Run %2$s to fix the issue." : "Der gespeicherte öffentliche Schlüssel für den verwendeten Algorithmus %1$s passt nicht zum gespeicherten privaten Schlüssel. %2$s ausführen, um das Problem zu beheben.",
    "High-performance backend not configured correctly. Run %s for details." : "DasHochleistungs-Backend ist nicht richtig eingerichtet. Für Einzelheiten %s ausführen.",
    "High-performance backend not configured correctly" : "Hochleistungs-Backend ist nicht richtig eingerichtet",
    ...
    "Error: System times of Nextcloud server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fehler: Die Systemzeiten des Nextcloud-Servers und des Hochleistungs-Backend-Servers sind nicht synchron. Bitte sicherstellen, dass beide Server mit einem Zeitserver verbunden sind oder die Zeit manuelle synchronisieren.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push ist installiert, dies verbessert die Pünktlichkeit der Talk-Benachrichtigungen.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** Nextcloud Talk comes with a simple text chat, allowing you to share or upload files from your Nextcloud Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other Nextcloud users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other Nextcloud apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to Nextcloud Talk and vice-versa." : "Chat, Video- und Audiokonferenzen mit WebRTC\n\n* 💬 **Chat** Nextcloud Talk verfügt über einen einfachen Text-Chat, in dem Dateien über die Nextcloud Dateien-App oder ein lokales Gerät geteilt oder hochgeladen und andere Teilnehmer erwähnt werden können.\n* 👥 **Private, Gruppen-, öffentliche und passwortgeschützte Anrufe!** Jemanden oder eine ganze Gruppe einladen oder einen öffentlichen Link senden, um zu einer Unterhaltung einzuladen.\n* 🌐 **Federated-Chats** Mit anderen Nextcloud-Benutzern über deren Server chatten\n* 💻 **Bildschirmfreigabe!** Den Bildschirm mit den Teilnehmern der Unterhaltung teilen.\n* 🚀 **Integration mit anderen Nextcloud-Apps** wie Dateien, Kalender, Benutzerstatus, Dashboard, Flow, Karten, Smart Picker, Kontakte, Deck und viele mehr.\n* 🌉 **Mit anderen Chat-Lösungen synchronisieren** Durch die Integration von [Matterbridge](https://github.com/42wim/matterbridge/) in Talk können viele andere Chat-Lösungen ganz einfach mit Nextcloud Talk und umgekehrt synchronisiert werden.",
    ...
    "Error occurred when getting the conversation information" : "Fehler beim Abrufen der Unterhaltungsinformationen",
    ...
    "Open in full application" : "In der Desktopversion öffnen",
    ...
    "Everyone" : "Jeder",
    "Users and moderators" : "Benutzer und die Moderation",
    "Moderators only" : "Nur die Moderation",
    ...
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Wenn mindestens eine Gruppe ausgewählt ist, können nur Mitglieder dieser Gruppen einen Anruf starten. Dies gilt auch für die Moderation, wobei Gäste und federierte Nutzer niemals Mitglieder dieser Gruppen sind. Sofern keine Gruppe ausgewählt ist, kann jeder einen Anruf starten.",
    ...
    "Locked for moderators" : "Gesperrt für die Moderation",
    "Enabled" : "Aktiviert",
    ...
    "Expired" : "Abgelaufen",
    "Never" : "Nie",
    "The trial could not be requested. Please try again later." : "Die Testversion konnte nicht angefordert werden. Bitte später erneut versuchen.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your Nextcloud will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Unser Partner Struktur AG bietet einen Dienst an, über den ein gehosteter Signalisierungsserver angefordert werden kann. Dazu ist das untenstehende Formular auszufüllen und die Nextcloud-Instanz wird ihn anfordern. Sobald der Server eingerichtet ist, werden die Anmeldedaten automatisch ausgefüllt. Dadurch werden bestehende Einstellungen des Signalisierungsservers überschrieben.",
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "Wenn dein Hochleistungs-Backend-Konto STUN- und/oder TURN-Funktionen enthält, werden die Einstellungen entsprechend aktualisiert.",
    ...
    "You can see the current status of your hosted signaling server in the following table." : "Den aktuellen Status Ihres gehosteten Signalisierungsservers siehst du in der folgenden Tabelle.",
    "Status" : "Status",
    "Created at" : "Erstellt am",
    "Expires at" : "Läuft ab am",
    "Limits" : "Beschränkungen",
    "STUN included" : "STUN inklusive",
    "Yes" : "Ja",
    "No" : "Nein",
    "TURN included" : "TURN inklusive",
    ...
    "An error occurred while installing the Talk Matterbridge. Please install it manually" : "Es ist ein Fehler bei der Installation von Talk Matterbridge aufgetreten. Bitte manuell installieren",
    ...
    "Error: System times of Nextcloud server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fehler: Die Systemzeiten des Nextcloud-Servers und des Aufzeichnungs-Backend-Servers sind nicht synchron. Bitte sicherstellen, dass beide Server mit einem Zeitserver verbunden sind oder dessen Zeit manuell synchronisieren.",
    ...
    "Configurable on conversation level by moderators" : "Konfigurierbar auf Unterhaltungsebene durch die Moderation",
    ...
    "Moderators will be allowed to enable consent on conversation level. The consent to be recorded will be required for each participant before joining every call in this conversation." : "Die Moderation kann die Zustimmung auf Unterhaltungsebene aktivieren. Die Einwilligung zur Aufzeichnung ist für jeden Teilnehmer vor der Teilnahme an der Unterhaltung erforderlich.",
    ...
    "Do not show SIP Dial-out caller number" : "Abgehend die eigene SIP-Rufnummer nicht anzeigen",
    "Anonymous number should appear as \"unknown\" or \"withheld number\" to call recipient" : "Die anonyme Nummer sollte als \"unbekannte\" oder \"unterdrückte Nummer\" angezeigt werden, um den Empfänger anzurufen",
    "Dial-out number" : "Abgehende Telefonnummer",
    "E164 formatted number used as a fallback caller number for outgoing calls" : "E164-formatierte Nummer, die als Fallback-Rufnummer für ausgehende Anrufe verwendet wird",
    "Dial-out prefix" : "Vorwahl für ausgehende Anrufe",
    "Prefix to configured user number for outgoing calls (default is `+`)" : "Präfix zur eingestellten Rufnummer für ausgehende Anrufe (Standard ist \"+\")",
    "Restrict SIP configuration" : "SIP-Konfiguration einschränken",
    "Enable SIP configuration" : "SIP-Konfiguration aktivieren",
    "Only users of the following groups can enable SIP in conversations they moderate" : "Nur Benutzer der folgenden Gruppen können SIP in von dessen moderierten Unterhaltungen aktivieren",
    ...
    "OK" : "OK",
    "Checking …" : "Überprüfe …",
    "Failed: WebAssembly is disabled or not supported in this browser. Please enable WebAssembly or use a browser with support for it to do the check." : "Fehlgeschlagen: WebAssembly ist in diesem Browser deaktiviert oder wird nicht unterstützt. Bitte WebAssembly aktivieren oder einen Browser verwenden, der es unterstützt, um die Prüfung durchzuführen.",
    "Failed: \".wasm\" and \".tflite\" files were not properly returned by the web server. Please check \"System requirements\" section in Talk documentation." : "Fehlgeschlagen: Die Dateien \".wasm\" und \".tflite\" wurden vom Webserver nicht korrekt zurückgegeben. Bitte den Abschnitt \"Systemanforderungen\" in der Talk-Dokumentation überprüfen.",
    ...
    "It seems that the PHP and Apache configuration is not compatible. Please note that PHP can only be used with the MPM_PREFORK module and PHP-FPM can only be used with the MPM_EVENT module." : "Es scheint, dass die PHP- und Apache-Konfiguration nicht kompatibel ist. Bitte beachten, dass PHP nur mit dem Modul MPM_PREFORK und PHP-FPM nur mit dem Modul MPM_EVENT verwendet werden kann.",
    "Web server setup checks" : "Prüfung der Webserver-Einrichtung",
    ...
    "Enable live transcription (generated by AI)" : "Live-Transkription aktivieren (KI-generiert)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Live-Transkription aktivieren (Live-Transkriptions-App ist nicht installiert)",
    "Disable live translation" : "Live-Übersetzung deaktivieren",
    "Enable live translation (generated by AI)" : "Live-Übersetzung aktivieren (KI-generiert)",
    "Original language" : "Ausgangssprache",
    "Live translations app is not installed" : "Die Live-Übersetzungs-App ist nicht installiert",
    "Original language: {languageName}" : "Originalsprache: {languageName}",
    "Translated language" : "Übersetzte Sprache",
    "Translated language: {languageName}" : "Übersetzte Sprache: {languageName}",
    "Exit full screen (F)" : "Vollbild verlassen (F)",
    "Full screen (F)" : "Vollbild (F)",
    "Grid view" : "Kachelansicht",
    "Speaker view" : "Sprecheransicht",
    "Multi-speaker view" : "Mehrsprecheransicht",
    "Error when trying to load the available live transcription languages" : "Fehler beim Versuch, die verfügbaren Live-Transkriptionssprachen zu laden",
    "Failed to enable live transcription" : "Live-Transkription konnte nicht aktiviert werden",
    "Failed to enable live translations" : "Live-Übersetzung konnten nicht aktiviert werden",
    "Failed to disable live translations" : "Live-Übersetzung konnten nicht deaktiviert werden",
    ...
    "Lobby is still active and you're not a moderator" : "Die Lobby ist weiterhin aktiv und du bist kein Teil der Moderation",
    ...
    "You can invite others in the participant tab of the sidebar or share this link to invite others!" : "Andere Teilnehmer können auf dem Teilnehmer-Tab der Seitenleiste oder über diesen Link eingeladen werden!",
    "Share this link to invite others!" : "Diesen Link teilen, um andere Personen einzuladen!",
    "Copy link" : "Link kopieren",
    "You are not allowed to enable audio" : "Du darfst Audio nicht einschalten",
    ...
    "You have been muted by a moderator" : "Du wurdest von der Moderation stummgeschaltet",
    "Hide presenter video" : "Video des Präsentierenden ausblenden",
    ...
    "You" : "Du",
    "You are sharing a screen" : "Du teilst einen Bildschirm",
    "Sharing this window may cause a mirroring effect" : "Das Teilen dieses Fensters kann einen Spiegeleffekt verursachen",
    ...
    "Federated conversation" : "Federated-Unterhaltung",
    ...
    "Unban" : "Entsperren",
    "You can change the title and the description in {linkstart}Calendar ↗{linkend}." : "Den Titel und die Beschreibung kannst du im {linkstart} Kalender ↗ ändern{linkend}.",
    ...
    "Enter a description for this conversation" : "Eine Beschreibung für diese Unterhaltung eingeben",
    "Picture" : "Bild",
    "The following bots can be enabled in this conversation. Reach out to your administration to get more bots installed on this server." : "Die folgenden Bots können in dieser Unterhaltung aktiviert werden. Wende dich an deine Administration, um weitere Bots auf diesem Server installieren zu lassen.",
    ...
    "Enable" : "Aktivieren",
    "The bot is not available anymore" : "Der Bot ist nicht mehr verfügbar",
    ...
    "Edit the default permissions for participants in this conversation. These settings do not affect moderators." : "Die Standardberechtigungen für die Teilnehmer dieser Unterhaltung bearbeiten. Diese Einstellungen wirken sich nicht auf die Moderation aus.",
    ...
    "Participants can use all available features." : "Teilnehmer können alle verfügbaren Funktionen nutzen.",
    "Restricted" : "Eingeschränkt",
    "Participants can join calls, but cannot enable audio nor video nor share screen until a moderator manually grants them permissions." : "Die Teilnehmer können nur an Anrufen teilnehmen, aber keine Audio-, Video- oder Bildschirmübertragung aktivieren, bis die Moderation diese Berechtigungen manuell erteilt.",
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Die Teilnehmer erhalten einen reduzierten Funktionsumfang, bis die Moderation manuell zusätzliche Berechtigungen erteilt.",
    ...
    "Live transcriptions app is not installed" : "Die Live-Transkriptions-App ist nicht installiert",
    ...
    "You need to promote a new moderator before you can leave the conversation" : "Du musst eine neue Moderation bestimmen, bevor du die Unterhaltung verlassen kannst.",
    ...
    "Be careful, these actions cannot be undone." : "Achtung, diese Aktionen können nicht rückgängig gemacht werden.",
    "Once a conversation is left, to rejoin a closed conversation, an invite is needed. An open conversation can be rejoined at any time." : "Nachdem eine Unterhaltung verlassen wurde, ist eine Einladung erforderlich, um einer bereits geschlossenen Unterhaltung wieder beizutreten. Einer noch geöffneten Unterhaltung kann jederzeit wieder beigetreten werden.",
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Diese Unterhaltung ist aufbewahrt. Sie kann nicht gelöscht werden, und die Chat-Nachrichten können nicht gelöscht werden.",
    ...
    "Password could not be copied" : "Passwort kann nicht kopiert werden",
    ...
    "This setting can not be changed while the conversation is preserved." : "Diese Einstellung kann nicht geändert werden, solange die Unterhaltung aufbewahrt wird.",
    ...
    "Open conversation to registered users, showing it in search results" : "Unterhaltung für registrierte Benutzer öffnen und in den Suchergebnissen anzeigen",
    ...
    "Live transcription language set: {languageName}" : "Eingestellte Live-Transkriptionssprache: {languageName}",
    "Error when trying to set live transcription language" : "Fehler beim Einstellen der Live-Transkriptionssprache",
    ...
    "Enabling the lobby will remove non-moderators from the ongoing call." : "Durch Aktivieren der Lobby wird die Nicht-Moderation aus dem laufenden Anruf entfernt.",
    "Enable lobby, restricting the conversation to moderators" : "Lobby aktivieren, Unterhaltung auf die Moderation beschränken",
    ...
    "You can bridge channels from various instant messaging systems with Matterbridge." : "Mit Matterbridge kannst du Kanäle von verschiedenen Instant-Messaging-Systemen verbinden.",
    ...
    "Only moderators are allowed to mention @all" : "Nur die Moderation darf @all erwähnen",
    ...
    "Mentioning @all has been limited to moderators." : "Erwähnung von @all wurde auf die Moderation beschränkt.",
    ...
    "The entered token does not match the conversation token" : "Das eingegebene Token stimmt nicht mit der Unterhaltung überein",
    "Preserve conversation" : "Unterhaltung aufbewahren",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Solange diese Unterhaltung aufbewahrt ist, kann sie nicht gelöscht werden, der Verlauf kann nicht gelöscht werden und die Einstellungen für Gäste und die Teilnahmemöglichkeiten können nicht geändert werden.",
    "Only the owner can change whether this conversation is preserved." : "Nur der Eigentümer kann festlegen, ob diese Unterhaltung aufbewahrt wird.",
    ...
    "Stop preserving" : "Aufbewahrung stoppen",
    "Stop preserving conversation" : "Aufbewahrung der Unterhaltung beenden",
    "Conversation token" : "Unterhaltungstoken",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Wenn du die Aufbewahrung dieser Unterhaltung stoppst, kann sie gelöscht werden, der Verlauf kann gelöscht werden und die Einstellungen für Gäste und Teilnahmemöglichkeiten können erneut geändert werden.",
    "Conversation" : "Unterhaltung",
    "To confirm, type the conversation token into the field below:" : "Zur Bestätigung das Unterhaltungstoken in das untenstehende Feld eingeben:",
    "Ongoing" : "Laufend",
    ...
    "Join conversations" : "Unterhaltungen beitreten",
    "Call a phone number" : "Eine Telefonnummer anrufen",
    "Scroll backward" : "Rückwärts scrollen",
    "Scroll forward" : "Vorwärts scrollen",
    "Schedule meetings" : "Besprechungen planen",
    "You don't have any upcoming meetings" : "Du hast keine bevorstehenden Besprechungen",
    "Calendar events with a conversation link as the location are shown here" : "Hier werden Kalenderereignisse mit einem Unterhaltungslink als Ort angezeigt",
    "Open calendar" : "Kalender öffnen",
    "Unread mentions" : "Ungelesene Erwähnungen",
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Nachrichten, in denen Sie erwähnt wurden, werden hier angezeigt. Du kannst Personen erwähnen, indem du @ gefolgt von deren Namen eingibst",
    "Upcoming reminders" : "Anstehende Erinnerungen",
    "Message reminders" : "Nachrichtenerinnerungen",
    "Set a reminder on a message to be notified" : "Eine Erinnerung für eine Nachricht festlegen, um benachrichtigt zu werden",
    "Start a group conversation" : "Eine Gruppenunterhaltung beginnen",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Das Inhaltsformat besteht aus kommagetrennten Werten (CSV):<br/>- Eine Kopfzeile ist erforderlich und muss mit {sample1} oder {sample2} übereinstimmen. <br/>- Ein Eintrag pro Zeile (z. B. {sample3})",
    ...
    "Remove all tags" : "Alle Schlagworte entfernen",
    "Rename tag" : "Schlagwort umbenennen",
    "Delete tag" : "Schlagwort löschen",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Soll \"{name}\" gelöscht werden? Unterhaltungen mit diesem Schlagwort werden dann nach \"Sonstiges\" verschoben.",
    "Move up" : "Nach oben",
    "Move down" : "Nach unten",
    "Pending invitations" : "Ausstehende Einladungen",
    "Join conversations from other servers" : "Unterhaltungen von anderen Servern aus beitreten",
    ...
    "Sort conversations" : "Unterhaltungen sortieren",
    "By recent activity" : "Nach neuesten Aktivitäten",
    "Alphabetically" : "Alphabetisch",
    "Do not group by type" : "Nicht nach Typ gruppieren",
    "Show private ones first" : "Private zuerst zeigen",
    "Show group ones first" : "Gruppe zuerst zeigen",
    "No followed threads" : "Keine nachverfolgten Themen",
    "No matches found" : "Keine Übereinstimmungen gefunden",
    "No conversations found" : "Keine Unterhaltungen gefunden",
    "You have no archived conversations." : "Du hast keine archivierten Unterhaltungen",
    "Subscribe to an existing thread or start your own." : "Ein existierendes Thema abonnieren, oder ein eigenes Thema beginnen.",
    ...
    "Create a new conversation" : "Eine neue Unterhaltung erstellen",
    "New personal note" : "Neue persönliche Notiz",
    "Join open conversations" : "Offenen Unterhaltungen beitreten",
    "SIP backend is not installed" : "SIP-Backend ist nicht installiert",
    ...
    "The meeting will start soon" : "Das Meeting beginnt in Kürze",
    "This meeting is scheduled for {startTime}" : "Dieses Treffen ist geplant für {startTime}",
    "You are currently waiting in the lobby" : "Du wartest in der Lobby",
    ...
    "Access to microphone was denied" : "Zugriff auf das Mikrofon wurde verweigert",
    ...
    "The recording might include your voice, video from camera, and screen share. Your consent is required before joining the call." : "Die Aufnahme kann deine Stimme, Video von der Kamera und Bildschirmfreigabe umfassen. Vor der Teilnahme am Anruf ist deine Zustimmung hierzu erforderlich.",
    "Give consent to the recording of this call" : "Stimme bitte der Aufzeichnung dieser Unterhaltung zu",
    "You can only join a voice room via a call." : "Einem Sprachraum kann nur über einen Anruf beigetreten werden.",
    ...
    "Recording backend is not installed" : "Aufnahme-Backend ist nicht installiert",
    "Notify all participants about this call" : "Alle Teilnehmer über diesen Anruf benachrichtigen",
    "Apply settings" : "Einstellungen anwenden",
    "Select virtual office background" : "Einen virtuellen Hintergund auswählen (Büro)",
    "Select virtual home background" : "Einen virtuellen Hintergrund auswählen (Zuhause)",
    "Select virtual abstract background" : "Einen virtuellen abstrakten Hintergrund auswählen",
    "Select virtual beach background" : "Einen virtuellen Strandhintergrund auswählen",
    "Select virtual park background" : "Einen virtuellen Parkhintergrund auswählen",
    "Select virtual theater background" : "Einen virtuellen Theaterhintergrund auswählen",
    "Select virtual library background" : "Bibliothek als virtuellen Hintergrund auswählen",
    "Select virtual space station background" : "Einen virtuellen Hintergrund auswählen (Raumstation)",
    ...
    "7 days" : "7 Tage",
    "30 days" : "30 Tage",
    "Until unpin" : "Bis zum Ablösen",
    "Clear reminder – {timeLocale}" : "Erinnerung löschen – {timeLocale}",
    "Edited by {actor}" : "Bearbeitet von {actor}",
    "Pinned by you" : "Angeheftet von dir",
    "Pinned by {actor}" : "Angeheftet von {actor}",
    "Until {absoluteDate}" : "Bis {absoluteDate}",
    ...
    "Unpin message" : "Nachricht ablösen",
    ...
    "Go to thread" : "Zu Thema wechseln",
    "Edit thread details" : "Themendetails bearbeiten",
    "Forward message" : "Nachricht weiterleiten",
    "Translate" : "Übersetzen",
    "Set custom reminder" : "Benutzerdefinierte Erinnerung erstellen",
    "Keep pinned for" : "Angeheftet lassen für",
    "Set custom period" : "Benutzerdefinierten Zeitraum eingeben",
    ...
    "The message has been forwarded to {selectedConversationName}" : "Die Nachricht wurde an {selectedConversationName} weitergeleitet",
    ...
    "This translation is AI generated and may contain mistakes." : "Diese Übersetzung ist KI-generiert und kann Fehler enthalten.",
    "Copy translated text" : "Übersetzten Text kopieren",
    "Error when scheduling the message" : "Fehler beim Planen des Nachrichtenversands",
    "Reschedule" : "Umplanen",
    "Send now" : "Jetzt senden",
    "Choose a time" : "Eine Zeit wählen",
    "Send at custom time" : "Zur benutzerdefinierten Zeit senden",
    "Will be sent without notification" : "Wird ohne Benachrichtigung gesendet",
    ...
    "Deleting message" : "Lösche Nachricht",
    "Message deleted successfully, but a bot or Matterbridge is configured and the message might already be distributed to other services" : "Nachricht gelöscht, aber ein Bot oder Matterbridge ist eingerichtet und die Nachricht wurde unter Umständen bereits an andere Dienste verteilt",
    "Message deleted successfully" : "Nachricht gelöscht",
    "Message could not be deleted because it is too old" : "Nachricht konnte nicht gelöscht werden, weil sie zu alt ist.",
    ...
    "Pinned" : "Angeheftet",
    "Your browser does not support playing audio files" : "Der verwendete Browser unterstützt das Abspielen von Audio-Dateien nicht",
    "Contact" : "Kontakt",
    ...
    "Failed to send the message. Click to try again" : "Nachricht konnte nicht gesendet werden. Klicken, um es erneut zu versuchen.",
    ...
    "Reply to thread \"{threadTitle}\"" : "Antwort auf das Thema \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Du hast abgestimmt • %n Stimme","Du hast abgestimmt • %n Stimmen"],
    "You voted" : "Du hast abgestimmt",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Zum Abstimmen klicken • %n Stimme","Zum Abstimmen klicken • %n Stimmen"],
    "Click to vote" : "Zum Abstimmen klicken",
    ...
    "Closed poll" : "Geschlossene Umfrage",
    ...
    "_and %n other participant_::_and %n other participants_" : ["und %n weiterer Teilnehmender","und %n weitere Teilnehmende"],
    ...
    "Generate summary with AI" : "Zusammenfassung mit KI erstellen",
    "{author} (pinned by you)" : "{author} (Von dir angeheftet)",
    "{author} (pinned by {actor})" : "{author} (Angeheftet von {actor})",
    "Unpin" : "Abheften",
    ...
    "Conversation type" : "Unterhaltungstyp",
    "Default parameters are:" : "Standardparameter sind:",
    "These settings can be changed once the conversation is created." : "Diese Einstellungen können geändert werden, sobald die Unterhaltung erstellt wurde.",
    ...
    "Message will be sent {datetimeString}" : "Nachricht wird gesendet um {datetimeString}",
    ...
    "Message was successfully scheduled" : "Nachrichtenversand wurde geplant",
    ...
    "Show scheduled messages" : "Geplante Nachrichten ansehen",
    ...
    "Voice message {time} ({conversation})" : "Sprachnachricht {time} ({conversation})",
    ...
    "Standard image quality" : "Standard Bildqualität",
    "Original image quality" : "Original Bildqualität",
    "View-only for others" : "Für andere schreibgeschützt",
    "Editable by others" : "Für andere bearbeitbar",
    ...
    "Post messages" : "Nachrichten senden",
    "Post messages and reactions" : "Nachrichten und Reaktionen senden",
    ...
    "Show names on voted options" : "Namen bei ausgewählten Optionen anzeigen",
    ...
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n Stimme • Dein Name wird an der Option angezeigt für die du abgestimmt hast","%n Stimmen • Dein Name wird an den Optionen angezeigt für die du abgestimmt hast"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n Stimme • Dein Name wird nicht an der Option angezeigt für die du abgestimmt hast","%n Stimmen • Dein Name wird nicht an den Optionen angezeigt für die du abgestimmt hast"],
    "Your name will not be shown on voted options" : "Dein Name wird nicht an den Optionen angezeigt für die du abgestimmt hast",
    ...
    "Results" : "Ergebnisse",
    "Download as spreadsheet" : "Als Tabelle herunterladen",
    ...
    "The last moderator of a conversation can not be demoted" : "Eine Person muss Moderationsrechte behalten",
    "Could not change the type of the participant" : "Typ des Teilnehmers konnte nicht geändert werden",
    ...
    "Permissions removed for {displayName}" : "Berechtigungen für {displayName} entfernt",
    ...
    "Promote to owner" : "Zum Besitzer ernennen",
    "Demote from moderator" : "Aus der Moderation abberufen",
    "Promote to moderator" : "Zur Moderation heraufstufen",
    "Demote from owner to moderator" : "Vom Besitzer zur Moderation ändern",
    "Demote from owner to participant" : "Von Besitzer zu Teilnehmer ändern",
    ...
    "You can search or add participants via name, email, or Federated Cloud ID" : "Teilnehmer können über Namen, E-Mail-Adresse oder Federated-Cloud-ID gesucht oder hinzugefügt werden",
    ...
    "A new group conversation with selected participant will be created" : "Es wird eine neue Gruppenunterhaltung mit dem ausgewählten Teilnehmer erstellt",
    "Participants" : "Teilnehmer",
    "Pinned by a deleted user" : "Angeheftet von einem gelöschten Benutzer",
    ...
    "Thread notifications" : "Themen-Benachrichtigungen",
    ...
    "Check spelling or use complete words." : "Die Rechtschreibung überprüfen oder vollständige Wörter verwenden.",
    "Search conversations or users" : "Nach Unterhaltungen oder Benutzern suchen",
    "Select conversation" : "Unterhaltung auswählen",
    "Number length is not valid" : "Nummernlänge ist ungültig",
    "Region code is not valid" : "Regionalcode ist ungültig",
    "Number length is too short" : "Nummernlänge ist zu kurz",
    "Number length is too long" : "Nummernlänge ist zu lang",
    "Number is not valid" : "Nummer ist ungültig",
    "Phone numbers" : "Telefonnummern",
    "Display name: {name}" : "Anzeigename: {name}",
    "Edit display name" : "Anzeigename bearbeiten",
    "Display name (required)" : "Anzeigename (erforderlich)",
    "Save name" : "Namen speichern",
    "I picked message bubbles" : "Ich habe Sprechblasen ausgewählt",
    "I picked the list style" : "Ich habe den Listenstil ausgewählt",
    ...
    "Compact conversations list" : "Unterhaltungsliste verkleinern",
    "Chat appearance" : "Chat-Darstellung",
    ...
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "Derzeit aufgrund technischer Einschränkungen durch den Hersteller nicht auf iPhone und iPad verfügbar",
    "Notification settings" : "Benachrichtigungseinstellungen",
    "Sounds for chat and call notifications" : "Töne für Chat- und Anrufbenachrichtigungen",
    "Invalid language ({languageId})" : "Ungültige Sprache ({languageId})",
    "Default language" : "Standard-Sprache",
    "Default language ({languageName})" : "Standardsprache ({languageName})",
    "Error when trying to load the available live translation languages" : "Fehler beim Versuch, die verfügbaren Live-Übersetzungssprachen zu laden",
    "Error when trying to set live translation language" : "Fehler beim Versuch, eine Live-Übersetzungssprache festzulegen",
    "Set language used to show the transcriptions" : "Sprache festlegen, die zur Anzeige der Transkriptionen verwendet wird",
    ...
    "Turn camera and microphone off by default" : "Kamera und Mikrofon standardmäßig ausschalten",
    ...
    "When off, all read statuses will be hidden" : "Im ausgeschalteten Zustand werden alle Lesestatus ausgeblendet",
    "Share typing status" : "Schreibstatus teilen",
    "When off, all typing indicators will be hidden" : "Im ausgeschalteten Zustand werden alle Schreibanzeigen ausgeblendet",
    "Attachments folder" : "Ordner für Anhänge",
    "Toggle full screen" : "Vollbildmodus umschalten",
    "Return to Home screen" : "Zum Startbildschirm zurückkehren",
    "Shortcuts while in a chat" : "Tastaturkürzel während eines Chats",
    ...
    "Microphone on and off" : "Mikrofon ein- und ausschalten",
    ...
    "The server was updated, you cannot start or join a call." : "Der Server wurde aktualisiert, Du kannst keinen Anruf starten oder daran teilnehmen.",
    "This call has just ended" : "Dieser Anruf wurde gerade beendet",
    "You will be able to join the call only after a moderator starts it." : "Du kannst dem Anruf erst beitreten, nachdem die Moderation ihn gestartet hat.",
    ...
    "React with {reaction}" : "Mit {reaction} reagieren",
    ...
    "Select virtual background" : "Virtuellen Hintergrund auswählen",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Diese Konversation wird nach %n Minute Inaktivität automatisch für alle gelöscht.","Diese Unterhaltung wird nach %n Minuten Inaktivität automatisch für alle gelöscht."],
    ...
    "Scheduled {datetime}" : "Geplant {datetime}",
    "Scheduled for {datetime}" : "Geplant für {datetime}",
    "Search" : "Suche",
    "Message without mention" : "Nachricht ohne Erwähnung",
    "Mention myself" : "Mich selbst erwähnen",
    "Mention everyone" : "Jeden erwähnen",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Diese Unterhaltung wurde in einem anderen Tab geöffnet. Die aktuelle Serverversion unterstützt das Öffnen einer Unterhaltung in mehreren Tabs nicht.",
    ...
    "Another user" : "Ein anderer Benutzer",
    "Hey! Are you using the list style or message bubbles?" : "Hallo! Verwendest du Talk im Listenstil oder mit Sprechblasen?",
    ...
    "Audio" : "Audio",
    "Show all pinned messages" : "Alle angehefteten Nachrichten anzeigen",
    ...
    "Follow conversation settings" : "Unterhaltungseinstellungen folgen",
    "Group" : "Gruppe",
    "Team" : "Team",
    ...
    "You promoted {user0} and {user1} to moderators" : "Du hast {user0} und {user1} zur Moderation befördert",
    "_You promoted {user0}, {user1} and %n more participant to moderators_::_You promoted {user0}, {user1} and %n more participants to moderators_" : ["Du hast {user0}, {user1} und %n weiteren Teilnehmer zur Moderation befördert","Du hast {user0}, {user1} und %n weitere Teilnehmer zur Moderation befördert"],
    "An administrator promoted you and {user0} to moderators" : "Die Administration hat dich und {user0} zur Moderation ernannt",
    "{actor} promoted you and {user0} to moderators" : "{actor} hat dich und {user0} zur Moderation befördert",
    "_An administrator promoted you, {user0} and %n more participant to moderators_::_An administrator promoted you, {user0} and %n more participants to moderators_" : ["Die Administration hat dich, {user0} und %n weiteren Teilnehmer zur Moderation befördert ","Die Administration hat dich, {user0} und %n weitere Teilnehmer zur Moderation befördert"],
    "_{actor} promoted you, {user0} and %n more participant to moderators_::_{actor} promoted you, {user0} and %n more participants to moderators_" : ["{actor} hat dich, {user0} und %n weiteren Teilnehmer zur Moderation befördert","{actor} hat dich, {user0} und %n weitere Teilnehmer zur Moderation befördert"],
    "An administrator promoted {user0} and {user1} to moderators" : "Die Administration hat {user0} und {user1} zur Moderation befördert",
    "{actor} promoted {user0} and {user1} to moderators" : "{actor} hat {user0} und {user1} zur Moderation befördert",
    "_An administrator promoted {user0}, {user1} and %n more participant to moderators_::_An administrator promoted {user0}, {user1} and %n more participants to moderators_" : ["Die Administration hat {user0}, {user1} und %n weiteren Teilnehmer zur Moderation befördert","Die Administration hat {user0}, {user1} und %n weitere Teilnehmer zur Moderation befördert"],
    "_{actor} promoted {user0}, {user1} and %n more participant to moderators_::_{actor} promoted {user0}, {user1} and %n more participants to moderators_" : ["{actor} hat {user0}, {user1} und %n weiteren Teilnehmer zur Moderation befördert","{actor} hat {user0}, {user1} und %n weitere Teilnehmer zur Moderation befördert"],
    ...
    "_An administrator demoted {user0}, {user1} and %n more participant from moderators_::_An administrator demoted {user0}, {user1} and %n more participants from moderators_" : ["Die Administration hat {user0}, {user1} und %n weiteren Teilnehmer von der Moderation abberufen","Die Administration hat {user0}, {user1} und %n weitere Teilnehmer von der Moderation abberufen"],
    "_{actor} demoted {user0}, {user1} and %n more participant from moderators_::_{actor} demoted {user0}, {user1} and %n more participants from moderators_" : ["{actor} hat {user0}, {user1} und %n weiteren Teilnehmer von der Moderation abberufen","{actor} hat  {user0}, {user1} und %n weitere Teilnehmer von der Moderation abberufen"],
    "You:" : "Du:",
    "You: {lastMessage}" : "Du: {lastMessage}",
    "{actor}:" : "{actor}:",
    "{relativeDate}, {absoluteDate}" : "{relativeDate}, {absoluteDate}",
    "The server was updated." : "Der Server wurde aktualisiert.",
    ...
    "The recording failed. Please contact your administrator." : "Die Aufnahme ist fehlgeschlagen. Bitte an die Administration wenden.",
    ...
    "Error while changing the preserved status of the conversation" : "Fehler beim Ändern des Aufbewahrt-Status der Unterhaltung",
    "Error occurred when restricting the conversation to moderator" : "Es ist ein Fehler beim Beschränken der Unterhaltung auf die Moderation aufgetreten",
    ...
    "Error renaming tag" : "Fehler beim Umbenennen des Schlagwortes",
    "Error deleting tag" : "Fehler beim Löschen des Schlagwortes",
    "Error reordering tags" : "Fehler beim Umsortieren der Schlagworte",
    ...
    "Poll \"{name}\" was created by {user}. Click to vote" : "Umfrage \"{name}\" wurde von {user} erstellt. Klicken, um abzustimmen",
    "Failed to add reaction" : "Reaktion konnte nicht hinzugefügt werden",
    "Failed to remove reaction" : "Reaktion konnte nicht entfernt werden",
    "The server is in maintenance mode." : "Der Server befindet sich im Wartungsmodus.",
    "Federated server was updated." : "Der Federated-Server wurde aktualisiert.",
    ...
    "High-performance backend needs to be updated." : "Das Hochleistungs-Backend muss aktualisiert werden.",
    "The server is misconfigured. Please contact your administration." : "Der Server ist falsch konfiguriert. Bitte an die Administration wenden.",
    "Please restart the app." : "Bitte die App neu starten.",
    "Please reload the page." : "Bitte die Seite neu laden.",
    "Please try to restart the app." : "Bitte versuchen, die App neu zu starten.",
    ...
    "Please use a different browser like Firefox or Chrome" : "Bitte einen anderen Browser, wie z.B. Firefox oder Chrome benutzen",
    ...
    "The call summary bot posts an overview message after the call listing all participants and outlining tasks" : "Der Protokoll-Bot veröffentlicht nach einem Anruf eine Übersichtsnachricht, in der alle Teilnehmenden und die Aufgaben aufgeführt werden",
    "Tasks" : "Aufgaben",
    "Notes" : "Notizen",
    "Reports" : "Berichte",
    ...
    "Collapse stripe" : "Teilnehmerleiste einklappen",
    "Expand stripe" : "Teilnehmerleiste aufklappen",
    "Select a microphone" : "Ein Mikrofon auswählen",
    "Select a speaker" : "Einen Lautsprecher auswählen",
    "Select a video device" : "Eine Videoquelle auswählen",
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Plane ein Meeting aus deinem Kalender heraus. Ein Talk-Gespräch muss als Ort festgelegt werden, um hier angezeigt zu werden",
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match <samp>\"name\",\"email\"</samp> or just <samp>\"email\"</samp><br/>- One entry per line (e.g. <samp>\"John Doe\",\"john@example.tld\"</samp>)" : "Das Inhaltsformat besteht aus kommagetrennten Werten (CSV):<br/>- Eine Kopfzeile ist erforderlich und muss mit <samp>\"name\",\"email\"</samp> oder nur <samp>\"email\"</samp> übereinstimmen. <br/>- Ein Eintrag pro Zeile (z. B. <samp>\"Max Mustermann\",\"max@beispiel.de\"</samp>)",
    ...
    "Your privacy setting has been saved" : "Die Datenschutzeinstellungen wurde gespeichert",
    "Your personal setting has been saved" : "Die persönliche Einstellung wurde gespeichert",
    ...
    "Always shown if recording consent is required" : "Wird immer angezeigt, wenn eine Zustimmung zur Aufzeichnung erforderlich ist",
    ...
    "The configured signaling server needs to be updated to be compatible with this version of Talk. Please contact your administration." : "Der eingerichtete Signalisierungsserver muss aktualisiert werden, damit er mit dieser Version von Talk kompatibel ist. Bitte an die Administration wenden.",
    "Enable live translation" : "Live-Übersetzung aktivieren",
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["Offene Umfrage • %n Stimme • Dein Name wird an den Optionen angezeigt für die du abgestimmt hast","Offene Umfrage • %n Stimmen • Dein Name wird an den Optionen angezeigt für die du abgestimmt hast"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["Offene Umfrage • %n Stimme • Dein Name wird nicht an den Optionen angezeigt für die du abgestimmt hast","Offene Umfrage • %n Stimmen • Dein Name wird nicht an den Optionen angezeigt für die du abgestimmt hast"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "Offene Umfrage • Du hast bereits abgestimmt • Dein Name wird nicht an den Optionen angezeigt für die du abgestimmt hast",
    "Open poll • Your name will not be shown on voted options" : "Offene Umfrage • Dein Name wird nicht an den Optionen angezeigt für die du abgestimmt hast",
