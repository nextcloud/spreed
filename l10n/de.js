OC.L10N.register(
    ...
    "- Give your conversations some context with a description and open it up so logged in users can find it and join themselves" : "- Den Unterhaltungen einen Kontext mit einer Beschreibung geben und diese öffnen, damit angemeldete Benutzer diese finden und selbst teilnehmen können",
    ...
    "{actor} unpinned a message" : "{actor} hat eine Nachricht gelöst",
    "Message was automatically unpinned" : "Die Nachricht wurde automatisch gelöst.",
    "You unpinned a message" : "Du hast eine Nachricht gelöst",
    ...
    "Do not show SIP Dial-out caller number" : "Abgehend die eigene Rufnummer nicht anzeigen",
    ...
    "Dial-out number" : "Ausgehende Telefonnummer",
    ...
    "Invite all users and emails in this conversation" : "Alle Benutzer und E-Mail-Adressen in der Unterhaltung einladen",
    ...
    "Unban" : "Entsperren",
    "You can change the title and the description in {linkstart}Calendar ↗{linkend}." : "Den Titel und die Beschreibung können Sie im {linkstart} Kalender ↗{linkend} ändern.",
    ...
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Nachrichten, in denen du erwähnt wurdest, werden hier angezeigt. Du kannst Personen erwähnen, indem du @ gefolgt von deren Namen eingibst",
    ...
    "You can only join a voice room via a call." : "Du kannst einem Sprachraum nur über einen Anruf beitreten.",
    ...
    "Error occurred during a summary generation" : "Es ist ein Fehler beim Erstellen einer Zusammenfassung aufgetreten",
    "New file" : "Neue Datei",
    "Blank" : "Leer",
    ...
    "_%n vote • Your vote is anonymous_::_%n votes • Your vote is anonymous_" : ["%n Stimme • Deine Stimme ist anonym","%n Stimmen • Deine Stimme ist anonym"],
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hey! Verwendest du Talk im Listenstil oder mit Sprechblasen?",
    ...
    "Error occurred while allowing guests" : "Es ist ein Fehler beim Zulassen von Gästen aufgetreten",
    ...
    "Error fetching upcoming events" : "Fehler beim Abrufen der bevorstehenden Termine",
