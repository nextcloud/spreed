OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Lasse die Unterhaltungen fließen: ErwähneBenutzer, reagiere auf Nachrichten und mehr\n\nDu kannst alle Teilnehmer einer Unterhaltung %s erwähnen oder bestimmte Teilnehmer erwähnen, indem Du „@“ eingibst und ihren Namen aus der Liste auswählst.",
    ...
    "Please note that in calls with more than 2 participants without the High-performance backend, participants will most likely experience connectivity issues and cause high load on participating devices." : "Bitte beachte, dass bei Meetings mit mehr als 2 Teilnehmern ohne das Hochleistungs-Backend höchstwahrscheinlich Verbindungsprobleme auftreten und die teilnehmenden Geräte stark belastet werden.",
    "Install the High-performance backend to ensure calls with multiple participants work seamlessly." : "Installiere das Hochleistungs-Backend, um sicherzustellen, dass Meetings mit mehreren Teilnehmern reibungslos funktionieren.",
