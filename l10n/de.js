OC.L10N.register(
    ...
    "Open settings" : "Benötigt keine Übersetzung. Für Android wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Failed to request trial because the trial server is unreachable. Please try again later." : "Test konnte nicht angefordert werden, da der Testserver nicht erreichbar ist. Bitte versuche es später noch einmal.",
    "There is a problem with the authentication of this instance. Maybe it is not reachable from the outside to verify it's URL." : "Problem bei der Authentifizierung dieser Instanz aufgetreten. Möglicherweise sie von außen nicht erreichbar, um ihre URL zu überprüfen.",
    ...
    "Failed to delete the account because the trial server behaved wrongly. Please check back later." : "Fehler beim Löschen des Kontos, da sich der Testserver falsch verhalten hat. Bitte versuche es später erneut.",
    ...
    "Failed to delete the account because the trial server is unreachable. Please check back later." : "Fehler beim Löschen des Kontos, da der Testserver nicht erreichbar ist. Bitte versuche es später erneut.",
    "Andorra" : "Andorra",
    ...
    "Request signaling server trail" : "Test des Signalisierungsservers anfordern",
    ...
    "Delete the signaling server account" : "Signalisierungsserverkonto löschen",
