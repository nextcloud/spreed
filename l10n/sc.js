OC.L10N.register(
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your Nextcloud will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Su partner nostru Struktur AG frunit unu servìtziu in ue si podet pedire unu serbidore de signalatzione retzidu. Bastat a compilare su mòdulu a suta e Nextcloud dd'at a pedire pro tue. Una borta chi su serbidore est impostadu, is credentziales s'ant a compilare de manera automàtica. Custu at a subraiscriere sa cunfiguratzione esistente de su serbidore de signalatzione.",
