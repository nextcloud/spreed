OC.L10N.register(
    ...
    "{actor} removed {federated_user}" : "{actor} nch'at bogadu a {federated_user}",
    "You removed {federated_user}" : "Nch'as bogadu a {federated_user}",
    "An administrator removed {federated_user}" : "S'amministrazione nch'at bogadu {federated_user}",
    ...
    "{actor} added {phone}" : "{actor} at agiuntu a {phone}",
    "You added {phone}" : "As agiuntu a {phone}",
    "An administrator added {phone}" : "S'amministratzione at agiuntu {phone}",
    "{actor} removed {phone}" : "{actor} nch'at bogadu a {phone}",
    "You removed {phone}" : "Nch'as bogadu a {phone}",
    "An administrator removed {phone}" : "S'amministrazione nch'at bogadu {phone}",
    ...
    "Sweden" : "Isvètzia",
    "Singapore" : "Singapore",
    "Saint Helena, Ascension and Tristan da Cunha" : "Sant Elene, Ascension e Tristan da Cunha",
    "Slovenia" : "Slovènia",
    ...
    "Hello, {displayName}" : "Salude, {displayName}",
    ...
    "Add participants" : "Aguinghe partetzipantes",
    ...
    "Share from {nextcloud}" : "Cumpartzidu dae {nextcloud}",
    ...
    "Demote from moderator" : "Lea·ssi su permissu de moderare",
    ...
    "{guest} (guest)" : "{guest} (persone invitada)",
    ...
    "_%n week_::_%n weeks_" : ["%n chidas","%n chidas"],
