OC.L10N.register(
    ...
    "You tried to call {user}" : "سىز {user} call غا تېلېفون قىلماقچى بولدىڭىز",
    ...
    "{user} invited you to a private conversation" : "{user} سىزنى شەخسىي سۆھبەتكە تەكلىپ قىلدى",
    ...
    "{actor} added circle {circle}" : "{actor} قوشۇلغان چەمبىرەك {circle}",
    "You added circle {circle}" : "چەمبىرەك {circle} قوشتىڭىز",
    "An administrator added circle {circle}" : "باشقۇرغۇچى چەمبىرەك {circle} added قوشتى",
    "{actor} removed circle {circle}" : "{actor} چىقىرىۋېتىلگەن چەمبىرەك {circle}",
    "You removed circle {circle}" : "چەمبىرەك {circle} ئۆچۈردىڭىز",
    "An administrator removed circle {circle}" : "باشقۇرغۇچى چەمبىرەك {circle} ئېلىۋەتتى",
    "Call with {user1} and {user2} (Duration {duration})" : "{user1} ۋە {user2} with بىلەن تېلېفون قىلىڭ (Duration {duration})",
    "Call with {user1}, {user2} and {user3} (Duration {duration})" : "{user1} ، {user2} ۋە {user3} with بىلەن تېلېفون قىلىڭ (Duration {duration})",
    "Call with {user1}, {user2}, {user3} and {user4} (Duration {duration})" : "{user1}, {user2}, {user3} ۋە {user4} بىلەن تېلېفون قىلىڭ (Duration {duration})",
    "Call with {user1}, {user2}, {user3}, {user4} and {user5} (Duration {duration})" : "{user1}, {user2}, {user3}, {user4} ۋە {user5} بىلەن تېلېفون قىلىڭ (Duration {duration})",
