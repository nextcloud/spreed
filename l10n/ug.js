OC.L10N.register(
    ...
    "In this conversation <strong>{user}</strong> can:" : "بۇ سۆھبەتتە <strong> {ئىشلەتكۈچى} </strong> بولىدۇ:",
    "Edit default permissions for participants in <strong>{conversationName}</strong>" : "<strong> {پاراڭلىشىش ئىسمى} </strong> غا قاتناشقۇچىلارنىڭ سۈكۈتتىكى ئىجازەتلىرىنى تەھرىرلەڭ",
