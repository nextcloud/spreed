OC.L10N.register(
    ...
    "{user} invited you to a group conversation: {call}" : "{user} ju ftoi në një bisedë grupi: {call}",
    ...
    "Yes" : "Po",
    "{option1} and {option2}" : "{option1} dhe {option2}",
    ...
    "Remove" : "Hiqe",
    "Details" : "Detajet",
    "Search in {name}" : "Kërkoni në {name}",
    "Privacy" : "Privatësi",
