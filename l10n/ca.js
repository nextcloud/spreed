OC.L10N.register(
    ...
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "- *Previsualització:* El xat de text ara es pot fer de manera federada amb altres servidors de Talk",
    ...
    "Hosted high-performance backend" : "Servidor rerefons d'alt rendiment",
    "SIP configuration is only possible with a high-performance backend." : "La configuració SIP només és possible amb un rerefons d'alt rendiment.",
    "Missing high-performance backend warning hidden" : "Falta l'avís de rerefons d'alt rendiment amagat",
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Deixa fluir les converses: menciona els usuaris, reacciona als missatges i molt més\n\nPots esmentar tothom en una conversa %s o esmentar participants específics escrivint \"@\" i escollint-ne el nom a la llista."
},
