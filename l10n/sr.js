OC.L10N.register(
    ...
    "{actor} allowed guests in the conversation" : "{actor} је дозволио госте у разговор",
    "{actor} disallowed guests in the conversation" : "{actor} је забранио госте у разговор",
    "{actor} set a password for the conversation" : "{actor} је поставио лозинку за разговор",
    "{actor} removed the password for the conversation" : "{actor} је уклонио лозинку за разговор",
    "{actor} added {user} to the conversation" : "{actor} је додао корисника {user} у разговор",
    "{actor} removed {user} from the conversation" : "{actor} је уклонио корисника {user} из разговора",
