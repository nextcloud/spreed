OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Нека разговор тече: помените кориснике, реагујте на поруке и још тога\n\nУ разговору можете да поменете све @all или одређене учеснике тако што откуцате „@” па из листе изаберете њихово име.",
