OC.L10N.register(
    ...
    "{actor} pinned a message" : "{actor} је закачио поруку",
    "You pinned a message" : "Закачили сте поруку",
    "{actor} unpinned a message" : "{actor} је откачио поруку",
    "Message was automatically unpinned" : "Порука је аутоматски откачена",
    "You unpinned a message" : "Откачили сте поруку",
