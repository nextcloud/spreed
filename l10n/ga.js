OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Is féidir le modhnóirí teachtaireachtaí a phionáil anois ionas go gcoimeádtar iad ag an mbarr",
    "- Schedule a message to send it at a later time" : "- Sceideal teachtaireacht le seoladh ag am níos déanaí",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Clibeanna comhrá, grúpáil agus sórtáil chun an liosta comhrá a eagrú",
    "- Voice-rooms to connect spontaneously" : "- Seomraí gutha chun ceangal go spontáineach",
    ...
    "{actor} created the conversation" : "Chruthaigh {actor} an comhrá",
    ...
    "{actor} preserved the conversation" : "Choinnigh {actor} an comhrá",
    "You preserved the conversation" : "Choinnigh tú an comhrá",
    "An administrator preserved the conversation" : "Choinnigh riarthóir an comhrá",
    "{actor} stopped preserving the conversation" : "Stop {actor} ag caomhnú an chomhrá",
    "You stopped preserving the conversation" : "Stop tú ag caomhnú an chomhrá",
    "An administrator stopped preserving the conversation" : "Chuir riarthóir stop le caomhnú an chomhrá",
    ...
    "An administrator invited {federated_user}" : "Thug riarthóir cuireadh do {federated_user}",
    "{federated_user} accepted the invitation" : "Ghlac {federated_user} leis an gcuireadh",
    ...
    "{actor} added team {circle}" : "Chuir {actor} foireann {circle} leis",
    ...
    "{actor} promoted {user} to owner" : "ardú céime ag {actor} chuig {user} go húinéir",
    "You promoted {user} to owner" : "Chuir tú ardú céime ar {user} go dtí úinéir",
    "{actor} promoted you to owner" : "ardú céime chuig úinéir thú ag {actor}",
    "An administrator promoted you to owner" : "Thug riarthóir ardú céime duit mar úinéir",
    "An administrator promoted {user} to owner" : "Thug riarthóir ardú céime do {user} go dtí úinéir",
    "{actor} demoted {user} from owner" : "Íslíodh céim úinéara {actor} {user}",
    "You demoted {user} from owner" : "Íslíodh céim {user} ó úinéir",
    "{actor} demoted you from owner" : "Ísligh {actor} céim úinéara duit",
    "An administrator demoted you from owner" : "Ísligh riarthóir thú ó úinéir",
    "An administrator demoted {user} from owner" : "Ísligh riarthóir céim {user} ó úinéir",
    ...
    "{actor} pinned a message" : "Chuir {actor} teachtaireacht i bpriontáil",
    "You pinned a message" : "Chuir tú teachtaireacht i bpriontáil",
    "{actor} unpinned a message" : "Dhíphionáil {actor} teachtaireacht",
    "Message was automatically unpinned" : "Díphionáladh an teachtaireacht go huathoibríoch",
    "You unpinned a message" : "Dhíphionáil tú teachtaireacht",
    ...
    "{actor} set the conversation picture" : "Socraigh {actor} pictiúr an chomhrá",
    ...
    "Call %s" : "Glaoigh ar %s",
    "Chat with %s" : "Comhrá le %s",
    "An error occurred. Please contact your administrator." : "Tharla earráid. Déan teagmháil le do riarthóir le do thoil.",
    "App disabled" : "Aip díchumasaithe",
    "Conversation subfolders are disabled" : "Tá fo-fhillteáin chomhráite díchumasaithe",
    "Storage quota exceeded" : "Sáraíodh an cuóta stórála",
    "Could not prepare conversation folder" : "Níorbh fhéidir fillteán comhrá a ullmhú",
    "File not found" : "Comhad gan aimsiú",
    "Path must point to a file" : "Caithfidh an cosán pointeáil chuig comhad",
    "File is not inside the conversation draft folder for this room" : "Níl an comhad laistigh den fhillteán dréachta comhrá don seomra seo",
    ...
    "Missing %s field in header line" : "Réimse %s ar iarraidh sa líne ceanntásca",
    ...
    "{user} replied to your private message" : "D'fhreagair {user} do theachtaireacht phríobháideach",
    ...
    "Announcement" : "Fógra",
    "Conversation to inform a fixed audience, which can not be left." : "Comhrá chun lucht féachana socraithe a chur ar an eolas, nach féidir a fhágáil.",
    "Channel" : "Cainéal",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Craol comhrá do lucht féachana mór, áit nach féidir ach le modhnóirí postáil agus a bhfuil glaonna díchumasaithe.",
    "Classified conversation" : "Comhrá rúnda",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Comhrá faoi ghlas le haghaidh topaicí rúnda, agus rochtain phoiblí, aíonna, SIP agus taifeadtaí díchumasaithe.",
    "Default" : "Réamhshocrú",
    ...
    "Restricted conversation for internal presentations." : "Comhrá srianta le haghaidh cur i láthair inmheánacha.",
    "Voice room" : "Seomra gutha",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Glac páirt go díreach sa ghlao, rud atá iontach maith le haghaidh comhráite nó cruinnithe spontáineacha.",
    "Webinar" : "webinar",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Comhrá srianta leis an stocaireacht cumasaithe, oiriúnach do sheimineáir ghréasáin phoiblí.",
    ...
    "Open in full application" : "Oscail san fheidhmchlár iomlán",
    ...
    "Limit starting calls to certain groups" : "Teorainn a chur le glaonna a thosú do ghrúpaí áirithe",
    "Limit starting a call" : "Cuir teorainn le glao a thosú",
    "Limit starting calls" : "Cuir teorainn le glaonna tosaithe",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Nuair a roghnaítear grúpa amháin ar a laghad, ní féidir ach le baill de na grúpaí seo glao a thosú. Baineann sé seo le modhnóirí freisin, ach ní bhíonn aíonna ná úsáideoirí cónaidhme ina mbaill de na grúpaí seo riamh. Is féidir le gach duine glao a thosú fós nuair nach mbíonn aon ghrúpa roghnaithe.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "I gcás comhráite atá á óstáil ar fhreastalaí cónaidhme, is í cumraíocht an fhreastalaí óstach a bhaineann ina ionad.",
    ...
    "Trusted servers can be configured at {linkstart}Sharing settings page{linkend}." : "Is féidir freastalaithe iontaofa a chumrú ag {linkstart}Leathanach na socruithe a roinnt {linkend}.",
    "Beta" : "Béite",
    ...
    "Enable live transcription (generated by AI)" : "Cumasaigh trascríobh beo (ginte ag AI)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Cumasaigh trascríobh beo (Níl an aip trascríobh beo suiteáilte)",
    "Disable live translation" : "Díchumasaigh aistriúchán beo",
    "Enable live translation (generated by AI)" : "Cumasaigh aistriúchán beo (ginte ag AI)",
    "Original language" : "Teanga bhunaidh",
    "Live translations app is not installed" : "Níl an aip aistriúcháin bheo suiteáilte",
    "Original language: {languageName}" : "Teanga bhunaidh: {languageName}",
    "Translated language" : "Teanga aistrithe",
    "Translated language: {languageName}" : "Teanga aistrithe: {languageName}",
    ...
    "Multi-speaker view" : "Radharc ilchainteoirí",
    ...
    "Failed to enable live translations" : "Theip ar aistriúcháin bheo a chumasú",
    "Failed to disable live translations" : "Theip ar aistriúcháin bheo a dhíchumasú",
    ...
    "Page {page} of {pages}" : "Leathanach {page} de {pages}",
    "Collapse participant bar" : "Laghdaigh barra na rannpháirtithe",
    "Expand participant bar" : "Barra rannpháirtithe a leathnú",
    ...
    "Speaker" : "Cainteoir",
    "Microphone settings" : "Socruithe micreafóin",
    ...
    "You" : "tú",
    "You are sharing a screen" : "Tá tú ag roinnt scáileáin",
    "Sharing this window may cause a mirroring effect" : "D’fhéadfadh éifeacht scátháin a bheith mar thoradh ar an bhfuinneog seo a roinnt",
    ...
    "Enable" : "Cumasaigh",
    "The bot is not available anymore" : "Níl an bot ar fáil a thuilleadh",
    ...
    "Participants can use all available features." : "Is féidir le rannpháirtithe gach gné atá ar fáil a úsáid.",
    "Restricted" : "Srianta",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Gheobhaidh rannpháirtithe sraith gnéithe laghdaithe go dtí go dtabharfaidh modhnóir ceadanna breise de láimh.",
    ...
    "Live transcriptions app is not installed" : "Níl an aip trascríbhinní beo suiteáilte",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Tá an comhrá seo caomhnaithe. Ní féidir é a scriosadh agus ní féidir a theachtaireachtaí comhrá a ghlanadh.",
    ...
    "This setting can not be changed while the conversation is preserved." : "Ní féidir an socrú seo a athrú fad atá an comhrá á chaomhnú.",
    ...
    "The entered token does not match the conversation token" : "Ní hionann an comhartha a iontráladh agus an comhartha comhrá",
    "Preserve conversation" : "Coinnigh an comhrá",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Cé go bhfuil sé caomhnaithe, ní féidir an comhrá seo a scriosadh, ní féidir a stair comhrá a ghlanadh agus ní féidir na socruithe aíonna agus na socruithe inar féidir páirt a ghlacadh iontu a athrú.",
    "Only the owner can change whether this conversation is preserved." : "Ní féidir ach leis an úinéir athrú a dhéanamh ar cibé an gcaomhnófar an comhrá seo.",
    ...
    "Stop preserving" : "Stop a chaomhnú",
    "Stop preserving conversation" : "Stop a chur le comhrá a chaomhnú",
    "Conversation token" : "Comhartha comhartha",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Má stopann tú ag caomhnú an chomhrá seo, is féidir é a scriosadh, is féidir a stair comhrá a ghlanadh agus is féidir na haíonna agus na socruithe inar féidir páirt a ghlacadh iontu a athrú arís.",
    "Conversation" : "Comhrá",
    "To confirm, type the conversation token into the field below:" : "Chun a dheimhniú, clóscríobh an comhartha comhrá sa réimse thíos:",
    "Ongoing" : "Ar siúl",
    ...
    "Join conversations" : "Bí páirteach i gcomhráite",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Taispeántar imeachtaí féilire le nasc comhrá mar shuíomh anseo",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Is luachanna scartha le camóga (CSV) an fhormáid ábhair:<br/>- Tá líne ceanntásca riachtanach agus ní mór di a bheith mar an gcéanna le {sample1} nó le {sample2} amháin</br/>- Iontráil amháin in aghaidh na líne (m.sh. {sample3})",
    ...
    "Remove all tags" : "Bain na clibeanna go léir",
    "Rename tag" : "Athainmnigh an clib",
    "Delete tag" : "Scrios clib",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "An bhfuil tú cinnte gur mhaith leat \"{name}\" a scriosadh? Bogfar comhráite leis an gclib seo go \"Eile\".",
    "Move up" : "Bog suas",
    "Move down" : "Bog síos",
    "Pending invitations" : "Cuirí ar feitheamh",
    "Join conversations from other servers" : "Glac páirt i gcomhráite ó fhreastalaithe eile",
    ...
    "Mentions" : "Luann",
    "Meetings" : "Cruinnithe",
    "Sort conversations" : "Sórtáil comhráite",
    "By recent activity" : "De réir gníomhaíochta le déanaí",
    "Alphabetically" : "In ord aibítre",
    "Do not group by type" : "Ná grúpáil de réir cineáil",
    "Show private ones first" : "Taispeáin cinn phríobháideacha ar dtús",
    "Show group ones first" : "Taispeáin cinn na ngrúpaí ar dtús",
    ...
    "Search in app" : "Cuardaigh san aip",
    ...
    "SIP backend is not installed" : "Níl an cúltaca SIP suiteáilte",
    ...
    "Enable noise suppression" : "Cumasaigh cosc ​​torainn",
    "Reduce background noises for better voice quality" : "Laghdaigh torann cúlra le haghaidh caighdeán gutha níos fearr",
    "Basic" : "Bunúsach",
    "Advanced" : "Casta",
    "Enable echo cancellation" : "Cumasaigh cealú macalla",
    "Minimize echo effect from own surrounding" : "Íoslaghdaigh éifeacht macalla ón timpeallacht féin",
    "Enable auto gain control" : "Cumasaigh rialú uathoibríoch gnóthachain",
    "Dynamically adjust microphone volume for consistent level" : "Coigeartaigh toirt an mhicreafóin go dinimiciúil le haghaidh leibhéal comhsheasmhach",
    ...
    "Recording backend is not installed" : "Níl an chúltaca taifeadta suiteáilte",
    ...
    "7 days" : "7 lá",
    "30 days" : "30 lá",
    "Until unpin" : "Go dtí go ndíphionálfar",
    "Clear reminder – {timeLocale}" : "Glan meabhrúchán - {timeLocale}",
    "Edited by {actor}" : "Arna chur in eagar ag {actor}",
    "Pinned by you" : "Bioránta agatsa",
    "Pinned by {actor}" : "Bioránta ag {actor}",
    "Until {absoluteDate}" : "Go dtí {absoluteDate}",
    ...
    "Pin message" : "Teachtaireacht bioráin",
    "Unpin message" : "Bain teachtaireacht den bhiorán ",
    ...
    "Keep pinned for" : "Coinnigh bioránta le haghaidh",
    "Set custom period" : "Socraigh tréimhse saincheaptha",
    ...
    "This translation is AI generated and may contain mistakes." : "Is aistriúchán ginte ag hintleacht shaorga é seo agus d’fhéadfadh botúin a bheith ann.",
    "Copy translated text" : "Cóipeáil téacs aistrithe",
    "Error when scheduling the message" : "Earráid agus an teachtaireacht á sceidealú",
    "Reschedule" : "Athsceidealú",
    "Send now" : "Seol anois",
    "Choose a time" : "Roghnaigh am",
    "Send at custom time" : "Seol ag am saincheaptha",
    "Will be sent without notification" : "Seolfar gan fógra",
    ...
    "Reply to thread \"{threadTitle}\"" : "Freagra ar an snáithe \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Vótáil tú • %n vóta","Vótáil tú • %n vótaí","Vótáil tú • %n vótaí","Vótáil tú • %n vótaí","Vótáil tú • %n vótaí"],
    "You voted" : "Vótáil tú",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Cliceáil chun vótáil • %n vóta","Cliceáil chun vótáil • %n vótaí","Cliceáil chun vótáil • %n vótaí","Cliceáil chun vótáil • %n vótaí","Cliceáil chun vótáil • %n vótaí"],
    "Click to vote" : "Cliceáil chun vótáil",
    ...
    "Generate summary with AI" : "Achoimre a ghiniúint le hintleacht shaorga",
    "{author} (pinned by you)" : "{author} (bioránta agatsa)",
    "{author} (pinned by {actor})" : "{author} (bioránta ag {actor})",
    "Unpin" : "Díbhioráil",
    ...
    "Conversation type" : "Cineál comhrá",
    "Default parameters are:" : "Is iad na paraiméadair réamhshocraithe ná:",
    "These settings can be changed once the conversation is created." : "Is féidir na socruithe seo a athrú a luaithe a chruthaítear an comhrá.",
    ...
    "Message will be sent {datetimeString}" : "Seolfar an teachtaireacht chuig {datetimeString}",
    ...
    "Message was successfully scheduled" : "Sceidealaíodh an teachtaireacht go rathúil",
    ...
    "Show scheduled messages" : "Taispeáin teachtaireachtaí sceidealaithe",
    "Cancel editing" : "Cealaigh eagarthóireacht",
    "Schedule message" : "Teachtaireacht sceidealaithe",
    ...
    "Voice message {time} ({conversation})" : "Teachtaireacht ghutha {time} ({conversation})",
    ...
    "Standard image quality" : "Cáilíocht íomhá caighdeánach",
    "Original image quality" : "Cáilíocht íomhá bhunaidh",
    "View-only for others" : "Amharc amháin do dhaoine eile",
    "Editable by others" : "Is féidir le daoine eile eagarthóireacht a dhéanamh air",
    ...
    "Post messages" : "Postáil teachtaireachtaí",
    "Post messages and reactions" : "Postáil teachtaireachtaí agus frithghníomhartha",
    "Add reactions" : "Cuir frithghníomhartha leis",
    ...
    "Withdraw vote" : "Tarraing siar vóta",
    "Results" : "Torthaí",
    "Download as spreadsheet" : "Íoslódáil mar scarbhileog",
    "Download as CSV" : "Íoslódáil mar CSV",
    ...
    "The last moderator of a conversation can not be demoted" : "Ní féidir modhnóir deireanach comhrá a ísliú céime",
    "Could not change the type of the participant" : "Níorbh fhéidir cineál an rannpháirtí a athrú",
    ...
    "Promote to owner" : "Ardú céime chuig úinéir",
    "Demote from moderator" : "Léim as an modhnóir",
    "Promote to moderator" : "Cur chun cinn chuig modhnóir",
    "Demote from owner to moderator" : "Ísligh ó úinéir go modhnóirÍsligh ó úinéir go modhnóir",
    "Demote from owner to participant" : "Ísligh ó úinéir go rannpháirtí",
    ...
    "Pinned by a deleted user" : "Bioránta ag úsáideoir scriosta",
    ...
    "I picked the list style" : "Roghnaigh mé an stíl liosta",
    ...
    "Chat appearance" : "Cuma comhrá",
    "Messages list" : "Liosta teachtaireachtaí",
    "Message bubbles" : "Bolgáin teachtaireachta",
    ...
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "Níl sé ar fáil faoi láthair ar iPhone agus iPad mar gheall ar shrianta teicniúla ón monaróir",
    "Notification settings" : "Socruithe fógra",
    "Sounds for chat and call notifications" : "Fuaimeanna le haghaidh fógraí comhrá agus glaonna",
    "Invalid language ({languageId})" : "Teanga neamhbhailí ({languageId})",
    "Default language" : "Teanga réamhshocraithe",
    "Default language ({languageName})" : "Teanga réamhshocraithe ({languageName})",
    "Error when trying to load the available live translation languages" : "Earráid agus iarracht á déanamh na teangacha aistriúcháin bheo atá ar fáil a luchtú",
    "Error when trying to set live translation language" : "Earráid agus iarracht á déanamh teanga aistriúcháin bheo a shocrú",
    "Set language used to show the transcriptions" : "Socraigh an teanga a úsáidtear chun na trascríbhinní a thaispeáint",
    ...
    "Turn camera and microphone off by default" : "Múch an ceamara agus an micreafón de réir réamhshocraithe",
    "Blur camera background by default" : "Doiléirigh cúlra an cheamara de réir réamhshocraithe",
    "Skip device preview before joining a call" : "Seachain réamhamharc gléis sula dtéann tú isteach i nglao",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Múchfar an ceamara nuair a bheidh tú ag glacadh páirte. Taispeántar i gcónaí é má tá toiliú taifeadta ag teastáil.",
    "Appearance & Sounds" : "Dealramh & Fuaimeanna",
    "Privacy" : "Príobháideacht",
    "Send read receipts" : "Seol admhálacha léite",
    "When off, all read statuses will be hidden" : "Nuair a bhíonn sé múchta, beidh gach stádas léite i bhfolach",
    "Share typing status" : "Comhroinn stádas clóscríofa",
    "When off, all typing indicators will be hidden" : "Nuair a bhíonn sé múchta, beidh na táscairí clóscríofa go léir i bhfolach",
    "Attachments folder" : "Fillteán ceangaltáin",
    "Toggle full screen" : "Scoránaigh scáileán iomlán",
    "Return to Home screen" : "Fill ar ais go dtí an scáileán baile",
    "Shortcuts while in a chat" : "Aicearraí agus tú i gcomhrá",
    ...
    "The server was updated, you cannot start or join a call." : "Nuashonraíodh an freastalaí, ní féidir leat glao a thosú ná páirt a ghlacadh ann.",
    ...
    "React with {reaction}" : "Freagair le {reaction}",
    ...
    "Scheduled messages" : "Teachtaireachtaí sceidealaithe",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n nóiméad neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n nóiméad neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n nóiméad neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n nóiméad neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n nóiméad neamhghníomhaíochta."],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n lá neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n lá neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n lá neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n lá neamhghníomhaíochta.","Scriosfar an comhrá seo go huathoibríoch do gach duine tar éis %n lá neamhghníomhaíochta."],
    ...
    "Scheduled {datetime}" : "Sceidealaithe {datetime}",
    "Scheduled for {datetime}" : "Sceidealaithe do {datetime}",
    "Search" : "Cuardach",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Osclaíodh an comhrá seo i gcluaisín eile. Ní thacaíonn an leagan reatha den fhreastalaí le comhrá a oscailt i roinnt cluaisíní.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Haigh! An bhfuil tú ag úsáid an stíl liosta nó boilgeoga teachtaireachta?",
    ...
    "Jabber ID" : "ID Jabber",
    "Pinned messages" : "Teachtaireachtaí bioránta",
    "Media" : "Meáin",
    "Polls" : "Pobalbhreith",
    ...
    "Audio" : "Fuaime",
    "Show all pinned messages" : "Taispeáin na teachtaireachtaí uile atá bioránta",
    ...
    "The server was updated." : "Nuashonraíodh an freastalaí.",
    ...
    "Error while changing the preserved status of the conversation" : "Earráid agus stádas caomhnaithe an chomhrá á athrú",
    ...
    "Error renaming tag" : "Earráid ag athainmniú an chlib",
    "Error deleting tag" : "Earráid ag scriosadh an chlib",
    "Error reordering tags" : "Earráid ag athordú na gclibeanna",
    ...
    "The server is in maintenance mode." : "Tá an freastalaí i mód cothabhála.",
    "Federated server was updated." : "Nuashonraíodh an freastalaí cónaidhme.",
    ...
    "In {hours} and {minutes}" : "I gceann {hours} agus {minutes}",
    ...
    "Message link copied to clipboard" : "Nasc teachtaireachta cóipeáilte chuig an ghearrthaisce",
    ...
    "Away" : "Amach",
    "Microphone {number}" : "Micreafón {number}",
    "Camera {number}" : "Ceamara {number}",
    "Speaker {number}" : "Cainteoir {number}",
    ...
    "Call summary - {title}" : "Achoimre ar an nglao - {title}",
    ...
    "Always shown if recording consent is required" : "Taispeántar i gcónaí má tá toiliú taifeadta ag teastáil",
