OC.L10N.register(
    ...
    "You were invited to conversation \"%s.\"" : "Tugadh cuireadh duit chuig an gcomhrá \"%s.\"",
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Lig do na comhráite sreabhadh: luaigh úsáideoirí, freagairt do theachtaireachtaí agus tuilleadh\n\nIs féidir leat gach duine i gcomhrá %s a lua nó rannpháirtithe ar leith a lua trí \"@\" a chlóscríobh agus a n-ainm a phiocadh ón liosta.",
