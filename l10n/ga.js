OC.L10N.register(
    ...
    "Call with {user1}, {user2}, {user3} and {user4} (Duration {duration})" : "Glao le {user1}, {user2}, {user3} agus {user4} (Aga {duration})",
    ...
    "Call with {user1}, {user2}, {user3}, {user4} and {user5} (Duration {duration})" : "Glaoigh le {user1}, {user2}, {user3}, {user4} agus {user5} (Fad {duration})",
    ...
    "Unban" : "Dícosc",
    "<strong>Banned by:</strong> {actor}" : "<strong>Toirmiscthe ag:</strong> {actor}",
    "<strong>Note:</strong> {note}" : "<strong>Nóta:</strong> {nóta}",
    ...
    "Channel ID or name" : "ID cainéal nó ainm",
    "Channel" : "Cainéal",
    ...
    "Password protect" : "Pasfhocal a chosaint",
    ...
    "<strong>Date:</strong> {date}" : "<strong>Dáta:</strong> {date}",
    "Media" : "Meáin",
    "Polls" : "Pobalbhreith",
    ...
    "iOS app" : "aip iOS",
    "- You can now react to chat message" : "- Is féidir leat freagairt anois don teachtaireacht chomhrá",
    ...
    "{actor} opened the conversation to registered and guest app users" : "D'oscail {actor} an comhrá d'úsáideoirí cláraithe agus d'aoi-úsáideoirí aipeanna",
    "You opened the conversation to registered and guest app users" : "D'oscail tú an comhrá d'úsáideoirí cláraithe agus d'aoi-úsáideoirí aipeanna",
    "An administrator opened the conversation to registered and guest app users" : "D'oscail riarthóir an comhrá d'úsáideoirí cláraithe agus aoi-úsáideoirí aipeanna",
    "{actor} invited {user}" : "Thug {aisteoir} cuireadh do {user}",
    "You invited {user}" : "Thug tú cuireadh do {user}",
    "An administrator invited {user}" : "Thug riarthóir cuireadh do {user}",
    "{actor} added circle {circle}" : "Chuir {aisteoir} ciorcal {circle} leis",
    "You added circle {circle}" : "Chuir tú ciorcal {circle} leis",
    "An administrator added circle {circle}" : "Chuir riarthóir ciorcal {circle} leis",
    "{actor} removed circle {circle}" : "Bhain {actor} ciorcal {circle}",
    "You removed circle {circle}" : "Bhain tú ciorcal {circle}",
    "An administrator removed circle {circle}" : "Bhain riarthóir ciorcal {circle}",
    "More unread mentions" : "Tuilleadh tagairtí gan léamh",
    "{user1} shared room {roomName} on {remoteServer} with you" : "Roinn {user1} seomra {roomName} ar {remoteServer} leat",
    "Messages in {conversation}" : "Teachtaireachtaí i {conversation}",
    "Path is already shared with this room" : "Tá an chonair roinnte leis an seomra seo cheana féin",
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat integration!** Nextcloud Talk comes with a simple text chat. Allowing you to share files from your Nextcloud and mentioning other participants.\n* 👥 **Private, group, public and password protected calls!** Just invite somebody, a whole group or send a public link to invite to a call.\n* 💻 **Screen sharing!** Share your screen with participants of your call. You just need to use Firefox version 66 (or newer), latest Edge or Chrome 72 (or newer, also possible using Chrome 49 with this [Chrome extension](https://chrome.google.com/webstore/detail/screensharing-for-nextclo/kepnpjhambipllfmgmbapncekcmabkol)).\n* 🚀 **Integration with other Nextcloud apps** like Files, Contacts and Deck. More to come.\n\nAnd in the works for the [coming versions](https://github.com/nextcloud/spreed/milestones/):\n* ✋ [Federated calls](https://github.com/nextcloud/spreed/issues/21), to call people on other Nextclouds" : "Comhrá, físchomhdháil & closchomhdháil ag úsáid WebRTC\n\n* 💬 **Comhtháthú comhrá!** Tagann Nextcloud Talk le comhrá téacs simplí. Ligeann sé duit comhaid a roinnt ó do Nextcloud agus rannpháirtithe eile a lua.\n* 👥 **Glaonna príobháideacha, grúpa, poiblí agus cosanta ag pasfhocal!** Tabhair cuireadh do dhuine éigin, do ghrúpa iomlán nó seol nasc poiblí chun cuireadh a thabhairt do ghlao.\n* 💻 **Scáileán a roinnt!** Roinn do scáileán le rannpháirtithe do ghlao. Níl le déanamh agat ach leagan 66 (nó níos nuaí) de Firefox a úsáid, an Edge nó Chrome 72 is déanaí (nó níos nuaí, is féidir Chrome 49 a úsáid leis an [síneadh Chrome] seo (https://chrome.google.com/webstore/detail/screensharing-for-nextclo/kepnpjhambipllfmgmbapncekcmabkol)).\n* 🚀 **Comhtháthú le haipeanna eile Nextcloud** cosúil le Comhaid, Teagmhálacha agus Deic. Tuilleadh le teacht.\n\nAgus sna saothair do na [leaganacha atá le teacht]( https://github.com/nextcloud/spreed/milestones/):\n* ✋ [Glaonna Cónaidhme]( https://github.com/nextcloud/spreed/issues/21 ), chun glaoch ar dhaoine ar Nextclouds eile",
    "Commands" : "Orduithe",
    "Deprecated" : "Dímheasta",
    "Command" : "Ordú",
    "Script" : "Script",
    ...
    "Setup summary" : "Achoimre ar an socrú",
    "Also open to guest app users" : "Chomh maith leis sin oscailte d'úsáideoirí aip aoi",
    "Circles" : "Ciorcail",
    "Users, groups and circles" : "Úsáideoirí, grúpaí agus ciorcail",
    "Users and circles" : "Úsáideoirí agus ciorcail",
    "Groups and circles" : "Grúpaí agus ciorcail",
    "Creating your conversation" : "Ag cruthú do chomhrá",
    "All set" : "Gach sraith",
    ...
    "The participant will not be notified about this message" : "Ní thabharfar fógra don rannpháirtí faoin teachtaireacht seo",
    "The participants will not be notified about this message" : "Ní chuirfear na rannpháirtithe ar an eolas faoin teachtaireacht seo",
    "Add circles" : "Cuir ciorcail leis",
    ...
    "Meeting ID: {meetingId}" : "Aitheantas an chruinnithe: {meetingId}",
    "Your PIN: {attendeePin}" : "Do UAP: {attendeePin}",
    "Start a conversation" : "Cuir tús le comhrá",
    "Mention room" : "Luaigh seomra",
    "Post to conversation" : "Postáil chuig an gcomhrá",
    "Share to conversation" : "Roinn chuig an gcomhrá",
    "Specify commands the users can use in chats" : "Sonraigh na horduithe is féidir leis na húsáideoirí a úsáid i gcomhráite",
    "Delete Conversation" : "Scrios Comhrá",
    "Remove circle and members" : "Bain ciorcal agus baill",
    "Phone number could not be hanged up" : "Níorbh fhéidir an uimhir theileafóin a chrochadh",
    "Phone number could not be putted on hold" : "Níorbh fhéidir uimhir theileafóin a chur ar fionraí"
},
