OC.L10N.register(
    ...
    "- Add other participants to a one-to-one call to create a new group call on the fly" : "- Дадайце іншых удзельнікаў да індывідуальнага выкліку, каб адразу стварыць новы групавы выклік",
    ...
    "Say hi to your friends and colleagues!" : "Павітайцеся з сябрамі і калегамі!",
    ...
    "{user} invited you to a group conversation: {call}" : "{user} запрасіў(-ла) вас у групавую размову: {call}",
    ...
    "A group call has started in {call}" : "Групавы выклік пачаўся ў {call}",
    ...
    "Limit creating a public and group conversation" : "Абмежаваць стварэнне публічных і групавых размоў",
    ...
    "Done" : "Гатова",
    "Original language: {languageName}" : "Арыгінальная мова: {languageName}",
    "Translated language" : "Мова перакладу",
    "Translated language: {languageName}" : "Мова перакладу: {languageName}",
    ...
    "Start a group conversation" : "Пачаць групавую размову",
    ...
    "Remove all tags" : "Выдаліць усе тэгі",
    "Rename tag" : "Перайменаваць тэг",
    ...
    "New group conversation" : "Новая групавая размова",
    ...
    "7 days" : "7 дзён",
    "30 days" : "30 дзён",
    "Until unpin" : "Пакуль не адмацуецца",
    "Clear reminder – {timeLocale}" : "Ачысціць напамін – {timeLocale}",
    "Edited by {actor}" : "Адрэдагаваў(-ла) {actor}",
    "Pinned by you" : "Замацавана вамі",
    "Pinned by {actor}" : "Замацаваў(-ла) {actor}",
    "Until {absoluteDate}" : "Да {absoluteDate}",
    ...
    "Pin message" : "Замацаваць паведамленне",
    "Unpin message" : "Адмацаваць паведамленне",
    ...
    "Keep pinned for" : "Замацоўваць на працягу",
    "Set custom period" : "Уласны перыяд",
    ...
    "Error when scheduling the message" : "Памылка пры планаванні паведамлення",
    "Reschedule" : "Запланаваць паўторна",
    "Send now" : "Адправіць зараз",
    "Choose a time" : "Выберыце час",
    "Send at custom time" : "Адправіць у зададзены час",
    "Will be sent without notification" : "Будзе адпраўлена без апавяшчэння",
    ...
    "{author} (pinned by you)" : "{author} (замацавана вамі)",
    "{author} (pinned by {actor})" : "{author} (замацаваў(-ла) {actor})",
    "Unpin" : "Адмацаваць",
    ...
    "Create a new group conversation" : "Стварыць новую групавую размову",
    ...
    "Message will be sent {datetimeString}" : "Паведамленне будзе адпраўлена {datetimeString}",
    ...
    "Message was successfully scheduled" : "Паведамленне паспяхова запланавана",
    ...
    "Show scheduled messages" : "Паказаць запланаваныя паведамленні",
    "Cancel editing" : "Скасаваць рэдагаванне",
    "Schedule message" : "Запланаваць паведамленне",
    ...
    "A new group conversation with selected participant will be created" : "Будзе створана новая групавая размова з выбраным удзельнікам",
    "Participants" : "Удзельнікі",
    "Pinned by a deleted user" : "Замацавана выдаленым карыстальнікам",
    ...
    "Chat appearance" : "Выгляд чата",
    "Messages list" : "Спіс паведамленняў",
    ...
    "Default language ({languageName})" : "Прадвызначаная мова ({languageName})",
    ...
    "Scheduled messages" : "Запланаваныя паведамленні",
    ...
    "Scheduled {datetime}" : "Запланавана {datetime}",
    "Scheduled for {datetime}" : "Запланавана на {datetime}",
    "Search" : "Пошук",
    ...
    "Another user" : "Іншы карыстальнік",
    ...
    "Pinned messages" : "Замацаваныя паведамленні",
    "Media" : "Медыя",
    "Polls" : "Апытанні",
    ...
    "Audio" : "Аўдыя",
    "Show all pinned messages" : "Паказаць усе замацаваныя паведамленні",
    ...
    "_%n hour_::_%n hours_" : ["%n гадзіну","%n гадзіны","%n гадзін","%n гадзін"],
