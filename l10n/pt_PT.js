OC.L10N.register(
    ...
    "A (now) deleted user mentioned you in a group chat: %s" : "Um (agora) utilizador removido mencionou-o numa conversa de grupo: %s",
    "A (now) deleted user mentioned you in a group chat: {call}" : "Um (agora) utilizador removido mencionou-o numa conversa de grupo: {chamada}",
    "A (now) deleted user mentioned you in a group chat" : "Um (agora) utilizador removido mencionou-o numa conversa de grupo"
},
