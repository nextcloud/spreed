OC.L10N.register(
    ...
    "Storage quota exceeded" : "Kvote je premašena",
    ...
    "Enable live transcription (generated by AI)" : "Omogući pretvaranje u tekst uživo (generirano umjetnom inteligencijom)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Omogući pretvaranje u tekst uživo (Aplikacija generiranja umjetnom inteligencijom nije instalirana)",
    "Disable live translation" : "Onemogući prijevod uživo",
    "Enable live translation (generated by AI)" : "Omogući prijevod uživo (generirano umjetnom inteligencijom)",
    "Original language" : "Originalni jezik",
    "Live translations app is not installed" : "Aplikacija za prijevod uživo nije instalirana",
    ...
    "Live transcriptions app is not installed" : "Aplikacija za pretvaranje u tekst nije instaliranja",
    ...
    "Join conversations from other servers" : "Pridruži se razgovorima s drugih poslužitelja",
    ...
    "Meetings" : "Sastanci",
    "Sort conversations" : "Sortiraj razgovore",
    "By recent activity" : "Prema nedavnoj aktivnosti",
    "Alphabetically" : "Abecedno",
    "Do not group by type" : "Ne grupiraj po tipu",
    "Show private ones first" : "Prvo prikaži privatne",
    "Show group ones first" : "Prvo prikaži grupne",
    ...
    "SIP backend is not installed" : "SIP pozadinski sustav nije instaliran",
    ...
    "Enable noise suppression" : "Omogući uklanjanje šuma",
    "Reduce background noises for better voice quality" : "Smanjite pozadinske šumove za bolju kvalitetu glasa",
    "Enhanced noise suppression" : "Poboljšano uklanjanje šuma",
    "Use \"{modelName}\" real-time noise suppression algorithm" : "Koristi \"{modelName}\" algoritam za uklanjanje šuma u stvarnom vremenu",
    ...
    "Recording backend is not installed" : "Pozadinski sustav za snimanje nije instaliran",
    ...
    "_You voted • %n vote_::_You voted • %n votes_" : ["Glasali ste • %n glas","Glasali ste • %n glasa","Glasali ste • %n glasova"],
    "You voted" : "Glasali ste",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Glasajte • %n glas","Glasajte • %n glasa","Glasajte • %n glasova"],
    "Click to vote" : "Klikni za glasanje",
    ...
    "Generate summary with AI" : "Generiraj sažetak pomoću umjetne inteligencije",
    ...
    "Voice message {time} ({conversation})" : "Glasovna poruka {time} ({conversation})",
    ...
    "I picked the list style" : "Odabrao sam stil popisa",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Ovaj razgovor je otvoren u drugoj kartici. Trenutna verzija poslužitelja ne podržava otvaranje razgovora u više kartica.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hej! Koristite li prikaz u obliku popisa ili oblačiće poruka?",
    ...
    "The server was updated." : "Poslužitelj je ažuriran.",
    ...
    "The server is in maintenance mode." : "Poslužitelj je u načinu održavanja.",
    "Federated server was updated." : "Udruženi poslužitelj je ažuriran.",
