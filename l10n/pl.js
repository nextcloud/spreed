OC.L10N.register(
    ...
    ", " : ",",
    "%s invited you to a conversation." : "%szaprosił cię na rozmowę. ",
    ...
    "%s invited you to a private conversation" : "%szaprosił Ciebie na prywatną rozmowę",
    "{user} invited you to a private conversation" : "{user} zaprosił Ciebie na prywatną rozmowę",
    "%s invited you to a group conversation: %s" : "%szaprosił Cię na rozmowę grupową: %s ",
    "{user} invited you to a group conversation: {call}" : "{user} zaprosił Cię na rozmowę grupową: {call}",
    "%s invited you to a group conversation" : "%szaprosił Ciebie na rozmowę grupową",
    "{user} invited you to a group conversation" : "{user} zaprosił Ciebie na rozmowę grupową",
    ...
    "Video & audio-conferencing using WebRTC\n\n* 💬 **Chat integration!** Nextcloud Talk comes with some simple text chat since Nextcloud 13. More features are planned for future versions.\n* 👥 **Private, group, public and password protected calls!** Just invite somebody, a whole group or send a public link to invite to a call.\n* 💻 **Screen sharing!** Share your screen with participants of your call.\n* 🚀 **Integration with other Nextcloud apps!** Currently Contacts and users – more to come.\n* 🙈 **We’re not reinventing the wheel!** Based on the great [simpleWebRTC](https://simplewebrtc.com/) library.\n\nAnd in the works for the [coming versions](https://github.com/nextcloud/spreed/milestones/):\n* ✋ [Federated calls](https://github.com/nextcloud/spreed/issues/21), to call people on other Nextclouds" : "Konferencje wideo i audio z wykorzystaniem WebRTC * 💬 ** Integracja czatu! ** NextCloud Talk zawiera prosty czat tekstowy od NextCloud 13. Więcej funkcji jest planowanych dla przyszłych wersji. * 👥 ** Prywatne, grupowe, publiczne i hasło połączenia chronione! ** Po prostu zaproś kogoś, całą grupę lub wyślij publiczny link, aby zaprosić na rozmowę. * 💻 ** Udostępnianie ekranu! ** Udostępnij swój ekran uczestnikom twojego połączenia. * 🚀 ** Integracja z innymi Aplikacje NextCloud! ** Obecnie Kontakty i użytkownicy - jeszcze więcej. * * ** Nie odkrywamy koła! ** Na podstawie świetnej [simpleWebRTC] (https://simplewebrtc.com/) biblioteki. I w pracach dla [najbliższych wersji] (https://github.com/nextcloud/spreed/milestones/): * ✋ [Federated calls] (https://github.com/nextcloud/spreed/issues/21 ), aby dzwonić do osób z innych Nexcloud",
    ...
    "%s Talk on your mobile devices" : "%sRozmawiaj na urządzeniach mobilnych",
    ...
    "%s …" : "%s …",
    "… %s …" : "… %s …",
    "%s mentioned you in a private conversation" : "%swspomniałem o Tobie w prywatnej rozmowie ",
    "%s mentioned you in a group conversation: %s" : "%swspomniałem o Tobie w rozmowie grupowej: %s ",
    "{user} mentioned you in a group conversation: {call}" : "{user} wspomniał o Tobie w rozmowie grupowej: {call}",
    "%s mentioned you in a group conversation" : "%swspomniałem o Tobie w rozmowie grupowej ",
    "{user} mentioned you in a group conversation" : "{user} wspomniał o Tobie w rozmowie grupowej",
    "You were mentioned in a group conversation by a deleted user: %s" : "Wspomniano Ciebie w rozmowie grupowej przez usuniętego użytkownika: %s",
    ...
    "You were mentioned in a group conversation by a deleted user" : "Wspomniano Ciebie w rozmowie grupowej przez usuniętego użytkownika",
