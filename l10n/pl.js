OC.L10N.register(
    ...
    "Please enter the password for this call" : "Wprowadź hasło dla tej rozmowy telefonicznej",
    "Password required" : "Wymagane hasło",
    "Password" : "Hasło",
    "Cancel" : "Anuluj",
    "Submit" : "Zatwierdź",
    "Leave call" : "Opuść rozmowę telefoniczną",
    "Join call" : "Dołącz do rozmowy telefonicznej",
    "Start call" : "Rozpocznij rozmowę telefoniczną",
    ...
    "No other people in this call" : "W tej rozmowie telefonicznej nie uczestniczą inne osoby",
    "Waiting for {participantName} to join the call …" : "Oczekiwanie na {participantName} by przyłączyć się do rozmowy telefonicznej…",
    "Waiting for others to join the call …" : "Czekamy na innych aby przyłączyć się do rozmowy telefonicznej…",
    ...
    "Never notify" : "Nigdy nie powiadomi",
    ...
    "You attended a call with {user1}" : "Brałeś udział w rozmowie telefonicznej z {user1}",
    "_%n guest_::_%n guests_" : ["%n gość","%gości","%n gości","%n gości"],
    "You attended a call with {user1} and {user2}" : "Brałeś udział w rozmowie telefonicznej z {user1} i {user2}",
    "You attended a call with {user1}, {user2} and {user3}" : "Brałeś udział w rozmowie z {user1}, {user2} i {user3}",
    "You attended a call with {user1}, {user2}, {user3} and {user4}" : "Brałeś udział w rozmowie telefonicznej z {user1}, {user2}, {user3} i {user4}",
    "You attended a call with {user1}, {user2}, {user3}, {user4} and {user5}" : "Brałeś udział w rozmowie telefonicznej z {user1}, {user2}, {user3}, {user4} i {user5}",
    "_%n other_::_%n others_" : ["innym","%ninnymi","%n innymi","%n innymi"],
    "{actor} invited you to {call}" : "{actor} zaprosił Cię do {call}",
    "You were invited to a <strong>talk</strong> room or had a <strong>call</strong>" : "Otrzymano zaproszenie do pokoju <strong>rozmów</strong> lub masz <strong>rozmowę telefoniczną </strong>",
    "{actor} created the conversation" : "{actor} utworzył rozmowę",
    "You created the conversation" : "Utworzyłeś rozmowę",
    "{actor} started a call" : "{actor} rozpoczął rozmowę telefoniczną",
    "You started a call" : "Zadzwoniłeś",
    "{actor} joined the call" : "{actor} dołączył do rozmowy telefonicznej",
    "You joined the call" : "Dołączyłeś do rozmowy telefonicznej",
    "{actor} left the call" : "{actor} wyszedł z rozmowy telefonicznej",
    "You left the call" : "Wyszedłeś z rozmowy telefonicznej",
    "{actor} allowed guests" : "{actor} dopuszczone goście",
    ...
    "{actor} removed you" : "{actor} usunąłem cię",
    "Call with {user1} and {user2} (Duration {duration})" : "Rozmowa telefoniczna z {user1} i {user2} (Czas trwania {duration})",
    "Call with {user1}, {user2} and {user3} (Duration {duration})" : "Rozmowa telefoniczna z {user1}, {user2} i {user3} (Czas trwania {duration})",
    "Call with {user1}, {user2}, {user3} and {user4} (Duration {duration})" : "Rozmowa telefoniczna z {user1}, {user2}, {user3} i {user4} (Czas trwania {duration})",
    "Call with {user1}, {user2}, {user3}, {user4} and {user5} (Duration {duration})" : "Rozmowa telefoniczna z {user1}, {user2}, {user3}, {user4} i {user5} (Czas trwania {duration})",
    ...
    "A group call has started in {call}" : "Rozmowa telefoniczna grupowa została rozpoczęta w {call}",
    "A group call has started" : "Rozmowa  telefoniczna grupowa została rozpoczęta",
