OC.L10N.register(
    ...
    "You can set your name on the right sidebar so other participants can identify you better." : "Możesz ustawić swoje imię i nazwisko na prawym pasku bocznym, aby inni uczestnicy mogli Cię lepiej zidentyfikować.",
    "Copy" : "Skopiuj",
    "Copied!" : "Skopiowano!",
    ...
    "Send" : "Wyślij",
    "No messages yet, start the conversation!" : "Brak wiadomości, zacznij konwersację!",
    ...
    "You attended a call with {user1}" : "Próbowałeś(aś) rozmowy z {user1}",
    "_%n guest_::_%n guests_" : ["%n gość","%gości","%n gości","%n gości"],
    "You attended a call with {user1} and {user2}" : "Próbowałeś(aś) rozmowy z {user1} i {user2}",
    "You attended a call with {user1}, {user2} and {user3}" : "Próbowałeś(aś) rozmowy z {user1}, {user2} i {user3}",
    "You attended a call with {user1}, {user2}, {user3} and {user4}" : "Próbowałeś(aś) rozmowy z {user1}, {user2}, {user3} i {user4}",
    ...
    "%s …" : "%s ...",
    "… %s …" : "... %s ...",
    "%s mentioned you in a private chat" : "%s wspomniał o Tobie w prywatnym czacie",
    "{user} mentioned you in a private chat" : "{user} wspomniał o Tobie w prywatnym czacie",
    "%s mentioned you in a group chat: %s" : "%swspomniał o Tobie w grupie czatów: %s ",
    "{user} mentioned you in a group chat: {call}" : "{user} wspomniał o Tobie w grupie czatów: {call}",
    "%s mentioned you in a group chat" : "%swspomniał o Tobie w grupie czatów ",
    "{user} mentioned you in a group chat" : "{user} wspomniał o Tobie w grupie czatów",
    "A (now) deleted user mentioned you in a group chat: %s" : "Pewien (obecnie) usunięty użytkownik wspomniał o Tobie w grupie czatów: %s",
    "A (now) deleted user mentioned you in a group chat: {call}" : "Pewien (obecnie) usunięty użytkownik wspomniał o Tobie w grupie czatów: {call}",
    "A (now) deleted user mentioned you in a group chat" : "Pewien (obecnie) usunięty użytkownik wspomniał o Tobie w grupie czatów",
    "A guest mentioned you in a group chat: %s" : "Gość wspomniał o Tobie w grupie czatów: %s",
    "A guest mentioned you in a group chat: {call}" : "Gość wspomniał o Tobie w grupie czatów: {call}",
    "A guest mentioned you in a group chat" : "Gość wspomniał o Tobie w grupie czatów",
