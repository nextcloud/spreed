OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Pozwól rozmowom przebiegać: wspominaj użytkowników, reaguj na wiadomości i nie tylko\n\nMożesz wspomnieć wszystkich w rozmowach \"@all\" lub wspomnieć konkretnych uczestników, wpisując \"@\" i wybierając ich nazwę z listy.",
    ...
    "Generating summary of unread messages ..." : "Generowanie podsumowania nieprzeczytanych wiadomości...",
    ...
    "You can search or add participants via name, email, or Federated Cloud ID" : "Możesz wyszukiwać i dodawać uczestników po nazwisku, adresie e-mail lub identyfikatorze sfederalizowanej chmury",
    ...
    "- Unsent message drafts are now saved in your browser " : "- Wersje robocze niewysłanych wiadomości są teraz zapisywane w Twojej przeglądarce",
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "- *Podgląd:* Rozmowę tekstową można teraz prowadzić w sposób stowarzyszony z innymi serwerami Talk",
    ...
    "Missing high-performance backend warning hidden" : "Ukryto ostrzeżenie zaplecza o wysokiej wydajności",
    ...
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk together with a High Performance Back-end." : "Zdecydowanie zaleca się skonfigurowanie rozproszonej pamięci podręcznej podczas korzystania z usługi Nextcloud Talk z zapleczem o wysokiej wydajności.",
