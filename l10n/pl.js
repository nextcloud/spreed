OC.L10N.register(
    ...
    "%s …" : "%s ...",
    "… %s …" : "... %s ...",
    "%s mentioned you in a private chat" : "%s wspomniał(a) o Tobie w prywatnym czacie",
    "{user} mentioned you in a private chat" : "{user} wspomniał(a) o Tobie w prywatnym czacie",
    "%s mentioned you in a group chat: %s" : "%swspomniał(a) o Tobie w czacie grupowym: %s ",
    "{user} mentioned you in a group chat: {call}" : "{user} wspomniał(a) o Tobie w czacie grupowym: {call}",
    "%s mentioned you in a group chat" : "%swspomniał(a) o Tobie w czacie grupowym ",
    "{user} mentioned you in a group chat" : "{user} wspomniał(a) o Tobie w czacie grupowym",
    ...
    "A guest mentioned you in a group chat: %s" : "Gość wspomniał o Tobie w czacie grupowym: %s",
    "A guest mentioned you in a group chat: {call}" : "Gość wspomniał o Tobie w czacie grupowym: {call}",
    "A guest mentioned you in a group chat" : "Gość wspomniał o Tobie w czacie grupowym",
