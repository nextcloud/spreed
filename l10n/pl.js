OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Moderatorzy mogą teraz przypinać wiadomości, aby były wyświetlane na górze",
    "- Schedule a message to send it at a later time" : "- Zaplanuj wysłanie wiadomości na później",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Tagi rozmów, grupowanie i sortowanie do organizowania listy rozmów",
    "- Voice-rooms to connect spontaneously" : "- Pokoje głosowe do spontanicznego łączenia się",
    "- Presets for quick conversation configuration during creation" : "- Presety do szybkiej konfiguracji rozmowy podczas tworzenia",
    "- Direct calls from profile menus for calls within other apps" : "- Bezpośrednie połączenia z menu profilu dla połączeń w innych aplikacjach",
    ...
    "{actor} pinned a message" : "{actor} przypiął wiadomość",
    "You pinned a message" : "Przypiąłeś wiadomość",
    "{actor} unpinned a message" : "{actor} odpiął wiadomość",
    "Message was automatically unpinned" : "Wiadomość została automatycznie odpięta",
    "You unpinned a message" : "Odpiąłeś wiadomość",
    ...
    "Conversation subfolders are disabled" : "Podfoldery rozmów są wyłączone",
    "Storage quota exceeded" : "Limit przekroczony",
    "Could not prepare conversation folder" : "Nie można przygotować folderu rozmowy",
    "File not found" : "Nie odnaleziono pliku",
    "Path must point to a file" : "Ścieżka musi wskazywać na plik",
    "File is not inside the conversation draft folder for this room" : "Plik nie znajduje się w folderze wersji roboczych rozmowy dla tego pokoju",
    ...
    "Call via Talk" : "Połącz przez Talk",
    "Channel" : "Kanał",
    "Default" : "Domyślny",
    "Send messages, create threads, and start voice and video calls." : "Wysyłaj wiadomości, twórz wątki oraz rozpoczynaj połączenia głosowe i wideo.",
    "Presentation" : "Prezentacja",
    "Restricted conversation for internal presentations." : "Rozmowa ograniczona do prezentacji wewnętrznych.",
    "Voice room" : "Pokój głosowy",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Dołącz bezpośrednio do rozmowy, idealne do szybkich spotkań lub spontanicznych rozmów.",
    "Webinar" : "Webinarium",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Rozmowa ograniczona z włączonym lobby, idealna do publicznych webinarów.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push jest zainstalowany, to poprawia terminowość powiadomień Talk.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} nie jest zainstalowany. Może to powodować opóźnienia powiadomień Talk.",
    ...
    "Open in full application" : "Otwórz w pełnej aplikacji",
    ...
    "Enable live transcription (generated by AI)" : "Włącz transkrypcję na żywo (generowaną przez AI)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Włącz transkrypcję na żywo (aplikacja Live transcriptions nie jest zainstalowana)",
    "Disable live translation" : "Wyłącz tłumaczenie na żywo",
    "Enable live translation (generated by AI)" : "Włącz tłumaczenie na żywo (generowane przez AI)",
    "Original language" : "Język oryginalny",
    "Live translations app is not installed" : "Aplikacja Live translations nie jest zainstalowana",
    "Original language: {languageName}" : "Język oryginalny: {languageName}",
    "Translated language" : "Język tłumaczenia",
    "Translated language: {languageName}" : "Język tłumaczenia: {languageName}",
    ...
    "Failed to enable live translations" : "Nie udało się włączyć tłumaczeń na żywo",
    "Failed to disable live translations" : "Nie udało się wyłączyć tłumaczeń na żywo",
    ...
    "This conversation is read-only" : "Ten wątek jest tylko do odczytu",
    ...
    "None" : "Brak",
    "Speaker" : "Głośnik",
    "Microphone settings" : "Ustawienia mikrofonu",
    ...
    "Disable" : "Wyłącz",
    "Enable" : "Włącz",
    "The bot is not available anymore" : "Bot nie jest już dostępny",
    ...
    "Participants can use all available features." : "Uczestnicy mogą korzystać ze wszystkich dostępnych funkcji.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Uczestnicy mają ograniczony zestaw funkcji, dopóki moderator ręcznie nie przyzna dodatkowych uprawnień.",
    ...
    "Live transcriptions app is not installed" : "Aplikacja Live transcriptions nie jest zainstalowana",
    ...
    "Leave conversation" : "Opuść konwersację ",
    ...
    "Recording consent is required for all calls" : "W przypadku wszystkich rozmów wymagana jest zgoda na nagrywanie",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Wydarzenia kalendarza z linkiem do rozmowy jako lokalizacją są wyświetlane tutaj",
    ...
    "Remove all tags" : "Usuń wszystkie tagi",
    "Rename tag" : "Zmień nazwę etykiety",
    "Delete tag" : "Usuń etykiety",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Czy na pewno chcesz usunąć \"{name}\"? Rozmowy z tym tagiem zostaną przeniesione do \"Inne\".",
    "Move up" : "Przenieś wyżej",
    "Move down" : "Przenieś niżej",
    "Pending invitations" : "Oczekujące zaproszenia",
    "Join conversations from other servers" : "Dołącz do rozmów z innych serwerów",
    ...
    "Mentions" : "Wzmianki",
    "Meetings" : "Spotkania",
    "Sort conversations" : "Sortuj rozmowy",
    "By recent activity" : "Według ostatniej aktywności",
    "Alphabetically" : "Alfabetycznie",
    "Do not group by type" : "Nie grupuj według typu",
    "Show private ones first" : "Najpierw pokazuj prywatne",
    "Show group ones first" : "Najpierw pokazuj grupowe",
    ...
    "SIP backend is not installed" : "Backend SIP nie jest zainstalowany",
    ...
    "You are currently waiting in the lobby" : "Aktualnie czekasz w poczekalni",
    "Enable noise suppression" : "Włącz redukcję szumów",
    "Reduce background noises for better voice quality" : "Zredukuj szumy tła, aby poprawić jakość dźwięku",
    "Basic" : "Podstawowe",
    "Advanced" : "Zaawansowane",
    "Enable echo cancellation" : "Włącz eliminację echa",
    "Minimize echo effect from own surrounding" : "Minimalizuj efekt echa z otoczenia",
    "Enable auto gain control" : "Włącz automatyczną regulację wzmocnienia",
    "Dynamically adjust microphone volume for consistent level" : "Dynamicznie dostosuj głośność mikrofonu, aby utrzymać stały poziom",
    ...
    "Recording backend is not installed" : "Backend nagrywania nie jest zainstalowany",
    ...
    "7 days" : "7 dni",
    "30 days" : "30 dni",
    "Until unpin" : "Do odpięcia",
    "Clear reminder – {timeLocale}" : "Wyczyść przypomnienie – {timeLocale}",
    "Edited by {actor}" : "Edytowane przez {actor}",
    "Pinned by you" : "Przypięte przez Ciebie",
    "Pinned by {actor}" : "Przypięte przez {actor}",
    ...
    "Keep pinned for" : "Zachowaj przypięcie przez",
    "Set custom period" : "Ustaw niestandardowy okres",
    ...
    "This translation is AI generated and may contain mistakes." : "To tłumaczenie zostało wygenerowane przez AI i może zawierać błędy",
    "Copy translated text" : "Kopiuj przetłumaczony tekst",
    "Error when scheduling the message" : "Błąd podczas planowania wiadomości",
    "Reschedule" : "Zmień harmonogram",
    "Send now" : "Wyślij teraz",
    "Choose a time" : "Wybierz godzinę",
    "Send at custom time" : "Wyślij o niestandardowej porze",
    "Will be sent without notification" : "Zostanie wysłane bez powiadomienia",
    ...
    "Reply to thread \"{threadTitle}\"" : "Odpowiedz w wątku \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Oddałeś głos • %n głos","Oddałeś głos • %n głosów","Oddałeś głos • %n głosów","Oddałeś głos  • %n głosy"],
    "You voted" : "Zagłosowałeś",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Kliknij, aby zagłosować • %n głos","Kliknij, aby zagłosować • %n głosów","Kliknij, aby zagłosować • %n głosów","Kliknij, aby zagłosować • %n głosy"],
    "Click to vote" : "Kliknij, aby zagłosować",
    ...
    "Generate summary with AI" : "Wygeneruj podsumowanie za pomocą AI",
    "{author} (pinned by you)" : "{author} (przypięte przez Ciebie)",
    "{author} (pinned by {actor})" : "{author} (przypięte przez {actor})",
    "Unpin" : "Odepnij",
    ...
    "Default parameters are:" : "Domyślne parametry to:",
    "These settings can be changed once the conversation is created." : "Te ustawienia można zmienić po utworzeniu rozmowy.",
    ...
    "Message will be sent {datetimeString}" : "Wiadomość zostanie wysłana {datetimeString}",
    ...
    "Message was successfully scheduled" : "Wiadomość została pomyślnie zaplanowana",
    ...
    "Show scheduled messages" : "Pokaż zaplanowane wiadomości",
    ...
    "Voice message {time} ({conversation})" : "Wiadomość głosowa {time} ({conversation})",
    ...
    "Withdraw vote" : "Wycofaj głos",
    "Results" : "Wyniki",
    "Download as spreadsheet" : "Pobierz jako arkusz kalkulacyjny",
    ...
    "Pinned by a deleted user" : "Przypięte przez usuniętego użytkownika",
    ...
    "I picked the list style" : "Wybrałem styl listy",
    ...
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "Obecnie niedostępne na iPhonie i iPadzie z powodu ograniczeń technicznych narzuconych przez producenta",
    "Notification settings" : "Ustawienia powiadomień",
    "Sounds for chat and call notifications" : "Dźwięki powiadomień czatu i połączeń",
    "Invalid language ({languageId})" : "Nieprawidłowy język ({languageId})",
    "Default language" : "Domyślny język",
    "Default language ({languageName})" : "Język domyślny ({languageName})",
    "Error when trying to load the available live translation languages" : "Błąd podczas próby wczytania dostępnych języków tłumaczenia na żywo",
    "Error when trying to set live translation language" : "Błąd podczas próby ustawienia języka tłumaczenia na żywo",
    "Set language used to show the transcriptions" : "Ustaw język używany do wyświetlania transkrypcji",
    ...
    "Turn camera and microphone off by default" : "Domyślnie wyłącz kamerę i mikrofon",
    "Blur camera background by default" : "Domyślnie rozmyj tło kamery",
    "Skip device preview before joining a call" : "Pomiń podgląd urządzeń przed dołączeniem do rozmowy",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Kamera zostanie wyłączona podczas dołączania. Zawsze pokazuj, jeśli wymagana jest zgoda na nagrywanie.",
    "Appearance & Sounds" : "Wygląd i dźwięki",
    "Privacy" : "Prywatność",
    "Send read receipts" : "Wysyłaj potwierdzenia odczytu",
    "When off, all read statuses will be hidden" : "Gdy wyłączone, wszystkie statusy odczytu będą ukryte",
    "Share typing status" : "Udostępniaj status pisania",
    "When off, all typing indicators will be hidden" : "Gdy wyłączone, wszystkie wskaźniki pisania będą ukryte",
    "Attachments folder" : "Katalog załączników",
    "Toggle full screen" : "Przełącz tryb pełnoekranowy",
    "Return to Home screen" : "Wróć do ekranu głównego",
    "Shortcuts while in a chat" : "Skróty klawiaturowe w czacie",
    ...
    "The server was updated, you cannot start or join a call." : "Serwer został zaktualizowany, nie możesz rozpocząć ani dołączyć do rozmowy",
    ...
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Ta rozmowa zostanie automatycznie usunięta dla wszystkich po %n dniu braku aktywności","Ta rozmowa zostanie automatycznie usunięta dla wszystkich po %n dniach braku aktywności","Ta rozmowa zostanie automatycznie usunięta dla wszystkich po %n dniach braku aktywności","Ta rozmowa zostanie automatycznie usunięta dla wszystkich po %n dniach braku aktywności"],
    ...
    "Scheduled {datetime}" : "Zaplanowano {datetime}",
    "Scheduled for {datetime}" : "Zaplanowano na {datetime}",
    "Search" : "Szukaj",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Ta rozmowa została otwarta w innej karcie. Bieżąca wersja serwera nie obsługuje otwierania rozmowy w wielu kartach",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hej! Czy używasz stylu listy czy dymków wiadomości?",
    ...
    "Audio" : "Dźwięk",
    "Show all pinned messages" : "Pokaż wszystkie przypięte wiadomości",
    ...
    "The server was updated." : "Serwer został zaktualizowany",
    ...
    "Error renaming tag" : "Błąd podczas zmiany nazwy tagu",
    "Error deleting tag" : "Błąd podczas usuwania tagu",
    "Error reordering tags" : "Błąd podczas zmiany kolejności tagów",
    ...
    "The server is in maintenance mode." : "Serwer jest w trybie konserwacji",
    "Federated server was updated." : "Zaktualizowano serwer federacyjny",
    ...
    "Set time for later today" : "Ustaw czas na później dziś",
    "Tomorrow – {timeLocale}" : "Jutro – {timeLocale}",
    "Set time for tomorrow" : "Ustaw czas na jutro",
    "This weekend – {timeLocale}" : "W ten weekend – {timeLocale}",
    "Set time for this weekend" : "Ustaw czas na ten weekend",
    "Next week – {timeLocale}" : "Następny tydzień – {timeLocale}",
    "Set time for next week" : "Ustaw czas na przyszły tydzień",
    ...
    "Connecting is taking longer than expected …" : "Łączenie trwa dłużej niż oczekiwano…",
    "Failed to connect. Retrying …" : "Nie udało się połączyć. Ponawianie…",
    "Failed to connect. The signaling server may be set up incorrectly" : "Nie udało się połączyć. Serwer sygnalizacyjny może być nieprawidłowo skonfigurowany",
    ...
    "Always shown if recording consent is required" : "Zawsze wyświetlane, jeśli wymagana jest zgoda na nagrywanie",
