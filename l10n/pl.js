OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Pozwól rozmowom przebiegać: wspominaj użytkowników, reaguj na wiadomości i nie tylko\n\nMożesz wspomnieć wszystkich w rozmowach %s lub wspomnieć konkretnych uczestników, wpisując \"@\" i wybierając ich nazwę z listy.",
