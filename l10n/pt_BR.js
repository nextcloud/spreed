OC.L10N.register(
    ...
    "Unban" : "Proibir",
    "<strong>Banned by:</strong> {actor}" : "<strong>Proibido por:</strong> {actor}",
    "<strong>Note:</strong> {note}" : "<strong>Nota:</strong> {nota}",
    ...
    "<strong>Date:</strong> {date}" : "<strong>Data:</strong> {data}",
