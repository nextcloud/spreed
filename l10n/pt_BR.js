OC.L10N.register(
    ...
    "Your PIN" : "Seu PIN",
    "Click the button below to join the lobby now." : "Clique no botão abaixo para entrar no lobby agora.",
    "Click the link below to join the lobby now." : "Clique no link abaixo para entrar no lobby agora.",
    "Join lobby for \"%s\"" : "Entrar no lobby para \"%s\"",
    ...
    "Start recording immediately with the call" : "Comecar a gravar imediatamente com a chamada",
