OC.L10N.register(
    ...
    "_{actor} set the message expiration to %n day_::_{actor} set the message expiration to %n days_" : ["{actor} definiu a expiração de mensagens para %n dias","{actor} definiu a expiração de mensagens para %n dias","{actor} definiu a expiração de mensagens para %n dias"],
    ...
    "Uploading the file failed" : "O envio do arquivo falhou",
    ...
    "Call recording now available" : "Gravação de chamadas agora está disponível",
    ...
    "The server failed to transcript the recording at {file} for the call in {call}. Please reach out to the administration." : "O servidor falhou ao transcrever a gravação em {file} para a chamada em {call}. Entre em contato com a administração.",
    ...
    "The server failed to summarize the recording at {file} for the call in {call}. Please reach out to the administration." : "O servidor falhou ao resumir a gravação em {file} para a chamada em {call}. Entre em contato com a administração.",
    ...
    "{guest} (guest) mentioned team {team} in conversation {call}" : "{guest} (convidado/convidada) mencionou a equipe {team} na conversa {call}",
    ...
    "A guest mentioned team {team} in conversation {call}" : "Um convidado / uma convidada mencionou a equipe {team} na conversa {call}",
    ...
    "Using the SIP functionality requires a High-performance backend." : "O uso da funcionalidade SIP requer um backend de alto desempenho.",
    ...
    "Hosted High-performance backend" : "Back-end hospedado de alto desempenho",
    ...
    "Sending no invitations" : "Não enviar convites",
    ...
    "Show presenter" : "Mostrar o apresentador",
    "You" : "Você",
    "Mute" : "Silenciar",
    "Muted" : "Silenciado",
    ...
    "Browse" : "Navegar",
    "Verifying uploaded file …" : "Verificando arquivo enviado ...",
    "This might take a moment" : "Isso pode demorar um pouco",
    "Send invitations" : "Enviar convites",
    "_%n invalid email_::_%n invalid emails_" : ["%n emails inválido","%n emails inválidos","%n emails inválidos"],
    ...
    "Internal note (reason to ban)" : "Nota interna (motivo da proibição)",
    "Remove" : "Remover",
    ...
    "Zoom-in / zoom-out a screen share" : "Ampliar / reduzir o zoom de um compartilhamento de tela",
    "Start call silently" : "Iniciar chamada silenciosamente",
    "Start call" : "Iniciar chamada",
    "End call" : "Encerrar chamada",
    "Nextcloud Talk was updated, you cannot start or join a call." : "O Nextcloud Talk foi atualizado, você não pode iniciar ou participar de uma chamada.",
    "This call has just ended" : "Esta chamada acabou.",
    ...
    "_{done} of %n task_::_{done} of %n tasks_" : ["{done} de %n tarefas","{done} de %n tarefas","{done} de %n tarefas"],
    ...
    "You do not have permissions to access this conversation." : "Você não tem permissões para acessar essa conversa.",
    "Join a different conversation or start a new one." : "Participe de uma conversa diferente ou inicie uma nova.",
    ...
    "_You removed {user0}, {user1} and %n more participant_::_You removed {user0}, {user1} and %n more participants_" : ["Você removeu {user0}, {user1} e mais %n participantes","Você removeu {user0}, {user1} e mais %n participantes","Você removeu {user0}, {user1} e mais %n participantes"],
    ...
    "_An administrator removed you, {user0} and %n more participant_::_An administrator removed you, {user0} and %n more participants_" : ["Um administrador removeu você, {user0} e mais %n participantes","Um administrador removeu você, {user0} e mais %n participantes","Um administrador removeu você, {user0} e mais %n participantes"],
    "_{actor} removed you, {user0} and %n more participant_::_{actor} removed you, {user0} and %n more participants_" : ["{actor} removeu você, {user0} e mais %n participantes","{actor} removeu você, {user0} e mais %n participantes","{actor} removeu você, {user0} e mais %n participantes"],
    ...
    "_An administrator removed {user0}, {user1} and %n more participant_::_An administrator removed {user0}, {user1} and %n more participants_" : ["Um administrador removeu {user0}, {user1} e mais %n participantes","Um administrador removeu {user0}, {user1} e mais %n participantes","Um administrador removeu {user0}, {user1} e mais %n participantes"],
    "_{actor} removed {user0}, {user1} and %n more participant_::_{actor} removed {user0}, {user1} and %n more participants_" : ["{actor} removeu {user0}, {user1} e mais %n participantes","{actor} removeu {user0}, {user1} e mais %n participantes","{actor} removeu {user0}, {user1} e mais %n participantes"],
    ...
    "Failed to join the conversation." : "Falha ao participar da conversa.",
    ...
    "Don't warn about connectivity issues in calls with more than 2 participants" : "Não avise sobre problemas de conectividade em chamadas com mais de dois participantes",
    "Please try to reload the page" : "Por favor, tente recarregar a página",
