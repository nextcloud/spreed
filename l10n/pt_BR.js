OC.L10N.register(
    ...
    "_%n guest_::_%n guests_" : ["%n visitante","%n de visitantes","%n visitantes"],
    ...
    "_%n other_::_%n others_" : ["%n outro","%n de outros","%n outros"],
    ...
    "- You can now notify all participants by posting \"@all\" into the chat" : "- Agora você pode notificar todos os participantes postando “@all” no bate-papo",
    "- With the \"arrow-up\" key you can repost your last message" : "- Com a tecla “seta para cima” você pode repostar sua última mensagem",
    "- Talk can now have commands, send \"/help\" as a chat message to see if your administrator configured some" : "- Agora, o Talk pode ter comandos; envie “/help” como mensagem de bate-papo para ver se o seu administrador configurou algum",
    ...
    "- You can now mention guests in the chat" : "- Agora você pode mencionar visitantes no chat",
    "- Conversations can now have a lobby. This will allow moderators to join the chat and call already to prepare the meeting, while users and guests have to wait" : "- As conversas agora podem ter uma sala de espera. Isso permitirá que os moderadores já entrem no bate-papo e na chamada para preparar a reunião, enquanto os usuários e visitantes terão que esperar",
    ...
    "- You can now add custom user groups to conversations when the circles app is installed" : "- Agora você pode adicionar grupos de usuários personalizados a conversas quando o aplicativo Círculos estiver instalado",
    "- Check out the new grid and call view" : "- Confira a nova visualização em grade e de chamadas",
    "- You can now upload and drag'n'drop files directly from your device into the chat" : "- Agora você pode enviar e arrastar arquivos diretamente do seu dispositivo para o bate-papo",
    ...
    "- You can now search for chats and messages in the unified search in the top bar" : "- Você pode pesquisar conversas e mensagens usando a pesquisa unificada na barra superior",
    ...
    "- Give your conversations some context with a description and open it up so logged in users can find it and join themselves" : "- Dê às suas conversas algum contexto com uma descrição e abra-as para que os usuários logados possam encontrá-las e entrar nelas",
    "- See a read status and send failed messages again" : "- Veja um status de leitura e enviar novamente as mensagens com falha",
    ...
    "- You can now react to chat messages" : "- Agora você pode reagir às mensagens de bate-papo",
    ...
    "- Link various items using the new smart-picker by typing a \"/\"" : "- Vincule vários itens usando o novo seletor inteligente digitando uma “/”",
    ...
    "- Chat messages can be translated if a translation provider app is registered" : "- Mensagens de bate-papo podem ser traduzidas se um aplicativo provedor de traduções estiver disponível",
    "- **Markdown** can now be used in _chat_ messages" : "- **Markdown** agora pode ser usado em mensagens de _bate-papo_",
    "- Webhooks are now available to implement bots. See the documentation for more information https://nextcloud-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks agora estão disponíveis para implementar robôs. Consulte a documentação para obter mais informações: https://nextcloud-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Video of the speaker is now visible while sharing the screen and call reactions are animated" : "- O vídeo do palestrante agora está visível ao compartilhar a tela e as reações da chamada são animadas",
    ...
    "- Moderators can now ban accounts and guests to prevent them from rejoining a conversation" : "- Os moderadores agora podem banir contas e visitantes para impedir que eles reentrem em uma conversa",
    ...
    "- Summarize call recordings and unread messages in chats with the Nextcloud Assistant" : "- Resuma gravações de chamadas e mensagens não lidas em bate-papos com o Nextcloud Assistente",
    "- Improved meetings with recognizing guests invited via their email address, import of participant lists, drafts for polls and downloading call participant lists" : "- Reuniões aprimoradas com reconhecimento de visitantes por meio de seus endereços de e-mail, importação de listas de participantes, rascunhos para enquetes e download de listas de participantes de chamadas",
    ...
    "- Mark conversations as sensitive in the notification settings, to hide the message content from the conversation list and notifications" : "- Marque as conversas como confidenciais nas configurações de notificação para ocultar o conteúdo das mensagens da lista de conversas e das notificações",
    ...
    "- Use threads to keep your chat and discussions organized" : "- Use fios de conversas para manter suas conversas e discussões organizadas",
    "- Live transcriptions now available during the call (requires the live-transcription ExApp and the High-performance backend)" : "- Transcrições em tempo real agora disponíveis durante a chamada (requer o ExApp de transcrição em tempo real e o back-end de alto desempenho)",
    ...
    "- Schedule a message to send it at a later time" : "- Agende uma mensagem para enviá-la mais tarde",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Etiquetas, agrupamento e ordenação de conversas para organizar a lista de conversas",
    "- Voice-rooms to connect spontaneously" : "- Salas de voz para se conectar espontaneamente",
    "- Presets for quick conversation configuration during creation" : "- Predefinições para configuração rápida de conversas durante a criação",
    "- Direct calls from profile menus for calls within other apps" : "- Realize chamadas diretamente a partir dos menus dos perfis para chamadas dentro de outros aplicativos",
    "- Classified conversations for better discussions around sensitive topics" : "- Conversas confidenciais para promover discussões mais produtivas sobre temas delicados",
    "- Channels and announcements to broadcast information to a broader audience" : "- Canais e anúncios para divulgar informações a um público mais amplo",
    "- Owners can preserve a conversation, preventing deletion and chat purging" : "- Os proprietários podem preservar uma conversa, impedindo que ela seja excluída ou que o histórico do bate-papo seja apagado",
    "_All %n participant_::_All %n participants_" : ["Todos os %n participantes","Todos os %n de participantes","Todos os %n participantes"],
    ...
    "{actor} limited the conversation to the current participants" : "{actor} limitou a conversa aos participantes atuais",
    "You limited the conversation to the current participants" : "Você limitou a conversa aos participantes atuais",
    "An administrator limited the conversation to the current participants" : "Um administrador limitou a conversa aos participantes atuais",
    ...
    "{actor} opened the conversation to registered users and users created with the Guests app" : "{actor} abriu a conversa para usuários registrados e usuários criados com o aplicativo Visitantes",
    "You opened the conversation to registered users and users created with the Guests app" : "Você abriu a conversa para usuários registrados e usuários criados com o aplicativo Visitantes",
    "An administrator opened the conversation to registered users and users created with the Guests app" : "Um administrador abriu a conversa para usuários registrados e usuários criados com o aplicativo Visitantes",
    "{actor} preserved the conversation" : "{actor} preservou a conversa",
    "You preserved the conversation" : "Você preservou a conversa",
    "An administrator preserved the conversation" : "Um administrador preservou a conversa",
    "{actor} stopped preserving the conversation" : "{actor} encerrou a preservação da conversa",
    "You stopped preserving the conversation" : "Você encerrou a preservação da conversa",
    "An administrator stopped preserving the conversation" : "Um administrador encerrou a preservação da conversa",
    ...
    "{actor} allowed guests" : "{actor} permitiu visitantes",
    "You allowed guests" : "Você permitiu visitantes",
    "An administrator allowed guests" : "Um administrador permitiu visitantes",
    "{actor} disallowed guests" : "{actor} proibiu visitantes",
    "You disallowed guests" : "Você proibiu visitantes",
    "An administrator disallowed guests" : "Um administrador proibiu visitantes",
    ...
    "System added you" : "O sistema adicionou você",
    "System added {user}" : "O sistema adicionou {user}",
    "You joined the conversation" : "Você entrou na conversa",
    "{actor} joined the conversation" : "{actor} entrou na conversa",
    ...
    "An administrator removed you" : "Um administrador removeu você",
    ...
    "{actor} added group {group}" : "{actor} adicionou o grupo {group}",
    ...
    "{actor} promoted {user} to owner" : "{actor} promoveu {user} a proprietário",
    "You promoted {user} to owner" : "Você promoveu {user} a proprietário",
    "{actor} promoted you to owner" : "{actor} promoveu você a proprietário",
    "An administrator promoted you to owner" : "Um administrador promoveu você a proprietário",
    "An administrator promoted {user} to owner" : "Um administrador promoveu {user} a proprietário",
    "{actor} demoted {user} from owner" : "{actor} rebaixou {user} do cargo de proprietário",
    "You demoted {user} from owner" : "Você rebaixou {user} do cargo de proprietário",
    "{actor} demoted you from owner" : "{actor} rebaixou você do cargo de proprietário",
    "An administrator demoted you from owner" : "Um administrador rebaixou você do cargo de proprietário",
    "An administrator demoted {user} from owner" : "Um administrador rebaixou {user} do cargo de proprietário",
    ...
    "{actor} shared a file which is no longer available" : "{actor} compartilhou um arquivo que não está mais disponível",
    "You shared a file which is no longer available" : "Você compartilhou um arquivo que não está mais disponível",
    ...
    "{actor} removed the Matterbridge configuration" : "{actor} removeu a configuração do Matterbridge",
    "You removed the Matterbridge configuration" : "Você removeu a configuração do Matterbridge",
    ...
    "{actor} pinned a message" : "{actor} fixou uma mensagem",
    "You pinned a message" : "Você fixou uma mensagem",
    "{actor} unpinned a message" : "{actor} desfixou uma mensagem",
    "Message was automatically unpinned" : "A mensagem foi desfixada automaticamente",
    "You unpinned a message" : "Você desfixou uma mensagem",
    "{actor} deleted a reaction" : "{actor} excluiu uma reação",
    "You deleted a reaction" : "Você excluiu uma reação",
    "_You set the message expiration to %n week_::_You set the message expiration to %n weeks_" : ["Você definiu a expiração de mensagens para %n semana","Você definiu a expiração de mensagens para %n de semanas","Você definiu a expiração de mensagens para %n semanas"],
    "_You set the message expiration to %n day_::_You set the message expiration to %n days_" : ["Você definiu a expiração de mensagens para %n dia","Você definiu a expiração de mensagens para %n de dias","Você definiu a expiração de mensagens para %n dias"],
    "_You set the message expiration to %n hour_::_You set the message expiration to %n hours_" : ["Você definiu a expiração de mensagens para %n hora","Você definiu a expiração de mensagens para %n de horas","Você definiu a expiração de mensagens para %n horas"],
    "_You set the message expiration to %n minute_::_You set the message expiration to %n minutes_" : ["Você definiu a expiração de mensagens para %n minuto","Você definiu a expiração de mensagens para %n de minutos","Você definiu a expiração de mensagens para %n minutos"],
    "_{actor} set the message expiration to %n week_::_{actor} set the message expiration to %n weeks_" : ["{actor} definiu a expiração de mensagens para %n semana","{actor} definiu a expiração de mensagens para %n de semanas","{actor} definiu a expiração de mensagens para %n semanas"],
    "_{actor} set the message expiration to %n day_::_{actor} set the message expiration to %n days_" : ["{actor} definiu a expiração de mensagens para %n dia","{actor} definiu a expiração de mensagens para %n de dias","{actor} definiu a expiração de mensagens para %n dias"],
    "_{actor} set the message expiration to %n hour_::_{actor} set the message expiration to %n hours_" : ["{actor} definiu a expiração de mensagens para %n hora","{actor} definiu a expiração de mensagens para %n de horas","{actor} definiu a expiração de mensagens para %n horas"],
    "_{actor} set the message expiration to %n minute_::_{actor} set the message expiration to %n minutes_" : ["{actor} definiu a expiração de mensagens para %n minuto","{actor} definiu a expiração de mensagens para %n de minutos","{actor} definiu a expiração de mensagens para %n minutos"],
    ...
    "{actor} stopped the video recording" : "{actor} interrompeu a gravação de vídeo",
    "You stopped the video recording" : "Você interrompeu a gravação de vídeo",
    ...
    "{actor} stopped the audio recording" : "{actor} interrompeu a gravação de áudio",
    "You stopped the audio recording" : "Você interrompeu a gravação de áudio",
    "The recording failed" : "A gravação falhou",
    "Someone voted on the poll {poll}" : "Alguém votou na enquete {poll}",
    "Message deleted by author" : "Mensagem excluída pelo(a) autor(a)",
    ...
    "_Call with %n guest was ended, as it reached the maximum call duration (Duration {duration})_::_Call with %n guests was ended, as it reached the maximum call duration (Duration {duration})_" : ["A chamada com %n visitante foi encerrada, pois atingiu a duração máxima da chamada (Duração {duration})","A chamada com %n de visitantes foi encerrada, pois atingiu a duração máxima da chamada (Duração {duration})","A chamada com %n visitantes foi encerrada, pois atingiu a duração máxima da chamada (Duração {duration})"],
    "_Call with %n guest ended (Duration {duration})_::_Call with %n guests ended (Duration {duration})_" : ["Chamada com %n visitante encerrada (Duração {duration})","Chamada com %n de visitantes encerrada (Duração {duration})","Chamada com %n visitantes encerrada (Duração {duration})"],
    "_{actor} ended the call with %n guest (Duration {duration})_::_{actor} ended the call with %n guests (Duration {duration})_" : ["{actor} encerrou a chamada com %n visitante (Duração {duration})","{actor} encerrou a chamada com %n de visitantes (Duração {duration})","{actor} encerrou a chamada com %n visitantes (Duração {duration})"],
    ...
    "Call %s" : "Ligar para %s",
    "Chat with %s" : "Bate-papo com %s",
    "An error occurred. Please contact your administrator." : "Ocorreu um erro. Entre em contato com sua administração.",
    "App disabled" : "Aplicativo desativado",
    "Conversation subfolders are disabled" : "As subpastas de conversas estão desativadas",
    "Storage quota exceeded" : "Cota de armazenamento excedida",
    "Could not prepare conversation folder" : "Não foi possível preparar a pasta de conversas",
    "File not found" : "Arquivo não encontrado",
    "Path must point to a file" : "O caminho deve apontar para um arquivo",
    ...
    "Missing %s field in header line" : "Falta o campo %s na linha do cabeçalho",
    ...
    "Deleted user (%s)" : "Usuário excluído (%s)",
    ...
    "Transcript now available" : "Transcrição agora está disponível",
    ...
    "Reminder: {guest} (guest) in {call}" : "Lembrete: {guest} (visitante) em {call}",
    "Reminder: Guest in {call}" : "Lembrete: Visitante em {call}",
    ...
    "{guest} (guest) reacted with {reaction} in {call}" : "{guest} (visitante) reagiu com {reaction} em {call}",
    "Guest reacted with {reaction} in {call}" : "Visitante reagiu com {reaction} em {call}",
    "{user} in {call}" : "{user} em {call}",
    "Deleted user in {call}" : "Usuário excluído em {call}",
    "{guest} (guest) in {call}" : "{guest} (visitante) em {call}",
    "Guest in {call}" : "Visitante em {call}",
    "{user} sent you a private message" : "{user} enviou você uma mensagem privada",
    ...
    "{guest} (guest) sent a message in conversation {call}" : "{guest} (visitante) enviou uma mensagem na conversa {call}",
    "A guest sent a message in conversation {call}" : "Um visitante enviou uma mensagem na conversa {call}",
    "{user} replied to your private message" : "{user} respondeu à sua mensagem privada",
    ...
    "{guest} (guest) replied to your message in conversation {call}" : "{guest} (visitante) respondeu à sua mensagem na conversa {call}",
    "A guest replied to your message in conversation {call}" : "Um visitante respondeu à sua mensagem na conversa {call}",
    ...
    "Reminder: {guest} (guest) in conversation {call}" : "Lembrete: {guest} (visitante) na conversa {call}",
    "Reminder: A guest in conversation {call}" : "Lembrete: Um visitante na conversa {call}",
    ...
    "{guest} (guest) reacted with {reaction} to your message in conversation {call}" : "{guest} (visitante) reagiu com {reaction} à sua mensagem na conversa {call}",
    "A guest reacted with {reaction} to your message in conversation {call}" : "Um visitante reagiu com {reaction} à sua mensagem na conversa {call}",
    ...
    "{guest} (guest) mentioned group {group} in conversation {call}" : "{guest} (visitante) mencionou o {group} na conversa {call}",
    "{guest} (guest) mentioned team {team} in conversation {call}" : "{guest} (visitante) mencionou a equipe {team} na conversa {call}",
    "{guest} (guest) mentioned everyone in conversation {call}" : "{guest} (visitante) mencionou todas as pessoas na conversa {call}",
    "{guest} (guest) mentioned you in conversation {call}" : "{guest} (guest) citou você na conversa {call}",
    "A guest mentioned group {group} in conversation {call}" : "Um visitante mencionou o grupo {group} na conversa {call}",
    "A guest mentioned team {team} in conversation {call}" : "Um visitante mencionou a equipe {team} na conversa {call}",
    "A guest mentioned everyone in conversation {call}" : "Um visitante mencionou todas as pessoas na conversa {call}",
    "A guest mentioned you in conversation {call}" : "Um visitante mencionou você na conversa {call}",
    ...
    "A group call has started in {call}" : "Uma chamada em grupo foi iniciada em {call}",
    ...
    "The hosted signaling server account has changed the status from \"{oldstatus}\" to \"{newstatus}\"." : "A conta do servidor de sinalização hospedado mudou seu status de \"{oldstatus}\" para \"{newstatus}\".",
    "pending" : "pendentes",
    "active" : "ativo",
    "expired" : "expirado",
    "blocked" : "bloqueado",
    ...
    "Call via Talk" : "Chamar via Talk",
    "Announcement" : "Anúncio",
    "Conversation to inform a fixed audience, which can not be left." : "Conversa destinada a informar um público específico, que não pode ser deixada.",
    "Channel" : "Canal",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Conversa em modo de transmissão para um grande público, na qual apenas os moderadores podem postar e as chamadas estão desativadas.",
    "Classified conversation" : "Conversa confidencial",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Conversa restrita para assuntos confidenciais, com acesso público, visitantes, SIP e gravações desativados.",
    "Default" : "Padrão",
    "Send messages, create threads, and start voice and video calls." : "Envie mensagens, crie fios e inicie chamadas de voz e vídeo.",
    "Presentation" : "Apresentação",
    "Restricted conversation for internal presentations." : "Conversa restrita a apresentações internas.",
    "Voice room" : "Sala de voz",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Entre diretamente na chamada, ideal para colocar o papo em dia ou para reuniões espontâneas.",
    "Webinar" : "Webinário",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Conversa restrita com a sala de espera ativada, ideal para webinários públicos.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "O Client Push está instalado, o que melhora a pontualidade das notificações do Talk.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} não está instalado. Isso pode causar atrasos nas notificações do Talk.",
    ...
    "Open in full application" : "Abrir em tela cheia",
    ...
    "Guests can still join public conversations." : "Visitantes ainda podem juntar-se a conversas públicas.",
    ...
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Quando pelo menos um grupo estiver selecionado, somente os membros desses grupos poderão iniciar uma chamada. Isso também se aplica aos moderadores, enquanto visitantes e usuários federados nunca são membros desses grupos. Todos ainda podem iniciar uma chamada quando nenhum grupo estiver selecionado.",
    ...
    "Done" : "Concluído",
    "Disable live transcription" : "Desativar transcrição em tempo real",
    "Enable live transcription (generated by AI)" : "Ativar transcrição em tempo real (gerada por IA)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Ativar transcrição em tempo real (o aplicativo de transcrição em tempo real não está instalado)",
    "Disable live translation" : "Desativar tradução em tempo real",
    "Enable live translation (generated by AI)" : "Ativar tradução em tempo real (gerada por IA)",
    "Original language" : "Idioma original",
    "Live translations app is not installed" : "O aplicativo de tradução em tempo real não está instalado",
    "Original language: {languageName}" : "Idioma original: {languageName}",
    "Translated language" : "Idioma traduzido",
    ...
    "Speaker view" : "Visualização de palestrante",
    "Multi-speaker view" : "Visualização de vários palestrantes",
    "Error when trying to load the available live transcription languages" : "Erro ao carregar os idiomas disponíveis para transcrição em tempo real",
    "Failed to enable live transcription" : "Erro ao ativar a transcrição em tempo real",
    "Failed to enable live translations" : "Falha ao ativar a tradução em tempo real",
    "Failed to disable live translations" : "Falha ao desativar a tradução em tempo real",
    ...
    "This conversation is read-only" : "Esta conversa é somente para leitura",
    ...
    "Microphone settings" : "Configurações do microfone",
    ...
    "Edit conversation name" : "Editar nome da conversa",
    ...
    "Disable" : "Desativar",
    "Enable" : "Ativar",
    "The bot is not available anymore" : "O robô não está mais disponível",
    ...
    "Participants can use all available features." : "Os participantes podem utilizar todos os recursos disponíveis.",
    "Restricted" : "Restrito",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Os participantes têm acesso a um conjunto reduzido de recursos até que um moderador conceda manualmente permissões adicionais.",
    ...
    "Live transcriptions app is not installed" : "O aplicativo de transcrição em tempo real não está instalado",
    "Enable live transcription" : "Ativar transcrição em tempo real",
    "Breakout Rooms" : "Salas Temáticas",
    "Matterbridge" : "Matterbridge",
    "Bots" : "Bots",
    "Danger zone" : "Zona de perigo",
    "Archive conversation" : "Arquivar conversa",
    "Archived conversations are hidden from the conversation list by default. However, they will still appear when you search for the conversation name or access a list of archived conversations." : "Conversas arquivadas ficam ocultas da lista de conversas por padrão. No entanto, elas ainda aparecerão quando você pesquisar o nome da conversa ou acessar uma lista de conversas arquivadas.",
    ...
    "Once a conversation is left, to rejoin a closed conversation, an invite is needed. An open conversation can be rejoined at any time." : "Depois de sair de uma conversa, é necessário receber um convite para voltar a participar de uma conversa encerrada. É possível voltar a participar de uma conversa aberta a qualquer momento.",
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Esta conversa é preservada. Não é possível excluir a conversa e apagar as mensagens de bate-papo dela.",
    ...
    "Guest access" : "Acesso para visitantes",
    "Allow guests to join this conversation via link" : "Permitir que os visitantes entrem nesta conversa por meio de um link",
    "This setting can not be changed while the conversation is preserved." : "Não é possível alterar esta configuração enquanto a conversa estiver preservada.",
    ...
    "This conversation is password-protected. Guests need password to join" : "Esta conversa é protegida por senha. Os visitantes precisam de senha para participar",
    ...
    "Guests are allowed to join this conversation via link" : "Visitantes têm permissão para entrar nesta conversa por meio de um link",
    "Guests are not allowed to join this conversation" : "Visitantes não têm permissão para entrar nesta conversa",
    "Resend invitations" : "Reenviar convites",
    "This conversation is open to both registered users and users created with the Guests app" : "Esta conversa está aberta tanto para usuários registrados quanto para usuários criados com o aplicativo Visitantes",
    ...
    "You opened the conversation to both registered users and users created with the Guests app" : "Você abriu a conversa para usuários registrados e usuários criados com o aplicativo Visitantes",
    ...
    "Also open to users created with the Guests app" : "Também abrir para usuários criados com o aplicativo Visitantes",
    ...
    "Default live transcription language set" : "Idioma padrão definido para transcrição em tempo real",
    "Live transcription language set: {languageName}" : "Idioma definido para transcrição em tempo real: {languageName}",
    ...
    "The entered token does not match the conversation token" : "O token inserido não corresponde ao token da conversa",
    "Preserve conversation" : "Preservar conversa",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Enquanto estiver preservada, essa conversa não pode ser excluída, seu histórico de bate-papo não pode ser apagado e as configurações de visitantes e de quem pode entrar não podem ser alteradas.",
    "Only the owner can change whether this conversation is preserved." : "Somente o proprietário pode decidir se essa conversa será preservada.",
    ...
    "Stop preserving" : "Encerrar preservação",
    "Stop preserving conversation" : "Encerrar a preservação da conversa",
    "Conversation token" : "Token de conversa",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Se você encerrar a preservação dessa conversa, ela poderá ser excluída, o histórico de bate-papo poderá ser apagado e as configurações de visitantes e de quem pode entrar poderão ser alteradas novamente.",
    "Conversation" : "Conversa",
    "To confirm, type the conversation token into the field below:" : "Para confirmar, digite o token da conversa no campo abaixo:",
    "Ongoing" : "Em andamento",
    "{dayPrefix} {dateTime}" : "{dayPrefix} {dateTime}",
    "_%n person accepted_::_%n people accepted_" : ["%n pessoa aceitou","%n de pessoas aceitaram","%n pessoas aceitaram"],
    "_%n person declined_::_%n people declined_" : ["%n pessoa recusou","%n de pessoas recusaram","%n pessoas recusaram"],
    ...
    "Join conversations" : "Entrar na conversa",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Os eventos do calendário cujo local é um link de conversa são exibidos aqui",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "O formato do conteúdo é valores separados por vírgulas (CSV):<br/>- A linha de cabeçalho é obrigatória e deve corresponder a {sample1} ou simplesmente {sample2}<br/>- Uma entrada por linha (p.ex., {sample3})",
    ...
    "Creating the conversation …" : "Criar a conversa …",
    ...
    "Remove all tags" : "Remover todas as etiquetas",
    "Rename tag" : "Renomear etiqueta",
    "Delete tag" : "Excluir etiqueta",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Você tem certeza que quer excluir \"{name}\"? As conversas com essa etiqueta serão movidas para \"Outros\".",
    "Move up" : "Mover para cima",
    "Move down" : "Mover para baixo",
    "Pending invitations" : "Convites pendentes",
    "Join conversations from other servers" : "Entrar nas conversas de outros servidores",
    ...
    "Mentions" : "Menções",
    "Meetings" : "Reuniões",
    "Sort conversations" : "Ordenar conversas",
    "By recent activity" : "Por atividade recente",
    "Alphabetically" : "Alfabeticamente",
    "Do not group by type" : "Não agrupar por tipo",
    "Show private ones first" : "Mostrar primeiro as privadas",
    "Show group ones first" : "Mostrar primeiro as agrupadas",
    ...
    "SIP backend is not installed" : "O back-end SIP não está instalado",
    ...
    "You can only join a voice room via a call." : "Você só pode entrar em uma sala de voz por meio de uma chamada.",
    ...
    "Start recording immediately with the call" : "Iniciar a gravação imediatamente com a chamada",
    "Recording backend is not installed" : "O back-end de gravação não está instalado",
    ...
    "7 days" : "7 dias",
    "30 days" : "30 dias",
    "Until unpin" : "Até desfixar",
    "Clear reminder – {timeLocale}" : "Limpar lembrete – {timeLocale}",
    "Edited by {actor}" : "Editado por {actor}",
    "Pinned by you" : "Fixada por você",
    "Pinned by {actor}" : "Fixada por {actor}",
    "Until {absoluteDate}" : "Até {absoluteDate}",
    ...
    "Unpin message" : "Desfixar mensagem",
    ...
    "Keep pinned for" : "Manter fixada para",
    "Set custom period" : "Definir período personalizado",
    ...
    "This translation is AI generated and may contain mistakes." : "Esta tradução foi gerada por IA e pode conter erros.",
    ...
    "Send at custom time" : "Enviar em horário personalizado",
    ...
    "Reply to thread \"{threadTitle}\"" : "Responder ao fio \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Você votou • %n voto","Você votou • %n de votos","Você votou • %n votos"],
    "You voted" : "Você votou",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Clique para votar • %n voto","Clique para votar • %n de votos","Clique para votar • %n votos"],
    ...
    "Generate summary with AI" : "Gerar resumo com IA",
    "{author} (pinned by you)" : "{author} (fixada por você)",
    "{author} (pinned by {actor})" : "{author} (fixada por {actor})",
    "Unpin" : "Desfixar",
    ...
    "Create a new group conversation" : "Criar uma nova conversa em grupo",
    ...
    "Default parameters are:" : "Os parâmetros padrão são:",
    "These settings can be changed once the conversation is created." : "Essas configurações podem ser alteradas depois que a conversa for criada.",
    "Conversation visibility" : "Visibilidade da conversa",
    "Allow guests to join via link" : "Permitir que visitantes participem via link",
    ...
    "Voice message {time} ({conversation})" : "Mensagem de voz {time} ({conversation})",
    ...
    "Standard image quality" : "Qualidade padrão da imagem",
    "Original image quality" : "Qualidade original da imagem",
    "View-only for others" : "Somente visualização para outras pessoas",
    "Editable by others" : "Editável por outras pessoas",
    ...
    "Post messages" : "Postar mensagens",
    "Post messages and reactions" : "Postar mensagens e reações",
    ...
    "Show names on voted options" : "Exibir os nomes nas opções votadas",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Resultados finais • %n voto","Resultados finais • %n de votos","Resultados finais • %n votos"],
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n voto • Seu nome aparecerá nas opções votadas","%n de votos • Seu nome aparecerá nas opções votadas","%n votos • Seu nome aparecerá nas opções votadas"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n voto • Seu nome não aparecerá nas opções votadas","%n de votos • Seu nome não aparecerá nas opções votadas","%n votos • Seu nome não aparecerá nas opções votadas"],
    "Your name will not be shown on voted options" : "Seu nome não aparecerá nas opções votadas",
    ...
    "Results" : "Resultados",
    "Download as spreadsheet" : "Baixar como planilha",
    ...
    "Start a call before you start a breakout room session" : "Inicie uma chamada antes de iniciar uma sessão de sala temática",
    ...
    "The last moderator of a conversation can not be demoted" : "O último moderador de uma conversa não pode ser rebaixado",
    "Could not change the type of the participant" : "Não foi possível alterar o tipo do participante",
    ...
    "Promote to owner" : "Promover a proprietário",
    "Demote from moderator" : "Rebaixar de moderador",
    "Promote to moderator" : "Promover a moderador",
    "Demote from owner to moderator" : "Rebaixar de proprietário para moderador",
    "Demote from owner to participant" : "Rebaixar de proprietário para participante",
    "Resend invitation" : "Reenviar convite",
    "Send call notification" : "Enviar notificação de chamada",
    "Dial out phone number" : "Discar número de telefone",
    ...
    "Search or add participants" : "Pesquisar ou adicionar participantes",
    ...
    "A new group conversation with selected participant will be created" : "Será criada uma nova conversa em grupo com o participante selecionado",
    ...
    "I picked message bubbles" : "Eu escolhi balões de mensagem",
    "I picked the list style" : "Eu escolhi o estilo em lista",
    ...
    "Compact conversations list" : "Lista de conversas compacta",
    "Chat appearance" : "Aparência de bate-papos",
    ...
    "Currently not available on iPhone and iPad due to technical restrictions by the manufacturer" : "Atualmente indisponível no iPhone e iPad devido a restrições técnicas do fabricante",
    "Notification settings" : "Configurações de notificação",
    "Sounds for chat and call notifications" : "Sons para notificações de bate-papos e chamadas",
    "Invalid language ({languageId})" : "Idioma inválido ({languageId})",
    "Default language" : "Idioma padrão",
    "Default language ({languageName})" : "Idioma padrão ({languageName})",
    "Error when trying to load the available live translation languages" : "Erro ao tentar carregar os idiomas de tradução em tempo real disponíveis",
    "Error when trying to set live translation language" : "Erro ao tentar definir o idioma da tradução em tempo real",
    "Set language used to show the transcriptions" : "Definir o idioma usado para mostrar as transcrições",
    ...
    "Turn camera and microphone off by default" : "Desativar câmera e microfone por padrão",
    "Blur camera background by default" : "Desfocar o fundo da câmera por padrão",
    "Skip device preview before joining a call" : "Pular a pré-visualização dos dispositivos antes de entrar em uma chamada",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "A câmera será desligada ao entrar na chamada. Será sempre exibido se for necessário consentimento para a gravação.",
    "Appearance & Sounds" : "Aparência & Sons",
    "Privacy" : "Privacidade",
    "Send read receipts" : "Enviar confirmação de recebimento",
    "When off, all read statuses will be hidden" : "Quando desativado, todos os status de leitura serão ocultos",
    "Share typing status" : "Compartilhar status de digitação",
    "When off, all typing indicators will be hidden" : "Quando desativado, todos os indicadores de digitação serão ocultos",
    "Attachments folder" : "Pasta para os anexos",
    "Toggle full screen" : "Alternar modo de tela cheia",
    "Return to Home screen" : "Voltar à página inicial",
    "Shortcuts while in a chat" : "Atalhos durante um bate-bapo",
    ...
    "The server was updated, you cannot start or join a call." : "O servidor foi atualizado, você não pode iniciar ou entrar em uma chamada.",
    ...
    "Raise hand" : "Levantar mão",
    "Raise hand (R)" : "Levantar a mão (R) ",
    "Lower hand" : "Baixar mão",
    ...
    "Scheduled {datetime}" : "Agendado {datetime}",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Esta conversa foi aberta em outra aba. A versão atual do servidor não suporta a abertura de uma conversa em várias abas.",
    "Creating and joining a conversation with \"{userid}\"" : "Criando e entrando em uma conversa com \"{userid}\"",
    "Join a conversation or start a new one" : "Entre em uma conversa ou inicie uma nova",
    "Error while joining the conversation" : "Erro ao entrar na conversa",
    "Another user" : "Outro usuário",
    "Hey! Are you using the list style or message bubbles?" : "Ei! Você está usando o estilo em lista ou balões de mensagem?",
    ...
    "Jabber ID" : "ID Jabber",
    "Pinned messages" : "Mensagem fixada",
    "Media" : "Mídia",
    "Polls" : "Enquetes",
    ...
    "Audio" : "Áudio",
    "Show all pinned messages" : "Mostrar todas as mensagens fixadas",
    ...
    "_An administrator promoted {user0}, {user1} and %n more participant to moderators_::_An administrator promoted {user0}, {user1} and %n more participants to moderators_" : ["Um administrador promoveu {user0}, {user1} e mais %n participante a moderadores","Um administrador promoveu {user0}, {user1} e mais %n de participantes a moderadores","Um administrador promoveu {user0}, {user1} e mais %n participantes a moderadores"],
    ...
    "_{actor} demoted {user0}, {user1} and %n more participant from moderators_::_{actor} demoted {user0}, {user1} and %n more participants from moderators_" : ["{actor} rebaixou {user0}, {user1} e mais %n participante de moderadores","{actor} rebaixou {user0}, {user1} e mais %n de participantes de moderadores","{actor} rebaixou {user0}, {user1} e mais %n participantes de moderadores"],
    "You:" : "Você:",
    "You: {lastMessage}" : "Você: {lastMessage}",
    "{actor}:" : "{actor}:",
    "{relativeDate}, {absoluteDate}" : "{relativeDate}, {absoluteDate}",
    "The server was updated." : "O servidor foi atualizado.",
    ...
    "Error occurred while allowing guests" : "Erro ocorrido ao permitir visitantes",
    "Error occurred while disallowing guests" : "Erro ocorrido ao não permitir visitantes",
    "Error while changing the preserved status of the conversation" : "Erro ao alterar o status de preservação da conversa",
    ...
    "Error renaming tag" : "Erro ao renomear a etiqueta",
    "Error deleting tag" : "Erro ao excluir a etiqueta",
    ...
    "The link could not be copied" : "Não foi possível copiar o link",
    ...
    "Failed to connect. Retrying …" : "Falha na conexão. Tentando novamente …",
    "Failed to connect. The signaling server may be set up incorrectly" : "Falha na conexão. O servidor de sinalização pode estar configurado incorretamente",
    "High-performance backend needs to be updated." : "O back-end de alto desempenho precisa ser atualizado.",
    "The server is misconfigured. Please contact your administration." : "O servidor está configurado incorretamente. Entre em contato com a administração.",
    ...
    "Always shown if recording consent is required" : "Sempre exibido se for necessário consentimento para gravação",
    ...
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["Enquete aberta • %n voto • Seu nome aparecerá nas opções votadas","Enquete aberta • %n de votos • Seu nome aparecerá nas opções votadas","Enquete aberta • %n votos • Seu nome aparecerá nas opções votadas"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["Enquete aberta • %n voto • Seu nome não aparecerá nas opções votadas","Enquete aberta • %n de votos • Seu nome não aparecerá nas opções votadas","Enquete aberta • %n votos • Seu nome não aparecerá nas opções votadas"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "Enquete aberta • Você já votou • Seu nome não aparecerá nas opções votadas",
    "Open poll • Your name will not be shown on voted options" : "Enquete aberta • Seu nome não aparecerá nas opções votadas",
    ...
    "Allow editing of uploaded files" : "Permitir a edição de arquivos enviados"
},
