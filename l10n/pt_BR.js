OC.L10N.register(
    ...
    "Call summary now available" : "Resumo da chamada agora disponível",
    "The summary for the call in {call} was uploaded to {file}." : "O resumo para a chamada em {call} foi enviado para {file}.",
    "Failed to summarize call recording" : "Falha ao resumir a gravação da chamada",
    "The server failed to summarize the recording at {file} for the call in {call}. Please reach out to the administration." : "O servidor falhou ao resumir a gravação em {file} para a chamada em {call}. Por favor entre em contato com o administrador.",
    ...
    "Recording transcription" : "Gravando transcrição",
