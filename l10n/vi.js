OC.L10N.register(
    ...
    "{actor} removed {federated_user}" : "{actor} đã mời {federated_user} ra ngoài",
    "You removed {federated_user}" : "Bạn đã mời {federated_user} ra ngoài. ",
    "An administrator removed {federated_user}" : "Quản trị viên đã xóa {federated_user}",
    ...
    "{actor} added {phone}" : "{actor} đã thêm {phone}",
    "You added {phone}" : "Bạn đã thêm {phone}",
    "An administrator added {phone}" : "Quản trị viên đã thêm {phone}",
    "{actor} removed {phone}" : "{actor} đã mời {phone} ra ngoài",
    "You removed {phone}" : "Bạn đã mời {phone} ra ngoài. ",
    "An administrator removed {phone}" : "Quản trị viên đã xóa {phone}",
    ...
    "Navigating away from the page will leave the call in {conversation}" : "Điều hướng khỏi trang sẽ rời khỏi cuộc gọi trong {conversation}",
    ...
    "Leave conversation" : "Thoát đàm thoại",
    ...
    "Demote from moderator" : "Giảm hạng từ người kiểm duyệt",
    ...
    "Details" : "Chi tiết",
    "Search in {name}" : "Tìm kiếm trong {name}",
    "{actor} in {conversation}" : "{actor} trong {conversation}",
    ...
    "Audio" : "Âm thanh",
    "Show all files" : "Hiển thị tất cả tệp",
    "Group" : "Nhóm",
    "Team" : "Đội",
    ...
    "_%n hour_::_%n hours_" : ["%n giờ"],
    "_%n day_::_%n days_" : ["%n ngày"],
    "_%n week_::_%n weeks_" : ["%n tuần"],
