OC.L10N.register(
    ...
    "You invited {federated_user}" : "Tú invitaste a {federated_user}",
    "An administrator invited {federated_user}" : "Un administrador invitó a {federated_user}",
    ...
    "Could not set the conversation picture: {error}" : "Error al recortar la imagen de la conversación: {error}",
    "Error cropping conversation picture" : "No se pudo establecer la imagen de la conversación",
    ...
    "Default permissions modified for {conversationName}" : "Permisos predeterminados modificados para {conversationName}",
    "Could not modify default permissions for {conversationName}" : "No se pudieron modificar los permisos predeterminados para {conversationName}",
    ...
    "Do you really want to delete \"{displayName}\"?" : "¿Realmente quieres eliminar \"{displayName}\"?",
    ...
    "Do you really want to delete all messages in \"{displayName}\"?" : "¿Realmente quieres eliminar todos los mensajes en \"{displayName}\"?",
