OC.L10N.register(
    ...
    "An administrator promoted {user} to moderator" : "L'alministración ascendió a {user} a moderador",
    ...
    "Contact" : "Contautu",
    "Remove {fileName}" : "Quitar «{fileName}»",
    ...
    "Local time: {time}" : "Hora llocal: {time}",
    "Search" : "Buscar",
