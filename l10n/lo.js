OC.L10N.register(
    ...
    "_%n guest_::_%n guests_" : ["%n guests"],
    ...
    "_%n other_::_%n others_" : ["%n others"],
    ...
    "_All %n participant_::_All %n participants_" : ["All %n participants"],
    ...
    "_You set the message expiration to %n week_::_You set the message expiration to %n weeks_" : ["You set the message expiration to %n weeks"],
    "_You set the message expiration to %n day_::_You set the message expiration to %n days_" : ["You set the message expiration to %n days"],
    "_You set the message expiration to %n hour_::_You set the message expiration to %n hours_" : ["You set the message expiration to %n hour"],
    "_You set the message expiration to %n minute_::_You set the message expiration to %n minutes_" : ["You set the message expiration to %n minutes"],
    "_{actor} set the message expiration to %n week_::_{actor} set the message expiration to %n weeks_" : ["{actor} set the message expiration to %n weeks"],
    "_{actor} set the message expiration to %n day_::_{actor} set the message expiration to %n days_" : ["{actor} set the message expiration to %n days"],
    "_{actor} set the message expiration to %n hour_::_{actor} set the message expiration to %n hours_" : ["{actor} set the message expiration to %n hours"],
    "_{actor} set the message expiration to %n minute_::_{actor} set the message expiration to %n minutes_" : ["{actor} set the message expiration to %n minutes"],
    ...
    "_Call with %n guest was ended, as it reached the maximum call duration (Duration {duration})_::_Call with %n guests was ended, as it reached the maximum call duration (Duration {duration})_" : ["Call with %n guests was ended, as it reached the maximum call duration (Duration {duration})"],
    "_Call with %n guest ended (Duration {duration})_::_Call with %n guests ended (Duration {duration})_" : ["Call with %n guests ended (Duration {duration})"],
    "_{actor} ended the call with %n guest (Duration {duration})_::_{actor} ended the call with %n guests (Duration {duration})_" : ["{actor} ended the call with %n guests (Duration {duration})"],
    ...
    "_{participant0}, {participant1} and %n other will receive invitations_::_{participant0}, {participant1} and %n others will receive invitations_" : ["{participant0}, {participant1} and %n others will receive invitations"],
    ...
    "_%n person accepted_::_%n people accepted_" : ["%n people accepted"],
    "_%n person declined_::_%n people declined_" : ["%n people declined"],
    "_and %n other attachment_::_and %n other attachments_" : ["and %n other attachments"],
    ...
    "_%n invalid email_::_%n invalid emails_" : ["%n invalid emails"],
    "_%n email is already imported or a duplicate_::_%n emails are already imported or duplicates_" : ["%n email is already imported or a duplicate"],
    "_%n invitation can be sent_::_%n invitations can be sent_" : ["%n invitations can be sent"],
    ...
    "_Poll draft • %n option_::_Poll draft • %n options_" : ["Poll draft • %n options"],
    "_%n vote_::_%n votes_" : ["%n vote"],
    ...
    "_and %n other participant_::_and %n other participants_" : ["and %n other participants"],
    ...
    "_{user1}, {user2}, {user3} and %n other are typing …_::_{user1}, {user2}, {user3} and %n others are typing …_" : ["{user1}, {user2}, {user3} and %n others are typing …"],
    ...
    "Add users or groups" : "ເພີ່ມ ຜຸ້ໃຊ້ ຫຼື ກຸ່ມ",
    ...
    "_{done} of %n task_::_{done} of %n tasks_" : ["{done} of %n tasks"],
    "Add participants to this call" : "Add participants to this call",
    "_%n participant in call_::_%n participants in call_" : ["%n participants in call"],
    ...
    "_You added {user0}, {user1} and %n more participant_::_You added {user0}, {user1} and %n more participants_" : ["You added {user0}, {user1} and %n more participants"],
    ...
    "_An administrator added you, {user0} and %n more participant_::_An administrator added you, {user0} and %n more participants_" : ["An administrator added you, {user0} and %n more participants"],
    "_{actor} added you, {user0} and %n more participant_::_{actor} added you, {user0} and %n more participants_" : ["{actor} added you, {user0} and %n more participants"],
    ...
    "_An administrator added {user0}, {user1} and %n more participant_::_An administrator added {user0}, {user1} and %n more participants_" : ["An administrator added {user0}, {user1} and %n more participants"],
    "_{actor} added {user0}, {user1} and %n more participant_::_{actor} added {user0}, {user1} and %n more participants_" : ["{actor} added {user0}, {user1} and %n more participants"],
    "You removed {user0} and {user1}" : "You removed {user0} and {user1}",
    "_You removed {user0}, {user1} and %n more participant_::_You removed {user0}, {user1} and %n more participants_" : ["You removed {user0}, {user1} and %n more participants"],
    ...
    "_An administrator removed you, {user0} and %n more participant_::_An administrator removed you, {user0} and %n more participants_" : ["An administrator removed you, {user0} and %n more participants"],
    "_{actor} removed you, {user0} and %n more participant_::_{actor} removed you, {user0} and %n more participants_" : ["{actor} removed you, {user0} and %n more participants"],
    ...
    "_An administrator removed {user0}, {user1} and %n more participant_::_An administrator removed {user0}, {user1} and %n more participants_" : ["An administrator removed {user0}, {user1} and %n more participants"],
    "_{actor} removed {user0}, {user1} and %n more participant_::_{actor} removed {user0}, {user1} and %n more participants_" : ["{actor} removed {user0}, {user1} and %n more participants"],
    "You and {user0} joined the call" : "You and {user0} joined the call",
    "_You, {user0} and %n more participant joined the call_::_You, {user0} and %n more participants joined the call_" : ["You, {user0} and %n more participants joined the call"],
    "{user0} and {user1} joined the call" : "{user0} and {user1} joined the call",
    "_{user0}, {user1} and %n more participant joined the call_::_{user0}, {user1} and %n more participants joined the call_" : ["{user0}, {user1} and %n more participant joined the call"],
    "You and {user0} left the call" : "You and {user0} left the call",
    "_You, {user0} and %n more participant left the call_::_You, {user0} and %n more participants left the call_" : ["You, {user0} and %n more participants left the call"],
    "{user0} and {user1} left the call" : "{user0} and {user1} left the call",
    "_{user0}, {user1} and %n more participant left the call_::_{user0}, {user1} and %n more participants left the call_" : ["{user0}, {user1} and %n more participants left the call"],
    "You promoted {user0} and {user1} to moderators" : "You promoted {user0} and {user1} to moderators",
    "_You promoted {user0}, {user1} and %n more participant to moderators_::_You promoted {user0}, {user1} and %n more participants to moderators_" : ["You promoted {user0}, {user1} and %n more participants to moderators"],
    ...
    "_An administrator promoted you, {user0} and %n more participant to moderators_::_An administrator promoted you, {user0} and %n more participants to moderators_" : ["An administrator promoted you, {user0} and %n more participants to moderators"],
    "_{actor} promoted you, {user0} and %n more participant to moderators_::_{actor} promoted you, {user0} and %n more participants to moderators_" : ["{actor} promoted you, {user0} and %n more participants to moderators"],
    ...
    "_An administrator promoted {user0}, {user1} and %n more participant to moderators_::_An administrator promoted {user0}, {user1} and %n more participants to moderators_" : ["An administrator promoted {user0}, {user1} and %n more participants to moderators"],
    "_{actor} promoted {user0}, {user1} and %n more participant to moderators_::_{actor} promoted {user0}, {user1} and %n more participants to moderators_" : ["{actor} promoted {user0}, {user1} and %n more participants to moderators"],
    "You demoted {user0} and {user1} from moderators" : "You demoted {user0} and {user1} from moderators",
    "_You demoted {user0}, {user1} and %n more participant from moderators_::_You demoted {user0}, {user1} and %n more participants from moderators_" : ["You demoted {user0}, {user1} and %n more participants from moderators"],
    ...
    "_An administrator demoted you, {user0} and %n more participant from moderators_::_An administrator demoted you, {user0} and %n more participants from moderators_" : ["An administrator demoted you, {user0} and %n more participants from moderators"],
    "_{actor} demoted you, {user0} and %n more participant from moderators_::_{actor} demoted you, {user0} and %n more participants from moderators_" : ["{actor} demoted you, {user0} and %n more participant from moderators"],
    ...
    "_An administrator demoted {user0}, {user1} and %n more participant from moderators_::_An administrator demoted {user0}, {user1} and %n more participants from moderators_" : ["An administrator demoted {user0}, {user1} and %n more participants from moderators"],
    "_{actor} demoted {user0}, {user1} and %n more participant from moderators_::_{actor} demoted {user0}, {user1} and %n more participants from moderators_" : ["{actor} demoted {user0}, {user1} and %n more participants from moderators"],
    "You:" : "You:",
    ...
    "_Poll results • %n vote_::_Poll results • %n votes_" : ["Poll results • %n votes"],
    "_Open poll • %n vote_::_Open poll • %n votes_" : ["Open poll • %n votes"],
