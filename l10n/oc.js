OC.L10N.register(
    ...
    "An administrator added {phone}" : "Un administrator a apondut {phone}",
    "{actor} removed {phone}" : "{actor} a levat {phone}",
    "You removed {phone}" : "Avètz tirat {phone}",
    "An administrator removed {phone}" : "Un administrator a tirat {phone}",
    ...
    "Path must point to a file" : "Lo camin deu menar a un fichièr",
    ...
    "Poll" : "Sondatge",
    "Uploading the file failed" : "Fracàs del mandadís del fichièr",
    ...
    "None" : "Cap",
    "Microphone" : "Microfòn",
    "Microphone settings" : "Paramètres del microfòn",
    ...
    "Hide presenter video" : "Amagar la vidèo del presentator",
    ...
    "Copy password" : "Copiar lo senhal",
    ...
    "Open conversation to registered users, showing it in search results" : "Dobrir la conversacion als utilizaires enregistrats, la far veire als resultats de recèrca",
    "Open conversation" : "Dobrir la conversacion",
    "Set language spoken in calls" : "Definir la lenga utilizada dins las sonadas",
    ...
    "Important conversation" : "Conversacion importanta",
    "\"Do not disturb\" user status is ignored for important conversations" : "L’estatut utilizaire « Destorbar pas » es ignorat per las conversacions importantas",
    "Sensitive conversation" : "Conversacion sensibla",
    "Recording Consent" : "Consentiment d'enregistrament",
    "Join" : "Rejónher",
    "Error while creating the conversation" : "Error pendent la creacion de la conversacion",
    "Hello, {displayName}" : "Adieu, {displayName}",
    "Create and copy link" : "Crear e copiar lo ligam",
    ...
    "Ignore \"Do not disturb\"" : "Ignorar « Destorbar pas »",
    "Conversation actions" : "Accions de conversacion",
    "Tags" : "Etiquetas",
    "Notify about calls" : "Notificar de las sonadas",
    "Hide message text" : "Amagar lo messatge tèxt",
    "Home" : "Acuèlh",
    ...
    "Join open conversations" : "Rejónher de conversacions dobèrtas",
    "Threads" : "Fils",
    "Show more threads" : "Mostrar mai de fils",
    ...
    "Notify all participants about this call" : "Notificar totes los participants d’aquesta sonada",
    "Select virtual home background" : "Seleccionar un rèireplan d’acuèlh virtual",
    "Select a file" : "Seleccionar un fichièr",
    ...
    "All set, the conversation \"{conversationName}\" was created." : "Lèst, la conversacion « {conversationName} » es estada creada.",
    "Create a new group conversation" : "Crear una conversacion de grop",
    ...
    "Write a message without notification" : "Escriure un messatge sens notificacion",
    ...
    "Hide list of participants" : "Amagar la lista dels participants",
    "Stop session" : "Arrestar la session",
    "Calls without High-performance backend can cause connectivity issues and high load on devices. {linkstart}Learn more{linkend}" : "Las sonadas sens infrastructura de naut rendiment, High-performance backend, pòdon causar de problèmas de connectivitat e una carga elevada suls periferics. {linkstart}Ne saber mai{linkend}",
    ...
    "Copy phone number" : "Copiar lo numèro de telefòn",
    ...
    "Search in {name}" : "Cercar {name}",
    "Threads in {name}" : "Fils dins {name}",
    "{actor} in {conversation}" : "{actor} dins {conversation}",
    "Load more results" : "Cargar mai de resultats",
    "Recent threads" : "Fils recents",
    "Projects" : "Projèctes",
    ...
    "Return to Home screen" : "Tornar a l’ecran d’acuèlh",
