OC.L10N.register(
    ...
    "Unban" : "رفع الحظر",
    "<strong>Banned by:</strong> {actor}" : "<strong>محظورٌ من قِبَل:</strong> {actor}",
    "<strong>Note:</strong> {note}" : "<strong>ملاحظة:</strong> {note}",
    ...
    "Background blur for Nextcloud instance can be adjusted in the theming settings." : "تضبيب الخلفية في نكست كلاود يمكن ضبطه من خلال إعدادات الثيمات theming",
    ...
    "<strong>Date:</strong> {date}" : "<strong>التاريخ:</strong> {date}",
    "Media" : "وسائط",
