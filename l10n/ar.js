OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 دع المحادثات تتدفق: أشِر إلى المُستخدِمين، وتفاعل مع الرسائل؛ والمزيد. \n\nيمكنك الإشارة إلى جميع المُشارِكين في المحادثة باستعمال الرمز @all أو الإشارة إلى مُشارِكين مُحدَّدِين عن طريق كتابة \"@\" واختيار الاسم من القائمة.",
    ...
    "Attendees" : "المشاركون",
    "Invite all users and emails" : "قُم بدعوة كل الأشخاص والإيميلات ",
    ...
    "Generating summary of unread messages ..." : "توليد مُلخَّص بالرسائل غير المقرؤة ...",
