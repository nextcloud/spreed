OC.L10N.register(
    ...
    "Say hi to your friends and colleagues!" : "رحّب بالأصدقاء و الزملاء!",
    ...
    "Invite {user}" : "أرسل دعوةً إلى {user}",
    ...
    "Default permissions modified for {conversationName}" : "تم تعديل الأذونات الافتراضية لـ {conversationName}",
    "Could not modify default permissions for {conversationName}" : "تعذر تعديل الأذونات الافتراضية لـ {conversationName}",
    ...
    "Resend invitations" : "إعادة إرسال الدّعوَات ",
    ...
    "Hello, {displayName}" : "أهلا، {displayName} ",
    "New conversation" : "محادثة جديدة",
    "Call a phone number" : "اتَّصِل برقم هاتف",
    "Unread mentions" : "إشاراتٌ غير مقروءة",
    ...
    "_%n vote_::_%n votes_" : ["%n أصوات","%n صوت","%n أصوات","%n أصوات","%n أصوات","%n أصوات"],
    ...
    "Owner" : "المالك",
    "Moderator" : "مشرف",
    "Settings for participant \"{user}\"" : "إعدادات المشارك \"{user}\"",
    ...
    "Remove group and members" : "حذف المجموعة group و الأعضاء",
    ...
    "Invitation was sent to {actorId}" : "تمّ إرسال الدعوة إلى {actorId}",
    ...
    "{actor} in {conversation}" : "{actor} في {conversation}",
    ...
    "Local time: {time}" : "الوقت المحلّي: {time}",
    "Search" : "بحث",
    ...
    "Join a conversation or start a new one" : "إنضم لمحادثةٍ او ابدأ محادثةً جديدةً",
