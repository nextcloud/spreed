OC.L10N.register(
    ...
    "Now" : "الآن",
    "Error: Invalid calendar selected" : "خطأ: التقويم الذي تم اختياره غير صحيح",
    "Error: Invalid start time selected" : "خطأ: وقت البداية الذي تمّ اختياره غير صحيح",
    "Error: Invalid end time selected" : "خطأ: وقت الانتهاء الذي تم اختياره غير صحيح",
    ...
    "Invite all users and email guests" : "دعوة كل المستخدِمين و ضيوف البريد الإلكتروني",
    "Select attendees" : "تحديد الحُضُور",
    "Save" : "حفظ",
    "Search participants" : "البحث عن مشاركين",
    "No results" : "دون أية نتيجة",
    "_Sending %n invitation_::_Sending %n invitations_" : ["إرسال %n دعوة","إرسال %n دعوة","إرسال %n دعوة","إرسال %n دعوات","إرسال %n دعوة","إرسال %n دعوة"],
