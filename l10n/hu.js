OC.L10N.register(
    ...
    "Show presenter" : "Előadó mutatása",
    ...
    "Current message expiration" : "Jelenlegi üzenet elévülés",
    ...
    "You have no unread mentions in your inbox." : "Nincs olvasatlan említés a beérkező üzenetek között.",
    "You have no unread messages in your inbox." : "Nincs olvasatlan üzenet a beérkező üzenetek között.",
    "Your inbox is empty." : "Nincs beérkezett üzenet",
    ...
    "Message forwarded to \"Note to self\"" : "Az üzenet továbbítva a \"Saját jegyzetek\"-be",
    "Error while forwarding message to \"Note to self\"" : "Az üzenet \"Saját jegyzetek\" közé továbbítása nem sikerült.",
    ...
    "Start a call before you start a breakout room session" : "Indítson el egy hívást mielőtt szobabontást indít",
    ...
    "Sounds can currently not be played on iPad and iPhone devices due to technical restrictions by the manufacturer." : "A hangok jelenleg nem játszhatók le iPad és iPhone készülékeken a gyártó technikai korlátozásai miatt.",
    ...
    "An administrator added you and {user0}" : "Egy rendszergazda hozzáadta Önt és {user} felhasználót",
    "{actor} added you and {user0}" : "{actor} hozáadta Önt és {user0} -t",
    "An administrator added {user0} and {user1}" : "Egy rendszergazda hozzáadta {user0} és {user1} felhasználókat",
    "{actor} added {user0} and {user1}" : "{actor} hozzáadta {user0} -t és {user1} -t",
    ...
    "{actor} promoted you and {user0} to moderators" : "{actor} moderátorrá léptette elő Önt és {user0} -t",
