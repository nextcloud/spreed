OC.L10N.register(
    ...
    "- Moderators can now create breakout rooms (requires the external signaling server)" : "- A moderátorok mostantól szobabontást hozhatnak létre (külső jelzőkiszolgálót igényel)",
    "- Calls can now be recorded (requires the external signaling server)" : "- A hívások mostantól felvehetők (külső jelzőkiszolgálót igényel)",
    ...
    "Missing high-performance backend warning hidden" : "Hiányzó nagy teljesítményű háttérrendszer figyelmeztetésének elrejtve",
