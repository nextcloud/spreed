OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- A moderátorok most már kitűzhetnek bejegyzéseket, így felül maradnak",
    "- Schedule a message to send it at a later time" : "- Üzenet ütemezése későbbi elküldésre",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Beszélgetéscímkék, csoportosítás és rendezés a beszélgetéslisták szervezéséhez",
    "- Voice-rooms to connect spontaneously" : "- Hangszobás a spontán kapcsolódáshoz",
    ...
    "- Channels and announcements to broadcast information to a broader audience" : "- Csatornák és bejelentések a nagyobb közönségnek szóló információközléshez",
    ...
    "{actor} preserved the conversation" : "{actor} megőrizte a beszélgetést",
    "You preserved the conversation" : "Megőrizte a beszélgetést",
    "An administrator preserved the conversation" : "Egy rendszergazda megőrizte a beszélgetést",
    "{actor} stopped preserving the conversation" : "{actor} leállította a beszélgetés megőrzését",
    "You stopped preserving the conversation" : "Leállította a beszélgetés megőrzését",
    "An administrator stopped preserving the conversation" : "Egy rendszergazda leállította a beszélgetés megőrzését",
    ...
    "System added you" : "A rendszer hozzáadta",
    "System added {user}" : "A rendszer hozzáadta: {user}",
    ...
    "{actor} promoted {user} to owner" : "{actor} tulajdonossá léptette elő: {user}",
    "You promoted {user} to owner" : "Tulajdonossá léptette elő: {user}",
    "{actor} promoted you to owner" : "{actor} tulajdonossá léptette elő",
    "An administrator promoted you to owner" : "Egy rendszergazda tulajdonossá léptette elő",
    "An administrator promoted {user} to owner" : "Egy rendszergazda tulajdonossá léptette elő: {user}",
    "{actor} demoted {user} from owner" : "{actor} visszavonta {user} tulajdonosi kinevezését",
    "You demoted {user} from owner" : "Visszavonta {user} tulajdonosi kinevezését",
    "{actor} demoted you from owner" : "{actor} visszavonta a tulajdonosi kinevezését",
    "An administrator demoted you from owner" : "Egy rendszergazda visszavonta a tulajdonosi kinevezését",
    "An administrator demoted {user} from owner" : "Egy rendszergazda visszavonta {user} tulajdonosi kinevezését",
    ...
    "{actor} shared a file which is no longer available" : "{actor} megosztott egy fájlt, amely már nem érhető el",
    "You shared a file which is no longer available" : "Megosztott egy fájlt, amely már nem érhető el",
    ...
    "{actor} set up Matterbridge to synchronize this conversation with other chats" : "{actor} beállította a Matterbridge-et, hogy szinkronizálja ezt a beszélgetést más beszélgetésekkel",
    "You set up Matterbridge to synchronize this conversation with other chats" : "Beállította a Matterbridge-et, hogy szinkronizálja ezt a beszélgetést más beszélgetésekkel",
    ...
    "{actor} started Matterbridge" : "{actor} elindította a Matterbridge-et",
    "You started Matterbridge" : "Elindította a Matterbridge-et",
    "{actor} stopped Matterbridge" : "{actor} leállította a Matterbridge-et",
    "You stopped Matterbridge" : "Leállította Matterbridge-et",
    ...
    "{actor} deleted a reaction" : "{actor} törölt egy reakciót",
    ...
    "Call %s" : "%s hívása",
    "Chat with %s" : "Beszélgetés vele: %s",
    ...
    "Conversation subfolders are disabled" : "A beszélgetések almappa le van tiltva",
    "Storage quota exceeded" : "Tárhelykvóta túllépve",
    "Could not prepare conversation folder" : "Nem sikerült a beszélgetésmappa előkészítése",
    "File not found" : "A fájl nem található",
    "Path must point to a file" : "Az elérési útnak egy fájlra kell mutatnia",
    "File is not inside the conversation draft folder for this room" : "A fájl nincs a szobához tartozó beszélgetésvázlat-mappában",
    ...
    "Missing %s field in header line" : "Hiányzó %s mező a fejlécsorban",
    ...
    "{guest} (guest) in {call}" : "{guest} (vendég) itt: {call}",
    ...
    "Call via Talk" : "Hívás a Beszélgetéssel",
    ...
    "Channel" : "Csatorna",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Tömegkommunikáció nagy közönség számára, ahol csak a moderátorok tehetnek közzé bejegyzéseket, és a hívások le vannak tiltva.",
    "Classified conversation" : "Bizalmas beszélgetés",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Zárolt beszélgetés bizalmas témákhoz, ahol a nyilvános elérés, a vendégek, a SIP és a felvételek le vannak tiltva.",
    "Default" : "Alapértelmezett",
    "Send messages, create threads, and start voice and video calls." : "Üzenetek küldése, szálak létrehozása, hang- és videóhívások indítása.",
    "Presentation" : "Bemutató",
    "Restricted conversation for internal presentations." : "Korlátozott beszélgetés belső prezentációkhoz.",
    "Voice room" : "Hangos szoba",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Közvetlen csatlakozás a híváshoz, ideális a felzárkózáshoz vagy a spontán megbeszélésekhez.",
    "Webinar" : "Webinár",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Korlátozott beszélgetés bekapcsolt váróval, a nyilvános webinárok számára ideális.",
    ...
    "The URL is invalid." : "A webcím érvénytelen.",
    "An HTTPS URL is required." : "Egy HTTPS webcím szükséges.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "A Kliensleküldés telepítve van, ez növeli a Beszélgetés értesítéseinek pontosságát.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "A {notify_push} nincs telepítve. Ez késleltetett Beszélgetés értesítésekhez vezethet.",
    ...
    "Open in full application" : "Megnyitás a teljes alkalmazásban",
    ...
    "Limit starting calls to certain groups" : "Hívásindítás bizonyos csoportokra korlátozása",
    "Limit starting a call" : "Hívásindítás korlátozása",
    "Limit starting calls" : "Hívások indításának korlátozása",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Ha legalább egy csoport ki van választva, akkor csak ezen csoportok tagjai tudnak hívást indítani. Ez a moderátorokra is vonatkozik, míg a vendégek és a föderált felhasználók sosem tagjai ezen csoportoknak. Viszont ha nincs csoport kiválasztva, akkor bárki indíthat hívást.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "A föderált kiszolgálón lévő beszélgetésekre a gazdakiszolgáló konfigurációja vonatkozik.",
    ...
    "Room {roomNumber}" : "{roomNumber}. szoba",
    ...
    "Enable live transcription (generated by AI)" : "Élő leiratozás bekapcsolása (MI által előállítva)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Élő leiratozás bekapcsolása (Az Élő leiratozás alkalmazás nincs telepítve)",
    "Disable live translation" : "Élő fordítás bekapcsolása",
    "Enable live translation (generated by AI)" : "Élő fordítás bekapcsolása (MI által előállítva)",
    "Original language" : "Eredeti nyelv",
    "Live translations app is not installed" : "Az Élő fordítás alkalmazás nincs telepítve",
    "Original language: {languageName}" : "Eredeti nyelv: {languageName}",
    "Translated language" : "Fordítás nyelve",
    "Translated language: {languageName}" : "Fordítás nyelve: {languageName}",
    ...
    "Multi-speaker view" : "Több beszélős nézet",
    ...
    "Failed to enable live transcription" : "Nem sikerült az élő leiratozás bekapcsolása",
    "Failed to enable live translations" : "Nem sikerült az élő fordítás bekapcsolása",
    "Failed to disable live translations" : "Nem sikerült az élő fordítás kikapcsolása",
    ...
    "Collapse participant bar" : "Résztvevői sáv összecsukása",
    "Expand participant bar" : "Résztvevői sáv kibontása",
    ...
    "You" : "Ön",
    "You are sharing a screen" : "Megoszt egy képernyőt",
    "Sharing this window may cause a mirroring effect" : "Az ablak megosztása tükörhatást okozhat",
    ...
    "Disable" : "Letiltás",
    "Enable" : "Engedélyezés",
    "The bot is not available anymore" : "A bot már nem érhető el",
    ...
    "Participants can use all available features." : "A résztvevők használhatják az összes elérhető funkciót.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "A résztvevők korlátozott funkciókészletet kapnak amíg egy moderátor nem ad nekik kézileg további jogosultságokat.",
    ...
    "Live transcriptions app is not installed" : "Az Élő leiratozás alkalmazás nincs telepítve",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Ez a beszélgetés meg van őrizve. Nem törölhető, és a csevegési üzenetek nem távolíthatók el.",
    ...
    "Error when trying to set message expiration" : "Hiba az üzenet elévülésének beállítása során",
    "Chat messages can be expired after a certain time. Note: Files shared in chat will not be deleted for the owner, but will no longer be shared in the conversation." : "A csevegési üzenetek bizonyos idő után elévülhetnek. Megjegyzés: A csevegésben megosztott fájlok nem törlődnek a tulajdonosuk számára, csak többé nem lesznek megosztva a beszélgetéssel.",
    ...
    "This setting can not be changed while the conversation is preserved." : "Ez a beállítás nem változtatható meg, amíg a beszélgetés meg van őrizve.",
    ...
    "This conversation is password-protected. Guests need password to join" : "Ez a beszélgetés jelszóval van védve. A vendégeknek jelszó szükséges a csatlakozáshoz.",
    ...
    "The entered token does not match the conversation token" : "A megadott token nem egyezik a beszélgetés tokenjével",
    "Preserve conversation" : "Beszélgetés megőrzése",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Amíg ez a beszélgetés megőrzésre kerül, addig nem lehet törölni, a csevegési előzményeit nem lehet eltávolítani, a vendégek és a csatlakozási beállítások sem módosíthatók.",
    "Only the owner can change whether this conversation is preserved." : "Csak a tulajdonos módosíthatja, hogy ez a beszélgetés meg legyen-e őrizve.",
    ...
    "Stop preserving" : "Megőrzés leállítása",
    "Stop preserving conversation" : "Beszélgetés megőrzésének leállítása",
    "Conversation token" : "Beszélgetés tokenje",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Ha leállítja a beszélgetés megőrzését, akkor le lehet törölni, a beszélgetési előzményeket el lehet távolítani, a vendégeket és a csatlakozási beállításokat újból meg lehet változtatni.",
    "Conversation" : "Beszélgetés",
    "To confirm, type the conversation token into the field below:" : "A megerősítéshez gépelje be a beszélgetés tokenjét az alábbi mezőbe:",
    "Ongoing" : "Folyamatban",
    ...
    "Join conversations" : "Csatlakozás beszélgetésekhez",
    ...
    "Calendar events with a conversation link as the location are shown here" : "A beszélgetési hivatkozást helyszínként tartalmazó naptáresemények itt jelennek meg",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "A tartalomformátum CSV (vesszővel elválasztott értékek):<br/>- A fejlécsor kötelező, és egyeznie kell ezek egyikével: {sample1} vagy csak {sample2}<br/>- Soronként egy bejegyzés (például {sample3})",
    ...
    "Remove all tags" : "Összes címke eltávolítása",
    "Rename tag" : "Címke átnevezése",
    "Delete tag" : "Címke törlése",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Biztos, hogy törli: „{name}”? Az ilyen címkéjű beszélgetések átkerülnek az „Egyebek” csoportba.",
    "Move up" : "Mozgatás fel",
    "Move down" : "Mozgatás le",
    "Pending invitations" : "Függőben lévő meghívások",
    "Join conversations from other servers" : "Csatlakozás beszélgetésekhez más kiszolgálókról",
    ...
    "Meetings" : "Találkozók",
    "Sort conversations" : "Beszélgetések rendezése",
    "By recent activity" : "Legfrissebb tevékenység",
    "Alphabetically" : "Betűrendben",
    "Do not group by type" : "Ne csoportosítsa típus szerint",
    "Show private ones first" : "Privátak megjelenítése elöl",
    "Show group ones first" : "Csoportosak megjelenítése elöl",
    "No followed threads" : "Nincs követett szál",
    ...
    "Search in app" : "Keresés alkalmazásban",
    ...
    "SIP backend is not installed" : "Nincs telepítve SIP háttérrendszer",
    ...
    "Enable noise suppression" : "Hangelnyomás bekapcsolása",
    "Reduce background noises for better voice quality" : "Csökkenti a háttérzajokat a jobb hangminőség érdekében",
    "Basic" : "Alapvető",
    "Advanced" : "Speciális",
    "Enable echo cancellation" : "Visszhangkioltás bekapcsolása",
    "Minimize echo effect from own surrounding" : "Környezetből fakadó visszhanghatás minimalizálása",
    "Enable auto gain control" : "Automatikus erősítésvezérlés bekapcsolása",
    "Dynamically adjust microphone volume for consistent level" : "Mikrofon hangerejének dinamikus igazítása a konzisztens szint eléréséhez",
    ...
    "You can only join a voice room via a call." : "Hangszobához csak hívással kapcsolódhat.",
    ...
    "Recording backend is not installed" : "Nincs telepítve a rögzítési háttérrendszer",
    ...
    "7 days" : "7 nap",
    "30 days" : "30 nap",
    "Until unpin" : "Kitűzés megszüntetéséig",
    "Clear reminder – {timeLocale}" : "Emlékeztető törlése – {timeLocale}",
    "Edited by {actor}" : "Szerkesztette: {actor}",
    "Pinned by you" : "Ön tűzte ki",
    "Pinned by {actor}" : "{actor} tűzte ki",
    "Until {absoluteDate}" : "Eddig: {absoluteDate}",
    ...
    "Unpin message" : "Üzenet kitűzésének megszüntetése",
    ...
    "Download folder" : "Mappa letöltése",
    ...
    "Keep pinned for" : "Kitűzve tartás eddig:",
    "Set custom period" : "Egyéni időszak beállítása",
    ...
    "This translation is AI generated and may contain mistakes." : "Ez a fordítás MI használatával készült, és hibákat tartalmazhat.",
    "Copy translated text" : "Lefordított szöveg másolása",
    "Error when scheduling the message" : "Hiba az üzenet ütemezése során",
    "Reschedule" : "Újraütemezés",
    "Send now" : "Küldés most",
    "Choose a time" : "Válasszon egy időt",
    "Send at custom time" : "Küldés egyéni időben",
    "Will be sent without notification" : "Értesítés nélkül lesz elküldve",
    ...
    "Reply to thread \"{threadTitle}\"" : "Válasz a(z) „{threadTitle}” szálban",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Szavazott • %n szavazat","Szavazott • %n szavazat"],
    "You voted" : "Szavazott",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Kattintson a szavazáshoz • %n szavazat","Kattintson a szavazáshoz • %n szavazat"],
    "Click to vote" : "Kattintson a szavazáshoz",
    "_Poll draft • %n option_::_Poll draft • %n options_" : ["Szavazásvázlat • %n lehetőség","Szavazásvázlat • %n lehetőség"],
    "_%n vote_::_%n votes_" : ["%n szavazat","%n szavazat"],
    ...
    "Generate summary with AI" : "Összefoglaló előállítása MI-vel",
    "{author} (pinned by you)" : "{author} (Ön tűzte ki)",
    "{author} (pinned by {actor})" : "{author} ({actor} tűzte ki)",
    ...
    "Default parameters are:" : "Az alapértelmezett paraméterek:",
    "These settings can be changed once the conversation is created." : "Ezek a beállítások a beszélgetés létrehozása után megváltoztathatóak.",
    ...
    "Message was successfully scheduled" : "Az üzenet sikeresen be lett ütemezve",
    ...
    "Show scheduled messages" : "Ütemezett üzenetek megjelenítése",
    "Cancel editing" : "Szerkesztés megszakítása",
    "Schedule message" : "Üzenet ütemezése",
    ...
    "Record voice message" : "Hangüzenet felvétele",
    ...
    "Voice message {time} ({conversation})" : "Hangüzenet {time} ({conversation})",
    ...
    "Standard image quality" : "Szokásos képminőség",
    "Original image quality" : "Eredeti képminőség",
    "View-only for others" : "Mások által csak megtekinthető",
    "Editable by others" : "Mások által szerkeszthető",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Végső eredmények • %n szavazat","Végső eredmények • %n szavazat"],
    "_%n vote • Your vote is anonymous_::_%n votes • Your vote is anonymous_" : ["%n szavazat • A szavazata anonim","%n szavazat • A szavazata anonim"],
    "Your vote is anonymous" : "A szavazata anonim",
    "You voted for this option" : "Erre a lehetőségre szavazott",
    "End poll" : "Szavazás befejezése",
    "Change your vote" : "Szavazat módosítása",
    "Withdraw vote" : "Szavazat visszavonása",
    "Results" : "Eredmények",
    "Download as spreadsheet" : "Letöltés munkafüzetként",
    "Download as CSV" : "Letöltés CSV-ként",
    ...
    "The last moderator of a conversation can not be demoted" : "A beszélgetés utolsó moderátora nem fokozható le",
    "Could not change the type of the participant" : "Nem sikerült a résztvevő típusának módosítása",
    ...
    "Promote to owner" : "Kinevezés tulajdonossá",
    "Demote from moderator" : "Lefokozás moderátorról",
    "Promote to moderator" : "Kinevezés moderátorrá",
    "Demote from owner to moderator" : "Lefokozás tulajdonosról moderátorrá",
    "Demote from owner to participant" : "Lefokozás tulajdonosról résztvevővé",
    ...
    "Pinned by a deleted user" : "Törölt felhasználó tűzte ki",
    ...
    "I picked message bubbles" : "Üzenetbuborékokat választottam",
    "I picked the list style" : "Listastílust választottam",
    ...
    "Chat appearance" : "Csevegés megjelenése",
    "Messages list" : "Üzenetlista",
    ...
    "Invalid language ({languageId})" : "Érvénytelen nyelv ({languageId})",
    "Default language" : "Alapértelmezett nyelv",
    "Default language ({languageName})" : "Alapértelmezett nyelv ({languageName})",
    "Error when trying to load the available live translation languages" : "Hiba történt az elérhető élő fordítási nyelvek betöltése során",
    "Error when trying to set live translation language" : "Hiba történt az élő fordítás nyelvének beállítása során",
    "Set language used to show the transcriptions" : "A leiratozás megjelenítéséhez használt nyelv beállítása",
    ...
    "Skip device preview before joining a call" : "Eszközelőnézet kihagyása a híváshoz való csatlakozás előtt",
    "Camera will be turned off when joining. Always shown if recording consent is required." : "A kamera csatlakozáskor ki lesz kapcsolva. Mindig megjelenik, ha felvételi hozzájárulás szükséges.",
    ...
    "The server was updated, you cannot start or join a call." : "A kiszolgáló frissítve lett, nem indíthat vagy csatlakozhat híváshoz.",
    ...
    "Scheduled messages" : "Ütemezett üzenetek",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Ez a beszélgetés %n perc tétlenség után mindenki számára törölve lesz.","Ez a beszélgetés %n perc tétlenség után mindenki számára törölve lesz."],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Ez a beszélgetés %n nap tétlenség után mindenki számára törölve lesz.","Ez a beszélgetés %n nap tétlenség után mindenki számára törölve lesz."],
    ...
    "Scheduled {datetime}" : "Ütemezve: {datetime}",
    "Scheduled for {datetime}" : "Ütemezve: {datetime}",
    "Search" : "Keresés",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Ez a beszélgetés egy másik lapon meg lett nyitva. A kiszolgáló jelenlegi verziója nem támogatja a beszélgetések több lapon való megjelenítését.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hé! Listastílust vagy üzenetbuborékokat használsz?",
    ...
    "Audio" : "Hang",
    "Show all pinned messages" : "Összes kitűzött üzenet megjelenítése",
    ...
    "The server was updated." : "A kiszolgáló frissítve lett.",
    ...
    "Error while changing the preserved status of the conversation" : "Hiba történt a beszélgetés védettségi állapotának módosítása során",
    ...
    "Error renaming tag" : "Hiba a címke átnevezése során",
    "Error deleting tag" : "Hiba a címke törlése során",
    "Error reordering tags" : "Hiba a címkék átrendezése során",
    ...
    "The server is in maintenance mode." : "A kiszolgáló karbantartási módban van.",
    "Federated server was updated." : "A föderált kiszolgáló frissítve lett.",
    ...
    "Set time for later today" : "Idő beállítása későbbre a mai nap",
    "Tomorrow – {timeLocale}" : "Holnap – {timeLocale}",
    "Set time for tomorrow" : "Idő beállítása holnapra",
    "This weekend – {timeLocale}" : "Ez a hétvége – {timeLocale}",
    "Set time for this weekend" : "Idő beállítása a hétvégére",
    "Next week – {timeLocale}" : "Következő hét – {timeLocale}",
    "Set time for next week" : "Idő beállítása a következő hétre",
    ...
    "Connecting is taking longer than expected …" : "A kapcsolódás a vártnál tovább tart…",
    "Failed to connect. Retrying …" : "Nem sikerült a csatlakozás. Újrapróbálkozás…",
    "Failed to connect. The signaling server may be set up incorrectly" : "Nem sikerült a csatlakozás. A jelzőkiszolgáló lehet, hogy helytelenül van beállítva.",
    "High-performance backend needs to be updated." : "Frissíteni kell a nagy teljesítményű háttérrendszert.",
    "The server is misconfigured. Please contact your administration." : "A kiszolgáló hibásan van beállítva. Vegye fel a kapcsolatot a rendszergazdával.",
    ...
    "Enable live translation" : "Élő fordítás bekapcsolása",
    "_Open poll • %n vote • Your vote is anonymous_::_Open poll • %n votes • Your vote is anonymous_" : ["Nyitott szavazás • %n szavazat • A szavazata anonim","Nyitott szavazás • %n szavazat • A szavazata anonim"],
    "Open poll • You voted already • Your vote is anonymous" : "Nyitott szavazás • Már szavazott • A szavazata anonim",
