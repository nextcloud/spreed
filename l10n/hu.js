OC.L10N.register(
    ...
    "Could not check for WASM loading support. Please check manually if your web server serves `.wasm` files." : "Nem sikült a WASM fájlok betöltési támogatásának ellenőrzése. Ellenőrizze kézileg, hogy a webkiszolgálója kiszolgálja-e a `.wasm` fájlokat.",
    ...
    "No High-performance backend configured - Running Nextcloud Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "Nincs Nagy teljesítményű háttérrendszer beállítva – A Nextcloud Talk enélküli futtatása csak nagyon kis hívások (legfeljebb 2-3 résztvevő) esetén skálázódik. Állítson be egy nagy teljesítményű háttérrendszert, hogy a több résztvevős hívások is zökkenőmentesek legyenek.",
    ...
    "Anonymous number should appear as \"unknown\" or \"withheld number\" to call recipient" : "A névtelen szám megjelenítése mint „ismeretlen” vagy „visszatartott szám”",
    ...
    "Please note that in calls with more than 2 participants without the High-performance backend, participants will most likely experience connectivity issues and cause high load on participating devices." : "Vegye figyelembe, hogy a 2-nél több résztvevős hívásoknál, a Nagy teljesítményű háttérrendszer nélkül, a résztvevők kapcsolódási problémákat és magas terhelést tapasztalhatnak az eszközükön.",
