OC.L10N.register(
    ...
    "- Call recordings are automatically transcribed if a transcription provider app is registered" : "- Le registrazioni delle chiamate vengono trascritte automaticamente se è registrata un'applicazione di trascrizione.",
    ...
    "{actor} opened the conversation to registered users and users created with the Guests app" : "{actor} ha aperto la conversazione agli utenti registrati e agli utenti creati con l'applicazione Ospiti",
    "You opened the conversation to registered users and users created with the Guests app" : "Hai aperto la conversazione agli utenti registrati e agli utenti creati con l'applicazione Ospiti",
    "An administrator opened the conversation to registered users and users created with the Guests app" : "Un amministratore ha aperto la conversazione agli utenti registrati e agli utenti creati con l'applicazione Ospiti",
    ...
    "{federated_user} accepted the invitation" : "{federated_user} ha accettato l'invito",
    ...
    "You removed the conversation picture" : "Hai rimosso l'immagine della conversazione",
    ...
    "The recording failed" : "La registrazione non è riuscita",
    ...
    "Call was ended, as it reached the maximum call duration (Duration {duration})" : "La chiamata è stata terminata in quanto ha raggiunto la massima durata per le chiamate (Durata {duration})",
    ...
    "_Call with %n guest ended (Duration {duration})_::_Call with %n guests ended (Duration {duration})_" : ["La chiamata con %n ospite è terminata (Durata {duration})","La chiamata con %n ospiti è terminata (Durata {duration})","La chiamata con %n ospiti è terminata (Durata {duration})"],
    ...
    "Message of a deleted user in {conversation}" : "Messaggio di un utente eliminato in {conversation}",
    ...
    "Click the link below to join the lobby now." : "Premi il collegamento in basso per entrare nella stanza adesso.",
    ...
    "Click the link below to join the conversation now." : "Premi il collegamento in basso per entrare nella conversazione ora.",
    "Join \"%s\"" : "Entra in \"%s\"",
    ...
    "Reminder: Deleted user in {call}" : "Promemoria: Utente eliminato in {call}",
    ...
    "Deleted user reacted with {reaction} in {call}" : "L'utente eliminato ha reagito con {reaction} in {call}",
    ...
    "Reminder: A deleted user in private conversation {call}" : "Promemoria: Un utente eliminato nella conversazione privata {call}",
    ...
    "Reminder: A deleted user in conversation {call}" : "Promemoria: Un utente eliminato nella conversazione {call}",
    ...
    "A deleted user mentioned group {group} in conversation {call}" : "Un utente eliminato ha menzionato il gruppo {group} nella conversazione {call}",
    "A deleted user mentioned team {team} in conversation {call}" : "Un utente eliminato ha menzionato il team {team} nella conversazione {call}",
    "A deleted user mentioned everyone in conversation {call}" : "Un utente eliminato ha menzionato chiunque nella conversazione {call}",
    "A deleted user mentioned you in conversation {call}" : "Un utente eliminato ti ha menzionato nella conversazione {call}",
    "{guest} (guest) mentioned group {group} in conversation {call}" : "{guest} (ospite) ha menzionato il gruppo {group} nella conversazione {call}",
    ...
    "An error occurred while installing the Talk Matterbridge. Please install it manually" : "Si è verificato un errore durante l'installazione di Talk Matterbridge. Installalo manualmente.",
    ...
    "Error: Websocket connection failed" : "Errore: connessione Websocket non riuscita",
    ...
    "Reset" : "Ripristina",
    "Delete breakout rooms" : "Elimina sessioni secondarie",
    ...
    "Translated language" : "Lingua tradotta",
    "Translated language: {languageName}" : "Lingua tradotta: {languageName}",
    ...
    "Allow guests to join this conversation via link" : "Permetti agli ospiti di unirsi alla conversazione via collegamento",
    ...
    "Guests are allowed to join this conversation via link" : "Gli ospiti possono partecipare alla conversazione tramite collegamento.",
    ...
    "You opened the conversation to both registered users and users created with the Guests app" : "Hai aperto la conversazione sia agli utenti registrati che agli utenti creati con l'applicazione Ospiti.",
    ...
    "Open conversation to registered users, showing it in search results" : "Apri la conversazione agli utenti registrati, mostrandoli tra i risultati di ricerca",
    ...
    "Create and copy link" : "Crea e copia collegamento",
    ...
    "Unarchive conversation" : "Recupera la conversazione dall'archivio",
    ...
    "Cancel quote" : "Annulla citazione",
    "24 hours" : "24 ore",
    "7 days" : "7 giorni",
    "30 days" : "30 giorni",
    ...
    "_%n vote_::_%n votes_" : ["%n voto","%n voti","%n voti"],
    "Edit poll draft" : "Modifica bozza del sondaggio",
    "Delete poll draft" : "Elimina bozza del sondaggio",
    "Poll" : "Sondaggio",
    ...
    "Delete poll option" : "Elimina opzione del sondaggio",
    ...
    "The message was sent to \"{roomName}\"" : "Il messaggio è stato inviato su \"{roomName}\"",
    ...
    "React with {reaction}" : "Reagisci con {reaction}",
    ...
    "Disable screenshare" : "Disabilita la condivisione dello schermo",
    ...
    "This conversation will be automatically deleted for everyone {expirationDurationFormatted} of no activity." : "Questa conversazione verrà automaticamente eliminata per tutti in caso di inattività per {expirationDurationFormatted}.",
    "Are you sure you want to delete this conversation?" : "Vuoi davvero eliminare questa conversazione?",
    ...
    "(edited by a deleted user)" : "(modificato da un utente eliminato)",
    ...
    "Conversation picture deleted" : "Icona della conversazione eliminata",
    "Could not delete the conversation picture" : "Impossibile eliminare l'icona della conversazione",
    ...
    "An error occurred while deleting breakout rooms" : "Un errore è avvenuto durante l'eliminazione di sessioni secondarie",
    ...
    "Poll \"{name}\" was created by {user}. Click to vote" : "Il sondaggio \"{name}\" è stato creato da {user}. Fai clic per votare",
    ...
    "Conversation link copied to clipboard" : "Collegamento alla conversazione copiato negli appunti",
    "The link could not be copied" : "Impossibile copiare il collegamento",
    ...
    "Open poll • Click to vote" : "Sondaggio aperto • Fai clic per votare",
