OC.L10N.register(
    ...
    "You were mentioned in a group chat by a user that has since been deleted: %s" : "Sei stato menzionato in una chat di gruppo da un utente che è stato eliminato: %s",
    "You were mentioned in a group chat by a user that has since been deleted: {call}" : "Sei stato menzionato in una chat di gruppo da un utente che è stato eliminato: {call}",
    "You were mentioned in a group chat by a user that has since been deleted" : "Sei stato menzionato in una chat di gruppo da un utente che è stato eliminato",
