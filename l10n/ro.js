OC.L10N.register(
    ...
    "{actor} invited {federated_user}" : "{actor} a invitat pe {federated_user}",
    "You invited {federated_user}" : "Ați invitat pe {federated_user}",
    "An administrator invited {federated_user}" : "Un administrator a invitat pe {federated_user}",
    "{actor} removed {federated_user}" : "{actor} a eliminat pe {federated_user}",
    "You removed {federated_user}" : "Ați eliminat pe {federated_user}",
    "An administrator removed {federated_user}" : "Un administrator a eliminat pe {federated_user}",
    ...
    "{actor} added {phone}" : "{actor} a adăugat pe {phone}",
    "You added {phone}" : "Ați adăugat pe {phone}",
    "An administrator added {phone}" : "Un administrator a adăugat pe {phone}",
    "{actor} removed {phone}" : "{actor} a eliminat pe {phone}",
    "You removed {phone}" : "Ați eliminat pe {phone}",
    "An administrator removed {phone}" : "Un administrator a eliminat pe {phone}",
    ...
    "Messages" : "Mesaje",
    "{user} in {conversation}" : "{user} în {conversation}",
    ...
    "{option1} and {option2}" : "{option1} și {option2}",
    "Failed" : "Eșuat",
    "OK" : "OK",
    ...
    "Hello, {displayName}" : "Bună, {displayName}",
    ...
    "Remove {fileName}" : "Șterge {fileName}",
    ...
    "Search in {name}" : "Căutare în {name}",
    ...
    "Local time: {time}" : "Timp local: {time}",
    "Search" : "Căutare",
    ...
    "_%n hour_::_%n hours_" : ["%n oră","%n ore","%n de ore"],
    "_%n day_::_%n days_" : ["%n zi","%n zile","%n de zile"],
    "_%n week_::_%n weeks_" : ["%n săptămână","%n săptămâni","%n de săptămâni"],
