OC.L10N.register(
    ...
    "- Send chat messages without notifying the recipients in case it is not urgent" : "- 급한 일이 아니라면, 참여자에게 알림이 가지 않는 메세지를 보낼 수 있습니다",
    ...
    "{actor} started breakout rooms" : "{actor}(이)가 소회의실을 시작했습니다",
    "You started breakout rooms" : "소회의실을 시작했습니다",
    "{actor} stopped breakout rooms" : "{actor}(이)가 소회의실을 중지했습니다",
    ...
    "{actor} invited {user}" : "{actor}(이)가 {user}(을)를 초대했습니다",
    "You invited {user}" : "{user}(을)를 초대했습니다",
    "An administrator invited {user}" : "관리자가 {user}(을)를 초대했습니다",
    "{federated_user} accepted the invitation" : "{federated_user}(이)가 초대를 수락했습니다",
    "{actor} removed {federated_user}" : "{actor}(이)가 {federated_user}(을)를 제외했습니다",
    "You removed {federated_user}" : "{federated_user}(을)를 제외했습니다",
    "An administrator removed {federated_user}" : "관리자가 {federated_user}(을)를 제외했습니다",
    "{federated_user} declined the invitation" : "{federated_user}(이)가 초대를 거부했습니다",
    "{actor} added group {group}" : "{actor}(이)가 {group} 그룹을 추가했습니다",
    "You added group {group}" : "{group} 그룹을 추가했습니다",
    "An administrator added group {group}" : "관리자가 {group} 그룹을 추가했습니다",
    "{actor} removed group {group}" : "{actor}(이)가 {group} 그룹을 제거했습니다",
    "You removed group {group}" : "{group} 그룹을 제거했습니다",
    "An administrator removed group {group}" : "관리자가 {group} 그룹을 제거했습니다",
