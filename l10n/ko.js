OC.L10N.register(
    ...
    "Failed to upload call recording" : "통화 녹음을 업로드하지 못했습니다.",
    ...
    "The recording for the call in {call} was uploaded to {file}." : "{call} 통화의 녹음을 {file}에 업로드했습니다.",
