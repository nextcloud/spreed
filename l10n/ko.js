OC.L10N.register(
    ...
    "- Moderators can now create breakout rooms (requires the High-performance backend)" : "- 중재자는 이제 소회의실들을 만들 수 있습니다. (High-performance backend 필요)",
    "- Calls can now be recorded (requires the High-performance backend)" : "- 통화는 이제 저장될 수 있습니다. (High-performance backend 필요)",
    ...
    "- Messages can now be edited by logged-in authors and moderators for 6 hours" : "- 내용은 이제 로그인한 생성자나 중재자에 의해 6시간 동안 편집이 가능합니다.",
    "- Unsent message drafts are now saved in your browser" : "- 보내지 않은 메세지 초안은 이제 브라우저에 저장됩니다.",
    "- Text chatting can now be done in a federated way with other Talk servers" : "- 다른 토크서버와의 문자대화는 이제 연합으로 가능해 집니다.",
    "- Moderators can now ban accounts and guests to prevent them from rejoining a conversation" : "- 이제 중재자는 대화에 다시 참여하지 못하도록 계정과 게스트를 차단할 수 있습니다.",
    ...
    "{user} reacted with {reaction} to your private message" : "{user}님이 당신의 비공개 메시지에 {reaction}(으)로 반응했습니다.",
    "{user} reacted with {reaction} to your message in conversation {call}" : "{user}님이 {call} 대화에서 당신의 메시지에 {reaction}(으)로 반응했습니다.",
    ...
    "{user} mentioned group {group} in conversation {call}" : "{user}님이 {call} 대화에서 {group} 그룹을 언급했습니다.",
    "{user} mentioned everyone in conversation {call}" : "{user} 님이 {call} 대화에서 모두를 언급했습니다.",
    ...
    "Recording consent is required for calls in this conversation" : "이 대화의 통화에서 녹음/녹화 동의 필요",
    "Recording consent is not required for calls in this conversation" : "이 대화의 통화에서 녹음/녹화 동의 불필요",
    "Recording consent requirement was updated" : "녹음/녹화 동의 필요 여부가 바뀌었습니다.",
    "Error occurred while updating recording consent" : "녹음/녹화 동의를 바꾸는 중 오류 발생",
    "Recording Consent" : "녹음/녹화 동의",
    "Recording consent cannot be changed once a call or breakout session has started." : "녹음/녹화 동의는 통화나 소회의 세션이 시작되면 바꿀 수 없습니다.",
    "Require recording consent before joining call in this conversation" : "이 대화에 참여하기 전 녹음/녹화 동의 필요",
    "Recording consent is required for all calls" : "모든 통화에서 녹음/녹화 동의 필요",
    ...
    "Hello, {displayName}" : "안녕하세요, {displayName}님.",
    ...
    "The call might be recorded." : "통화가 녹음/녹화됩니다.",
    "The recording might include your voice, video from camera, and screen share. Your consent is required before joining the call." : "녹음/녹화는 당신의 목소리, 카메라의 화상, 화면 공유를 포함할 수 있습니다. 통화에 참여하기 전 당신의 동의가 필요합니다.",
    "Give consent to the recording of this call" : "이 통화의 녹화/녹음에 동의",
    "Start recording immediately with the call" : "통화하는 즉시 녹음/녹화를 시작",
    ...
    "All set, the conversation \"{conversationName}\" was created." : "모두 설정했으며,  \"{conversationName}\" 대화가 만들어졌습니다.",
    ...
    "{user} is out of office and might not respond." : "{user}가 부재중이어서 응답하지 않을 수 있습니다.",
    ...
    "in the lobby" : "로비에서",
    "Dial out phone" : "전화 걸기",
    "Hang up phone" : "전화 끊기",
    "Move back to lobby" : "로비로 나가기",
    "Move to conversation" : "대화로 이동",
    "Dial-in PIN" : "전화 접속 PIN",
    "Demote from moderator" : "중재자 권한 제거",
    "Promote to moderator" : "중재자 권한 부여",
    "Resend invitation" : "초대 재전송",
    "Send call notification" : "통화 알림 보내기",
    "Dial out phone number" : "전화번호로 전화 걸기",
    "Resume call for phone number" : "전화번호로 전화 재개",
    ...
    "Search in {name}" : "{name} 안에서 검색",
    "{actor} in {conversation}" : "{conversation}의 {actor}",
    "Until" : "까지",
    ...
    "Creating and joining a conversation with \"{userid}\"" : "{userid}님과의 대화를 생성하고 참가합니다",
    ...
    "(edited by you)" : "(당신에 의해 수정됨)",
    "(edited by a deleted user)" : "(삭제된 사용자에 의해 수정됨)",
    "(edited by {moderator})" : "({moderator}에 의해 수정됨)",
