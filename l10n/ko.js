OC.L10N.register(
    ...
    "- Talk can now have commands, send \"/help\" as a chat message to see if your administrator configured some" : "- 이제 Talk에서 명령어를 사용할 수 있습니다. 관리자가 설정한 명령어를 확인하려면, \"/help\"를 입력하세요.",
    ...
    "- You can now mention guests in the chat" : "- 이제 채팅 메세지로 게스트 계정을 언급할 수 있습니다",
    "- Conversations can now have a lobby. This will allow moderators to join the chat and call already to prepare the meeting, while users and guests have to wait" : "- 대화에 로비를 만들 수 있습니다. 관리자가 미리 대화나 통화를 시작하여 준비할 수 있으며, 그 동안 다른 사용자와 게스트 계정은 대기하여야 합니다.",
    ...
    "- You can now upload and drag'n'drop files directly from your device into the chat" : "- 이제 장치에서 채팅으로 곧바로 파일을 업로드 하고 드래그&드랍 할 수 있습니다.",
    ...
    "- Give your conversations some context with a description and open it up so logged in users can find it and join themselves" : "- 대화방에 설명을 추가하여, 로그인한 사용자들이 쉽게 찾고 참여할 수 있도록 할 수 있습니다.",
    ...
    "- Join the same conversation and call from multiple devices" : "- 여러 기기에서 같은 대화에 참여하고, 통화할 수 있습니다.",
    ...
    "- A preview of your audio and video is shown before joining a call" : "- 통화에 참여하기 전에 자신의 음성과 영상을 미리 볼 수 있습니다.",
    ...
    "- Configure an expiration time for chat messages" : "- 메세지에 표시 만료 기한을 설정할 수 있습니다",
    "- Start calls without notifying others in big conversations. You can send individual call notifications once the call has started." : "- 단체 대화방에서 다른 참여자에게 알리지 않고 통화를 시작할 수 있습니다. 통화를 시작한 이후 참여자에게 개별적으로 통화 알림을 보낼 수 있습니다.",
    "- Send chat messages without notifying the recipients in case it is not urgent" : "- 급한 일이 아니라면, 받는이에게 알림이 가지 않는 메세지를 보낼 수 있습니다.",
    ...
    "- Moderators can now create breakout rooms (requires the external signaling server)" : "사회자는 이제 새로운 소회의실을 만들 수 있습니다(외부 시그널링 서버 필요)",
    ...
    "{actor} joined the call" : "{actor}님이 통화에 참여했습니다",
    "You joined the call" : "통화에 참여왔습니다",
    ...
    "{actor} limited the conversation to the current participants" : "{actor}이/가 현재 참여자들로 대화를 제한하였습니다",
    "You limited the conversation to the current participants" : "현재 참여자들로 대화를 제한하였습니다",
    "An administrator limited the conversation to the current participants" : "관리자가 현재 참여자들로 대화를 제한하였습니다",
    ...
    "{actor} restricted the conversation to moderators" : "{actor}님이 대화를 관리자만 허용했습니다",
    ...
    "{actor} set a password" : "{actor}님이 비밀번호를 설정했습니다",
    "You set a password" : "당신이 비밀번호를 설정했습니다.",
    "An administrator set a password" : "관리자가 비밀번호를 설정했습니다.",
    "{actor} removed the password" : "{actor}님이 비밀번호를 제거했습니다",
    ...
    "{actor} joined the conversation" : "{actor}님이 대화에 참여했습니다",
    ...
    "{actor} removed {federated_user}" : "{actor}님이 {federated_user}님을 제외함",
    "You removed {federated_user}" : "{federated_user}님을 제외함",
    "An administrator removed {federated_user}" : "관리자가 {federated_user}님을 제외함",
    ...
    "{actor} promoted {user} to moderator" : "{actor}님이 {user}님을 관리자로 설정했습니다",
    "You promoted {user} to moderator" : "당신이 {user} 를 진행자로 승진시켰습니다.",
    "{actor} promoted you to moderator" : "{actor}님이 당신을 관리자로 설정했습니다",
    ...
    "{actor} demoted {user} from moderator" : "{actor}님이 {user}님의 관리자 권한을 박탈했습니다",
    "You demoted {user} from moderator" : "당신이 {user} 를 진행자에서 내렸습니다.",
    "{actor} demoted you from moderator" : "{actor}님이 당신의 관리자 권한을 박탈했습니다",
    ...
    "{actor} deleted a message" : "{actor}님이 메세지를 삭제했습니다.",
    "You deleted a message" : "메세지를 삭제했습니다.",
    "{actor} deleted a reaction" : "{actor}님이 반응을 삭제했습니다.",
    "You deleted a reaction" : "반응을 삭제했습니다.",
    "_You set the message expiration to %n week_::_You set the message expiration to %n weeks_" : ["메세지의 유효 기간을 %n주로 설정했습니다."],
    "_You set the message expiration to %n day_::_You set the message expiration to %n days_" : ["메세지의 유효 기간을 %n일로 설정했습니다."],
    "_You set the message expiration to %n hour_::_You set the message expiration to %n hours_" : ["메세지의 유효 기간을 %n시간으로 설정했습니다."],
    "_You set the message expiration to %n minute_::_You set the message expiration to %n minutes_" : ["메세지의 유효 기간을 %n분으로 설정했습니다."],
    "_{actor} set the message expiration to %n week_::_{actor} set the message expiration to %n weeks_" : ["{actor}님이 메세지의 유효 기간을 %n주로 설정했습니다."],
    "_{actor} set the message expiration to %n day_::_{actor} set the message expiration to %n days_" : ["{actor}님이 메세지의 유효 기간을 %n일로 설정했습니다."],
    "_{actor} set the message expiration to %n hour_::_{actor} set the message expiration to %n hours_" : ["{actor}님이 메세지의 유효 기간을 %n시간으로 설정했습니다."],
    "_{actor} set the message expiration to %n minute_::_{actor} set the message expiration to %n minutes_" : ["{actor}님이 메세지의 유효 기간을 %n분으로 설정했습니다."],
    "{actor} disabled message expiration" : "{actor}님이 메세지의 유효 기간을 해제했습니다.",
    "You disabled message expiration" : "메세지의 유효 기간을 해제했습니다.",
    ...
    "The recording failed" : "녹음을 하지 못했습니다.",
    "Someone voted on the poll {poll}" : "누군가가 {poll} 투표에 투표했습니다.",
    "Message deleted by author" : "작성자가 메세지를 삭제함",
    "Message deleted by {actor}" : "{actor}님이 메세지를 삭제함",
    "Message deleted by you" : "메세지를 삭제함",
    "Deleted user" : "삭제된 사용자",
    "%s (guest)" : "%s (손님)",
    "You missed a call from {user}" : "당신이 {user} 와 통화를 하지 못했습니다.",
    "You tried to call {user}" : "{user}님에게 전화를 걸었습니다.",
    ...
    "When at least one group is selected, only people of the listed groups can be part of conversations." : "하나 이상의 그룹이 선택되면, 선택된 그룹의 구성원만 대화에 참여할 수 있습니다.",
    "Guests can still join public conversations." : "게스트 계정은 여전히 공개 대화에 참여할 수 있습니다.",
    "Limit using Talk" : "Talk 제한 사항",
    ...
    "When a call has started, everyone with access to the conversation can join the call." : "통화가 시작되면, 대화에 참여할 수 있는 모두가 통화에 참여할 수 있습니다.",
    "Everyone" : "모두",
    ...
    "Commands are a new beta feature in Nextcloud Talk. They allow you to run scripts on your Nextcloud server. You can define them with our command line interface. An example of a calculator script can be found in our {linkstart}documentation{linkend}." : "명령은 Nextcloud Talk의 새로운 베타 기능입니다. 이를 통해 Nextcloud 서버에서 스크립트를 실행할 수 있습니다. 명령줄 인터페이스를 사용하여 이 인터페이스를 정의할 수 있습니다. 계산기 스크립트의 예는 {linkstart} 설명서 {linkend}에서 확인할 수 있습니다.",
    "None" : "없음",
    "User" : "사용자",
    "Disabled" : "비활성화됨",
    "Moderators" : "진행자",
    ...
    "Downloading …" : "다운중 ...",
    "Install Talk Matterbridge" : "Talk Matterbridge 설치",
    ...
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk together with a High Performance Back-end." : "고성능 백엔드와 함께 Nextcloud Talk를 사용할 때는 분산 캐시를 설정하는 것이 좋습니다.",
    ...
    "Allow guests to join via link" : "링크를 통해 게스트 계정이 참여하도록 허용",
    ...
    "You joined the conversation in another window or device. This is currently not supported by Nextcloud Talk so this session was closed." : "다른 창이나 기기에서 대화에 참여했습니다. 이 기능은 현재 Nextcloud Talk에서 지원되지 않으며, 현재 세션은 종료됩니다.",
    ...
    "Audio" : "오디오",
    "Other" : "기타",
    "Nextcloud Talk was updated, please reload the page" : "Nextcloud Talk가 업데이트되었습니다. 페이지를 다시 로드하십시오.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by Nextcloud Talk. What do you want to do?" : "다른 창이나 기기에서 활성된 세션이 존재합니다. 이 기능은 현재 Nextcloud Talk에서 지원되지 않습니다. 어떻게 할까요?",
    "Join here" : "여기에 참가",
    ...
    "Join conversations at any time, anywhere, on any device." : "언제 어디서나, 원하는 기기에서 대화에 참여하세요.",
    ...
    "An error occurred while installing the Talk Matterbridge. Please install it manually." : "Talk Matterbridge를 설치하는 동안 오류가 발생했습니다. 수동으로 설치하십시오.",
