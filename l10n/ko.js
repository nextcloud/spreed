OC.L10N.register(
    ...
    "You can install the Matterbridge to link Nextcloud Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}appstore{linkend}." : "Nextcloud Talk를 다른 서비스에 연결하기 위해 Matterbridge를 설치할 수 있습니다. 자세한 내용은 {linkstart1} GitHub 페이지 {linkend} 를 참조하십시오. 앱을 다운로드하고 설치하는 데 시간이 걸릴 수 있습니다. 시간이 초과된 경우 {linkstart2} 앱스토어 {linkend}에서 수동으로 설치하십시오.",
    ...
    "Allow guests to use a public link to join this conversation." : "게스트 계정이 공개 링크를 이용하여 대화에 참여할 수 있도록 허용합니다.",
    "Allow guests" : "손님 허용",
    ...
    "Calls" : "통화",
    "Allow participants to join from a phone." : "휴대 기기를 통한 참여를 허용합니다.",
