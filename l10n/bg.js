OC.L10N.register(
    ...
    "{actor} invited {federated_user}" : "{actor} покани {federated_user}",
    "You invited {federated_user}" : "Поканихте {federated_user}",
    "An administrator invited {federated_user}" : "Администратор покани {federated_user}",
    ...
    "{actor} added {phone}" : "{actor} добави {phone}",
    "You added {phone}" : "Добавихте {phone}",
    "An administrator added {phone}" : "Администратор добави {phone}",
    "{actor} removed {phone}" : "{actor} премахна {phone}",
    "You removed {phone}" : "Премахнахте {phone}",
    "An administrator removed {phone}" : "Администратор премахна {phone}",
    ...
    "_%n vote_::_%n votes_" : ["%nгласувания ","%n гласувания"],
    ...
    "Local time: {time}" : "Местно време: {time}",
    "Search" : "Търсене",
    ...
    "Talk conversation for event" : "Talk разговор за събитие",
