OC.L10N.register(
    ...
    "Notes" : "Бележки",
    "Reports" : "Доклади",
    "- Moderators can now create breakout rooms (requires the external signaling server)" : "- Модераторите вече могат да създават стаи за отделно събрание (изисква се външен сървър за сигнализация)",
    "- Calls can now be recorded (requires the external signaling server)" : "- Разговорите вече могат да се записват (изисква се външен сървър за сигнализация)",
