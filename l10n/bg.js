OC.L10N.register(
    ...
    "The STUN server is used to determine the public address of participants behind a router." : "STUN сървърът се използва за определяне на публичния адрес на участниците, които стоят зад рутер.",
