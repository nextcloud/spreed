OC.L10N.register(
    ...
    "Invalid file provided" : "Το αρχείο που παρασχέθηκε δεν είναι έγκυρο",
    ...
    "Heard Island and McDonald Islands" : "Νησιά Χερντ και Μακντόναλντ",
    "Honduras" : "Ονδούρα",
    "Croatia" : "Κροατία",
    "Haiti" : "Αϊτή",
    "Hungary" : "Ουγγαρία",
    ...
    "Saint Helena, Ascension and Tristan da Cunha" : "Αγία Ελένη, Ασένσιον και Τριστάν ντα Κούνια",
    "Slovenia" : "Σλοβενία",
    ...
    "Ukraine" : "Ουκρανία",
    "Uganda" : "Ουγάντα",
    "United States Minor Outlying Islands" : "Μικρές Απώτερες Νήσοι Ηνωμένων Πολιτειών",
    ...
    "Viet Nam" : "Βιετνάμ",
    "Vanuatu" : "Βανουάτου",
    "Wallis and Futuna" : "Γουαλίς και Φουτούνα",
    "Samoa" : "Σαμόα",
    "Yemen" : "Υεμένη",
    "Mayotte" : "Μαγιότ",
    ...
    "Mobile clients do not support end-to-end encrypted calls at the moment." : "Οι εφαρμογές για κινητές συσκευές προς το παρόν δεν υποστηρίζουν κρυπτογραφημένες κλήσεις από άκρο σε άκρο.",
    ...
    "_%n vote_::_%n votes_" : ["%n ψήφος","%n ψήφοι"],
    ...
    "Create a new group conversation" : "Δημιουργήα νέας ομαδικής συζήτησης",
    ...
    "Upload from device" : "Μεταφόρτωση από τη συσκευή",
    ...
    "Select conversation" : "Επιλογή συνομιλίας",
    ...
    "Stop recording" : "Διακοπή καταγραφής",
    ...
    "Nextcloud URL" : "Διεύθυνση URL Nextcloud",
    ...
    "Error while sharing file" : "Σφάλμα κατά την κοινή χρήση αρχείου",
    ...
    "Talk conversation for event" : "Συνομιλία Talk για το συμβάν",
