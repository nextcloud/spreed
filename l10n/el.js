OC.L10N.register(
    ...
    "The STUN server is used to determine the public address of participants behind a router." : "Ο διακομιστής STUN χρησιμοποιείται για να καθορίσει την δημόσια διεύθυνση των συμετεχόντων πίσω από το δρομολογητή.",
