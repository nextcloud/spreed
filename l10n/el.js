OC.L10N.register(
    ...
    "Full name of the user requesting the trail" : "Πλήρες όνομα του χρήστη που ζητά το ίχνος",
    "Name of the user requesting the trail" : "Το όνομα του χρήστη που ζητά το ίχνος",
    "E-mail of the user" : "Διεύθυνση ηλεκτρονικού ταχυδρομείου του χρήστη",
    "Language" : "Γλώσσα",
    "Country" : "Χώρα",
    "Request signaling server trail" : "Αίτημα διαδρομής διακομιστή σηματοδότησης",
