OC.L10N.register(
    ...
    "Your PIN" : "Το PIN σας",
    "Click the button below to join the lobby now." : "Κάντε κλικ στο παρακάτω κουμπί για να συμμετάσχετε τώρα στο lobby.",
    "Click the link below to join the lobby now." : "Κάντε κλικ στον παρακάτω σύνδεσμο για να συμμετάσχετε τώρα στο lobby.",
    "Join lobby for \"%s\"" : "Συμμετοχή στο lobby για \"%s\"",
    ...
    "OK" : "OK",
    "Checking …" : "Έλεγχος ...",
    "Federated user" : "Ομοσπονδιακός χρήστης",
    ...
    "Skip the lobby" : "Παράκαμψη του λόμπι",
