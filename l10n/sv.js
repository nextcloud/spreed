OC.L10N.register(
    ...
    "Could not prepare conversation folder" : "Kunde inte förbereda konversationsmappen",
    ...
    "Webinar" : "Webbinarium",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Begränsad konversation med lobby aktiverad, idealisk för offentliga webbseminarier.",
    ...
    "Open in full application" : "Öppna i fullständig applikation",
    ...
    "Failed to enable live translations" : "Kunde inte aktivera live-översättning",
    "Failed to disable live translations" : "Kunde inte inaktivera live-översättning",
    ...
    "Recording backend is not installed" : "Recording-backend är inte installerad",
    ...
    "Error when scheduling the message" : "Kunde inte schemalägga meddelandet",
    ...
    "Results" : "Resultat",
    "Download as spreadsheet" : "Ladda ned som kalkylblad",
    "Download as CSV" : "Ladda ned som CSV",
    ...
    "Error renaming tag" : "Kunde inte byta namn på tagg",
    "Error deleting tag" : "Kunde inte ta bort tagg",
    "Error reordering tags" : "Kunde inte sortera om taggar",
    ...
    "Failed to connect. Retrying …" : "Kunde inte ansluta. Försöker igen …",
    "Failed to connect. The signaling server may be set up incorrectly" : "Kunde inte ansluta. Signalservern kan vara felkonfigurerad",
