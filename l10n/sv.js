OC.L10N.register(
    ...
    "{actor} created a thread" : "{actor} skapade en tråd",
    ...
    "Thread origin message expired" : "Trådens ursprungsmeddelande har gått ut",
    "{actor}: {lastMessage}" : "{actor}: {lastMessage}",
    "Subscribe to thread" : "Prenumerera på tråd",
