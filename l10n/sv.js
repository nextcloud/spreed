OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Låt konversationerna flöda: nämn användare, reagera på meddelanden och mycket mer\n\nDu kan nämna alla i konversationen med @all eller nämna specifika deltagare genom att skriva “@” och välja deras namn från listan.",
