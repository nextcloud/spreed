OC.L10N.register(
    ...
    "- Conversations can now have a lobby. This will allow moderators to join the chat and call already to prepare the meeting, while users and guests have to wait" : "- Konversationer kan nu ha en väntrum. Detta gör att moderatorer nu kan förbereda mötet, medan användare och gäster måste vänta.",
    ...
    "- Check out the new grid and call view" : "- Se den nya rutnäts- och samtalsvyn",
    ...
    "- Shared files are now opened directly inside the chat view with the viewer apps" : "- Delade filer öppnas nu direkt i chattvyn med visningsapparna",
    ...
    "- Spice up your messages with emojis from the emoji picker" : "- Snygga till dina meddelanden med emojier",
    ...
    "- Emojis can now be autocompleted by typing a \":\"" : "- Emojier kan nu autokompletteras om man skriver \".\"",
    "- Link various items using the new smart-picker by typing a \"/\"" : "- Länka olika objekt med nya smart-picker genom att skriva ett \"/\"",
    "- Moderators can now create breakout rooms (requires the High-performance backend)" : "- Moderatorer kan nu skapa grupprum (kräver högpresterande backend)",
    "- Calls can now be recorded (requires the High-performance backend)" : "- Samtal kan nu spelas in (kräver högpresterande backend)",
    ...
    "- Unsent message drafts are now saved in your browser" : "- Oskickade meddelandeutkast sparas nu i din webbläsare",
    ...
    "- Calls can now be done in a federated way with other Talk servers (requires the High-performance backend)" : "- Samtal kan nu göras på ett federerat sätt med andra Talk-servrar (kräver högpresterande backend)",
    ...
    "- Live transcriptions now available during the call (requires the live-transcription ExApp and the High-performance backend)" : "- Live-transkriberingar är nu tillgängliga under samtalet (kräver ExApp-appen för live-transkribering och högpresterande backend)",
    "- Moderators can now pin messages so they are kept at the top" : "- Moderatorer kan nu fästa meddelanden så att de hålls kvar överst",
    "- Schedule a message to send it at a later time" : "- Schemalägg ett meddelande för att skicka det senare",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Konversationstaggar, gruppering och sortering för att organisera konversationslistan",
    "- Voice-rooms to connect spontaneously" : "- Röstrum för spontana anslutningar",
    ...
    "- Channels and announcements to broadcast information to a broader audience" : "- Kanaler och meddelanden för att sprida information till en bredare publik",
    ...
    "{actor} preserved the conversation" : "{actor} bevarade konversationen",
    "You preserved the conversation" : "Du bevarade konversationen",
    "An administrator preserved the conversation" : "En administratör bevarade konversationen",
    "{actor} stopped preserving the conversation" : "{actor} slutade bevara konversationen",
    "You stopped preserving the conversation" : "Du slutade bevara konversationen",
    "An administrator stopped preserving the conversation" : "En administratör slutade bevara konversationen",
    ...
    "{actor} added {user}" : "{actor} lade till {user}",
    "System added you" : "Systemet lade till dig",
    "System added {user}" : "Systemet lade till {user}",
    ...
    "{actor} added {phone}" : "{actor} lade till {phone}",
    "You added {phone}" : "Du lade till {phone}",
    ...
    "{actor} promoted {user} to owner" : "{actor} befordrade {user} till ägare",
    "You promoted {user} to owner" : "Du befordrade {user} till ägare",
    "{actor} promoted you to owner" : "{actor} befordrade dig till ägare",
    "An administrator promoted you to owner" : "En administratör befordrade dig till ägare",
    "An administrator promoted {user} to owner" : "En administratör befordrade {user} till ägare",
    "{actor} demoted {user} from owner" : "{actor} nedgraderade {user} från ägare",
    "You demoted {user} from owner" : "Du nedgraderade {user} från ägare",
    "{actor} demoted you from owner" : "{actor} nedgraderade dig från ägare",
    "An administrator demoted you from owner" : "En administratör nedgraderade dig från ägare",
    "An administrator demoted {user} from owner" : "En administratör nedgraderade {user} från ägare",
    ...
    "Call %s" : "Ring %s",
    "Chat with %s" : "Chatta med %s",
    "An error occurred. Please contact your administrator." : "Ett fel har uppstått. Kontakta din administratör.",
    "App disabled" : "App inaktiverad",
    "Conversation subfolders are disabled" : "Undermappar för konversationer är inaktiverade",
    "Storage quota exceeded" : "Lagringskvot överskriden",
    "Could not prepare conversation folder" : "Det gick inte att förbereda konversationsmappen",
    "File not found" : "Filen hittades inte",
    "Path must point to a file" : "Sökvägen måste peka på en fil",
    "File is not inside the conversation draft folder for this room" : "Filen finns inte i konversationens utkastsmapp för detta rum",
    ...
    "Missing %s field in header line" : "Fältet %s saknas på rubrikraden",
    ...
    "Meeting ID" : "Mötes-ID",
    "Your PIN" : "Din pinkod",
    "Click the button below to join the lobby now." : "Klicka på knappen nedan för att gå med i väntrummet nu.",
    "Click the link below to join the lobby now." : "Klicka på länken nedan för att gå med i väntrummet nu.",
    "Join lobby for \"%s\"" : "Gå med i väntrummet för \"%s\"",
    ...
    "Failed to upload call recording" : "Det gick inte att ladda upp samtalsinspelningen",
    "The recording server failed to upload recording of call {call}. Please reach out to the administration." : "Inspelningsservern kunde inte ladda upp inspelningen av samtalet {call}. Kontakta administratören.",
    ...
    "Failed to transcript call recording" : "Det gick inte att transkribera samtalsinspelningen",
    "The server failed to transcript the recording at {file} for the call in {call}. Please reach out to the administration." : "Servern kunde inte transkribera inspelningen i {file} för samtalet i {call}. Kontakta administratören.",
    ...
    "The server failed to summarize the recording at {file} for the call in {call}. Please reach out to the administration." : "Servern kunde inte sammanfatta inspelningen i {file} för samtalet i {call}. Kontakta administratören.",
    ...
    "Channel" : "Kanal",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Sändningskonversation för en stor målgrupp, där endast moderatorer kan skriva och samtal är inaktiverade.",
    "Classified conversation" : "Klassificerad konversation",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Låst konversation för konfidentiella ämnen, där offentlig åtkomst, gäster, SIP och inspelningar är inaktiverade.",
    "Default" : "Standard",
    "Send messages, create threads, and start voice and video calls." : "Skicka meddelanden, skapa trådar och starta röst- och videosamtal.",
    "Presentation" : "Presentation",
    "Restricted conversation for internal presentations." : "Begränsad konversation för interna presentationer.",
    "Voice room" : "Ljudrum",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Gå direkt med i samtalet, perfekt för avstämningar eller spontana möten.",
    "Webinar" : "Webbinarium",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Begränsad konversation med väntrum aktiverad, idealisk för offentliga webbseminarier.",
    ...
    "Favorites" : "Favoriter",
    "Other" : "Annat",
    "Failed to request trial because the trial server is unreachable. Please try again later." : "Det gick inte att begära en testperiod eftersom testservern inte kan nås. Försök igen senare.",
    ...
    "There is a problem with the request of the trial. Please check your logs for further information." : "Det uppstod ett problem med begäran om en testperiod. Kontrollera loggarna för mer information.",
    "Too many requests are send from your servers address. Please try again later." : "För många förfrågningar är skickade från din serveradress. Försök igen senare.",
    "There is already a trial registered for this Nextcloud instance." : "En testperiod har redan registrerats för den här Nextcloud-instansen.",
    "Something unexpected happened. Please try again later." : "Ett oväntat fel inträffade. Försök igen senare.",
    "Failed to request trial because the trial server behaved wrongly. Please try again later." : "Det gick inte att begära en testperiod eftersom testservern gav ett felaktigt svar. Försök igen senare.",
    "Trial requested but failed to get account information. Please check back later." : "Testperioden begärdes, men kontoinformationen kunde inte hämtas. Försök igen senare.",
    ...
    "Failed to fetch account information because the trial server behaved wrongly. Please check back later." : "Det gick inte att hämta kontoinformation eftersom testservern gav ett felaktigt svar. Försök igen senare.",
    "There is a problem with fetching the account information. Please check your logs for further information." : "Det är problem med att motta kontoinformation. Kontrollera dina loggar för mer information.",
    "There is no such account registered." : "Det finns inget sådan konto registrerat.",
    "Failed to fetch account information because the trial server is unreachable. Please check back later." : "Det gick inte att hämta kontoinformation eftersom testservern inte kan nås. Försök igen senare.",
    "Deleting the hosted signaling server account failed. Please check back later." : "Det gick inte att ta bort signaling server kontot. Försök igen senare.",
    "Failed to delete the account because the trial server behaved wrongly. Please check back later." : "Det gick inte att ta bort kontot eftersom testservern gav ett felaktigt svar. Försök igen senare.",
    "There is a problem with deleting the account. Please check your logs for further information." : "Det är problem med att ta bort kontot. Kontrollera dina inställningar för mer information.",
    "Too many requests are sent from your servers address. Please try again later." : "För många förfrågningar är skickade från din serveradress. Försök igen senare.",
    "Failed to delete the account because the trial server is unreachable. Please check back later." : "Det gick inte att ta bort kontot eftersom testservern inte kan nås. Försök igen senare.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from Nextcloud apps, GIFs, map locations, AI generated content and much more." : "## ✨ Gör mer med Smartväljaren\n\nSkriv “/” eller gå till “+”-menyn för att öppna smartväljaren, där du kan bifoga olika typer av innehåll till dina meddelanden. Du kan konfigurera Smartväljaren för att kunna lägga till objekt från Nextcloud-appar, GIF:ar, platsinformation från kartor, AI-genererat innehåll och mycket mer.",
    ...
    "Could not check for WASM loading support. Please check manually if your web server serves `.wasm` files." : "Det gick inte att kontrollera stöd för laddning av WASM. Kontrollera manuellt om din webbserver tillhandahåller .wasm-filer.",
    ...
    "High-performance backend" : "Högpresterande backend",
    "No High-performance backend configured - Running Nextcloud Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "Ingen högpresterande backend konfigurerad - Att köra Nextcloud Talk utan högpresterande backend skalar endast för mycket små samtal (max. 2-3 deltagare). Konfigurera högpresterande backend för att säkerställa att samtal med flera deltagare fungerar sömlöst.",
    "Defining multiple High-performance backends is deprecated and will no longer be supported in the upcoming version. Instead a load-balancer should be set up together with clustered signaling servers and configured in the Talk settings." : "Att definiera flera högpresterande backendservrar är föråldrat och kommer inte längre att stödjas i den kommande versionen. Istället bör en lastbalanserare ställas in tillsammans med klustrade signalservrar och konfigureras i Talk-inställningarna.",
    ...
    "High-performance backend not configured correctly. Run %s for details." : "högpresterande backend är inte korrekt konfigurerad. Kör %s för detaljer.",
    "High-performance backend not configured correctly" : "högpresterande backend är inte korrekt konfigurerad",
    "Error: Cannot connect to server" : "Fel: Det går inte att ansluta till servern",
    ...
    "It is highly recommended to configure a memory cache when running Nextcloud Talk with a High-performance backend." : "Det rekommenderas starkt att konfigurera en minnescache när du kör Nextcloud Talk med en högpresterande backend.",
    "Client Push" : "Klient-Push",
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Client Push är installerat, vilket gör Talk-aviseringar mer tillförlitliga.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} är inte installerat. Detta kan leda till fördröjda Talk-aviseringar.",
    "Recording backend" : "Inspelningsserver",
    "Using the recording backend requires a High-performance backend." : "För att kunna använda inspelningsserver krävs en högpresterande backend.",
    "No recording backend configured" : "Ingen inspelningsserver har konfigurerats",
    "SIP configuration" : "SIP-konfiguration",
    "Using the SIP functionality requires a High-performance backend." : "Användning av SIP-funktionalitet kräver en högpresterande backend.",
    ...
    "Open in full application" : "Öppna i appen",
    ...
    "Limit starting calls to certain groups" : "Begränsa vilka grupper som får starta samtal",
    "Limit starting a call" : "Begränsa att starta ett samtal",
    "Limit starting calls" : "Begränsa att starta samtal",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "När minst en grupp är vald kan endast medlemmar i dessa grupper starta ett samtal. Detta gäller även moderatorer, medan gäster och federerade användare aldrig är medlemmar i dessa grupper. Alla kan fortfarande starta ett samtal när ingen grupp är vald.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "För konversationer som finns på en federerad server används i stället värdserverns konfiguration.",
    ...
    "The following bots are installed on this server. In the documentation you can find details how to {linkstart1}build your own bot{linkend} or a {linkstart2}list of bots{linkend} to enable on your server." : "Följande botar är installerade på denna server. I dokumentationen kan du hitta detaljer om hur du {linkstart1}bygger din egen bot{linkend} eller en {linkstart2}lista av botar{linkend} för att aktivera på din server.",
    "No bots are installed on this server. In the documentation you can find details how to {linkstart1}build your own bot{linkend} or a {linkstart2}list of bots{linkend} to enable on your server." : "Inga botar är installerad på denna server. I dokumentationen kan du hitta detaljer om hur du {linkstart1}bygger din egen bot{linkend} eller en {linkstart2}lista av botar{linkend} för att aktivera på din server.",
    "Description is not provided" : "Beskrivning fattas",
    "Locked for moderators" : "Låst för moderatorer",
    "Enabled" : "Aktiverad",
    "Disabled" : "Inaktiverad",
    "Bots settings" : "Botinställningar",
    "State" : "Status",
    "Name" : "Namn",
    "Last error" : "Senaste fel",
    "Total errors count" : "Totalt antal fel",
    "Find more bots" : "Hitta fler botar",
    ...
    "End-to-end encrypted calls with a configured SIP bridge require a newer version of the High-performance backend and SIP bridge." : "End-to-end-krypterade samtal med en konfigurerad SIP-brygga kräver en nyare version av högpresterande backend och SIP-brygga.",
    ...
    "Expired" : "Utgånget",
    "Never" : "Aldrig",
    "The trial could not be requested. Please try again later." : "Det gick inte att begära en testperiod. Försök igen senare.",
    "The account could not be deleted. Please try again later." : "Kontot kunde inte raderas. Försök igen senare.",
    "Hosted High-performance backend" : "Värdbaserad högpresterande backend",
    ...
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "Om ditt konto för högpresterande backend inkluderar STUN- och/eller TURN-funktionalitet, kommer inställningarna att uppdateras därefter.",
    "URL of this Nextcloud instance" : "URL till denna Nextcloud-instans",
    "Full name of the user requesting the trial" : "Fullständigt namn på användaren som begär testperioden",
    "Email of the user" : "Användarens e-post",
    "Language" : "Språk",
    "Country" : "Land",
    "Request signaling server trial" : "Begär en testperiod för signalservern",
    ...
    "You can install the Matterbridge to link Nextcloud Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}Nextcloud App Store{linkend}." : "Du kan installera Matterbridge för att länka Nextcloud Talk till några andra tjänster, besök deras {linkstart1}GitHub-sida{linkend} för mer information. Att hämta och installera appen kan ta ett tag. Vid timeout, installera den manuellt från {linkstart2}Nextcloud App Store{linkend}.",
    ...
    "Matterbridge binary was not found or couldn't be executed." : "Matterbridge-binärfilen hittades inte eller kunde inte köras.",
    ...
    "Error: System times of Nextcloud server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fel: Systemtiderna för Nextcloud-servern och Inspelningsserver-servern är osynkroniserade. Se till att båda servrarna är anslutna till en tidsserver eller synkronisera deras tid manuellt.",
    "Recording backend URL" : "Inspelningsserverns URL",
    ...
    "Recording backend settings saved" : "Inställningarna för inspelningsservern har sparats",
    ...
    "Recording backend configuration is only possible with a High-performance backend." : "Inspelningsserver-konfiguration är endast möjlig med en högpresterande backend.",
    "Add a new recording backend server" : "Lägg till en ny inspelningsserver",
    ...
    "SIP configuration is only possible with a High-performance backend." : "SIP-konfiguration är endast möjlig med en högpresterande backend.",
    ...
    "High-performance backend URL" : "URL till högpresterande backend",
    "Missing High-performance backend warning hidden" : "Varning för saknad högpresterande backend är dold",
    "High-performance backend settings saved" : "Inställningar för högpresterande backend har sparats",
    "Nextcloud Talk setup not complete" : "Nextcloud Talk-installationen är inte klar",
    "Please note that in calls with more than 2 participants without the High-performance backend, participants will most likely experience connectivity issues and cause high load on participating devices." : "Observera att i samtal med fler än 2 deltagare utan högpresterande backend kommer deltagarna med största sannolikhet att uppleva anslutningsproblem och orsaka hög belastning på deltagande enheter.",
    "Install the High-performance backend to ensure calls with multiple participants work seamlessly." : "Installera högpresterande backend för att säkerställa att samtal med flera deltagare fungerar sömlöst.",
    "Nextcloud portal" : "Nextcloud portal",
    "Quick installation guide" : "Snabb installationsguide",
    "The High-performance backend is required for calls and conversations with multiple participants. Without the backend, all participants have to upload their own video individually for each other participant, which will most likely cause connectivity issues and a high load on participating devices." : "högpresterande backend krävs för samtal och konversationer med flera deltagare. Utan detta så måste alla deltagare ladda upp sin egen video individuellt för varje annan deltagare, vilket med största sannolikhet kommer att orsaka anslutningsproblem och en hög belastning på deltagande enheter.",
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk with a High-performance backend." : "Det rekommenderas starkt att sätta upp en distribuerad cache när du använder Nextcloud Talk med en högpresterande backend.",
    "Add High-performance backend server" : "Lägg till högpresterande backend-server",
    ...
    "A TURN server is used to proxy the traffic from participants behind a firewall. If individual participants cannot connect to others a TURN server is most likely required. See {linkstart}this documentation{linkend} for setup instructions." : "En TURN-server används för att förmedla trafik från deltagare bakom en brandvägg. Om enskilda deltagare inte kan ansluta till andra behövs sannolikt en TURN-server. Installationsanvisningar finns i {linkstart}dokumentationen{linkend}.",
    ...
    "Cancel" : "Avbryt",
    "Unassigned participants" : "Otilldelade deltagare",
    "Back" : "Tillbaka",
    "Assign" : "Tilldela",
    ...
    "Enable live transcription (generated by AI)" : "Aktivera live-transkribering (genereras av AI)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Aktivera live-transkribering (appen Live Transcriptions är inte installerad)",
    "Disable live translation" : "Inaktivera live-översättning",
    "Enable live translation (generated by AI)" : "Aktivera live-översättning (genereras av AI)",
    "Original language" : "Originalspråk",
    "Live translations app is not installed" : "Appen Live translations är inte installerad",
    "Original language: {languageName}" : "Originalspråk: {languageName}",
    "Translated language" : "Översatt språk",
    "Translated language: {languageName}" : "Översatt språk: {languageName}",
    "Exit full screen (F)" : "Avsluta fullskärm (F)",
    "Full screen (F)" : "Fullskärm (F)",
    "Grid view" : "Rutnätsvy",
    "Speaker view" : "Presentationsvy",
    "Multi-speaker view" : "Vyn med flera talare",
    ...
    "Failed to enable live transcription" : "Det gick inte att aktivera live-transkribering",
    "Failed to enable live translations" : "Det gick inte att aktivera live-översättning",
    "Failed to disable live translations" : "Det gick inte att inaktivera live-översättning",
    ...
    "Lobby is still active and you're not a moderator" : "Väntrummet är fortfarande aktiv och du är inte moderator",
    ...
    "Collapse participant bar" : "Fäll ihop deltagarpanelen",
    "Expand participant bar" : "Expandera deltagarpanelen",
    ...
    "Microphone" : "Mikrofon",
    "Speaker" : "Högtalare",
    "Microphone settings" : "Mikrofoninställningar",
    ...
    "You" : "Du",
    "You are sharing a screen" : "Du delar en skärm",
    "Sharing this window may cause a mirroring effect" : "Delning av det här fönstret kan orsaka en spegeleffekt",
    ...
    "Picture" : "Bild",
    "The following bots can be enabled in this conversation. Reach out to your administration to get more bots installed on this server." : "Följande botar kan aktiveras i den här konversationen. Kontakta administratören om du behöver fler botar på servern.",
    "No bots are installed on this server. Reach out to your administration to get bots installed on this server." : "Inga botar är installerade på den här servern. Kontakta administratören för att få botar installerade.",
    "Disable" : "Inaktivera",
    "Enable" : "Aktivera",
    "The bot is not available anymore" : "Boten är inte längre tillgänglig",
    ...
    "Could not set the conversation picture: {error}" : "Det gick inte att ställa in konversationsbilden: {error}",
    "Error cropping conversation picture" : "Det gick inte att beskära konversationsbilden",
    "Error removing conversation picture" : "Det gick inte att ta bort konversationsbilden",
    ...
    "Could not modify default permissions for {conversationName}" : "Det gick inte att ändra standardbehörigheter för {conversationName}",
    ...
    "Participants can use all available features." : "Deltagare kan använda alla tillgängliga funktioner.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Deltagare får en begränsad uppsättning funktioner tills en moderator manuellt beviljar ytterligare behörigheter.",
    ...
    "Live transcriptions app is not installed" : "Appen Live transcriptions är inte installerad",
    ...
    "Error while deleting conversation" : "Det gick inte att ta bort konversationen",
    ...
    "Error while clearing chat history" : "Det gick inte att rensa chatthistoriken",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Den här konversationen bevaras. Den kan inte tas bort och dess chattmeddelanden kan inte rensas.",
    ...
    "Chat messages can be expired after a certain time. Note: Files shared in chat will not be deleted for the owner, but will no longer be shared in the conversation." : "Chattmeddelanden kan löpa ut efter en viss tid. Observera: Filer som delas i chatten kommer inte att raderas för ägaren, men kommer inte längre att delas i konversationen.",
    ...
    "This setting can not be changed while the conversation is preserved." : "Inställningen kan inte ändras medan konversationen bevaras.",
    ...
    "Languages could not be loaded" : "Det gick inte att läsa in språken",
    ...
    "Enabling the lobby will remove non-moderators from the ongoing call." : "Aktivering av väntrummet kommer att ta bort icke-moderatorer från det pågående samtalet.",
    "Enable lobby, restricting the conversation to moderators" : "Aktivera väntrummet, begränsa konversationen till moderatorer",
    ...
    "The entered token does not match the conversation token" : "Angiven token stämmer inte överens med konversationens token",
    "Preserve conversation" : "Bevara konversation",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Medan konversationen bevaras kan den inte tas bort, chatthistoriken kan inte rensas och inställningarna för gäster och anslutning kan inte ändras.",
    "Only the owner can change whether this conversation is preserved." : "Endast ägaren kan ändra om konversationen ska bevaras.",
    ...
    "Stop preserving" : "Sluta bevara",
    "Stop preserving conversation" : "Sluta bevara konversationen",
    "Conversation token" : "Konversationstoken",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Om du slutar bevara konversationen kan den tas bort, chatthistoriken kan rensas och inställningarna för gäster och anslutning kan ändras igen.",
    "Conversation" : "Konversation",
    "To confirm, type the conversation token into the field below:" : "Bekräfta genom att skriva konversationens token i fältet nedan:",
    "Ongoing" : "Pågår",
    ...
    "Join conversations" : "Gå med i konversationer",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Innehållet ska vara i formatet kommaseparerade värden (CSV):<br/>- En rubrikrad krävs och måste motsvara {sample1} eller endast {sample2}<br/>- En post per rad (t.ex. {sample3})",
    ...
    "Phone number could not be called: {error}" : "Det gick inte att ringa upp telefonnummer: {error}",
    "Phone number could not be called" : "Det gick inte att ringa upp telefonnummer",
    ...
    "Remove all tags" : "Ta bort alla taggar",
    "Rename tag" : "Byt namn på tagg",
    "Delete tag" : "Radera tagg",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Vill du verkligen ta bort \"{name}\"? Konversationer med denna tagg flyttas till \"Övrigt\".",
    "Move up" : "Flytta upp",
    "Move down" : "Flytta ner",
    "Pending invitations" : "Väntande inbjudningar",
    "Join conversations from other servers" : "Gå med i konversationer från andra servrar",
    ...
    "Meetings" : "Möten",
    "Sort conversations" : "Sortera konversationer",
    "By recent activity" : "Efter senaste aktivitet",
    "Alphabetically" : "Alfabetiskt",
    "Do not group by type" : "Gruppera inte efter typ",
    "Show private ones first" : "Visa privata först",
    "Show group ones first" : "Visa grupper först",
    ...
    "SIP backend is not installed" : "SIP-backend är inte installerad",
    ...
    "You are currently waiting in the lobby" : "Du väntar för närvarande i väntrummet",
    "Enable noise suppression" : "Aktivera brusreducering",
    "Reduce background noises for better voice quality" : "Minska bakgrundsljud för bättre ljudkvalitet",
    "Basic" : "Grundläggande",
    "Advanced" : "Avancerat",
    "Enable echo cancellation" : "Aktivera ekoborttagning",
    "Minimize echo effect from own surrounding" : "Minimera eko från din omgivning",
    "Enable auto gain control" : "Aktivera automatisk ljudnivåjustering",
    ...
    "You can only join a voice room via a call." : "Du kan endast ansluta till ett röstrum via ett samtal.",
    ...
    "Recording backend is not installed" : "Inspelningsservern är inte installerad",
    ...
    "7 days" : "7 dagar",
    "30 days" : "30 dagar",
    "Until unpin" : "Tills fästet tas bort",
    "Clear reminder – {timeLocale}" : "Rensa påminnelse – {timeLocale}",
    "Edited by {actor}" : "Redigerad av {actor}",
    "Pinned by you" : "Fäst av dig",
    "Pinned by {actor}" : "Fäst av {actor}",
    "Until {absoluteDate}" : "Till {absoluteDate}",
    ...
    "Unpin message" : "Ta bort fäst meddelande",
    ...
    "Keep pinned for" : "Behåll fäst i",
    "Set custom period" : "Ange anpassad period",
    ...
    "This translation is AI generated and may contain mistakes." : "Denna översättning är AI-genererad och kan innehålla fel.",
    "Copy translated text" : "Kopiera översatt text",
    "Error when scheduling the message" : "Det gick inte att schemalägga meddelandet",
    "Reschedule" : "Ändra schemaläggning",
    "Send now" : "Skicka nu",
    "Choose a time" : "Välj en tid",
    "Send at custom time" : "Skicka vid anpassad tid",
    "Will be sent without notification" : "Kommer att skickas utan avisering",
    ...
    "Message deleted successfully, but a bot or Matterbridge is configured and the message might already be distributed to other services" : "Meddelandet har raderats, men en bot eller Matterbridge är konfigurerat och meddelandet kanske redan har distribuerats till andra tjänster",
    ...
    "Failed to send the message. Click to try again" : "Det gick inte att skicka meddelandet. Klicka för att försöka igen",
    ...
    "Could not update the message" : "Det gick inte att uppdatera meddelandet",
    "Reply to thread \"{threadTitle}\"" : "Svara i tråd \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Du röstade • %n röst","Du röstade • %n röster"],
    "You voted" : "Du röstade",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Klicka för att rösta • %n röst","Klicka för att rösta • %n röster"],
    "Click to vote" : "Klicka för att rösta",
    ...
    "Closed poll" : "Avslutad omröstning",
    ...
    "Generate summary with AI" : "Skapa en sammanfattning med AI",
    "{author} (pinned by you)" : "{author} (fäst av dig)",
    "{author} (pinned by {actor})" : "{author} (fäst av {actor})",
    "Unpin" : "Lossa",
    ...
    "Default parameters are:" : "Standardparametrar är:",
    "These settings can be changed once the conversation is created." : "Dessa inställningar kan ändras när konversationen har skapats.",
    ...
    "Message will be sent {datetimeString}" : "Meddelandet kommer att skickas {datetimeString}",
    ...
    "Message was successfully scheduled" : "Meddelandet har schemalagts",
    ...
    "Show scheduled messages" : "Visa schemalagda meddelanden",
    "Cancel editing" : "Avbryt redigering",
    "Schedule message" : "Schemalägg meddelande",
    ...
    "Voice message {time} ({conversation})" : "Röstmeddelande {time} ({conversation})",
    ...
    "Standard image quality" : "Standardbildkvalitet",
    "Original image quality" : "Ursprunglig bildkvalitet",
    "View-only for others" : "Endast visning för andra",
    "Editable by others" : "Redigerbar av andra",
    ...
    "Skip the lobby" : "Hoppa över väntrummet",
    "Can post messages" : "Kan skicka meddelanden",
    "Can post messages and reactions" : "Kan posta meddelanden och reaktioner",
    "Can add reactions" : "Kan lägga till reaktioner",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Slutresultat • %n röst","Slutresultat • %n röster"],
    ...
    "Withdraw vote" : "Återkalla röst",
    "Results" : "Resultat",
    "Download as spreadsheet" : "Hämta som kalkylblad",
    "Download as CSV" : "Hämta som CSV",
    ...
    "Calls without High-performance backend can cause connectivity issues and high load on devices. {linkstart}Learn more{linkend}" : "Samtal utan högpresterande backend kan orsaka anslutningsproblem och hög belastning på enheter. {linkstart}Läs mer{linkend}",
    "Talk setup incomplete" : "Talk-installationen är inte klar",
    "Disable lobby" : "Inaktivera väntrummet",
    "Owner" : "Ägare",
    "Moderator" : "Moderator",
    ...
    "The last moderator of a conversation can not be demoted" : "Den sista moderatorn i en konversation kan inte nedgraderas",
    "Could not change the type of the participant" : "Det gick inte att ändra deltagarens typ",
    "Notification was sent to {displayName}" : "Notifiering skickades till {displayName}",
    "Could not send notification to {displayName}" : "Det gick inte att skicka notifiering till {displayName}",
    "Permissions granted to {displayName}" : "Behörighet beviljad till {displayName}",
    "Could not modify permissions for {displayName}" : "Det gick inte att ändra behörigheter för {displayName}",
    ...
    "Phone number could not be unmuted" : "Det gick inte att aktivera ljudet för telefonnummer",
    ...
    "in the lobby" : "i väntrummet",
    "Dial out phone" : "Telefon för att ringa ut",
    "Hang up phone" : "Lägg på telefon",
    "Move back to lobby" : "Gå tillbaka till väntrummet",
    "Move to conversation" : "Flytta till konversation",
    "Dial-in PIN" : "PIN-kod för uppringning",
    "Promote to owner" : "Befordra till ägare",
    "Demote from moderator" : "Degradera från moderator",
    "Promote to moderator" : "Befordra till moderator",
    "Demote from owner to moderator" : "Nedgradera från ägare till moderator",
    "Demote from owner to participant" : "Nedgradera från ägare till deltagare",
    ...
    "Pinned by a deleted user" : "Fäst av en borttagen användare",
    ...
    "I picked message bubbles" : "Jag valde meddelandebubblor",
    "I picked the list style" : "Jag valde listvy",
    ...
    "Invalid language ({languageId})" : "Ogiltigt språk ({languageId})",
    "Default language" : "Standardspråk",
    "Default language ({languageName})" : "Standardspråk ({languageName})",
    "Error when trying to load the available live translation languages" : "Fel vid försök att läsa in tillgängliga språk för live-översättning",
    "Error when trying to set live translation language" : "Fel vid försök att ställa in språk för live-översättning",
    "Set language used to show the transcriptions" : "Ange språk för visning av transkriberingar",
    ...
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Kameran stängs av vid anslutning. Visas alltid om samtycke till inspelning krävs.",
    ...
    "Unfocus the chat input to use shortcuts" : "Ta bort fokus från chattfältet för att använda kortkommandon",
    ...
    "The server was updated, you cannot start or join a call." : "Servern har uppdaterats, du kan inte starta eller gå med i ett samtal.",
    ...
    "Scheduled messages" : "Schemalagda meddelanden",
    ...
    "Disable background blur" : "Inaktivera bakgrundsoskärpa",
    ...
    "Download attendance list" : "Hämta deltagarlista",
    "Open Calendar" : "Öppna kalender",
    ...
    "Scheduled {datetime}" : "Schemalagd {datetime}",
    "Scheduled for {datetime}" : "Schemalagd till {datetime}",
    "Search" : "Sök",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Den här konversationen har öppnats i en annan flik. Den aktuella serverversionen stöder inte att öppna en konversation i flera flikar.",
    "Creating and joining a conversation with \"{userid}\"" : "Skapar och går med i en konversation med \"{userid}\"",
    "Join a conversation or start a new one" : "Anslut till en konversation eller starta en ny",
    "Error while joining the conversation" : "Det gick inte att gå med i konversationen",
    "Another user" : "En annan användare",
    "Hey! Are you using the list style or message bubbles?" : "Hej! Använder du listvy eller meddelandebubblor?",
    ...
    "Bot user name" : "Botens användarnamn",
    "Bot API key" : "Bot API-nyckel",
    ...
    "Audio" : "Ljud",
    "Show all pinned messages" : "Visa alla fästa meddelanden",
    ...
    "The server was updated." : "Servern har uppdaterats.",
    ...
    "The recording failed. Please contact your administrator." : "Samtalsinspelningen misslyckades. Kontakta din administratör.",
    ...
    "Error while clearing conversation history" : "Det gick inte att rensa konversationshistorik",
    ...
    "Error while changing the preserved status of the conversation" : "Ett fel uppstod när konversationens bevarandestatus ändrades",
    ...
    "Could not delete the conversation picture" : "Det gick inte att ta bort konversationsbilden",
    "Could not remove the automatic expiration" : "Det gick inte att ta bort den automatiska utgången",
    "Could not post message: {errorMessage}" : "Det gick inte att skicka meddelandet: {errorMessage}",
    ...
    "Could not send invitation to {actorId}" : "Det gick inte att skicka inbjudan till {actorId}",
    ...
    "Failed to rename the thread" : "Det gick inte att byta namn på tråd",
    "Error renaming tag" : "Det gick inte att byta namn på tagg",
    "Error deleting tag" : "Det gick inte att ta bort tagg",
    "Error reordering tags" : "Det gick inte att sortera om taggar",
    "Error fetching upcoming events" : "Det gick inte att hämta kommande händelser",
    "Error fetching upcoming reminders" : "Det gick inte att hämta kommande påminnelser",
    ...
    "Failed to add reaction" : "Det gick inte att lägga till reaktion",
    "Failed to remove reaction" : "Det gick inte att ta bort reaktionen",
    "The server is in maintenance mode." : "Servern är i underhållsläge.",
    "Federated server was updated." : "Den federerade servern har uppdaterats.",
    ...
    "Sending signaling message has failed" : "Det gick inte att skicka signalmeddelandet",
    ...
    "Connecting is taking longer than expected …" : "Anslutningen tar längre tid än förväntat …",
    "Failed to connect. Retrying …" : "Det gick inte att ansluta. Försöker igen …",
    "Failed to connect. The signaling server may be set up incorrectly" : "Det gick inte att ansluta. Signalservern kan vara felkonfigurerad",
    "High-performance backend needs to be updated." : "Högprestandabackenden måste uppdateras.",
    "The server is misconfigured. Please contact your administration." : "Servern är felkonfigurerad. Kontakta administratören.",
    ...
    "Please move your setup to HTTPS" : "Flytta din inställning till HTTPS",
    ...
    "Please use a different browser like Firefox or Chrome" : "Använd en annan webbläsare som t.ex Firefox eller Chrome",
    ...
    "Running the High-performance backend \"conversation_cluster\" mode is deprecated and will no longer be supported in the upcoming version. The High-performance backend supports real clustering nowadays which should be used instead." : "Att köra med högpresterande backend \"conversation_cluster\" läge är utfasat och kommer inte längre att stödjas i den kommande versionen. högpresterande backend stöder real clustering nuförtiden som bör användas istället.",
