OC.L10N.register(
    ...
    "No High-performance backend configured - Running Nextcloud Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "Kein Hochleistungs-Backend konfiguriert – Ohne das Hochleistungs-Backend funktioniert nur für kleinere Meetings (max. 2–3 Teilnehmer). Bitte richten Sie das Hochleistungs-Backend ein, um sicherzustellen, dass Meetings mit mehreren Teilnehmern reibungslos funktionieren.",
    ...
    "Beta" : "Beta",
    "Federated chats and calls work already. Attachment handling is coming in a future version." : "Federierte Chats und Anrufe funktionieren bereits. Die Verwaltung von Anhängen ist für eine spätere Version geplant.",
