OC.L10N.register(
    ...
    "Failed to request trial because the trial server is unreachable. Please try again later." : "Test konnte nicht angefordert werden, da der Testserver nicht erreichbar ist. Bitte versuchen Sie es später noch einmal.",
    ...
    "Failed to delete the account because the trial server behaved wrongly. Please check back later." : "Fehler beim Löschen des Kontos, da sich der Testserver falsch verhalten hat. Bitte versuchen Sie es später erneut.",
    ...
    "Failed to delete the account because the trial server is unreachable. Please check back later." : "Fehler beim Löschen des Kontos, da der Testserver nicht erreichbar ist. Bitte versuchen Sie es später erneut.",
    "Andorra" : "Andorra",
