OC.L10N.register(
    ...
    "Unban" : "Entsperren",
    "<strong>Banned by:</strong> {actor}" : "<strong>Gesperrt von:</strong> {actor}",
    "<strong>Note:</strong> {note}" : "<strong>Bemerkung:</strong> {note}",
    ...
    "<strong>Date:</strong> {date}" : "<strong>Datum:</strong> {date}",
    "Media" : "Medien",
    "Polls" : "Umfragen",
    ...
    "Nextcloud Talk Federation was updated, please reload the page" : "Nextcloud-Talk Föderation wurde aktualisiert, bitte laden Sie die Seite neu",
