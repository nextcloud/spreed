OC.L10N.register(
    ...
    "- Start calls without notifying others in big conversations. You can send individual call notifications once the call has started." : "- Anrufe starten, ohne andere in großen Gesprächen zu benachrichtigen. Sie können einzelne Anrufbenachrichtigungen senden, sobald der Anruf gestartet hat.",
    ...
    "- Use the **Note to self** conversation to take notes and share information between your devices" : "- **Notiz an mich**-Unterhaltung verwenden, um Notizen zu machen und Informationen zwischen Ihren Geräten auszutauschen",
    ...
    "You started a call" : "Sie haben einen Anruf gestartet",
    ...
    "You preserved the conversation" : "Sie haben die Unterhaltung aufbewahrt",
    "An administrator preserved the conversation" : "Die Administration hat die Unterhaltung aufbewahrt",
    "{actor} stopped preserving the conversation" : "{actor} hat die speichern der Unterhaltung gestoppt",
    "You stopped preserving the conversation" : "Sie haben die Aufbewahrung der Unterhaltung gestoppt",
    ...
    "You restricted the conversation to moderators" : "Sie haben die Unterhaltung auf die Moderation beschränkt",
    ...
    "System added you" : "System hat Sie hinzugefügt",
    ...
    "An administrator removed you" : "Die Administration hat Sie entfernt",
    ...
    "An administrator invited you" : "Die Administration hat Sie eingeladen",
    ...
    "You promoted {user} to owner" : "Sie haben {user} zum Besitzer ernannt",
    "{actor} promoted you to owner" : "{actor} hat Sie zum Besitzer ernannt",
    "An administrator promoted you to owner" : "Die Administration hat Sie zum Besitzer ernannt",
    ...
    "You demoted {user} from owner" : "Sie haben {user} die Besitzrechte entzogen",
    "{actor} demoted you from owner" : "{actor} hat Ihnen die Besitzrechte entzogen",
    "An administrator demoted you from owner" : "Die Administration hat Ihnen die Besitzrechte entzogen",
    ...
    "You promoted {user} to moderator" : "Sie haben {user} Moderationsrechte zugeteilt",
    "{actor} promoted you to moderator" : "{actor} hat Ihnen Moderationsrechte zugeteilt",
    "An administrator promoted you to moderator" : "Die Administration hat Ihnen Moderationsrechte zugeteilt",
    ...
    "You demoted {user} from moderator" : "Sie haben {user} Moderationsrechte entzogen",
    "{actor} demoted you from moderator" : "{actor} hat Ihnen Moderationsrechte entzogen",
    "An administrator demoted you from moderator" : "Die Administration hat Ihnen Moderationsrechte entzogen",
    ...
    "You created thread {title}" : "Sie haben das Thema {title} erstellt",
    "{actor} renamed thread {title}" : "{actor} hat das Thema {title} umbenannt",
    "You renamed thread {title}" : "Sie haben das Thema {title} umbenannt",
    ...
    "You pinned a message" : "Sie haben eine Nachricht angepinnt",
    ...
    "You unpinned a message" : "Sie haben eine Nachricht abgelöst",
    ...
    "You removed the conversation picture" : "Sie haben das Unterhaltungsbild entfernt",
    ...
    "%1$s invited you to conversation \"%2$s\"." : "%1$s hat Sie zur Unterhaltung \"%2$s\" eingeladen.",
    "You were invited to conversation \"%s\"." : "Sie wurden zur Unterhaltung \"%s\" eingeladen.",
    ...
    "You missed a phone call from {call}" : "Sie haben einen Anruf von {call} verpasst",
    ...
    "Too many requests are send from your servers address. Please try again later." : "Es wurden zu viele Anfragen von Ihrer Serveradresse aus gesendet. Bitte später erneut versuchen.",
    ...
    "There is a problem with fetching the account information. Please check your logs for further information." : "Beim Abrufen der Kontoinformationen ist ein Problem aufgetreten. Bitte die Protokolldateien für weitere Informationen überprüfen.",
    ...
    "You can reply to messages, forward them to other chats and people, or copy message content." : "Es kann auf Nachrichten geantwortet, sie an andere Chats und Personen weitergeleitet oder Nachrichteninhalte kopiert werden.",
    ...
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "Wenn Ihr Hochleistungs-Backend-Konto STUN- und/oder TURN-Funktionen enthält, werden die Einstellungen entsprechend aktualisiert.",
    ...
    "Lobby is still active and you're not a moderator" : "Die Lobby ist weiterhin aktiv und Sie sind kein Teil der Moderation",
    ...
    "You can invite others in the participant tab of the sidebar" : "Andere Teilnehmer können auf dem Teilnehmer-Tab der Seitenleiste eingeladen werden",
    ...
    "You have been muted by a moderator" : "Sie wurden von der Moderation stummgeschaltet",
    ...
    "You" : "Sie",
    "You are sharing a screen" : "Sie teilen einen Bildschirm",
    ...
    "Do you really want to leave \"{displayName}\"?" : "Möchten Sie \"{displayName}\" verlassen?",
    ...
    "You need to promote a new moderator before you can leave the conversation" : "Sie müssen eine neue Moderation bestimmen, bevor Sie die Unterhaltung verlassen können.",
    ...
    "Only moderators are allowed to mention @all" : "Nur die Moderation dürfen @all erwähnen",
    ...
    "Stop preserving" : "Speicherung beenden",
    "Stop preserving conversation" : "Speichern der Unterhaltung beenden",
    "Conversation token" : "Unterhaltungstoken",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Wenn die Aufbewahrung dieser Unterhaltung beendet wird, kann sie gelöscht werden, der Verlauf kann gelöscht werden und die Einstellungen für Gäste und Teilnahmemöglichkeiten können wieder geändert werden.",
    ...
    "You don't have any upcoming meetings" : "Sie haben keine bevorstehenden Besprechungen",
    ...
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Nachrichten, in denen Sie erwähnt wurden, werden hier angezeigt. Sie können Personen erwähnen, indem Sie @ gefolgt von deren Namen eingeben",
    ...
    "Join conversations from other servers" : "Unterhaltungen von anderen Servern beitreten",
    ...
    "You are currently waiting in the lobby" : "Sie warten in der Lobby",
    ...
    "Select virtual library background" : "Einen virtuellen Hintergrund auswählen (Bibliothek)",
    ...
    "Pinned by you" : "Angeheftet von Ihnen",
    "Pinned by {actor}" : "Angeheftet von {actor}",
    "Until {absoluteDate}" : "Bis zum {absoluteDate}",
    ...
    "_You voted • %n vote_::_You voted • %n votes_" : ["Sie haben abgestimmt • %n Stimme","Sie haben abgestimmt • %n Stimmen"],
    ...
    "{author} (pinned by you)" : "{author} (Von Ihnen angeheftet)",
    ...
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n Stimme • Ihr Name wird an der Option angezeigt für die Sie abgestimmt haben","%n Stimmen • Ihr Name wird an den Optionen angezeigt für die Sie abgestimmt haben"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n Stimme • Ihr Name wird nicht an der Option angezeigt für die Sie abgestimmt haben","%n Stimmen • Ihr Name wird nicht an den Optionen angezeigt für die Sie abgestimmt haben"],
    "Your name will not be shown on voted options" : "Ihr Name wird nicht an den Optionen angezeigt für die Sie abgestimmt haben",
    ...
    "The server was updated, you cannot start or join a call." : "Der Server wurde aktualisiert, Sie können keinen Anruf starten oder daran teilnehmen.",
    "This call has just ended" : "Dieser Anruf wurde gerade beendet",
    "You will be able to join the call only after a moderator starts it." : "Sie können dem Anruf erst beitreten, nachdem die Moderation ihn gestartet hat.",
    ...
    "You do not have permissions to access this conversation." : "Sie haben nicht die Berechtigung auf diese Unterhaltung zuzugreifen",
    "Join a different conversation or start a new one." : "Nehmen Sie an einer anderen Unterhaltung teil oder beginnen Sie eine neue.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hey! Verwenden Sie Talk im Listenstil oder mit Sprechblasen?",
    ...
    "_An administrator added you, {user0} and %n more participant_::_An administrator added you, {user0} and %n more participants_" : ["Die Administration hat Sie, {user0} und %n weiteren Teilnehmer hinzugefügt","Die Administration hat Sie, {user0} und %n weitere Teilnehmer hinzugefügt"],
    ...
    "You promoted {user0} and {user1} to moderators" : "Sie haben {user0} und {user1} zur Moderation ernannt",
    "_You promoted {user0}, {user1} and %n more participant to moderators_::_You promoted {user0}, {user1} and %n more participants to moderators_" : ["Sie haben {user0}, {user1} und %n weiteren Teilnehmer zur Moderation ernannt","Sie haben {user0}, {user1} und %n weitere Teilnehmer zur Moderation ernannt"],
    "An administrator promoted you and {user0} to moderators" : "Die Administration hat Sie und {user0} zur Moderation ernannt",
    "{actor} promoted you and {user0} to moderators" : "{actor} hat Sie und {user0} zur Moderation ernannt",
    "_An administrator promoted you, {user0} and %n more participant to moderators_::_An administrator promoted you, {user0} and %n more participants to moderators_" : ["Die Administration hat Sie, {user0} und %n weiteren Teilnehmer zur Moderation ernannt","Die Administration hat Sie, {user0} und %n weitere  Teilnehmer zur Moderation ernannt"],
    "_{actor} promoted you, {user0} and %n more participant to moderators_::_{actor} promoted you, {user0} and %n more participants to moderators_" : ["{actor} hat Sie, {user0} und %n weiteren Teilnehmer zur Moderation ernannt","{actor} hat Sie, {user0} und %n weitere Teilnehmer zur Moderation ernannt"],
    "An administrator promoted {user0} and {user1} to moderators" : "Ein Administrator hat {user0} und {user1} zur Moderation ernannt",
    "{actor} promoted {user0} and {user1} to moderators" : "{actor} hat {user0} und {user1} zur Moderation ernannt",
    "_An administrator promoted {user0}, {user1} and %n more participant to moderators_::_An administrator promoted {user0}, {user1} and %n more participants to moderators_" : ["Die Administration hat {user0}, {user1} und %n weiteren Teilnehmer zur Moderation ernannt","Die Administration hat {user0}, {user1} und %n weitere Teilnehmer zur Moderation ernannt"],
    "_{actor} promoted {user0}, {user1} and %n more participant to moderators_::_{actor} promoted {user0}, {user1} and %n more participants to moderators_" : ["{actor} hat {user0}, {user1} und %n weiteren Teilnehmer zu Moderatoren befördert\n ","{actor} hat {user0}, {user1} und %n weitere Teilnehmer zur Moderation ernannt"],
    "You demoted {user0} and {user1} from moderators" : "Sie haben {user0} und {user1} von der Moderation abberufen",
    "_You demoted {user0}, {user1} and %n more participant from moderators_::_You demoted {user0}, {user1} and %n more participants from moderators_" : ["Sie haben {user0}, {user1} und %n weiteren Teilnehmer von der Moderation abberufen","Sie haben {user0}, {user1} und %n weitere Teilnehmer von der Moderation abberufen"],
    ...
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Planen Sie ein Meeting aus Ihrem Kalender. Ein Talk-Gespräch muss als Ort festgelegt werden, um hier angezeigt zu werden",
    ...
    "Nextcloud Talk was updated, you cannot start or join a call." : "Nextcloud Talk wurde aktualisiert. Sie können keinen Anruf starten oder beitreten.",
    "Search …" : "Suche …",
    ...
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["Offene Umfrage • %n Stimme • Ihr Name wird an den Optionen angezeigt für die Sie abgestimmt haben","Offene Umfrage • %n Stimmen • Ihr Name wird an den Optionen angezeigt für die Sie abgestimmt haben"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["Offene Umfrage • %n Stimme • Ihr Name wird nicht an den Optionen angezeigt für die Sie abgestimmt haben","Offene Umfrage • %n Stimmen • Ihr Name wird nicht an den Optionen angezeigt für die Sie abgestimmt haben"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "Offene Umfrage • Sie haben bereits abgestimmt • Ihr Name wird nicht an den Optionen angezeigt für die Sie abgestimmt haben",
    "Open poll • Your name will not be shown on voted options" : "Offene Umfrage • Ihr Name wird nicht an den Optionen angezeigt für die Sie abgestimmt haben",
    "I picked list style" : "Ich habe den Listenstil ausgewählt",
    "Hey! Are you using Talk in list style or with message bubbles?" : "Hallo! Verwenden Sie Talk im Listenstil oder mit Sprechblasen?",
