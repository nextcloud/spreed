OC.L10N.register(
    ...
    "You were invited to a <strong>talk</strong> room or had a <strong>call</strong>" : "Sie wurden in ein <strong>Gespräch</strong> eingeladen oder hatten einen <strong>Anruf</strong>",
    ...
    "You were mentioned in a group chat by a user that has since been deleted: %s" : "Sie wurden in einem Gruppenchat von einem bereits gelöschten Benutzer erwähnt, dieser war: %s",
    "You were mentioned in a group chat by a user that has since been deleted: {call}" : "Sie wurden in einem Gruppenchat von einem bereits gelöschten Benutzer erwähnt, dieser war: {call}",
    "You were mentioned in a group chat by a user that has since been deleted" : "Sie wurden in einem Gruppenchat von einem bereits gelöschten Benutzer erwähnt",
