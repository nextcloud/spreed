OC.L10N.register(
    ...
    "You closed the poll {poll}" : "Sie haben die Umfrage {poll} beendet",
    "{actor} voted on the poll {poll}" : "{actor} hat in der Umfrage {poll} abgestimmt",
    "You voted on the poll {poll}" : "Sie haben in der Umfrage {poll} abgestimmt",
    ...
    "Add a reaction to this message" : "Fügen Sie dieser Nachricht eine Reaktion hinzu",
    "Reply" : "Antworten",
