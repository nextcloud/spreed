OC.L10N.register(
    ...
    "You were mentioned in a group chat by a user that has since been deleted: %s" : "Du ble nevnt i en gruppesludring av en bruker som siden har blitt slettet: %s",
    "You were mentioned in a group chat by a user that has since been deleted: {call}" : "Du ble nevnt i en gruppesludring av en bruker som siden har blitt slettet: {call}",
    "You were mentioned in a group chat by a user that has since been deleted" : "Du ble nevnt i en gruppesludring av en bruker som siden har blitt slettet.",
