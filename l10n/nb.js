OC.L10N.register(
    ...
    "- Moderators can now create breakout rooms (requires the High-performance backend)" : "- Moderatorer kan nå opprette grupperom (krever serverdelen med høy ytelse)",
    "- Calls can now be recorded (requires the High-performance backend)" : "- Samtaler kan nå tas opp (krever serverdelen med høy ytelse)",
    ...
    "- Moderators can now ban accounts and guests to prevent them from rejoining a conversation" : "- Moderatorer kan nå utestenge kontoer og gjester for å hindre dem i å bli med i en samtale igjen",
    "- Upcoming calls from linked calendar events and out-of-office replacements are now shown in conversations" : "- Kommende anrop fra koblede kalenderhendelser og ikke-tilstedeværende erstatninger vises nå i samtaler",
    ...
    "You declined the invitation" : "Du avslo invitasjonen",
    ...
    "{actor} added team {circle}" : "{actor} la til laget {circle}",
    "You added team {circle}" : "Du la til laget {circle}",
    "An administrator added team {circle}" : "En administrator la til laget {circle}",
    "{actor} removed team {circle}" : "{actor} fjernet laget {circle}",
    "You removed team {circle}" : "Du fjernet laget {circle}",
    "An administrator removed team {circle}" : "En administrator fjernet laget {circle}",
    ...
    "File shares are currently not supported in federated conversations" : "Delte filressurser støttes for øyeblikket ikke i forente diskusjoner",
    ...
    "Call ended (Duration {duration})" : "Samtale avsluttet (Varighet {duration})",
    "Call was ended, as it reached the maximum call duration (Duration {duration})" : "Samtalen ble avsluttet da den nådde maksimal samtalevarighet (Varighet {duration})",
    "{actor} ended the call (Duration {duration})" : "{actor} avsluttet samtale (Varighet {duration})",
    "_Call with %n guest was ended, as it reached the maximum call duration (Duration {duration})_::_Call with %n guests was ended, as it reached the maximum call duration (Duration {duration})_" : ["Samtalen med %n gjest ble avsluttet da den nådde maksimal samtalevarighet (Varighet {duration})","Samtalen med %n gjester ble avsluttet da den nådde maksimal samtalevarighet (Varighet {duration})"],
    "_Call with %n guest ended (Duration {duration})_::_Call with %n guests ended (Duration {duration})_" : ["Samtale med %n gjest avsluttet (Varighet {duration})","Samtale med %n gjester avsluttet (Varighet {duration})"],
    ...
    "You missed a phone call from {call}" : "Du har et tapt telefonanrop fra {call}",
    ...
    "Error: Running version: {version}; Server needs to be updated to be compatible with this version of Talk" : "Feil: kjørende versjon: {version}; serveren må oppdateres for å være kompatibel med denne versjonen av Talk.",
    "Error: Server responded with: {error}" : "Feil: server svarte med: {error}",
    "Error: Unknown error occurred" : "Feil: ukjent feil oppstod",
    "Warning: Running version: {version}; Server does not support all features of this Talk version, missing features: {features}" : "Advarsel: kjørende versjon: {version}; server støtter ikke alle funksjonene i denne Talk-versjonen, mangler funksjoner: {features}.",
    ...
    "Trusted servers can be configured at {linkstart}Sharing settings page{linkend}." : "Klarerte servere kan konfigureres på {linkstart}siden med innstillinger for deling {linkend}.",
    "Beta" : "Beta",
    ...
    "Recording consent is required" : "Samtykke til opptak kreves",
    ...
    "Only moderators are allowed to mention @all" : "Bare moderatorer har lov til å nevne @all",
    "All participants are allowed to mention @all" : "Bare deltakere har lov til å nevne @all",
    "Participants are now allowed to mention @all." : "Deltakere har nå tillatelse til å nevne @all.",
    "Mentioning @all has been limited to moderators." : "Å nevne @all har blitt begrenset til moderatorer.",
    "Allow participants to mention @all" : "La deltakerne nevne @all",
    "Mention permissions" : "Nevn rettigheter",
    ...
    "Display video as you will see it (mirrored)" : "Vis video slik du vil se den (speilet)",
    "Display video as others will see it" : "Vis video slik andre vil se den",
    ...
    "Message deleted successfully, but a bot or Matterbridge is configured and the message might already be distributed to other services" : "Meldingen er slettet, men en robot eller Matterbridge er konfigurert, og meldingen kan allerede være distribuert til andre tjenester",
    ...
    "Load more results" : "Hent flere resultat",
    "Projects" : "Prosjekter",
    ...
    "All tasks done!" : "Alle oppgaver fullført!",
    "_{done} of %n task_::_{done} of %n tasks_" : ["{done} av %n oppgave","{done} av %n oppgaver"],
