OC.L10N.register(
    ...
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Conversation tags, grouping and sorting to organise the conversation list",
    ...
    "- Channels and announcements to broadcast information to a broader audience" : "- Channels and announcements to broadcast information to a broader audience",
    ...
    "{actor} preserved the conversation" : "{actor} preserved the conversation",
    "You preserved the conversation" : "You preserved the conversation",
    "An administrator preserved the conversation" : "An administrator preserved the conversation",
    "{actor} stopped preserving the conversation" : "{actor} stopped preserving the conversation",
    "You stopped preserving the conversation" : "You stopped preserving the conversation",
    "An administrator stopped preserving the conversation" : "An administrator stopped preserving the conversation",
    ...
    "System added you" : "System added you",
    ...
    "{actor} promoted {user} to owner" : "{actor} promoted {user} to owner",
    "You promoted {user} to owner" : "You promoted {user} to owner",
    "{actor} promoted you to owner" : "{actor} promoted you to owner",
    "An administrator promoted you to owner" : "An administrator promoted you to owner",
    "An administrator promoted {user} to owner" : "An administrator promoted {user} to owner",
    "{actor} demoted {user} from owner" : "{actor} demoted {user} from owner",
    "You demoted {user} from owner" : "You demoted {user} from owner",
    "{actor} demoted you from owner" : "{actor} demoted you from owner",
    "An administrator demoted you from owner" : "An administrator demoted you from owner",
    "An administrator demoted {user} from owner" : "An administrator demoted {user} from owner",
    ...
    "Conversation to inform a fixed audience, which can not be left." : "Conversation to inform a fixed audience, which can not be left.",
    "Channel" : "Channel",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Broadcast conversation for a large audience, where only moderators can post and calls are disabled.",
    "Classified conversation" : "Classified conversation",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled.",
    "Default" : "Default",
    ...
    "Multi-speaker view" : "Multi-speaker view",
    ...
    "You" : "You",
    "You are sharing a screen" : "You are sharing a screen",
    "Sharing this window may cause a mirroring effect" : "Sharing this window may cause a mirroring effect",
    ...
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "This conversation is preserved. It can not be deleted and its chat messages can not be cleared.",
    ...
    "This setting can not be changed while the conversation is preserved." : "This setting can not be changed while the conversation is preserved.",
    ...
    "The entered token does not match the conversation token" : "The entered token does not match the conversation token",
    "Preserve conversation" : "Preserve conversation",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed.",
    "Only the owner can change whether this conversation is preserved." : "Only the owner can change whether this conversation is preserved.",
    ...
    "Stop preserving" : "Stop preserving",
    "Stop preserving conversation" : "Stop preserving conversation",
    "Conversation token" : "Conversation token",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again.",
    "Conversation" : "Conversation",
    "To confirm, type the conversation token into the field below:" : "To confirm, type the conversation token into the field below:",
    "Ongoing" : "Ongoing",
    ...
    "Join conversations" : "Join conversations",
    ...
    "Standard image quality" : "Standard image quality",
    "Original image quality" : "Original image quality",
    "View-only for others" : "View-only for others",
    "Editable by others" : "Editable by others",
    ...
    "Post messages and reactions" : "Post messages and reactions",
    ...
    "Settings" : "Settings",
    "Show names on voted options" : "Show names on voted options",
    ...
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n vote • Your name will be shown on voted options","%n votes • Your name will be shown on voted options"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n vote • Your name will not be shown on voted options","%n votes • Your name will not be shown on voted options"],
    "Your name will not be shown on voted options" : "Your name will not be shown on voted options",
    ...
    "The last moderator of a conversation can not be demoted" : "The last moderator of a conversation can not be demoted",
    "Could not change the type of the participant" : "Could not change the type of the participant",
    ...
    "Demote from owner to moderator" : "Demote from owner to moderator",
    "Demote from owner to participant" : "Demote from owner to participant",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["This conversation will be automatically deleted for everyone after %n minute of inactivity.","This conversation will be automatically deleted for everyone after %n minutes of inactivity."],
    ...
    "Error while changing the preserved status of the conversation" : "Error while changing the preserved status of the conversation",
    ...
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["Open poll • %n vote • Your name will be shown on voted options","Open poll • %n votes • Your name will be shown on voted options"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["Open poll • %n vote • Your name will not be shown on voted options","Open poll • %n votes • Your name will not be shown on voted options"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "Open poll • You voted already • Your name will not be shown on voted options",
    "Open poll • Your name will not be shown on voted options" : "Open poll • Your name will not be shown on voted options",
