OC.L10N.register(
    ...
    ", " : ", ",
    "%s mentioned you in a private conversation" : "Používateľ %s vás spomenul v súkromnom rozhovore",
    "%s mentioned you in a group conversation: %s" : "Používateľ %s vás spomenul v skupinovom rozhovore: %s",
    "{user} mentioned you in a group conversation: {call}" : "Používateľ {user} vás spomenul v skupinovom rozhovore: {call}",
    "%s mentioned you in a group conversation" : "Používateľ %s vás spomenul v skupinovom rozhovore",
    "{user} mentioned you in a group conversation" : "Používateľ {user} vás spomenul v skupinovom rozhovore",
    "You were mentioned in a group conversation by a deleted user: %s" : "Boli ste spomenutí v skupinovom rozhovore odstráneným používateľom: %s",
    "You were mentioned in a group conversation by a deleted user: {call}" : "Boli ste spomenutí v skupinovom rozhovore odstráneným používateľom: {call}",
    "You were mentioned in a group conversation by a deleted user" : "Boli ste spomenutí v skupinovom rozhovore odstráneným používateľom",
