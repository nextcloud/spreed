OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Nechajte konverzácie plynúť:  môžete zmieniť užívateľov, reagovať na správy a ďalšie\n\nMôžete sa zmieniť o všetkých v konverzácii %s alebo o konkrétnych účastníkoch tak, že napíšete „@“ a vyberiete ich meno zo zoznamu.",
