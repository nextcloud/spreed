OC.L10N.register(
    ...
    "_%n other_::_%n others_" : ["%n ďalší","%n ďalších","%n ďalších","%n ďalších"],
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Moderátori teraz môžu pripnúť správy, aby zostali na vrchu.",
    "- Schedule a message to send it at a later time" : "- Naplánovať správu na odoslanie neskôr.",
    "- Conversation tags, grouping and sorting to organize the conversation list" : "- Štítky konverzácií, zoskupovanie a triedenie na organizáciu zoznamu konverzácií",
    "- Voice-rooms to connect spontaneously" : "- Hlasové miestnosti na spontánne spojenie",
    ...
    "- Channels and announcements to broadcast information to a broader audience" : "– Kanály a oznámenia na šírenie informácií širšiemu publiku",
    ...
    "{actor} preserved the conversation" : "{actor} zachované konverzácie",
    "You preserved the conversation" : "Zachovali ste konverzáciu",
    "An administrator preserved the conversation" : "Administrátor zachoval konverzáciu",
    "{actor} stopped preserving the conversation" : "{actor} prestal uchovávať konverzáciu",
    "You stopped preserving the conversation" : "Prestali ste uchovávať konverzáciu",
    "An administrator stopped preserving the conversation" : "Administrátor prestal uchovávať konverzáciu",
    ...
    "System added you" : "Systém vás pridal",
    "System added {user}" : "Systém pridal {user}",
    ...
    "{actor} promoted {user} to owner" : "{actor} povýšil(a) používateľa {user} na vlastníka",
    "You promoted {user} to owner" : "Povýšili ste používateľa {user} na vlastníka",
    "{actor} promoted you to owner" : "{actor} povýšil(a) vás na vlastníka",
    "An administrator promoted you to owner" : "Správca vás povýšil na vlastníka",
    "An administrator promoted {user} to owner" : "Správca povýšil používateľa {user} na vlastníka",
    "{actor} demoted {user} from owner" : "{actor} odobral(a) používateľovi {user} vlastnícke oprávnenia",
    "You demoted {user} from owner" : "Odobrali ste používateľovi {user} vlastnícke oprávnenia",
    "{actor} demoted you from owner" : "{actor} odobral(a) vám vlastnícke oprávnenia",
    "An administrator demoted you from owner" : "Správca vám odobral vlastnícke oprávnenia",
    "An administrator demoted {user} from owner" : "Správca odobral používateľovi {user} vlastnícke oprávnenia",
    ...
    "_You set the message expiration to %n day_::_You set the message expiration to %n days_" : ["Nastavili ste platnosť správy na %n deň","Nastavili ste platnosť správy na %n dni","Nastavili ste platnosť správy na %n dní","Nastavili ste platnosť správy na %n dní"],
    ...
    "Message of {user} in {conversation}" : "Správa od {user} v {conversation}",
    "Message of {user}" : "Správa od {user}",
    "Message of a deleted user in {conversation}" : "Správa od zmazaného užívateľa v {conversation}",
    "Talk conversations" : "Talk konverzácie",
    "Call %s" : "Zavolať %s",
    "Chat with %s" : "Chatovanie s %s",
    "An error occurred. Please contact your administrator." : "Vyskytla sa chyba. Prosím, kontaktujte svojho správcu.",
    "App disabled" : "Aplikácia vypnutá",
    "Conversation subfolders are disabled" : "Podpriečinky konverzácie sú vypnuté",
    "Storage quota exceeded" : "Kapacita úložiska prekročená",
    "Could not prepare conversation folder" : "Nepodarilo sa pripraviť priečinok konverzácie",
    "File not found" : "Súbor nenájdený",
    "Path must point to a file" : "Cesta musí smerovať k súboru",
    "File is not inside the conversation draft folder for this room" : "Súbor nie je vo vnútri priečinka konceptov konverzácie pre túto miestnosť",
    ...
    "Missing %s field in header line" : "Chýba %s pole v riadku hlavičky",
    ...
    "{email} is requesting the password to access {file}" : "{email} požaduje heslo pre prístup k {file}",
    ...
    "Conversation to inform a fixed audience, which can not be left." : "Konverzácia na informovanie vymedzeného publika, z ktorej nemožno odísť.",
    "Channel" : "Kanál",
    "Broadcast conversation for a large audience, where only moderators can post and calls are disabled." : "Vysielacia konverzácia pre veľké publikum, v ktorej môžu písať iba moderátori a hovory sú zakázané.",
    "Classified conversation" : "Dôverná konverzácia",
    "Locked down conversation for confidential topics, with public access, guests, SIP and recordings disabled." : "Uzamknutá konverzácia na dôverné témy, v ktorej sú zakázané verejný prístup, hostia, SIP a nahrávanie.",
    "Default" : "Predvolené",
    ...
    "Restricted conversation for internal presentations." : "Obmedzená konverzácia pre interné prezentácie.",
    "Voice room" : "Hlasová miestnosť",
    "Directly join the call, ideal for catch-ups or spontaneous meetings." : "Priamo sa pripojte k hovoru, ideálne na rýchle aktualizácie alebo spontánne stretnutia.",
    "Webinar" : "Webinár",
    "Restricted conversation with lobby enabled, ideal for public webinars." : "Obmedzená konverzácia s povoleným lobby, ideálna pre verejné webináre.",
    ...
    "Client Push is installed, this improves the punctuality of Talk notifications." : "Klient Push je nainštalovaný, čo zlepšuje presnosť notifikácií v aplikácii Talk.",
    "{notify_push} is not installed. This may lead to delayed Talk notifications." : "{notify_push} nie je nainštalovaný. To môže spôsobiť oneskorené oznámenia o hovore.",
    ...
    "Open in full application" : "Otvoriť v plnej aplikácii",
    ...
    "Limit starting calls to certain groups" : "Obmedziť začínanie hovorov na určité skupiny",
    "Limit starting a call" : "Obmedziť začatie hovoru",
    "Limit starting calls" : "Obmedziť začatie hovorov",
    "When at least one group is selected, only members of these groups can start a call. This also applies to moderators, while guests and federated users are never members of these groups. Everyone can still start a call when no group is selected." : "Ak je vybraná aspoň jedna skupina, hovor môžu začať iba členovia týchto skupín. Platí to aj pre moderátorov, pričom hostia a federovaní používatelia nikdy nie sú členmi týchto skupín. Ak nie je vybraná žiadna skupina, hovor môže naďalej začať každý.",
    "For conversations hosted on a federated server, the configuration of the host server applies instead." : "V prípade konverzácií hosťovaných na federovanom serveri sa namiesto toho uplatňuje konfigurácia hostiteľského servera.",
    ...
    "_%n user_::_%n users_" : ["%n používateľ","%n používatelia","%n používateľov","%n používateľov"],
    ...
    "Enable live transcription (generated by AI)" : "Povoliť živý prepis (generovaný AI)",
    "Enable live transcription (Live transcriptions app is not installed)" : "Povoliť živý prepis (Aplikácia Live transcriptions nie je nainštalovaná)",
    "Disable live translation" : "Vypnúť živý preklad",
    "Enable live translation (generated by AI)" : "Povoliť živý preklad (generovaný AI)",
    "Original language" : "Pôvodný jazyk",
    "Live translations app is not installed" : "Aplikácia pre živé preklady nie je nainštalovaná",
    "Original language: {languageName}" : "Pôvodný jazyk: {languageName}",
    "Translated language" : "Jazyk prekladu",
    "Translated language: {languageName}" : "Jazyk prekladu: {languageName}",
    ...
    "Multi-speaker view" : "Zobrazenie viacerých hovoriacich",
    ...
    "Failed to enable live translations" : "Nepodarilo sa povoliť živé preklady",
    "Failed to disable live translations" : "Nepodarilo sa vypnúť živé preklady",
    ...
    "This conversation is read-only" : "Táto konverzácia je len na čítanie",
    ...
    "Collapse participant bar" : "Zbaliť panel účastníkov",
    "Expand participant bar" : "Rozbaliť panel účastníkov",
    ...
    "Microphone" : "Mikrofón",
    "Speaker" : "Reproduktor",
    "Microphone settings" : "Nastavenia mikrofónu",
    ...
    "You have been muted by a moderator" : "Boli ste stlmení moderátorom",
    ...
    "You" : "Vy",
    "You are sharing a screen" : "Zdieľate obrazovku",
    "Sharing this window may cause a mirroring effect" : "Zdieľanie tohto okna môže spôsobiť zrkadlový efekt",
    ...
    "Disable" : "Zakázať",
    "Enable" : "Povoliť",
    "The bot is not available anymore" : "Bot už nie je k dispozícii",
    ...
    "Participants can use all available features." : "Účastníci môžu využívať všetky dostupné funkcie.",
    ...
    "Participants get a reduced feature set until a moderator manually grants additional permissions." : "Účastníci majú k dispozícii obmedzenú sadu funkcií, kým im moderátor manuálne nepridelí ďalšie oprávnenia.",
    ...
    "Live transcriptions app is not installed" : "Aplikácia pre živé prepisy nie je nainštalovaná",
    ...
    "Once a conversation is left, to rejoin a closed conversation, an invite is needed. An open conversation can be rejoined at any time." : "Akonáhle opustíte konverzáciu, na opätovné pripojenie sa k uzavretej konverzácii je potrebná pozvánka. K otvorenej konverzácii sa môžete kedykoľvek znova pripojiť.",
    "This conversation is preserved. It can not be deleted and its chat messages can not be cleared." : "Táto konverzácia je zachovaná. Nemožno ju vymazať a jej chatové správy nie je možné vyčistiť.",
    ...
    "Chat messages can be expired after a certain time. Note: Files shared in chat will not be deleted for the owner, but will no longer be shared in the conversation." : "Platnosť četových správ môže po určitom čase vypršať. Poznámka: Súbory zdieľané v čete sa vlastníkovi neodstránia, ale už sa nebudú zdieľať v konverzácii.",
    ...
    "This setting can not be changed while the conversation is preserved." : "Toto nastavenie sa nedá zmeniť, kým je konverzácia zachovaná.",
    ...
    "Resend invitations" : "Znovu odslať pozvánky",
    ...
    "The entered token does not match the conversation token" : "Zadaný token sa nezhoduje s tokenom konverzácie",
    "Preserve conversation" : "Zachovať konverzáciu",
    "While preserved, this conversation can not be deleted, its chat history can not be cleared and the guests and joinable settings can not be changed." : "Pokiaľ je táto konverzácia zachovaná, nemožno ju odstrániť, jej históriu chatu nemožno vymazať a nastavenia hostí ani možnosť pripojenia sa nemožno zmeniť.",
    "Only the owner can change whether this conversation is preserved." : "Iba vlastník môže zmeniť, či sa táto konverzácia zachová.",
    ...
    "Stop preserving" : "Prestaň zachovávať",
    "Stop preserving conversation" : "Prestaň uchovávať konverzáciu",
    "Conversation token" : "Token konverzácie",
    "If you stop preserving this conversation, it can be deleted, its chat history can be cleared and the guests and joinable settings can be changed again." : "Ak prestanete uchovávať túto konverzáciu, môže byť vymazaná, jej história chatu môže byť vymazaná a nastavenia pre hostí a možnosť pripojenia sa môžu byť opäť zmenené.",
    "Conversation" : "Konverzácia",
    "To confirm, type the conversation token into the field below:" : "Pre potvrdenie zadajte konverzačný token do poľa nižšie:",
    "Ongoing" : "Prebieha",
    ...
    "_and %n other attachment_::_and %n other attachments_" : ["a %n iná príloha","a %n iné prílohy","a %n iných príloh","a %n iných príloh"],
    ...
    "Join conversations" : "Pripojiť sa ku konverzáciám",
    ...
    "Calendar events with a conversation link as the location are shown here" : "Udalosti v kalendári s odkazom na konverzáciu ako miestom sa zobrazujú tu",
    ...
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match {sample1} or just {sample2}<br/>- One entry per line (e.g. {sample3})" : "Formát obsahu je CSV (hodnoty oddelené čiarkou):<br/>- Riadok hlavičky je povinný a musí zodpovedať {sample1} alebo len {sample2}<br/>- Jeden záznam na riadok (napr. {sample3})",
    ...
    "_%n email is already imported or a duplicate_::_%n emails are already imported or duplicates_" : ["%n e-mail je už importovaný alebo je duplikát","%n e-maily sú už importované alebo sú duplikáty","%n e-mailov sú už importované alebo sú duplikáty","%n e-mailu je už importovaný alebo je duplikát"],
    ...
    "Remove all tags" : "Odstrániť všetky štítky",
    "Rename tag" : "Premenovať štítok",
    "Delete tag" : "Zmazať štítok",
    "Do you really want to delete \"{name}\"? Conversations with this tag will be moved to \"Other\"." : "Naozaj chcete odstrániť \"{name}\"? Konverzácie s touto značkou budú presunuté do \"Iné\".",
    "Move up" : "Posunúť nahor",
    "Move down" : "Posunúť nadol",
    "Pending invitations" : "Čakajúce pozvánky",
    "Join conversations from other servers" : "Pripojte sa k rozhovorom z iných serverov",
    ...
    "Mentions" : "Zmienky",
    "Meetings" : "Stretnutia",
    "Sort conversations" : "Zoradiť konverzácie",
    "By recent activity" : "Podľa nedávnej aktivity",
    "Alphabetically" : "Abecedne",
    "Do not group by type" : "Nezoskupovať podľa typu",
    "Show private ones first" : "Najprv zobraz súkromné položky",
    "Show group ones first" : "Zobraziť najprv skupiny",
    ...
    "Search in app" : "Hľadať v aplikácii",
    ...
    "SIP backend is not installed" : "Backend SIP nie je nainštalovaný",
    ...
    "You are currently waiting in the lobby" : "Momentálne čakáte v lobby",
    "Enable noise suppression" : "Povoliť potlačenie šumu",
    "Reduce background noises for better voice quality" : "Znížiť šum v pozadí pre lepšiu kvalitu hlasu",
    "Basic" : "Základné",
    "Advanced" : "Rozšírené",
    "Enable echo cancellation" : "Povoliť zrušenie ozveny",
    "Minimize echo effect from own surrounding" : "Minimalizovať efekt ozveny z vlastného okolia",
    "Enable auto gain control" : "Povoliť automatické ovládanie zosilnenia",
    "Dynamically adjust microphone volume for consistent level" : "Dynamické upravovanie hlasitosti mikrofónu pre konzistentnú úroveň",
    ...
    "You can only join a voice room via a call." : "Do hlasovej miestnosti sa môžete pripojiť iba prostredníctvom hovoru.",
    ...
    "Recording backend is not installed" : "Prostredie pre nahrávanie nie je nainštalované",
    ...
    "Download folder" : "Stiahnuť priečinok",
    ...
    "This translation is AI generated and may contain mistakes." : "Táto preklad je generovaný pomocou AI a môže obsahovať chyby.",
    ...
    "Reply to thread \"{threadTitle}\"" : "Odpovedať na vlákno \"{threadTitle}\"",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Hlasovali ste • %n hlas","Hlasovali ste • %n hlasy","Hlasovali ste • %n hlasov","Hlasovali ste • %n hlasov"],
    "You voted" : "Hlasovali ste",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Kliknite pre hlasovanie • %n hlas","Kliknite pre hlasovanie • %n hlasy","Kliknite pre hlasovanie • %n hlasov","Kliknite pre hlasovanie • %n hlasov"],
    "Click to vote" : "Kliknite pre hlasovanie",
    ...
    "Generate summary with AI" : "Vygenerovať zhrnutie pomocou AI",
    ...
    "Conversation type" : "Typ konverzácie",
    "Default parameters are:" : "Predvolené parametre sú:",
    "These settings can be changed once the conversation is created." : "Tieto nastavenia je možné zmeniť až po vytvorení konverzácie.",
    ...
    "Voice message {time} ({conversation})" : "Hlasová správa {time} ({conversation})",
    ...
    "_{user1}, {user2}, {user3} and %n other are typing …_::_{user1}, {user2}, {user3} and %n others are typing …_" : ["{user1}, {user2}, {user3} a %n ďalší píšu ...","{user1}, {user2}, {user3} a %n ďalších píšu ...","{user1}, {user2}, {user3} a %n ďalších píšu ...","{user1}, {user2}, {user3} a %n ďalších píšu ..."],
    "Standard image quality" : "Štandardná kvalita obrazu",
    "Original image quality" : "Pôvodná kvalita obrazu",
    "View-only for others" : "Pre ostatných iba na čítanie",
    "Editable by others" : "Ostatní môžu upravovať",
    ...
    "Post messages" : "Odoslať správy",
    "Post messages and reactions" : "Posielať správy a reakcie",
    "Add reactions" : "Pridať reakcie",
    ...
    "Settings" : "Nastavenia",
    "Show names on voted options" : "Zobrazovať mená pri hlasovaných možnostiach",
    "Multiple answers" : "Viac odpovedí",
    "Save as draft" : "Uložiť ako koncept",
    "Export draft to file" : "Exportovať koncept do súboru",
    "_Final results • %n vote_::_Final results • %n votes_" : ["Konečné výsledky • %n hlas","Konečné výsledky • %n hlasy","Konečné výsledky • %n hlasov","Konečné výsledky • %n hlasov"],
    "_%n vote • Your name will be shown on voted options_::_%n votes • Your name will be shown on voted options_" : ["%n hlas • Vaše meno bude zobrazené pri hlasovaných možnostiach","%n hlasy • Vaše meno bude zobrazené pri hlasovaných možnostiach","%n hlasu • Vaše meno bude zobrazené pri hlasovaných možnostiach","%n hlasov • Vaše meno bude zobrazené pri hlasovaných možnostiach"],
    "_%n vote • Your name will not be shown on voted options_::_%n votes • Your name will not be shown on voted options_" : ["%n hlas • Vaše meno nebude zobrazené pri hlasovaných možnostiach","%n hlasy • Vaše meno nebude zobrazené pri hlasovaných možnostiach","%n hlasu • Vaše meno nebude zobrazené pri hlasovaných možnostiach","%n hlasov • Vaše meno nebude zobrazené pri hlasovaných možnostiach"],
    "Your name will not be shown on voted options" : "Vaše meno nebude zobrazené pri hlasovaných možnostiach",
    "You voted for this option" : "Hlasovali ste pre túto možnosť",
    "End poll" : "Ukončiť anketu",
    "Change your vote" : "Zmeniť hlasovanie",
    "Withdraw vote" : "Stiahnuť hlas",
    "Results" : "Výsledky",
    "Download as spreadsheet" : "Stiahnuť ako tabuľku",
    ...
    "The last moderator of a conversation can not be demoted" : "Poslednému moderátorovi konverzácie nemožno odobrať rolu moderátora.",
    "Could not change the type of the participant" : "Typ účastníka sa nepodarilo zmeniť",
    ...
    "Promote to owner" : "Povýšiť na vlastníka",
    "Demote from moderator" : "Zrušiť práva moderátora",
    "Promote to moderator" : "Povýšiť na moderátora",
    "Demote from owner to moderator" : "Zmeniť vlastníka na moderátora",
    "Demote from owner to participant" : "Zmeniť vlastníka na účastníka",
    "Resend invitation" : "Znovu odoslať pozvánku",
    "Send call notification" : "Odoslať notifikáciu o hovore",
    ...
    "I picked message bubbles" : "Vybral/a som si správy v bublinách",
    "I picked the list style" : "Vybral som štýl zoznamu",
    ...
    "Default language ({languageName})" : "Predvolený jazyk ({languageName})",
    "Error when trying to load the available live translation languages" : "Chyba pri pokuse o načítanie dostupných jazykov živého prekladu",
    "Error when trying to set live translation language" : "Chyba pri pokuse o nastavenie jazyka živého prekladu",
    "Set language used to show the transcriptions" : "Nastaviť jazyk, ktorý sa použije na zobrazenie prepisov",
    ...
    "Camera will be turned off when joining. Always shown if recording consent is required." : "Kamera bude pri pripojení vypnutá. Vždy sa zobrazí, ak je potrebný súhlas na nahrávanie.",
    ...
    "The server was updated, you cannot start or join a call." : "Server bol aktualizovaný, nemôžete začať ani sa pripojiť k hovoru.",
    ...
    "_This conversation will be automatically deleted for everyone after %n minute of inactivity._::_This conversation will be automatically deleted for everyone after %n minutes of inactivity._" : ["Táto konverzácia sa po %n minúte nečinnosti automaticky odstráni všetkým.","Táto konverzácia sa po %n minútach nečinnosti automaticky odstráni všetkým.","Táto konverzácia sa po %n minútach nečinnosti automaticky odstráni všetkým.","Táto konverzácia sa po %n minútach nečinnosti automaticky odstráni všetkým."],
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Táto konverzácia bude automaticky odstránená pre všetkých po %n dni nečinnosti.","Táto konverzácia bude automaticky odstránená pre všetkých po %n dňoch nečinnosti.","Táto konverzácia bude automaticky odstránená pre všetkých po %n dňoch nečinnosti.","Táto konverzácia bude automaticky odstránená pre všetkých po %n dňoch nečinnosti."],
    ...
    "Scheduled {datetime}" : "Naplánované {datetime}",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Táto konverzácia bola otvorená v inom paneli. Súčasná verzia servera nepodporuje otváranie konverzácie vo viacerých paneloch.",
    "Creating and joining a conversation with \"{userid}\"" : "Vytváranie konverzácie s užívateľom „{userid}“ a pripojenie sa k nej",
    "Join a conversation or start a new one" : "Pripojte sa ku konverzácii alebo začnite novú",
    "Error while joining the conversation" : "Chyba pri pripájaní sa ku konverzácii",
    "Another user" : "Iný používateľ",
    "Hey! Are you using the list style or message bubbles?" : "Ahoj! Používaš štýl zoznamu alebo bubliny správ?",
    ...
    "_You, {user0} and %n more participant left the call_::_You, {user0} and %n more participants left the call_" : ["Vy, {user0} a %n účastník opustili hovor","Vy, {user0} a %n účastníci opustili hovor","Vy, {user0} a %n účastníkov opustili hovor","Vy, {user0} a %n účastníkov opustili hovor"],
    "{user0} and {user1} left the call" : "{user0} a {user1} opustili hovor",
    "_{user0}, {user1} and %n more participant left the call_::_{user0}, {user1} and %n more participants left the call_" : ["{user0}, {user1} a %n ďalší účastník opustili hovor","{user0}, {user1} a %n ďalší účastníci opustili hovor","{user0}, {user1} a %n ďalších účastníkov opustili hovor","{user0}, {user1} a %n ďalších účastníkov opustili hovor"],
    ...
    "_An administrator promoted {user0}, {user1} and %n more participant to moderators_::_An administrator promoted {user0}, {user1} and %n more participants to moderators_" : ["Administrátor povýšil {user0}, {user1} a %n ďalšieho účastníka na moderátorov","Administrátor povýšil {user0}, {user1} a %n ďalších účastníkov na moderátorov","Administrátor povýšil {user0}, {user1} a %n ďalších účastníkov na moderátorov","Administrátor povýšil {user0}, {user1} a %n ďalších účastníkov na moderátorov"],
    ...
    "_An administrator demoted {user0}, {user1} and %n more participant from moderators_::_An administrator demoted {user0}, {user1} and %n more participants from moderators_" : ["Administrátor degradoval {user0}, {user1} a ďalšieho %n účastníka z moderátorov","Administrátor degradoval {user0}, {user1} a ďalších %n účastníkov z moderátorov","Administrátor degradoval {user0}, {user1} a ďalších %n účastníkov z moderátorov","Administrátor degradoval {user0}, {user1} a ďalších %n účastníkov z moderátorov"],
    ...
    "The server was updated." : "Server bol aktualizovaný.",
    ...
    "Error while changing the preserved status of the conversation" : "Chyba pri zmene stavu uchovania konverzácie",
    ...
    "Error renaming tag" : "Chyba pri premenovaní štítku",
    "Error deleting tag" : "Chyba pri mazaní štítka",
    "Error reordering tags" : "Chyba pri preusporiadaní štítkov",
    ...
    "The server is in maintenance mode." : "Server je v režime údržby.",
    "Federated server was updated." : "Združený server bol aktualizovaný.",
    ...
    "_%n week_::_%n weeks_" : ["%n týždeň","%n týždne","%n týždňov","%n týždňa"],
    ...
    "Connecting is taking longer than expected …" : "Pripojenie trvá dlhšie, než sa očakávalo…",
    "Failed to connect. Retrying …" : "Nepodarilo sa pripojiť. Skúšam znova…",
    "Failed to connect. The signaling server may be set up incorrectly" : "Nepodarilo sa pripojiť. Signálny server môže byť nesprávne nastavený.",
    "High-performance backend needs to be updated." : "Vysokovýkonný backend je potrebné aktualizovať.",
    "The server is misconfigured. Please contact your administration." : "Server je nesprávne nakonfigurovaný. Obráťte sa na svojho administrátora.",
    ...
    "_Poll results • %n vote_::_Poll results • %n votes_" : ["Výsledky ankety • %n hlas","Výsledky ankety • %n hlasy","Výsledky ankety • %n hlasov","Výsledky ankety • %n hlasu"],
    ...
    "Enable live translation" : "Povoliť živý preklad",
    "_Open poll • %n vote • Your name will be shown on voted options_::_Open poll • %n votes • Your name will be shown on voted options_" : ["Otvorená anketa • %n hlas • Vaše meno bude zobrazené pri hlasovaných možnostiach","Otvorená anketa • %n hlasy • Vaše meno bude zobrazené pri hlasovaných možnostiach","Otvorená anketa • %n hlasu • Vaše meno bude zobrazené pri hlasovaných možnostiach","Otvorená anketa • %n hlasov • Vaše meno bude zobrazené pri hlasovaných možnostiach"],
    "_Open poll • %n vote • Your name will not be shown on voted options_::_Open poll • %n votes • Your name will not be shown on voted options_" : ["Otvorená anketa • %n hlas • Vaše meno nebude zobrazené pri hlasovaných možnostiach","Otvorená anketa • %n hlasy • Vaše meno nebude zobrazené pri hlasovaných možnostiach","Otvorená anketa • %n hlasu • Vaše meno nebude zobrazené pri hlasovaných možnostiach","Otvorená anketa • %n hlasov • Vaše meno nebude zobrazené pri hlasovaných možnostiach"],
    "Open poll • You voted already • Your name will not be shown on voted options" : "Otvorená anketa • Už ste hlasovali • Vaše meno nebude zobrazené pri hlasovaných možnostiach",
    "Open poll • Your name will not be shown on voted options" : "Otvorená anketa • Vaše meno nebude zobrazené pri hlasovaných možnostiach",
