OC.L10N.register(
    ...
    "{actor} added {user} to the conversation" : "{actor} přidal {user} do konverzace",
    "{actor} removed {user} from the conversation" : "{actor} odebral(a) {user} uživatele z konverzace",
