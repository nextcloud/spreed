OC.L10N.register(
    ...
    "Client Push" : "Push klienta",
    "Client Push is installed, this improves the performance of desktop clients." : "Push klienta je nainstalované – toto zlepší výkon klientů pro počítač.",
    ...
    "Thread origin message expired" : "Platnost původní zprávy vlákna skončila",
    "{actor}: {lastMessage}" : "{actor}: {lastMessage}",
    "Subscribe to thread" : "Přihlásit se k odběru vlákna",
    ...
    "Do not show the device preview screen before joining a call" : "Před připojením se k hovoru nezobrazovat náhledovou obrazovku zařízení",
    "Preview screen will still be shown if recording consent is required" : "Obrazovka náhledu bude i tak zobrazeno v případě, že je zapotřebí souhlasu s pořizováním nahrávky",
    ...
    "Unsubscribe from thread" : "Odhlásit se z odběru vlákna",
