OC.L10N.register(
    ...
    "- Moderators can now pin messages so they are kept at the top" : "- Moderátoři nyní mohou připínat zprávy, takže zůstávají nahoře",
    "- Schedule a message to send it at a later time" : "- Naplánovat zprávu pro její odeslání později",
    ...
    "Accept" : "Přijmout",
    "Decline" : "Odmítnout",
    "{user1} invited you to a federated conversation" : "{user1} vás pozval(a) do federované konverzace",
    ...
    "{guest} (guest) mentioned group {group} in conversation {call}" : "{guest} (host) zmínil(a) skupinu {group} v konverzaci {call}",
    "{guest} (guest) mentioned team {team} in conversation {call}" : "{guest} (host) zmínil(a) tým {team} v konverzaci {call}",
    "{guest} (guest) mentioned everyone in conversation {call}" : "{guest} (host) zmínil(a) všechny v konverzaci {call}",
    ...
    "Enable live transcription (generated by AI)" : "Zapnout průběžné přepisování do textu (vytvářeno AI)",
    "Disable live translation" : "Vypnout překlad v reálném čase",
    "Enable live translation (generated by AI)" : "Zapnout průběžné překládání (vytvářeno AI)",
    "Original language" : "Původní jazyk",
    "Original language: {languageName}" : "Původní jazyk: {languageName}",
    "Translated language" : "Přeložený jazyk",
    "Translated language: {languageName}" : "Přeložený jazyk: {languageName}",
    ...
    "Failed to enable live translations" : "Nepodařilo se zapnout průběžné překládání",
    "Failed to disable live translations" : "Nepodařilo se vypnout průběžné překládání",
    ...
    "Enable video. Your connection will be briefly interrupted when enabling the video for the first time" : "Zapnout video. Při jeho prvním zapnutí bude spojení nakrátko přerušeno",
    "Camera" : "Kamera",
    "Show presenter" : "Zobrazit přezentujícího",
    "You" : "Vy",
    ...
    "Preserve conversation" : "Zachovat konverzaci",
    ...
    "Stop preserving" : "Zastavit zachovávání",
    ...
    "Join conversations from other servers" : "Připojit se ke konverzacím z ostatních serverů",
    "From {user} at {remoteServer}" : "Od {user} v {remoteServer}",
    "Decline invitation" : "Odmítnout pozvání",
    "Accept invitation" : "Přijmout pozvání",
    "No pending invitations" : "Žádné nevyřízené pozvánky",
    "Home" : "Domů",
    "Unread" : "Nastavit jako nepřečtené",
    "Mentions" : "Zmínění",
    "Meetings" : "Schůze",
    "Sort conversations" : "Seřadit konverzace",
    ...
    "Enable noise suppression" : "Zapnout potlačování hluku",
    "Reduce background noises for better voice quality" : "Omezit hluk na pozadí pro lepší kvalitu hlasu",
    "Basic" : "Základní",
    "Advanced" : "Pokročilé",
    "Enable echo cancellation" : "Zapnout potlačování ozvěn",
    "Minimize echo effect from own surrounding" : "Minimalizovat ozvěnu ze svého okolí",
    "Enable auto gain control" : "Zapnout automatickou regulaci zesílení",
    "Dynamically adjust microphone volume for consistent level" : "Dynamicky uzpůsobí zesílení mikrofonu, aby snímal pořád stejně hlasitě",
    ...
    "7 days" : "7 dnů",
    "30 days" : "30 dnů",
    "Until unpin" : "Dokud není připnutí zrušeno",
    "Clear reminder – {timeLocale}" : "Odstranit připomínku – {timeLocale}",
    "Edited by {actor}" : "Upravil(a) {actor}",
    "Pinned by you" : "Připnuto vámi",
    "Pinned by {actor}" : "Připnul/a {actor}",
    ...
    "Unpin message" : "Zrušit připnutí zprávy",
    ...
    "Keep pinned for" : "Ponechat připnuté po dobu",
    "Set custom period" : "Nastavit uživatelsky určené období",
    ...
    "Reply to thread \"{threadTitle}\"" : "Odpovědět na vlákno „{threadTitle}“",
    "_You voted • %n vote_::_You voted • %n votes_" : ["Hlasovali jste • %n hlas","Hlasovali jste • %n hlasy","Hlasovali jste • %n hlasů","Hlasovali jste • %n hlasy"],
    "You voted" : "Hlasovali jste",
    "_Click to vote • %n vote_::_Click to vote • %n votes_" : ["Kliknutím hlasujte • %n hlas","Kliknutím hlasujte • %n hlasy","Kliknutím hlasujte • %n hlasů","Kliknutím hlasujte • %n hlasy"],
    "Click to vote" : "Kliknutím hlasujte",
    ...
    "Generate summary with AI" : "Vytvořit shrnutí pomocí AI",
    ...
    "Show scheduled messages" : "Zobrazit naplánované zprávy",
    "Cancel editing" : "Zrušit upravování",
    "Schedule message" : "Naplánovat zprávu",
    ...
    "Voice message {time} ({conversation})" : "Hlasová zpráva {time} ({conversation})",
    ...
    "_Final results • %n vote_::_Final results • %n votes_" : ["Konečné výsledky • %n hlas","Konečné výsledky • %n hlasy","Konečné výsledky • %n hlasů","Konečné výsledky • %n hlasy"],
    "Your vote is anonymous" : "Vaše hlasování je anonymní",
    "You voted for this option" : "Hlasovali jste pro tuto možnost",
    "End poll" : "Ukončit anketu",
    "Change your vote" : "Změňte svůj hlas",
    "Withdraw vote" : "Vzít hlasování zpět",
    "Results" : "Výsledky",
    ...
    "Remove group and members" : "Odebrat skupinu a uživatele",
    ...
    "I picked the list style" : "Vybral jsem si styl seznamu",
    ...
    "Invalid language ({languageId})" : "Neplatný jazyk ({languageId})",
    "Default language" : "Výchozí jazyk",
    "Default language ({languageName})" : "Výchozí jazyk ({languageName})",
    "Error when trying to load the available live translation languages" : "Chyba při pokusu o načtení jazyků, dostupných pro průběžný překlad",
    "Error when trying to set live translation language" : "Chyba při pokusu o nastavení jazyka průběžného překladu",
    "Set language used to show the transcriptions" : "Nastavit jazyk použitý pro zobrazení přepisu do textu",
    ...
    "Start call" : "Zavolat",
    "The server was updated, you cannot start or join a call." : "Server byl zaktualizován – nemůžete zahájit nebo se připojit do volání.",
    ...
    "Scheduled messages" : "Naplánované zprávy",
    ...
    "_This conversation will be automatically deleted for everyone after %n day of inactivity._::_This conversation will be automatically deleted for everyone after %n days of inactivity._" : ["Tato konverzace bude automaticky smazána pro kohokoli po uplynutí %n dne neaktivity.","Tato konverzace bude automaticky smazána pro kohokoli po uplynutí %n dnů neaktivity.","Tato konverzace bude automaticky smazána pro kohokoli po uplynutí %n dnů neaktivity.","Tato konverzace bude automaticky smazána pro kohokoli po uplynutí %n dnů neaktivity."],
    ...
    "Scheduled {datetime}" : "Naplánováno {datetime}",
    ...
    "This conversation was opened in another tab. The current server version does not support opening a conversation in multiple tabs." : "Tato konverzace byla otevřena v jiném panelu. Stávající verze serveru nepodporuje otevírání konverzace ve vícero panelech.",
    ...
    "Hey! Are you using the list style or message bubbles?" : "Hej! Používáte styl seznamu nebo bubliny zpráv?",
    ...
    "The server was updated." : "Server byl zaktualizován.",
    ...
    "The server is in maintenance mode." : "Server se nachází v režimu údržby.",
    "Federated server was updated." : "Federovaný server byl zaktualizován.",
