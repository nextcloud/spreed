...
class LiveTranscriptionController extends AEnvironmentAwareOCSController {
	 ...
	 * ("origin_languages") and a list of target languages ("target_languages").
	 * Any origin language can be translated to any target language.
	 *
	 * @return DataResponse<Http::STATUS_OK, array<string, array<string, TalkLiveTranscriptionLanguage>>, array{}>|DataResponse<Http::STATUS_BAD_REQUEST, array{error: 'app'|'translations'}, array{}>
	 *
	 * 200: Available languages got successfully
	 ...
	 *
	 * Translations are also implicitly enabled or disabled depending on whether
	 * the target language matches the original transcription language or not.
	 *
	 * @param string $targetLanguageId the ID of the language to set
	 * @return DataResponse<Http::STATUS_OK, null, array{}>|DataResponse<Http::STATUS_BAD_REQUEST, array{error: 'app'|'translations'}, array{}>
	 *
