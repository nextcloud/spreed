...
class Notifier {
	 ...
	 * @param Room $chat
	 * @param array $list
	 * @psalm-param array<int, array{id: string, type: string, reason: string, ?string: sourceId}> $list
	 * @return array
	 * @psalm-return array<int, array{id: string, type: string, reason: string, ?string: sourceId, ?Attendee: attendee}>
	 */
