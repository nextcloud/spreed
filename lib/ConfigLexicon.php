...
PROMPT;
	...
	public function getAppConfigs(): array {
		return [
			...
			new Entry(Config::ALLOWED_START_CALLS, ValueType::INT, 0, definition: 'Who can start a call, see https://github.com/nextcloud/spreed/blob/main/docs/constants.md#start-call '),
		];
	}
