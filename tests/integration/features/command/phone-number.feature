Feature: command/phone-number
  ...
  Scenario: Configuring a phone number
    ...
    And the command output contains the text "Phone number is invalid."
  ...
  Scenario: Phone number validation
    ...
    Then the command failed with exit code 0
    And the command output contains the text "Phone number 004971112347 is now assigned to participant1"
    ...
    Then the command failed with exit code 0
    And the command output contains the text "Phone number 071112348 is now assigned to participant1"
    ...
    Then the command failed with exit code 0
    And the command output contains the text "Phone number 00112345678901 is now assigned to participant1"
