...
STATUS:CONFIRMED
SUMMARY:Test
LOCATION:https://nextcloud.local/index.php/call/twt33xa5
END:VEVENT
BEGIN:VTIMEZONE
TZID:Europe/Vienna
BEGIN:DAYLIGHT
...
EOD;
	...
	public function testRoomNotFound(): void {
		$event = new CalendarObjectUpdatedEvent(1, [], [], ['calendardata' => $this->calData]);
	...
	public function testUserNotParticipant(): void {
		$event = new CalendarObjectUpdatedEvent(1, [], [], ['calendardata' => $this->calData]);
	...
	public function testUserNotModerator(): void {
		$event = new CalendarObjectUpdatedEvent(1, [], [], ['calendardata' => $this->calData]);
	...
	public function testRoomNotEventRoom(): void {
		$event = new CalendarObjectUpdatedEvent(1, [], [], ['calendardata' => $this->calData]);
...
EOF;
	...
	public function testTime(): void {
		$event = new CalendarObjectCreatedEvent(1, [], [], ['calendardata' => $this->calData]);
		$room = $this->createMock(Room::class);
		$room->method('getObjectType')->willReturn(Room::OBJECT_TYPE_EVENT);
		$participant = $this->createMock(Participant::class);
		$participant->method('hasModeratorPermissions')->willReturn(true);
